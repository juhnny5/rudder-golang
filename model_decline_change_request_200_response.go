...
// checks if the DeclineChangeRequest200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeclineChangeRequest200Response{}

// DeclineChangeRequest200Response struct for DeclineChangeRequest200Response
type DeclineChangeRequest200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ListChangeRequests200ResponseData `json:"data"`
}

type _DeclineChangeRequest200Response DeclineChangeRequest200Response
...
func NewDeclineChangeRequest200Response(result string, action string, data ListChangeRequests200ResponseData) *DeclineChangeRequest200Response {
	this := DeclineChangeRequest200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *DeclineChangeRequest200Response) GetData() ListChangeRequests200ResponseData {
	if o == nil {
		var ret ListChangeRequests200ResponseData
		return ret
	}
...
func (o DeclineChangeRequest200Response) MarshalJSON() ([]byte, error) {
...
func (o DeclineChangeRequest200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeclineChangeRequest200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeclineChangeRequest200Response := _DeclineChangeRequest200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeclineChangeRequest200Response)

	if err != nil {
		return err
	}

	*o = DeclineChangeRequest200Response(varDeclineChangeRequest200Response)

	return err
}

type NullableDeclineChangeRequest200Response struct {
	value *DeclineChangeRequest200Response
	isSet bool
}

func (v NullableDeclineChangeRequest200Response) Get() *DeclineChangeRequest200Response {
	return v.value
}

func (v *NullableDeclineChangeRequest200Response) Set(val *DeclineChangeRequest200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeclineChangeRequest200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeclineChangeRequest200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeclineChangeRequest200Response(val *DeclineChangeRequest200Response) *NullableDeclineChangeRequest200Response {
	return &NullableDeclineChangeRequest200Response{value: val, isSet: true}
}

func (v NullableDeclineChangeRequest200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeclineChangeRequest200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
