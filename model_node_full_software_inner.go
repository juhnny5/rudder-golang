...
// checks if the NodeFullSoftwareInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullSoftwareInner{}

// NodeFullSoftwareInner struct for NodeFullSoftwareInner
type NodeFullSoftwareInner struct {
	...
	License *NodeFullSoftwareInnerLicense `json:"license,omitempty"`
}
...
func (o *NodeFullSoftwareInner) GetLicense() NodeFullSoftwareInnerLicense {
	if o == nil || IsNil(o.License) {
		var ret NodeFullSoftwareInnerLicense
		return ret
	}
	return *o.License
}
...
// SetLicense gets a reference to the given NodeFullSoftwareInnerLicense and assigns it to the License field.
func (o *NodeFullSoftwareInner) SetLicense(v NodeFullSoftwareInnerLicense) {
	o.License = &v
}

func (o NodeFullSoftwareInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullSoftwareInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullSoftwareInner struct {
	value *NodeFullSoftwareInner
	isSet bool
}

func (v NullableNodeFullSoftwareInner) Get() *NodeFullSoftwareInner {
	return v.value
}

func (v *NullableNodeFullSoftwareInner) Set(val *NodeFullSoftwareInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullSoftwareInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullSoftwareInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullSoftwareInner(val *NodeFullSoftwareInner) *NullableNodeFullSoftwareInner {
	return &NullableNodeFullSoftwareInner{value: val, isSet: true}
}

func (v NullableNodeFullSoftwareInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullSoftwareInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
