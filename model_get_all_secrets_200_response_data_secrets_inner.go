...
// checks if the GetAllSecrets200ResponseDataSecretsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllSecrets200ResponseDataSecretsInner{}

// GetAllSecrets200ResponseDataSecretsInner struct for GetAllSecrets200ResponseDataSecretsInner
type GetAllSecrets200ResponseDataSecretsInner struct {
...
type _GetAllSecrets200ResponseDataSecretsInner GetAllSecrets200ResponseDataSecretsInner
...
func NewGetAllSecrets200ResponseDataSecretsInner(name string, description string) *GetAllSecrets200ResponseDataSecretsInner {
	this := GetAllSecrets200ResponseDataSecretsInner{}
	this.Name = name
...
func (o GetAllSecrets200ResponseDataSecretsInner) MarshalJSON() ([]byte, error) {
...
func (o GetAllSecrets200ResponseDataSecretsInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetAllSecrets200ResponseDataSecretsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllSecrets200ResponseDataSecretsInner := _GetAllSecrets200ResponseDataSecretsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllSecrets200ResponseDataSecretsInner)

	if err != nil {
		return err
	}

	*o = GetAllSecrets200ResponseDataSecretsInner(varGetAllSecrets200ResponseDataSecretsInner)

	return err
}

type NullableGetAllSecrets200ResponseDataSecretsInner struct {
	value *GetAllSecrets200ResponseDataSecretsInner
	isSet bool
}

func (v NullableGetAllSecrets200ResponseDataSecretsInner) Get() *GetAllSecrets200ResponseDataSecretsInner {
	return v.value
}

func (v *NullableGetAllSecrets200ResponseDataSecretsInner) Set(val *GetAllSecrets200ResponseDataSecretsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllSecrets200ResponseDataSecretsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllSecrets200ResponseDataSecretsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllSecrets200ResponseDataSecretsInner(val *GetAllSecrets200ResponseDataSecretsInner) *NullableGetAllSecrets200ResponseDataSecretsInner {
	return &NullableGetAllSecrets200ResponseDataSecretsInner{value: val, isSet: true}
}

func (v NullableGetAllSecrets200ResponseDataSecretsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllSecrets200ResponseDataSecretsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
