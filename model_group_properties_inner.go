...
// checks if the GroupPropertiesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPropertiesInner{}

// GroupPropertiesInner struct for GroupPropertiesInner
type GroupPropertiesInner struct {
	// Property name
...
type _GroupPropertiesInner GroupPropertiesInner
...
func (o GroupPropertiesInner) MarshalJSON() ([]byte, error) {
...
func (o GroupPropertiesInner) ToMap() (map[string]interface{}, error) {
...
func (o *GroupPropertiesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupPropertiesInner := _GroupPropertiesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupPropertiesInner)

	if err != nil {
		return err
	}

	*o = GroupPropertiesInner(varGroupPropertiesInner)

	return err
}

type NullableGroupPropertiesInner struct {
	value *GroupPropertiesInner
	isSet bool
}

func (v NullableGroupPropertiesInner) Get() *GroupPropertiesInner {
	return v.value
}

func (v *NullableGroupPropertiesInner) Set(val *GroupPropertiesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupPropertiesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupPropertiesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupPropertiesInner(val *GroupPropertiesInner) *NullableGroupPropertiesInner {
	return &NullableGroupPropertiesInner{value: val, isSet: true}
}

func (v NullableGroupPropertiesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupPropertiesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
