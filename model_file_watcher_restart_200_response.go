...
// checks if the FileWatcherRestart200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileWatcherRestart200Response{}

// FileWatcherRestart200Response struct for FileWatcherRestart200Response
type FileWatcherRestart200Response struct {
...
type _FileWatcherRestart200Response FileWatcherRestart200Response
...
func NewFileWatcherRestart200Response(result string, action string, data string) *FileWatcherRestart200Response {
	this := FileWatcherRestart200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o FileWatcherRestart200Response) MarshalJSON() ([]byte, error) {
...
func (o FileWatcherRestart200Response) ToMap() (map[string]interface{}, error) {
...
func (o *FileWatcherRestart200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varFileWatcherRestart200Response := _FileWatcherRestart200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFileWatcherRestart200Response)

	if err != nil {
		return err
	}

	*o = FileWatcherRestart200Response(varFileWatcherRestart200Response)

	return err
}

type NullableFileWatcherRestart200Response struct {
	value *FileWatcherRestart200Response
	isSet bool
}

func (v NullableFileWatcherRestart200Response) Get() *FileWatcherRestart200Response {
	return v.value
}

func (v *NullableFileWatcherRestart200Response) Set(val *FileWatcherRestart200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFileWatcherRestart200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFileWatcherRestart200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileWatcherRestart200Response(val *FileWatcherRestart200Response) *NullableFileWatcherRestart200Response {
	return &NullableFileWatcherRestart200Response{value: val, isSet: true}
}

func (v NullableFileWatcherRestart200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileWatcherRestart200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
