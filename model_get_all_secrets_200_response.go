...
// checks if the GetAllSecrets200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllSecrets200Response{}

// GetAllSecrets200Response struct for GetAllSecrets200Response
type GetAllSecrets200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetAllSecrets200ResponseData `json:"data"`
}

type _GetAllSecrets200Response GetAllSecrets200Response
...
func (o *GetAllSecrets200Response) GetData() GetAllSecrets200ResponseData {
	if o == nil {
		var ret GetAllSecrets200ResponseData
		return ret
	}
...
func (o GetAllSecrets200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAllSecrets200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAllSecrets200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllSecrets200Response := _GetAllSecrets200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllSecrets200Response)

	if err != nil {
		return err
	}

	*o = GetAllSecrets200Response(varGetAllSecrets200Response)

	return err
}

type NullableGetAllSecrets200Response struct {
	value *GetAllSecrets200Response
	isSet bool
}

func (v NullableGetAllSecrets200Response) Get() *GetAllSecrets200Response {
	return v.value
}

func (v *NullableGetAllSecrets200Response) Set(val *GetAllSecrets200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllSecrets200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllSecrets200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllSecrets200Response(val *GetAllSecrets200Response) *NullableGetAllSecrets200Response {
	return &NullableGetAllSecrets200Response{value: val, isSet: true}
}

func (v NullableGetAllSecrets200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllSecrets200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
