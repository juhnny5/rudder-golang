...
// checks if the RuleTargetsInnerInclude type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleTargetsInnerInclude{}

// RuleTargetsInnerInclude list of groups to include in rule application
type RuleTargetsInnerInclude struct {
...
func (o RuleTargetsInnerInclude) MarshalJSON() ([]byte, error) {
...
func (o RuleTargetsInnerInclude) ToMap() (map[string]interface{}, error) {
...
type NullableRuleTargetsInnerInclude struct {
	value *RuleTargetsInnerInclude
	isSet bool
}

func (v NullableRuleTargetsInnerInclude) Get() *RuleTargetsInnerInclude {
	return v.value
}

func (v *NullableRuleTargetsInnerInclude) Set(val *RuleTargetsInnerInclude) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleTargetsInnerInclude) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleTargetsInnerInclude) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleTargetsInnerInclude(val *RuleTargetsInnerInclude) *NullableRuleTargetsInnerInclude {
	return &NullableRuleTargetsInnerInclude{value: val, isSet: true}
}

func (v NullableRuleTargetsInnerInclude) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleTargetsInnerInclude) UnmarshalJSON(src []byte) error {
	v.isSet = true
