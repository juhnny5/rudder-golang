...
// checks if the CampaignEventResultNodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEventResultNodesInner{}

// CampaignEventResultNodesInner Campaign result for a Node
type CampaignEventResultNodesInner struct {
	// Node id
	NodeId *string `json:"nodeId,omitempty"`
	// Campaign status
	Status *string `json:"status,omitempty"`
	// Number of software updated
	NbPackages *int32 `json:"nbPackages,omitempty"`
...
func NewCampaignEventResultNodesInner() *CampaignEventResultNodesInner {
	this := CampaignEventResultNodesInner{}
	return &this
}
...
// GetNbPackages returns the NbPackages field value if set, zero value otherwise.
func (o *CampaignEventResultNodesInner) GetNbPackages() int32 {
	if o == nil || IsNil(o.NbPackages) {
		var ret int32
		return ret
	}
	return *o.NbPackages
...
// GetNbPackagesOk returns a tuple with the NbPackages field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CampaignEventResultNodesInner) GetNbPackagesOk() (*int32, bool) {
	if o == nil || IsNil(o.NbPackages) {
		return nil, false
	}
	return o.NbPackages, true
}
...
// SetNbPackages gets a reference to the given int32 and assigns it to the NbPackages field.
...
func (o CampaignEventResultNodesInner) MarshalJSON() ([]byte, error) {
...
func (o CampaignEventResultNodesInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NbPackages) {
		toSerialize["nbPackages"] = o.NbPackages
	}
	if !IsNil(o.Date) {
...
type NullableCampaignEventResultNodesInner struct {
	value *CampaignEventResultNodesInner
	isSet bool
}

func (v NullableCampaignEventResultNodesInner) Get() *CampaignEventResultNodesInner {
	return v.value
}

func (v *NullableCampaignEventResultNodesInner) Set(val *CampaignEventResultNodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignEventResultNodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignEventResultNodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignEventResultNodesInner(val *CampaignEventResultNodesInner) *NullableCampaignEventResultNodesInner {
	return &NullableCampaignEventResultNodesInner{value: val, isSet: true}
}

func (v NullableCampaignEventResultNodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignEventResultNodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
