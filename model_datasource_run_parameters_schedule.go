...
// checks if the DatasourceRunParametersSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasourceRunParametersSchedule{}
...
func NewDatasourceRunParametersSchedule() *DatasourceRunParametersSchedule {
	this := DatasourceRunParametersSchedule{}
	return &this
}
...
func (o DatasourceRunParametersSchedule) MarshalJSON() ([]byte, error) {
...
func (o DatasourceRunParametersSchedule) ToMap() (map[string]interface{}, error) {
...
type NullableDatasourceRunParametersSchedule struct {
	value *DatasourceRunParametersSchedule
	isSet bool
}

func (v NullableDatasourceRunParametersSchedule) Get() *DatasourceRunParametersSchedule {
	return v.value
}

func (v *NullableDatasourceRunParametersSchedule) Set(val *DatasourceRunParametersSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasourceRunParametersSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasourceRunParametersSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasourceRunParametersSchedule(val *DatasourceRunParametersSchedule) *NullableDatasourceRunParametersSchedule {
	return &NullableDatasourceRunParametersSchedule{value: val, isSet: true}
}

func (v NullableDatasourceRunParametersSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasourceRunParametersSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
