...
// checks if the NodeFullEnvironmentVariablesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullEnvironmentVariablesInner{}

// NodeFullEnvironmentVariablesInner struct for NodeFullEnvironmentVariablesInner
type NodeFullEnvironmentVariablesInner struct {
...
func NewNodeFullEnvironmentVariablesInner() *NodeFullEnvironmentVariablesInner {
	this := NodeFullEnvironmentVariablesInner{}
	return &this
}
...
func (o NodeFullEnvironmentVariablesInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullEnvironmentVariablesInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullEnvironmentVariablesInner struct {
	value *NodeFullEnvironmentVariablesInner
	isSet bool
}

func (v NullableNodeFullEnvironmentVariablesInner) Get() *NodeFullEnvironmentVariablesInner {
	return v.value
}

func (v *NullableNodeFullEnvironmentVariablesInner) Set(val *NodeFullEnvironmentVariablesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullEnvironmentVariablesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullEnvironmentVariablesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullEnvironmentVariablesInner(val *NodeFullEnvironmentVariablesInner) *NullableNodeFullEnvironmentVariablesInner {
	return &NullableNodeFullEnvironmentVariablesInner{value: val, isSet: true}
}

func (v NullableNodeFullEnvironmentVariablesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullEnvironmentVariablesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
