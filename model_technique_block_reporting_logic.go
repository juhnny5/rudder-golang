...
// checks if the TechniqueBlockReportingLogic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueBlockReportingLogic{}

// TechniqueBlockReportingLogic struct for TechniqueBlockReportingLogic
type TechniqueBlockReportingLogic struct {
...
func NewTechniqueBlockReportingLogic() *TechniqueBlockReportingLogic {
	this := TechniqueBlockReportingLogic{}
	return &this
}
...
func (o TechniqueBlockReportingLogic) MarshalJSON() ([]byte, error) {
...
func (o TechniqueBlockReportingLogic) ToMap() (map[string]interface{}, error) {
...
type NullableTechniqueBlockReportingLogic struct {
	value *TechniqueBlockReportingLogic
	isSet bool
}

func (v NullableTechniqueBlockReportingLogic) Get() *TechniqueBlockReportingLogic {
	return v.value
}

func (v *NullableTechniqueBlockReportingLogic) Set(val *TechniqueBlockReportingLogic) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueBlockReportingLogic) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueBlockReportingLogic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueBlockReportingLogic(val *TechniqueBlockReportingLogic) *NullableTechniqueBlockReportingLogic {
	return &NullableTechniqueBlockReportingLogic{value: val, isSet: true}
}

func (v NullableTechniqueBlockReportingLogic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueBlockReportingLogic) UnmarshalJSON(src []byte) error {
	v.isSet = true
