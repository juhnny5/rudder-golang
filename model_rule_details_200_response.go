...
// checks if the RuleDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleDetails200Response{}

// RuleDetails200Response struct for RuleDetails200Response
type RuleDetails200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ListRules200ResponseData `json:"data"`
}

type _RuleDetails200Response RuleDetails200Response
...
func (o *RuleDetails200Response) GetData() ListRules200ResponseData {
	if o == nil {
		var ret ListRules200ResponseData
		return ret
	}
...
func (o RuleDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o RuleDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *RuleDetails200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleDetails200Response := _RuleDetails200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleDetails200Response)

	if err != nil {
		return err
	}

	*o = RuleDetails200Response(varRuleDetails200Response)

	return err
}

type NullableRuleDetails200Response struct {
	value *RuleDetails200Response
	isSet bool
}

func (v NullableRuleDetails200Response) Get() *RuleDetails200Response {
	return v.value
}

func (v *NullableRuleDetails200Response) Set(val *RuleDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleDetails200Response(val *RuleDetails200Response) *NullableRuleDetails200Response {
	return &NullableRuleDetails200Response{value: val, isSet: true}
}

func (v NullableRuleDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
