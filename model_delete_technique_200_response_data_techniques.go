...
// checks if the DeleteTechnique200ResponseDataTechniques type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteTechnique200ResponseDataTechniques{}

// DeleteTechnique200ResponseDataTechniques struct for DeleteTechnique200ResponseDataTechniques
type DeleteTechnique200ResponseDataTechniques struct {
...
type _DeleteTechnique200ResponseDataTechniques DeleteTechnique200ResponseDataTechniques
...
func NewDeleteTechnique200ResponseDataTechniques(id string, version string) *DeleteTechnique200ResponseDataTechniques {
	this := DeleteTechnique200ResponseDataTechniques{}
	this.Id = id
...
func (o DeleteTechnique200ResponseDataTechniques) MarshalJSON() ([]byte, error) {
...
func (o DeleteTechnique200ResponseDataTechniques) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteTechnique200ResponseDataTechniques) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteTechnique200ResponseDataTechniques := _DeleteTechnique200ResponseDataTechniques{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteTechnique200ResponseDataTechniques)

	if err != nil {
		return err
	}

	*o = DeleteTechnique200ResponseDataTechniques(varDeleteTechnique200ResponseDataTechniques)

	return err
}

type NullableDeleteTechnique200ResponseDataTechniques struct {
	value *DeleteTechnique200ResponseDataTechniques
	isSet bool
}

func (v NullableDeleteTechnique200ResponseDataTechniques) Get() *DeleteTechnique200ResponseDataTechniques {
	return v.value
}

func (v *NullableDeleteTechnique200ResponseDataTechniques) Set(val *DeleteTechnique200ResponseDataTechniques) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteTechnique200ResponseDataTechniques) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteTechnique200ResponseDataTechniques) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteTechnique200ResponseDataTechniques(val *DeleteTechnique200ResponseDataTechniques) *NullableDeleteTechnique200ResponseDataTechniques {
	return &NullableDeleteTechnique200ResponseDataTechniques{value: val, isSet: true}
}

func (v NullableDeleteTechnique200ResponseDataTechniques) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteTechnique200ResponseDataTechniques) UnmarshalJSON(src []byte) error {
	v.isSet = true
