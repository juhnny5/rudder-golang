...
// checks if the GetCampaignEventResult200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCampaignEventResult200ResponseData{}

// GetCampaignEventResult200ResponseData struct for GetCampaignEventResult200ResponseData
type GetCampaignEventResult200ResponseData struct {
	EventResult []CampaignEventResult `json:"eventResult"`
}

type _GetCampaignEventResult200ResponseData GetCampaignEventResult200ResponseData
...
func NewGetCampaignEventResult200ResponseData(eventResult []CampaignEventResult) *GetCampaignEventResult200ResponseData {
	this := GetCampaignEventResult200ResponseData{}
...
// GetEventResultOk returns a tuple with the EventResult field value
// and a boolean to check if the value has been set.
func (o *GetCampaignEventResult200ResponseData) GetEventResultOk() ([]CampaignEventResult, bool) {
	if o == nil {
		return nil, false
	}
	return o.EventResult, true
}

// SetEventResult sets field value
func (o *GetCampaignEventResult200ResponseData) SetEventResult(v []CampaignEventResult) {
	o.EventResult = v
}

func (o GetCampaignEventResult200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetCampaignEventResult200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["eventResult"] = o.EventResult
	return toSerialize, nil
}

func (o *GetCampaignEventResult200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCampaignEventResult200ResponseData := _GetCampaignEventResult200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCampaignEventResult200ResponseData)

	if err != nil {
		return err
	}

	*o = GetCampaignEventResult200ResponseData(varGetCampaignEventResult200ResponseData)

	return err
}

type NullableGetCampaignEventResult200ResponseData struct {
	value *GetCampaignEventResult200ResponseData
	isSet bool
}

func (v NullableGetCampaignEventResult200ResponseData) Get() *GetCampaignEventResult200ResponseData {
	return v.value
}

func (v *NullableGetCampaignEventResult200ResponseData) Set(val *GetCampaignEventResult200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCampaignEventResult200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCampaignEventResult200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCampaignEventResult200ResponseData(val *GetCampaignEventResult200ResponseData) *NullableGetCampaignEventResult200ResponseData {
	return &NullableGetCampaignEventResult200ResponseData{value: val, isSet: true}
}

func (v NullableGetCampaignEventResult200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCampaignEventResult200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
