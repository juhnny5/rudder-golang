...
// checks if the ValidatedUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidatedUser{}
...
type _ValidatedUser ValidatedUser
...
func (o ValidatedUser) MarshalJSON() ([]byte, error) {
...
func (o ValidatedUser) ToMap() (map[string]interface{}, error) {
...
func (o *ValidatedUser) UnmarshalJSON(data []byte) (err error) {
	...
	varValidatedUser := _ValidatedUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varValidatedUser)

	if err != nil {
		return err
	}

	*o = ValidatedUser(varValidatedUser)

	return err
}

type NullableValidatedUser struct {
	value *ValidatedUser
	isSet bool
}

func (v NullableValidatedUser) Get() *ValidatedUser {
	return v.value
}

func (v *NullableValidatedUser) Set(val *ValidatedUser) {
	v.value = val
	v.isSet = true
}

func (v NullableValidatedUser) IsSet() bool {
	return v.isSet
}

func (v *NullableValidatedUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidatedUser(val *ValidatedUser) *NullableValidatedUser {
	return &NullableValidatedUser{value: val, isSet: true}
}

func (v NullableValidatedUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidatedUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
