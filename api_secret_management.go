...
type ApiAddSecretRequest struct {
	ctx context.Context
	ApiService *SecretManagementAPIService
	secrets *Secrets
}

func (r ApiAddSecretRequest) Secrets(secrets Secrets) ApiAddSecretRequest {
	r.secrets = &secrets
	return r
}

func (r ApiAddSecretRequest) Execute() (*AddSecret200Response, *http.Response, error) {
	return r.ApiService.AddSecretExecute(r)
}
...
Add a secret
 ...
 @return ApiAddSecretRequest
*/
func (a *SecretManagementAPIService) AddSecret(ctx context.Context) ApiAddSecretRequest {
	return ApiAddSecretRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return AddSecret200Response
func (a *SecretManagementAPIService) AddSecretExecute(r ApiAddSecretRequest) (*AddSecret200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AddSecret200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecretManagementAPIService.AddSecret")
	if err != nil {
	...
	if r.secrets == nil {
		return localVarReturnValue, nil, reportError("secrets is required and must be specified")
	}
...
func (r ApiDeleteSecretRequest) Execute() (*DeleteSecret200Response, *http.Response, error) {
...
*/
func (a *SecretManagementAPIService) DeleteSecret(ctx context.Context, name string) ApiDeleteSecretRequest {
	return ApiDeleteSecretRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
//  @return DeleteSecret200Response
func (a *SecretManagementAPIService) DeleteSecretExecute(r ApiDeleteSecretRequest) (*DeleteSecret200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteSecret200Response
	)
	...
	localVarPath := localBasePath + "/secret/{name}"
...
func (r ApiGetAllSecretsRequest) Execute() (*GetAllSecrets200Response, *http.Response, error) {
...
*/
func (a *SecretManagementAPIService) GetAllSecrets(ctx context.Context) ApiGetAllSecretsRequest {
	return ApiGetAllSecretsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetAllSecrets200Response
func (a *SecretManagementAPIService) GetAllSecretsExecute(r ApiGetAllSecretsRequest) (*GetAllSecrets200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetAllSecrets200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecretManagementAPIService.GetAllSecrets")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetSecretRequest) Execute() (*GetSecret200Response, *http.Response, error) {
...
*/
func (a *SecretManagementAPIService) GetSecret(ctx context.Context, name string) ApiGetSecretRequest {
	return ApiGetSecretRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
//  @return GetSecret200Response
func (a *SecretManagementAPIService) GetSecretExecute(r ApiGetSecretRequest) (*GetSecret200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSecret200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecretManagementAPIService.GetSecret")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateSecretRequest) Secrets(secrets Secrets) ApiUpdateSecretRequest {
	r.secrets = &secrets
	return r
}

func (r ApiUpdateSecretRequest) Execute() (*UpdateSecret200Response, *http.Response, error) {
...
*/
func (a *SecretManagementAPIService) UpdateSecret(ctx context.Context) ApiUpdateSecretRequest {
	return ApiUpdateSecretRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return UpdateSecret200Response
func (a *SecretManagementAPIService) UpdateSecretExecute(r ApiUpdateSecretRequest) (*UpdateSecret200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateSecret200Response
	)
