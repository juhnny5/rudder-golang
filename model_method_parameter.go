...
// checks if the MethodParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MethodParameter{}

// MethodParameter struct for MethodParameter
type MethodParameter struct {
	// Parameter name
	Name string `json:"name"`
	// Description of this parameter
	Description string `json:"description"`
	Constraints MethodParameterConstraints `json:"constraints"`
	// Type of the parameter
	Type *string `json:"_type,omitempty"`
}

type _MethodParameter MethodParameter
...
func (o *MethodParameter) GetConstraints() MethodParameterConstraints {
	if o == nil {
		var ret MethodParameterConstraints
		return ret
	}
...
func (o MethodParameter) MarshalJSON() ([]byte, error) {
...
func (o MethodParameter) ToMap() (map[string]interface{}, error) {
...
func (o *MethodParameter) UnmarshalJSON(data []byte) (err error) {
	...
	varMethodParameter := _MethodParameter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMethodParameter)

	if err != nil {
		return err
	}

	*o = MethodParameter(varMethodParameter)

	return err
}

type NullableMethodParameter struct {
	value *MethodParameter
	isSet bool
}

func (v NullableMethodParameter) Get() *MethodParameter {
	return v.value
}

func (v *NullableMethodParameter) Set(val *MethodParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableMethodParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableMethodParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMethodParameter(val *MethodParameter) *NullableMethodParameter {
	return &NullableMethodParameter{value: val, isSet: true}
}

func (v NullableMethodParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMethodParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
