...
// checks if the SetAllowedNetworks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetAllowedNetworks200Response{}

// SetAllowedNetworks200Response struct for SetAllowedNetworks200Response
type SetAllowedNetworks200Response struct {
	...
	Data SetAllowedNetworks200ResponseData `json:"data"`
}

type _SetAllowedNetworks200Response SetAllowedNetworks200Response
...
func NewSetAllowedNetworks200Response(result string, action string, data SetAllowedNetworks200ResponseData) *SetAllowedNetworks200Response {
	this := SetAllowedNetworks200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *SetAllowedNetworks200Response) GetData() SetAllowedNetworks200ResponseData {
	if o == nil {
		var ret SetAllowedNetworks200ResponseData
		return ret
	}
...
func (o SetAllowedNetworks200Response) MarshalJSON() ([]byte, error) {
...
func (o SetAllowedNetworks200Response) ToMap() (map[string]interface{}, error) {
...
func (o *SetAllowedNetworks200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSetAllowedNetworks200Response := _SetAllowedNetworks200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetAllowedNetworks200Response)

	if err != nil {
		return err
	}

	*o = SetAllowedNetworks200Response(varSetAllowedNetworks200Response)

	return err
}

type NullableSetAllowedNetworks200Response struct {
	value *SetAllowedNetworks200Response
	isSet bool
}

func (v NullableSetAllowedNetworks200Response) Get() *SetAllowedNetworks200Response {
	return v.value
}

func (v *NullableSetAllowedNetworks200Response) Set(val *SetAllowedNetworks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSetAllowedNetworks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSetAllowedNetworks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetAllowedNetworks200Response(val *SetAllowedNetworks200Response) *NullableSetAllowedNetworks200Response {
	return &NullableSetAllowedNetworks200Response{value: val, isSet: true}
}

func (v NullableSetAllowedNetworks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetAllowedNetworks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
