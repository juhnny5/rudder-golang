...
type _DeleteCampaign200Response DeleteCampaign200Response
...
func (o *DeleteCampaign200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteCampaign200Response := _DeleteCampaign200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteCampaign200Response)

	if err != nil {
		return err
	}

	*o = DeleteCampaign200Response(varDeleteCampaign200Response)
