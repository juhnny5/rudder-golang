...
// checks if the ApiVersions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiVersions{}

// ApiVersions struct for ApiVersions
...
// SetAll gets a reference to the given []ApiVersion and assigns it to the All field.
func (o *ApiVersions) SetAll(v []ApiVersion) {
	o.All = v
}

func (o ApiVersions) MarshalJSON() ([]byte, error) {
...
func (o ApiVersions) ToMap() (map[string]interface{}, error) {
...
type NullableApiVersions struct {
	value *ApiVersions
	isSet bool
}

func (v NullableApiVersions) Get() *ApiVersions {
	return v.value
}

func (v *NullableApiVersions) Set(val *ApiVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableApiVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableApiVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiVersions(val *ApiVersions) *NullableApiVersions {
	return &NullableApiVersions{value: val, isSet: true}
}

func (v NullableApiVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
