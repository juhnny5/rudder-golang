...
// checks if the GetSystemInfo200ResponseDataRudder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSystemInfo200ResponseDataRudder{}

// GetSystemInfo200ResponseDataRudder struct for GetSystemInfo200ResponseDataRudder
type GetSystemInfo200ResponseDataRudder struct {
	MajorVersion string `json:"major-version"`
	FullVersion string `json:"full-version"`
	BuildTime string `json:"build-time"`
}

type _GetSystemInfo200ResponseDataRudder GetSystemInfo200ResponseDataRudder
...
func NewGetSystemInfo200ResponseDataRudder(majorVersion string, fullVersion string, buildTime string) *GetSystemInfo200ResponseDataRudder {
	this := GetSystemInfo200ResponseDataRudder{}
...
// GetFullVersion returns the FullVersion field value
...
// GetFullVersionOk returns a tuple with the FullVersion field value
// and a boolean to check if the value has been set.
func (o *GetSystemInfo200ResponseDataRudder) GetFullVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FullVersion, true
}

// SetFullVersion sets field value
...
func (o GetSystemInfo200ResponseDataRudder) MarshalJSON() ([]byte, error) {
...
func (o GetSystemInfo200ResponseDataRudder) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["major-version"] = o.MajorVersion
	toSerialize["full-version"] = o.FullVersion
	toSerialize["build-time"] = o.BuildTime
	return toSerialize, nil
}

func (o *GetSystemInfo200ResponseDataRudder) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSystemInfo200ResponseDataRudder := _GetSystemInfo200ResponseDataRudder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetSystemInfo200ResponseDataRudder)

	if err != nil {
		return err
	}

	*o = GetSystemInfo200ResponseDataRudder(varGetSystemInfo200ResponseDataRudder)

	return err
}

type NullableGetSystemInfo200ResponseDataRudder struct {
	value *GetSystemInfo200ResponseDataRudder
	isSet bool
}

func (v NullableGetSystemInfo200ResponseDataRudder) Get() *GetSystemInfo200ResponseDataRudder {
	return v.value
}

func (v *NullableGetSystemInfo200ResponseDataRudder) Set(val *GetSystemInfo200ResponseDataRudder) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSystemInfo200ResponseDataRudder) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSystemInfo200ResponseDataRudder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSystemInfo200ResponseDataRudder(val *GetSystemInfo200ResponseDataRudder) *NullableGetSystemInfo200ResponseDataRudder {
	return &NullableGetSystemInfo200ResponseDataRudder{value: val, isSet: true}
}

func (v NullableGetSystemInfo200ResponseDataRudder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSystemInfo200ResponseDataRudder) UnmarshalJSON(src []byte) error {
	v.isSet = true
