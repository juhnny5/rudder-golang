...
// checks if the GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails{}

// GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails struct for GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails
type GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails struct {
...
func NewGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails() *GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails {
	this := GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) GetSuccessNotApplicableOk() (*float32, bool) {
	if o == nil || IsNil(o.SuccessNotApplicable) {
		return nil, false
	}
...
func (o *GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) GetSuccessRepaired() float32 {
...
func (o GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) MarshalJSON() ([]byte, error) {
...
func (o GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) ToMap() (map[string]interface{}, error) {
...
type NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails struct {
	value *GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails
	isSet bool
}

func (v NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) Get() *GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails {
	return v.value
}

func (v *NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) Set(val *GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails(val *GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) *NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails {
	return &NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails{value: val, isSet: true}
}

func (v NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
