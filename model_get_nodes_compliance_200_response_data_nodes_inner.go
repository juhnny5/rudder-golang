...
// checks if the GetNodesCompliance200ResponseDataNodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodesCompliance200ResponseDataNodesInner{}

// GetNodesCompliance200ResponseDataNodesInner struct for GetNodesCompliance200ResponseDataNodesInner
type GetNodesCompliance200ResponseDataNodesInner struct {
	// id of the node
	Id string `json:"id"`
	Mode string `json:"mode"`
	// Rule compliance level
	Compliance float32 `json:"compliance"`
	ComplianceDetails GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails `json:"complianceDetails"`
}

type _GetNodesCompliance200ResponseDataNodesInner GetNodesCompliance200ResponseDataNodesInner
...
func NewGetNodesCompliance200ResponseDataNodesInner(id string, mode string, compliance float32, complianceDetails GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) *GetNodesCompliance200ResponseDataNodesInner {
	this := GetNodesCompliance200ResponseDataNodesInner{}
	this.Id = id
	this.Mode = mode
...
func (o GetNodesCompliance200ResponseDataNodesInner) MarshalJSON() ([]byte, error) {
...
func (o GetNodesCompliance200ResponseDataNodesInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetNodesCompliance200ResponseDataNodesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodesCompliance200ResponseDataNodesInner := _GetNodesCompliance200ResponseDataNodesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodesCompliance200ResponseDataNodesInner)

	if err != nil {
		return err
	}

	*o = GetNodesCompliance200ResponseDataNodesInner(varGetNodesCompliance200ResponseDataNodesInner)

	return err
}

type NullableGetNodesCompliance200ResponseDataNodesInner struct {
	value *GetNodesCompliance200ResponseDataNodesInner
	isSet bool
}

func (v NullableGetNodesCompliance200ResponseDataNodesInner) Get() *GetNodesCompliance200ResponseDataNodesInner {
	return v.value
}

func (v *NullableGetNodesCompliance200ResponseDataNodesInner) Set(val *GetNodesCompliance200ResponseDataNodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodesCompliance200ResponseDataNodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodesCompliance200ResponseDataNodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodesCompliance200ResponseDataNodesInner(val *GetNodesCompliance200ResponseDataNodesInner) *NullableGetNodesCompliance200ResponseDataNodesInner {
	return &NullableGetNodesCompliance200ResponseDataNodesInner{value: val, isSet: true}
}

func (v NullableGetNodesCompliance200ResponseDataNodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodesCompliance200ResponseDataNodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
