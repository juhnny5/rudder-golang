...
// checks if the AddUser200ResponseDataAddedUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddUser200ResponseDataAddedUser{}

// AddUser200ResponseDataAddedUser struct for AddUser200ResponseDataAddedUser
type AddUser200ResponseDataAddedUser struct {
...
func NewAddUser200ResponseDataAddedUser() *AddUser200ResponseDataAddedUser {
	this := AddUser200ResponseDataAddedUser{}
	return &this
}
...
func (o AddUser200ResponseDataAddedUser) MarshalJSON() ([]byte, error) {
...
func (o AddUser200ResponseDataAddedUser) ToMap() (map[string]interface{}, error) {
...
type NullableAddUser200ResponseDataAddedUser struct {
	value *AddUser200ResponseDataAddedUser
	isSet bool
}

func (v NullableAddUser200ResponseDataAddedUser) Get() *AddUser200ResponseDataAddedUser {
	return v.value
}

func (v *NullableAddUser200ResponseDataAddedUser) Set(val *AddUser200ResponseDataAddedUser) {
	v.value = val
	v.isSet = true
}

func (v NullableAddUser200ResponseDataAddedUser) IsSet() bool {
	return v.isSet
}

func (v *NullableAddUser200ResponseDataAddedUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddUser200ResponseDataAddedUser(val *AddUser200ResponseDataAddedUser) *NullableAddUser200ResponseDataAddedUser {
	return &NullableAddUser200ResponseDataAddedUser{value: val, isSet: true}
}

func (v NullableAddUser200ResponseDataAddedUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddUser200ResponseDataAddedUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
