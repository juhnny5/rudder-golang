...
// checks if the DeleteTechnique200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteTechnique200Response{}

// DeleteTechnique200Response struct for DeleteTechnique200Response
type DeleteTechnique200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data DeleteTechnique200ResponseData `json:"data"`
}

type _DeleteTechnique200Response DeleteTechnique200Response
...
func NewDeleteTechnique200Response(result string, action string, data DeleteTechnique200ResponseData) *DeleteTechnique200Response {
	this := DeleteTechnique200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *DeleteTechnique200Response) GetData() DeleteTechnique200ResponseData {
	if o == nil {
		var ret DeleteTechnique200ResponseData
		return ret
	}
...
func (o DeleteTechnique200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteTechnique200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteTechnique200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteTechnique200Response := _DeleteTechnique200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteTechnique200Response)

	if err != nil {
		return err
	}

	*o = DeleteTechnique200Response(varDeleteTechnique200Response)

	return err
}

type NullableDeleteTechnique200Response struct {
	value *DeleteTechnique200Response
	isSet bool
}

func (v NullableDeleteTechnique200Response) Get() *DeleteTechnique200Response {
	return v.value
}

func (v *NullableDeleteTechnique200Response) Set(val *DeleteTechnique200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteTechnique200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteTechnique200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteTechnique200Response(val *DeleteTechnique200Response) *NullableDeleteTechnique200Response {
	return &NullableDeleteTechnique200Response{value: val, isSet: true}
}

func (v NullableDeleteTechnique200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteTechnique200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
