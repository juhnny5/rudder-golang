...
// checks if the UpdateUser200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUser200ResponseData{}

// UpdateUser200ResponseData struct for UpdateUser200ResponseData
type UpdateUser200ResponseData struct {
	UpdatedUser UpdateUser200ResponseDataUpdatedUser `json:"updatedUser"`
}

type _UpdateUser200ResponseData UpdateUser200ResponseData

// NewUpdateUser200ResponseData instantiates a new UpdateUser200ResponseData object
...
func NewUpdateUser200ResponseData(updatedUser UpdateUser200ResponseDataUpdatedUser) *UpdateUser200ResponseData {
	this := UpdateUser200ResponseData{}
	this.UpdatedUser = updatedUser
	return &this
}

// NewUpdateUser200ResponseDataWithDefaults instantiates a new UpdateUser200ResponseData object
...
// GetUpdatedUser returns the UpdatedUser field value
func (o *UpdateUser200ResponseData) GetUpdatedUser() UpdateUser200ResponseDataUpdatedUser {
	if o == nil {
		var ret UpdateUser200ResponseDataUpdatedUser
		return ret
	}
...
// GetUpdatedUserOk returns a tuple with the UpdatedUser field value
...
// SetUpdatedUser sets field value
func (o *UpdateUser200ResponseData) SetUpdatedUser(v UpdateUser200ResponseDataUpdatedUser) {
	o.UpdatedUser = v
}

func (o UpdateUser200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o UpdateUser200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["updatedUser"] = o.UpdatedUser
	return toSerialize, nil
}

func (o *UpdateUser200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateUser200ResponseData := _UpdateUser200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateUser200ResponseData)

	if err != nil {
		return err
	}

	*o = UpdateUser200ResponseData(varUpdateUser200ResponseData)

	return err
}

type NullableUpdateUser200ResponseData struct {
	value *UpdateUser200ResponseData
	isSet bool
}

func (v NullableUpdateUser200ResponseData) Get() *UpdateUser200ResponseData {
	return v.value
}

func (v *NullableUpdateUser200ResponseData) Set(val *UpdateUser200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUser200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUser200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUser200ResponseData(val *UpdateUser200ResponseData) *NullableUpdateUser200ResponseData {
	return &NullableUpdateUser200ResponseData{value: val, isSet: true}
}

func (v NullableUpdateUser200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUser200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
