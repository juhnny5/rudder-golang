...
// checks if the UpdateCVERequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCVERequest{}

// UpdateCVERequest CVE update config
...
func (o UpdateCVERequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateCVERequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateCVERequest struct {
	value *UpdateCVERequest
	isSet bool
}

func (v NullableUpdateCVERequest) Get() *UpdateCVERequest {
	return v.value
}

func (v *NullableUpdateCVERequest) Set(val *UpdateCVERequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCVERequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCVERequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCVERequest(val *UpdateCVERequest) *NullableUpdateCVERequest {
	return &NullableUpdateCVERequest{value: val, isSet: true}
}

func (v NullableUpdateCVERequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCVERequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
