...
// checks if the AddUser200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddUser200ResponseData{}

// AddUser200ResponseData struct for AddUser200ResponseData
type AddUser200ResponseData struct {
	AddedUser AddUser200ResponseDataAddedUser `json:"addedUser"`
}

type _AddUser200ResponseData AddUser200ResponseData
...
// GetAddedUser returns the AddedUser field value
func (o *AddUser200ResponseData) GetAddedUser() AddUser200ResponseDataAddedUser {
	if o == nil {
		var ret AddUser200ResponseDataAddedUser
		return ret
	}
...
func (o AddUser200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["addedUser"] = o.AddedUser
	return toSerialize, nil
}

func (o *AddUser200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varAddUser200ResponseData := _AddUser200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddUser200ResponseData)

	if err != nil {
		return err
	}

	*o = AddUser200ResponseData(varAddUser200ResponseData)

	return err
}

type NullableAddUser200ResponseData struct {
	value *AddUser200ResponseData
	isSet bool
}

func (v NullableAddUser200ResponseData) Get() *AddUser200ResponseData {
	return v.value
}

func (v *NullableAddUser200ResponseData) Set(val *AddUser200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableAddUser200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableAddUser200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddUser200ResponseData(val *AddUser200ResponseData) *NullableAddUser200ResponseData {
	return &NullableAddUser200ResponseData{value: val, isSet: true}
}

func (v NullableAddUser200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddUser200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
