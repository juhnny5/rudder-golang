...
// checks if the CreateNodes200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNodes200ResponseData{}

// CreateNodes200ResponseData struct for CreateNodes200ResponseData
type CreateNodes200ResponseData struct {
	Created []string `json:"created"`
	Failed []string `json:"failed"`
}

type _CreateNodes200ResponseData CreateNodes200ResponseData
...
func NewCreateNodes200ResponseData(created []string, failed []string) *CreateNodes200ResponseData {
	this := CreateNodes200ResponseData{}
...
func (o CreateNodes200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CreateNodes200ResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *CreateNodes200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNodes200ResponseData := _CreateNodes200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNodes200ResponseData)

	if err != nil {
		return err
	}

	*o = CreateNodes200ResponseData(varCreateNodes200ResponseData)

	return err
}

type NullableCreateNodes200ResponseData struct {
	value *CreateNodes200ResponseData
	isSet bool
}

func (v NullableCreateNodes200ResponseData) Get() *CreateNodes200ResponseData {
	return v.value
}

func (v *NullableCreateNodes200ResponseData) Set(val *CreateNodes200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNodes200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNodes200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNodes200ResponseData(val *CreateNodes200ResponseData) *NullableCreateNodes200ResponseData {
	return &NullableCreateNodes200ResponseData{value: val, isSet: true}
}

func (v NullableCreateNodes200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNodes200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
