...
// checks if the Import200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Import200ResponseData{}

// Import200ResponseData Details about archive import process
type Import200ResponseData struct {
...
// GetArchiveImported returns the ArchiveImported field value if set, zero value otherwise.
func (o *Import200ResponseData) GetArchiveImported() bool {
	if o == nil || IsNil(o.ArchiveImported) {
		var ret bool
		return ret
	}
...
// GetArchiveImportedOk returns a tuple with the ArchiveImported field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Import200ResponseData) GetArchiveImportedOk() (*bool, bool) {
	if o == nil || IsNil(o.ArchiveImported) {
		return nil, false
	}
	return o.ArchiveImported, true
}
...
// SetArchiveImported gets a reference to the given bool and assigns it to the ArchiveImported field.
func (o *Import200ResponseData) SetArchiveImported(v bool) {
	o.ArchiveImported = &v
}

func (o Import200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o Import200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ArchiveImported) {
		toSerialize["archiveImported"] = o.ArchiveImported
	}
	return toSerialize, nil
}

type NullableImport200ResponseData struct {
	value *Import200ResponseData
	isSet bool
}

func (v NullableImport200ResponseData) Get() *Import200ResponseData {
	return v.value
}

func (v *NullableImport200ResponseData) Set(val *Import200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableImport200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableImport200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImport200ResponseData(val *Import200ResponseData) *NullableImport200ResponseData {
	return &NullableImport200ResponseData{value: val, isSet: true}
}

func (v NullableImport200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImport200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
