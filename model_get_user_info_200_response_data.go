...
// checks if the GetUserInfo200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUserInfo200ResponseData{}

// GetUserInfo200ResponseData struct for GetUserInfo200ResponseData
type GetUserInfo200ResponseData struct {
	Digest string `json:"digest"`
	Users []Users `json:"users"`
}

type _GetUserInfo200ResponseData GetUserInfo200ResponseData
...
func NewGetUserInfo200ResponseData(digest string, users []Users) *GetUserInfo200ResponseData {
	this := GetUserInfo200ResponseData{}
	this.Digest = digest
	this.Users = users
	return &this
}
...
func (o GetUserInfo200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetUserInfo200ResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *GetUserInfo200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetUserInfo200ResponseData := _GetUserInfo200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetUserInfo200ResponseData)

	if err != nil {
		return err
	}

	*o = GetUserInfo200ResponseData(varGetUserInfo200ResponseData)

	return err
}

type NullableGetUserInfo200ResponseData struct {
	value *GetUserInfo200ResponseData
	isSet bool
}

func (v NullableGetUserInfo200ResponseData) Get() *GetUserInfo200ResponseData {
	return v.value
}

func (v *NullableGetUserInfo200ResponseData) Set(val *GetUserInfo200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUserInfo200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUserInfo200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUserInfo200ResponseData(val *GetUserInfo200ResponseData) *NullableGetUserInfo200ResponseData {
	return &NullableGetUserInfo200ResponseData{value: val, isSet: true}
}

func (v NullableGetUserInfo200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUserInfo200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
