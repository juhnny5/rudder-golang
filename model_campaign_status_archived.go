...
// checks if the CampaignStatusArchived type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignStatusArchived{}

// CampaignStatusArchived Campaign status
type CampaignStatusArchived struct {
...
func (o CampaignStatusArchived) MarshalJSON() ([]byte, error) {
...
func (o CampaignStatusArchived) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignStatusArchived struct {
	value *CampaignStatusArchived
	isSet bool
}

func (v NullableCampaignStatusArchived) Get() *CampaignStatusArchived {
	return v.value
}

func (v *NullableCampaignStatusArchived) Set(val *CampaignStatusArchived) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignStatusArchived) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignStatusArchived) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignStatusArchived(val *CampaignStatusArchived) *NullableCampaignStatusArchived {
	return &NullableCampaignStatusArchived{value: val, isSet: true}
}

func (v NullableCampaignStatusArchived) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignStatusArchived) UnmarshalJSON(src []byte) error {
	v.isSet = true
