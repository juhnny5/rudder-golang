...
// checks if the DemoteToNode200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DemoteToNode200Response{}

// DemoteToNode200Response struct for DemoteToNode200Response
type DemoteToNode200Response struct {
...
type _DemoteToNode200Response DemoteToNode200Response
...
func (o DemoteToNode200Response) MarshalJSON() ([]byte, error) {
...
func (o DemoteToNode200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DemoteToNode200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDemoteToNode200Response := _DemoteToNode200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDemoteToNode200Response)

	if err != nil {
		return err
	}

	*o = DemoteToNode200Response(varDemoteToNode200Response)

	return err
}

type NullableDemoteToNode200Response struct {
	value *DemoteToNode200Response
	isSet bool
}

func (v NullableDemoteToNode200Response) Get() *DemoteToNode200Response {
	return v.value
}

func (v *NullableDemoteToNode200Response) Set(val *DemoteToNode200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDemoteToNode200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDemoteToNode200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDemoteToNode200Response(val *DemoteToNode200Response) *NullableDemoteToNode200Response {
	return &NullableDemoteToNode200Response{value: val, isSet: true}
}

func (v NullableDemoteToNode200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDemoteToNode200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
