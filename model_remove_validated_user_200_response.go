...
// checks if the RemoveValidatedUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveValidatedUser200Response{}

// RemoveValidatedUser200Response struct for RemoveValidatedUser200Response
type RemoveValidatedUser200Response struct {
...
type _RemoveValidatedUser200Response RemoveValidatedUser200Response
...
func NewRemoveValidatedUser200Response(result string, action string, data string) *RemoveValidatedUser200Response {
	this := RemoveValidatedUser200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o RemoveValidatedUser200Response) MarshalJSON() ([]byte, error) {
...
func (o RemoveValidatedUser200Response) ToMap() (map[string]interface{}, error) {
...
func (o *RemoveValidatedUser200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoveValidatedUser200Response := _RemoveValidatedUser200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRemoveValidatedUser200Response)

	if err != nil {
		return err
	}

	*o = RemoveValidatedUser200Response(varRemoveValidatedUser200Response)

	return err
}

type NullableRemoveValidatedUser200Response struct {
	value *RemoveValidatedUser200Response
	isSet bool
}

func (v NullableRemoveValidatedUser200Response) Get() *RemoveValidatedUser200Response {
	return v.value
}

func (v *NullableRemoveValidatedUser200Response) Set(val *RemoveValidatedUser200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoveValidatedUser200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoveValidatedUser200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoveValidatedUser200Response(val *RemoveValidatedUser200Response) *NullableRemoveValidatedUser200Response {
	return &NullableRemoveValidatedUser200Response{value: val, isSet: true}
}

func (v NullableRemoveValidatedUser200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoveValidatedUser200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
