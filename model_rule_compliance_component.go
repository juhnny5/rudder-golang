...
// checks if the RuleComplianceComponent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleComplianceComponent{}

// RuleComplianceComponent struct for RuleComplianceComponent
type RuleComplianceComponent struct {
	...
	Components []RuleComplianceComponentComponentsInner `json:"components"`
}

type _RuleComplianceComponent RuleComplianceComponent
...
func (o *RuleComplianceComponent) GetComponents() []RuleComplianceComponentComponentsInner {
	if o == nil {
		var ret []RuleComplianceComponentComponentsInner
		return ret
	}
...
func (o RuleComplianceComponent) MarshalJSON() ([]byte, error) {
...
func (o RuleComplianceComponent) ToMap() (map[string]interface{}, error) {
...
func (o *RuleComplianceComponent) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleComplianceComponent := _RuleComplianceComponent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleComplianceComponent)

	if err != nil {
		return err
	}

	*o = RuleComplianceComponent(varRuleComplianceComponent)

	return err
}

type NullableRuleComplianceComponent struct {
	value *RuleComplianceComponent
	isSet bool
}

func (v NullableRuleComplianceComponent) Get() *RuleComplianceComponent {
	return v.value
}

func (v *NullableRuleComplianceComponent) Set(val *RuleComplianceComponent) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleComplianceComponent) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleComplianceComponent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleComplianceComponent(val *RuleComplianceComponent) *NullableRuleComplianceComponent {
	return &NullableRuleComplianceComponent{value: val, isSet: true}
}

func (v NullableRuleComplianceComponent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleComplianceComponent) UnmarshalJSON(src []byte) error {
	v.isSet = true
