...
// checks if the GetTechniqueAllVersion200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTechniqueAllVersion200ResponseData{}

// GetTechniqueAllVersion200ResponseData struct for GetTechniqueAllVersion200ResponseData
type GetTechniqueAllVersion200ResponseData struct {
	Techniques []GetTechniqueAllVersion200ResponseDataTechniquesInner `json:"techniques"`
}

type _GetTechniqueAllVersion200ResponseData GetTechniqueAllVersion200ResponseData
...
func NewGetTechniqueAllVersion200ResponseData(techniques []GetTechniqueAllVersion200ResponseDataTechniquesInner) *GetTechniqueAllVersion200ResponseData {
	this := GetTechniqueAllVersion200ResponseData{}
...
func (o *GetTechniqueAllVersion200ResponseData) GetTechniques() []GetTechniqueAllVersion200ResponseDataTechniquesInner {
	if o == nil {
		var ret []GetTechniqueAllVersion200ResponseDataTechniquesInner
		return ret
	}
...
func (o GetTechniqueAllVersion200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetTechniqueAllVersion200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["techniques"] = o.Techniques
	return toSerialize, nil
}

func (o *GetTechniqueAllVersion200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTechniqueAllVersion200ResponseData := _GetTechniqueAllVersion200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTechniqueAllVersion200ResponseData)

	if err != nil {
		return err
	}

	*o = GetTechniqueAllVersion200ResponseData(varGetTechniqueAllVersion200ResponseData)

	return err
}

type NullableGetTechniqueAllVersion200ResponseData struct {
	value *GetTechniqueAllVersion200ResponseData
	isSet bool
}

func (v NullableGetTechniqueAllVersion200ResponseData) Get() *GetTechniqueAllVersion200ResponseData {
	return v.value
}

func (v *NullableGetTechniqueAllVersion200ResponseData) Set(val *GetTechniqueAllVersion200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTechniqueAllVersion200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTechniqueAllVersion200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTechniqueAllVersion200ResponseData(val *GetTechniqueAllVersion200ResponseData) *NullableGetTechniqueAllVersion200ResponseData {
	return &NullableGetTechniqueAllVersion200ResponseData{value: val, isSet: true}
}

func (v NullableGetTechniqueAllVersion200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTechniqueAllVersion200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
