...
// checks if the Import200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Import200Response{}

// Import200Response struct for Import200Response
type Import200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data Import200ResponseData `json:"data"`
}

type _Import200Response Import200Response
...
func (o Import200Response) MarshalJSON() ([]byte, error) {
...
func (o Import200Response) ToMap() (map[string]interface{}, error) {
...
func (o *Import200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varImport200Response := _Import200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImport200Response)

	if err != nil {
		return err
	}

	*o = Import200Response(varImport200Response)

	return err
}

type NullableImport200Response struct {
	value *Import200Response
	isSet bool
}

func (v NullableImport200Response) Get() *Import200Response {
	return v.value
}

func (v *NullableImport200Response) Set(val *Import200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableImport200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableImport200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImport200Response(val *Import200Response) *NullableImport200Response {
	return &NullableImport200Response{value: val, isSet: true}
}

func (v NullableImport200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImport200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
