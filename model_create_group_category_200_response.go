...
// checks if the CreateGroupCategory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGroupCategory200Response{}

// CreateGroupCategory200Response struct for CreateGroupCategory200Response
type CreateGroupCategory200Response struct {
...
type _CreateGroupCategory200Response CreateGroupCategory200Response
...
func NewCreateGroupCategory200Response(result string, action string, data CreateGroupCategory200ResponseData) *CreateGroupCategory200Response {
	this := CreateGroupCategory200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o CreateGroupCategory200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateGroupCategory200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGroupCategory200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGroupCategory200Response := _CreateGroupCategory200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGroupCategory200Response)

	if err != nil {
		return err
	}

	*o = CreateGroupCategory200Response(varCreateGroupCategory200Response)

	return err
}

type NullableCreateGroupCategory200Response struct {
	value *CreateGroupCategory200Response
	isSet bool
}

func (v NullableCreateGroupCategory200Response) Get() *CreateGroupCategory200Response {
	return v.value
}

func (v *NullableCreateGroupCategory200Response) Set(val *CreateGroupCategory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateGroupCategory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateGroupCategory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateGroupCategory200Response(val *CreateGroupCategory200Response) *NullableCreateGroupCategory200Response {
	return &NullableCreateGroupCategory200Response{value: val, isSet: true}
}

func (v NullableCreateGroupCategory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateGroupCategory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
