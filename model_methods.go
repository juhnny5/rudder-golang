...
type Methods struct {
	...
	Condition MethodsCondition `json:"condition"`
	Deprecated MethodsDeprecated `json:"deprecated"`
}
...
func (o *Methods) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varMethods)

	if err != nil {
		return err
	}

	*o = Methods(varMethods)
