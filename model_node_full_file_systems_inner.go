...
// checks if the NodeFullFileSystemsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullFileSystemsInner{}

// NodeFullFileSystemsInner struct for NodeFullFileSystemsInner
type NodeFullFileSystemsInner struct {
...
// SetFreeSpace gets a reference to the given int32 and assigns it to the FreeSpace field.
...
// SetTotalSpace gets a reference to the given int32 and assigns it to the TotalSpace field.
func (o *NodeFullFileSystemsInner) SetTotalSpace(v int32) {
	o.TotalSpace = &v
}

func (o NodeFullFileSystemsInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullFileSystemsInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullFileSystemsInner struct {
	value *NodeFullFileSystemsInner
	isSet bool
}

func (v NullableNodeFullFileSystemsInner) Get() *NodeFullFileSystemsInner {
	return v.value
}

func (v *NullableNodeFullFileSystemsInner) Set(val *NodeFullFileSystemsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullFileSystemsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullFileSystemsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullFileSystemsInner(val *NodeFullFileSystemsInner) *NullableNodeFullFileSystemsInner {
	return &NullableNodeFullFileSystemsInner{value: val, isSet: true}
}

func (v NullableNodeFullFileSystemsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullFileSystemsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
