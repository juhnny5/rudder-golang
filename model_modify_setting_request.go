...
// checks if the ModifySettingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifySettingRequest{}

// ModifySettingRequest struct for ModifySettingRequest
...
func (o ModifySettingRequest) MarshalJSON() ([]byte, error) {
...
func (o ModifySettingRequest) ToMap() (map[string]interface{}, error) {
...
type NullableModifySettingRequest struct {
	value *ModifySettingRequest
	isSet bool
}

func (v NullableModifySettingRequest) Get() *ModifySettingRequest {
	return v.value
}

func (v *NullableModifySettingRequest) Set(val *ModifySettingRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableModifySettingRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableModifySettingRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifySettingRequest(val *ModifySettingRequest) *NullableModifySettingRequest {
	return &NullableModifySettingRequest{value: val, isSet: true}
}

func (v NullableModifySettingRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifySettingRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
