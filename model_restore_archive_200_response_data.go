...
// checks if the RestoreArchive200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestoreArchive200ResponseData{}

// RestoreArchive200ResponseData struct for RestoreArchive200ResponseData
type RestoreArchive200ResponseData struct {
...
func NewRestoreArchive200ResponseData() *RestoreArchive200ResponseData {
	this := RestoreArchive200ResponseData{}
	return &this
}
...
func (o RestoreArchive200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o RestoreArchive200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableRestoreArchive200ResponseData struct {
	value *RestoreArchive200ResponseData
	isSet bool
}

func (v NullableRestoreArchive200ResponseData) Get() *RestoreArchive200ResponseData {
	return v.value
}

func (v *NullableRestoreArchive200ResponseData) Set(val *RestoreArchive200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableRestoreArchive200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableRestoreArchive200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestoreArchive200ResponseData(val *RestoreArchive200ResponseData) *NullableRestoreArchive200ResponseData {
	return &NullableRestoreArchive200ResponseData{value: val, isSet: true}
}

func (v NullableRestoreArchive200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestoreArchive200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
