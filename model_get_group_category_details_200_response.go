...
// checks if the GetGroupCategoryDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGroupCategoryDetails200Response{}

// GetGroupCategoryDetails200Response struct for GetGroupCategoryDetails200Response
type GetGroupCategoryDetails200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data CreateGroupCategory200ResponseData `json:"data"`
}

type _GetGroupCategoryDetails200Response GetGroupCategoryDetails200Response
...
func NewGetGroupCategoryDetails200Response(result string, action string, data CreateGroupCategory200ResponseData) *GetGroupCategoryDetails200Response {
	this := GetGroupCategoryDetails200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetGroupCategoryDetails200Response) GetData() CreateGroupCategory200ResponseData {
	if o == nil {
		var ret CreateGroupCategory200ResponseData
		return ret
	}
...
func (o GetGroupCategoryDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o GetGroupCategoryDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetGroupCategoryDetails200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGroupCategoryDetails200Response := _GetGroupCategoryDetails200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetGroupCategoryDetails200Response)

	if err != nil {
		return err
	}

	*o = GetGroupCategoryDetails200Response(varGetGroupCategoryDetails200Response)

	return err
}

type NullableGetGroupCategoryDetails200Response struct {
	value *GetGroupCategoryDetails200Response
	isSet bool
}

func (v NullableGetGroupCategoryDetails200Response) Get() *GetGroupCategoryDetails200Response {
	return v.value
}

func (v *NullableGetGroupCategoryDetails200Response) Set(val *GetGroupCategoryDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGroupCategoryDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGroupCategoryDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGroupCategoryDetails200Response(val *GetGroupCategoryDetails200Response) *NullableGetGroupCategoryDetails200Response {
	return &NullableGetGroupCategoryDetails200Response{value: val, isSet: true}
}

func (v NullableGetGroupCategoryDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGroupCategoryDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
