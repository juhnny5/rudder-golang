...
// checks if the RegeneratePolicies200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegeneratePolicies200ResponseData{}

// RegeneratePolicies200ResponseData struct for RegeneratePolicies200ResponseData
type RegeneratePolicies200ResponseData struct {
	Policies string `json:"policies"`
}

type _RegeneratePolicies200ResponseData RegeneratePolicies200ResponseData
...
func NewRegeneratePolicies200ResponseData(policies string) *RegeneratePolicies200ResponseData {
	this := RegeneratePolicies200ResponseData{}
...
func (o RegeneratePolicies200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o RegeneratePolicies200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["policies"] = o.Policies
	return toSerialize, nil
}

func (o *RegeneratePolicies200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varRegeneratePolicies200ResponseData := _RegeneratePolicies200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegeneratePolicies200ResponseData)

	if err != nil {
		return err
	}

	*o = RegeneratePolicies200ResponseData(varRegeneratePolicies200ResponseData)

	return err
}

type NullableRegeneratePolicies200ResponseData struct {
	value *RegeneratePolicies200ResponseData
	isSet bool
}

func (v NullableRegeneratePolicies200ResponseData) Get() *RegeneratePolicies200ResponseData {
	return v.value
}

func (v *NullableRegeneratePolicies200ResponseData) Set(val *RegeneratePolicies200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableRegeneratePolicies200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableRegeneratePolicies200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegeneratePolicies200ResponseData(val *RegeneratePolicies200ResponseData) *NullableRegeneratePolicies200ResponseData {
	return &NullableRegeneratePolicies200ResponseData{value: val, isSet: true}
}

func (v NullableRegeneratePolicies200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegeneratePolicies200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
