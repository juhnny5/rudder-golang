...
// checks if the UpdateGroup200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGroup200Response{}

// UpdateGroup200Response struct for UpdateGroup200Response
type UpdateGroup200Response struct {
...
type _UpdateGroup200Response UpdateGroup200Response
...
func (o UpdateGroup200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateGroup200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateGroup200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateGroup200Response := _UpdateGroup200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateGroup200Response)

	if err != nil {
		return err
	}

	*o = UpdateGroup200Response(varUpdateGroup200Response)

	return err
}

type NullableUpdateGroup200Response struct {
	value *UpdateGroup200Response
	isSet bool
}

func (v NullableUpdateGroup200Response) Get() *UpdateGroup200Response {
	return v.value
}

func (v *NullableUpdateGroup200Response) Set(val *UpdateGroup200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateGroup200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateGroup200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateGroup200Response(val *UpdateGroup200Response) *NullableUpdateGroup200Response {
	return &NullableUpdateGroup200Response{value: val, isSet: true}
}

func (v NullableUpdateGroup200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateGroup200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
