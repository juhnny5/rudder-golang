...
// checks if the CveCheckScore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CveCheckScore{}

// CveCheckScore CVE score
type CveCheckScore struct {
...
func (o CveCheckScore) MarshalJSON() ([]byte, error) {
...
func (o CveCheckScore) ToMap() (map[string]interface{}, error) {
...
type NullableCveCheckScore struct {
	value *CveCheckScore
	isSet bool
}

func (v NullableCveCheckScore) Get() *CveCheckScore {
	return v.value
}

func (v *NullableCveCheckScore) Set(val *CveCheckScore) {
	v.value = val
	v.isSet = true
}

func (v NullableCveCheckScore) IsSet() bool {
	return v.isSet
}

func (v *NullableCveCheckScore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCveCheckScore(val *CveCheckScore) *NullableCveCheckScore {
	return &NullableCveCheckScore{value: val, isSet: true}
}

func (v NullableCveCheckScore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCveCheckScore) UnmarshalJSON(src []byte) error {
	v.isSet = true
