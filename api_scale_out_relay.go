...
// ScaleOutRelayAPIService ScaleOutRelayAPI service
type ScaleOutRelayAPIService service

type ApiDemoteToNodeRequest struct {
	ctx context.Context
	ApiService *ScaleOutRelayAPIService
	nodeId string
}

func (r ApiDemoteToNodeRequest) Execute() (*DemoteToNode200Response, *http.Response, error) {
	return r.ApiService.DemoteToNodeExecute(r)
}
...
Demote a relay to a simple node.
 ...
 @return ApiDemoteToNodeRequest
*/
func (a *ScaleOutRelayAPIService) DemoteToNode(ctx context.Context, nodeId string) ApiDemoteToNodeRequest {
	return ApiDemoteToNodeRequest{
		ApiService: a,
		ctx: ctx,
		nodeId: nodeId,
...
//  @return DemoteToNode200Response
func (a *ScaleOutRelayAPIService) DemoteToNodeExecute(r ApiDemoteToNodeRequest) (*DemoteToNode200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DemoteToNode200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScaleOutRelayAPIService.DemoteToNode")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/scaleoutrelay/demote/{nodeId}"
...
type ApiPromoteToRelayRequest struct {
	ctx context.Context
	ApiService *ScaleOutRelayAPIService
	nodeId string
}

func (r ApiPromoteToRelayRequest) Execute() (*PromoteToRelay200Response, *http.Response, error) {
	return r.ApiService.PromoteToRelayExecute(r)
}
...
Promote a node to relay
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param nodeId Id of the target node
 @return ApiPromoteToRelayRequest
*/
func (a *ScaleOutRelayAPIService) PromoteToRelay(ctx context.Context, nodeId string) ApiPromoteToRelayRequest {
	return ApiPromoteToRelayRequest{
		ApiService: a,
		ctx: ctx,
		nodeId: nodeId,
...
// Execute executes the request
//  @return PromoteToRelay200Response
func (a *ScaleOutRelayAPIService) PromoteToRelayExecute(r ApiPromoteToRelayRequest) (*PromoteToRelay200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PromoteToRelay200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScaleOutRelayAPIService.PromoteToRelay")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/scaleoutrelay/promote/{nodeId}"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeId"+"}", url.PathEscape(parameterValueToString(r.nodeId, "nodeId")), -1)
