...
// checks if the GetGlobalCompliance200ResponseDataGlobalCompliance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGlobalCompliance200ResponseDataGlobalCompliance{}

// GetGlobalCompliance200ResponseDataGlobalCompliance struct for GetGlobalCompliance200ResponseDataGlobalCompliance
type GetGlobalCompliance200ResponseDataGlobalCompliance struct {
	// Global compliance level (`-1` when no policies are defined)
	Compliance float32 `json:"compliance"`
	ComplianceDetails *GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails `json:"complianceDetails,omitempty"`
}

type _GetGlobalCompliance200ResponseDataGlobalCompliance GetGlobalCompliance200ResponseDataGlobalCompliance
...
func NewGetGlobalCompliance200ResponseDataGlobalCompliance(compliance float32) *GetGlobalCompliance200ResponseDataGlobalCompliance {
	this := GetGlobalCompliance200ResponseDataGlobalCompliance{}
...
func (o *GetGlobalCompliance200ResponseDataGlobalCompliance) GetComplianceDetails() GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails {
	if o == nil || IsNil(o.ComplianceDetails) {
		var ret GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails
		return ret
	}
...
// SetComplianceDetails gets a reference to the given GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails and assigns it to the ComplianceDetails field.
...
func (o GetGlobalCompliance200ResponseDataGlobalCompliance) MarshalJSON() ([]byte, error) {
...
func (o GetGlobalCompliance200ResponseDataGlobalCompliance) ToMap() (map[string]interface{}, error) {
...
func (o *GetGlobalCompliance200ResponseDataGlobalCompliance) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGlobalCompliance200ResponseDataGlobalCompliance := _GetGlobalCompliance200ResponseDataGlobalCompliance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetGlobalCompliance200ResponseDataGlobalCompliance)

	if err != nil {
		return err
	}

	*o = GetGlobalCompliance200ResponseDataGlobalCompliance(varGetGlobalCompliance200ResponseDataGlobalCompliance)

	return err
}

type NullableGetGlobalCompliance200ResponseDataGlobalCompliance struct {
	value *GetGlobalCompliance200ResponseDataGlobalCompliance
	isSet bool
}

func (v NullableGetGlobalCompliance200ResponseDataGlobalCompliance) Get() *GetGlobalCompliance200ResponseDataGlobalCompliance {
	return v.value
}

func (v *NullableGetGlobalCompliance200ResponseDataGlobalCompliance) Set(val *GetGlobalCompliance200ResponseDataGlobalCompliance) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGlobalCompliance200ResponseDataGlobalCompliance) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGlobalCompliance200ResponseDataGlobalCompliance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGlobalCompliance200ResponseDataGlobalCompliance(val *GetGlobalCompliance200ResponseDataGlobalCompliance) *NullableGetGlobalCompliance200ResponseDataGlobalCompliance {
	return &NullableGetGlobalCompliance200ResponseDataGlobalCompliance{value: val, isSet: true}
}

func (v NullableGetGlobalCompliance200ResponseDataGlobalCompliance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGlobalCompliance200ResponseDataGlobalCompliance) UnmarshalJSON(src []byte) error {
	v.isSet = true
