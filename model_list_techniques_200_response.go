...
// checks if the ListTechniques200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTechniques200Response{}

// ListTechniques200Response struct for ListTechniques200Response
type ListTechniques200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ListTechniques200ResponseData `json:"data"`
}

type _ListTechniques200Response ListTechniques200Response
...
func NewListTechniques200Response(result string, action string, data ListTechniques200ResponseData) *ListTechniques200Response {
	this := ListTechniques200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ListTechniques200Response) GetData() ListTechniques200ResponseData {
	if o == nil {
		var ret ListTechniques200ResponseData
		return ret
	}
...
func (o ListTechniques200Response) MarshalJSON() ([]byte, error) {
...
func (o ListTechniques200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListTechniques200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListTechniques200Response := _ListTechniques200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTechniques200Response)

	if err != nil {
		return err
	}

	*o = ListTechniques200Response(varListTechniques200Response)

	return err
}

type NullableListTechniques200Response struct {
	value *ListTechniques200Response
	isSet bool
}

func (v NullableListTechniques200Response) Get() *ListTechniques200Response {
	return v.value
}

func (v *NullableListTechniques200Response) Set(val *ListTechniques200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTechniques200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTechniques200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTechniques200Response(val *ListTechniques200Response) *NullableListTechniques200Response {
	return &NullableListTechniques200Response{value: val, isSet: true}
}

func (v NullableListTechniques200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTechniques200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
