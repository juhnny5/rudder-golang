...
type RuleTargetsInner struct {
	Include RuleTargetsInnerInclude `json:"include"`
	Exclude RuleTargetsInnerExclude `json:"exclude"`
}
...
func (o *RuleTargetsInner) GetInclude() RuleTargetsInnerInclude {
	if o == nil {
		var ret RuleTargetsInnerInclude
		return ret
	}
...
func (o *RuleTargetsInner) GetExclude() RuleTargetsInnerExclude {
	if o == nil {
		var ret RuleTargetsInnerExclude
		return ret
	}
