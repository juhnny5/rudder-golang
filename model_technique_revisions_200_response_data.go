...
// checks if the TechniqueRevisions200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueRevisions200ResponseData{}

// TechniqueRevisions200ResponseData struct for TechniqueRevisions200ResponseData
type TechniqueRevisions200ResponseData struct {
	Techniques []TechniquesRevisionsInner `json:"techniques"`
}

type _TechniqueRevisions200ResponseData TechniqueRevisions200ResponseData
...
func NewTechniqueRevisions200ResponseData(techniques []TechniquesRevisionsInner) *TechniqueRevisions200ResponseData {
	this := TechniqueRevisions200ResponseData{}
...
func (o *TechniqueRevisions200ResponseData) GetTechniques() []TechniquesRevisionsInner {
	if o == nil {
		var ret []TechniquesRevisionsInner
		return ret
	}
...
func (o TechniqueRevisions200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o TechniqueRevisions200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["techniques"] = o.Techniques
	return toSerialize, nil
}

func (o *TechniqueRevisions200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varTechniqueRevisions200ResponseData := _TechniqueRevisions200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTechniqueRevisions200ResponseData)

	if err != nil {
		return err
	}

	*o = TechniqueRevisions200ResponseData(varTechniqueRevisions200ResponseData)

	return err
}

type NullableTechniqueRevisions200ResponseData struct {
	value *TechniqueRevisions200ResponseData
	isSet bool
}

func (v NullableTechniqueRevisions200ResponseData) Get() *TechniqueRevisions200ResponseData {
	return v.value
}

func (v *NullableTechniqueRevisions200ResponseData) Set(val *TechniqueRevisions200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueRevisions200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueRevisions200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueRevisions200ResponseData(val *TechniqueRevisions200ResponseData) *NullableTechniqueRevisions200ResponseData {
	return &NullableTechniqueRevisions200ResponseData{value: val, isSet: true}
}

func (v NullableTechniqueRevisions200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueRevisions200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
