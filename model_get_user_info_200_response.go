...
type GetUserInfo200Response struct {
	...
	Data GetUserInfo200ResponseData `json:"data"`
}

type _GetUserInfo200Response GetUserInfo200Response
...
func (o *GetUserInfo200Response) GetData() GetUserInfo200ResponseData {
	if o == nil {
		var ret GetUserInfo200ResponseData
		return ret
	}
...
func (o *GetUserInfo200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetUserInfo200Response := _GetUserInfo200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetUserInfo200Response)

	if err != nil {
		return err
	}

	*o = GetUserInfo200Response(varGetUserInfo200Response)
