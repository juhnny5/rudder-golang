...
// checks if the GetAllCampaignEvents200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllCampaignEvents200Response{}

// GetAllCampaignEvents200Response struct for GetAllCampaignEvents200Response
type GetAllCampaignEvents200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetAllCampaignEvents200ResponseData `json:"data"`
}

type _GetAllCampaignEvents200Response GetAllCampaignEvents200Response
...
func NewGetAllCampaignEvents200Response(result string, action string, data GetAllCampaignEvents200ResponseData) *GetAllCampaignEvents200Response {
	this := GetAllCampaignEvents200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetAllCampaignEvents200Response) GetData() GetAllCampaignEvents200ResponseData {
	if o == nil {
		var ret GetAllCampaignEvents200ResponseData
		return ret
	}
...
func (o GetAllCampaignEvents200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAllCampaignEvents200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAllCampaignEvents200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllCampaignEvents200Response := _GetAllCampaignEvents200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllCampaignEvents200Response)

	if err != nil {
		return err
	}

	*o = GetAllCampaignEvents200Response(varGetAllCampaignEvents200Response)

	return err
}

type NullableGetAllCampaignEvents200Response struct {
	value *GetAllCampaignEvents200Response
	isSet bool
}

func (v NullableGetAllCampaignEvents200Response) Get() *GetAllCampaignEvents200Response {
	return v.value
}

func (v *NullableGetAllCampaignEvents200Response) Set(val *GetAllCampaignEvents200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllCampaignEvents200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllCampaignEvents200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllCampaignEvents200Response(val *GetAllCampaignEvents200Response) *NullableGetAllCampaignEvents200Response {
	return &NullableGetAllCampaignEvents200Response{value: val, isSet: true}
}

func (v NullableGetAllCampaignEvents200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllCampaignEvents200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
