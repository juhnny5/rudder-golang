...
// checks if the GetRuleCategoryDetails200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRuleCategoryDetails200ResponseData{}

// GetRuleCategoryDetails200ResponseData struct for GetRuleCategoryDetails200ResponseData
type GetRuleCategoryDetails200ResponseData struct {
	RulesCategories []RuleCategory `json:"rulesCategories"`
}

type _GetRuleCategoryDetails200ResponseData GetRuleCategoryDetails200ResponseData
...
func NewGetRuleCategoryDetails200ResponseData(rulesCategories []RuleCategory) *GetRuleCategoryDetails200ResponseData {
	this := GetRuleCategoryDetails200ResponseData{}
...
// GetRulesCategories returns the RulesCategories field value
...
// GetRulesCategoriesOk returns a tuple with the RulesCategories field value
// and a boolean to check if the value has been set.
func (o *GetRuleCategoryDetails200ResponseData) GetRulesCategoriesOk() ([]RuleCategory, bool) {
	if o == nil {
		return nil, false
	}
	return o.RulesCategories, true
}

// SetRulesCategories sets field value
func (o *GetRuleCategoryDetails200ResponseData) SetRulesCategories(v []RuleCategory) {
	o.RulesCategories = v
}

func (o GetRuleCategoryDetails200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetRuleCategoryDetails200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["rulesCategories"] = o.RulesCategories
	return toSerialize, nil
}

func (o *GetRuleCategoryDetails200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRuleCategoryDetails200ResponseData := _GetRuleCategoryDetails200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRuleCategoryDetails200ResponseData)

	if err != nil {
		return err
	}

	*o = GetRuleCategoryDetails200ResponseData(varGetRuleCategoryDetails200ResponseData)

	return err
}

type NullableGetRuleCategoryDetails200ResponseData struct {
	value *GetRuleCategoryDetails200ResponseData
	isSet bool
}

func (v NullableGetRuleCategoryDetails200ResponseData) Get() *GetRuleCategoryDetails200ResponseData {
	return v.value
}

func (v *NullableGetRuleCategoryDetails200ResponseData) Set(val *GetRuleCategoryDetails200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRuleCategoryDetails200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRuleCategoryDetails200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRuleCategoryDetails200ResponseData(val *GetRuleCategoryDetails200ResponseData) *NullableGetRuleCategoryDetails200ResponseData {
	return &NullableGetRuleCategoryDetails200ResponseData{value: val, isSet: true}
}

func (v NullableGetRuleCategoryDetails200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRuleCategoryDetails200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
