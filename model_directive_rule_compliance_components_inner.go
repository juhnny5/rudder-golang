...
// checks if the DirectiveRuleComplianceComponentsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectiveRuleComplianceComponentsInner{}

// DirectiveRuleComplianceComponentsInner struct for DirectiveRuleComplianceComponentsInner
type DirectiveRuleComplianceComponentsInner struct {
...
type _DirectiveRuleComplianceComponentsInner DirectiveRuleComplianceComponentsInner
...
func NewDirectiveRuleComplianceComponentsInner(name string, compliance float32, complianceDetails NodeComplianceComponentComplianceDetails, nodes NodeComplianceComponent) *DirectiveRuleComplianceComponentsInner {
	this := DirectiveRuleComplianceComponentsInner{}
	this.Name = name
...
func (o *DirectiveRuleComplianceComponentsInner) GetComplianceDetails() NodeComplianceComponentComplianceDetails {
	if o == nil {
		var ret NodeComplianceComponentComplianceDetails
		return ret
	}
...
func (o *DirectiveRuleComplianceComponentsInner) GetNodes() NodeComplianceComponent {
	if o == nil {
		var ret NodeComplianceComponent
		return ret
	}
...
func (o DirectiveRuleComplianceComponentsInner) MarshalJSON() ([]byte, error) {
...
func (o DirectiveRuleComplianceComponentsInner) ToMap() (map[string]interface{}, error) {
...
func (o *DirectiveRuleComplianceComponentsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectiveRuleComplianceComponentsInner := _DirectiveRuleComplianceComponentsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDirectiveRuleComplianceComponentsInner)

	if err != nil {
		return err
	}

	*o = DirectiveRuleComplianceComponentsInner(varDirectiveRuleComplianceComponentsInner)

	return err
}

type NullableDirectiveRuleComplianceComponentsInner struct {
	value *DirectiveRuleComplianceComponentsInner
	isSet bool
}

func (v NullableDirectiveRuleComplianceComponentsInner) Get() *DirectiveRuleComplianceComponentsInner {
	return v.value
}

func (v *NullableDirectiveRuleComplianceComponentsInner) Set(val *DirectiveRuleComplianceComponentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectiveRuleComplianceComponentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectiveRuleComplianceComponentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectiveRuleComplianceComponentsInner(val *DirectiveRuleComplianceComponentsInner) *NullableDirectiveRuleComplianceComponentsInner {
	return &NullableDirectiveRuleComplianceComponentsInner{value: val, isSet: true}
}

func (v NullableDirectiveRuleComplianceComponentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectiveRuleComplianceComponentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
