...
// checks if the DeleteDirective200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteDirective200Response{}

// DeleteDirective200Response struct for DeleteDirective200Response
type DeleteDirective200Response struct {
...
type _DeleteDirective200Response DeleteDirective200Response
...
func NewDeleteDirective200Response(result string, action string, data ListDirectives200ResponseData) *DeleteDirective200Response {
	this := DeleteDirective200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o DeleteDirective200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteDirective200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteDirective200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteDirective200Response := _DeleteDirective200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteDirective200Response)

	if err != nil {
		return err
	}

	*o = DeleteDirective200Response(varDeleteDirective200Response)

	return err
}

type NullableDeleteDirective200Response struct {
	value *DeleteDirective200Response
	isSet bool
}

func (v NullableDeleteDirective200Response) Get() *DeleteDirective200Response {
	return v.value
}

func (v *NullableDeleteDirective200Response) Set(val *DeleteDirective200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteDirective200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteDirective200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteDirective200Response(val *DeleteDirective200Response) *NullableDeleteDirective200Response {
	return &NullableDeleteDirective200Response{value: val, isSet: true}
}

func (v NullableDeleteDirective200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteDirective200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
