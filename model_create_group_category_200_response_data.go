...
// checks if the CreateGroupCategory200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGroupCategory200ResponseData{}

// CreateGroupCategory200ResponseData struct for CreateGroupCategory200ResponseData
type CreateGroupCategory200ResponseData struct {
	GroupCategories []GroupCategory `json:"groupCategories"`
}

type _CreateGroupCategory200ResponseData CreateGroupCategory200ResponseData
...
func NewCreateGroupCategory200ResponseData(groupCategories []GroupCategory) *CreateGroupCategory200ResponseData {
	this := CreateGroupCategory200ResponseData{}
...
// GetGroupCategories returns the GroupCategories field value
...
// GetGroupCategoriesOk returns a tuple with the GroupCategories field value
...
// SetGroupCategories sets field value
func (o *CreateGroupCategory200ResponseData) SetGroupCategories(v []GroupCategory) {
	o.GroupCategories = v
}

func (o CreateGroupCategory200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CreateGroupCategory200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["groupCategories"] = o.GroupCategories
	return toSerialize, nil
}

func (o *CreateGroupCategory200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGroupCategory200ResponseData := _CreateGroupCategory200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGroupCategory200ResponseData)

	if err != nil {
		return err
	}

	*o = CreateGroupCategory200ResponseData(varCreateGroupCategory200ResponseData)

	return err
}

type NullableCreateGroupCategory200ResponseData struct {
	value *CreateGroupCategory200ResponseData
	isSet bool
}

func (v NullableCreateGroupCategory200ResponseData) Get() *CreateGroupCategory200ResponseData {
	return v.value
}

func (v *NullableCreateGroupCategory200ResponseData) Set(val *CreateGroupCategory200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateGroupCategory200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateGroupCategory200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateGroupCategory200ResponseData(val *CreateGroupCategory200ResponseData) *NullableCreateGroupCategory200ResponseData {
	return &NullableCreateGroupCategory200ResponseData{value: val, isSet: true}
}

func (v NullableCreateGroupCategory200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateGroupCategory200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
