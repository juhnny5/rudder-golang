...
// checks if the GetAllCampaignEvents200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllCampaignEvents200ResponseData{}

// GetAllCampaignEvents200ResponseData struct for GetAllCampaignEvents200ResponseData
type GetAllCampaignEvents200ResponseData struct {
	CampaignEvents []CampaignEventDetails `json:"campaignEvents"`
}

type _GetAllCampaignEvents200ResponseData GetAllCampaignEvents200ResponseData

// NewGetAllCampaignEvents200ResponseData instantiates a new GetAllCampaignEvents200ResponseData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetAllCampaignEvents200ResponseData(campaignEvents []CampaignEventDetails) *GetAllCampaignEvents200ResponseData {
	this := GetAllCampaignEvents200ResponseData{}
	this.CampaignEvents = campaignEvents
	return &this
}

// NewGetAllCampaignEvents200ResponseDataWithDefaults instantiates a new GetAllCampaignEvents200ResponseData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetAllCampaignEvents200ResponseDataWithDefaults() *GetAllCampaignEvents200ResponseData {
	this := GetAllCampaignEvents200ResponseData{}
	return &this
}

// GetCampaignEvents returns the CampaignEvents field value
func (o *GetAllCampaignEvents200ResponseData) GetCampaignEvents() []CampaignEventDetails {
	if o == nil {
		var ret []CampaignEventDetails
		return ret
	}
...
// GetCampaignEventsOk returns a tuple with the CampaignEvents field value
// and a boolean to check if the value has been set.
func (o *GetAllCampaignEvents200ResponseData) GetCampaignEventsOk() ([]CampaignEventDetails, bool) {
	if o == nil {
		return nil, false
	}
	return o.CampaignEvents, true
}

// SetCampaignEvents sets field value
func (o *GetAllCampaignEvents200ResponseData) SetCampaignEvents(v []CampaignEventDetails) {
	o.CampaignEvents = v
}

func (o GetAllCampaignEvents200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetAllCampaignEvents200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["campaignEvents"] = o.CampaignEvents
	return toSerialize, nil
}

func (o *GetAllCampaignEvents200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllCampaignEvents200ResponseData := _GetAllCampaignEvents200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllCampaignEvents200ResponseData)

	if err != nil {
		return err
	}

	*o = GetAllCampaignEvents200ResponseData(varGetAllCampaignEvents200ResponseData)

	return err
}

type NullableGetAllCampaignEvents200ResponseData struct {
	value *GetAllCampaignEvents200ResponseData
	isSet bool
}

func (v NullableGetAllCampaignEvents200ResponseData) Get() *GetAllCampaignEvents200ResponseData {
	return v.value
}

func (v *NullableGetAllCampaignEvents200ResponseData) Set(val *GetAllCampaignEvents200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllCampaignEvents200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllCampaignEvents200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllCampaignEvents200ResponseData(val *GetAllCampaignEvents200ResponseData) *NullableGetAllCampaignEvents200ResponseData {
	return &NullableGetAllCampaignEvents200ResponseData{value: val, isSet: true}
}

func (v NullableGetAllCampaignEvents200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllCampaignEvents200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
