...
// checks if the GetNodesStatus200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodesStatus200ResponseData{}

// GetNodesStatus200ResponseData List of nodeId and associated status
type GetNodesStatus200ResponseData struct {
	// List of nodeId and associated status
	Nodes []GetNodesStatus200ResponseDataNodesInner `json:"nodes"`
}

type _GetNodesStatus200ResponseData GetNodesStatus200ResponseData
...
func NewGetNodesStatus200ResponseData(nodes []GetNodesStatus200ResponseDataNodesInner) *GetNodesStatus200ResponseData {
	this := GetNodesStatus200ResponseData{}
	this.Nodes = nodes
	return &this
}
...
func (o *GetNodesStatus200ResponseData) GetNodes() []GetNodesStatus200ResponseDataNodesInner {
	if o == nil {
		var ret []GetNodesStatus200ResponseDataNodesInner
		return ret
	}
...
func (o GetNodesStatus200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetNodesStatus200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodes"] = o.Nodes
	return toSerialize, nil
}

func (o *GetNodesStatus200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodesStatus200ResponseData := _GetNodesStatus200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodesStatus200ResponseData)

	if err != nil {
		return err
	}

	*o = GetNodesStatus200ResponseData(varGetNodesStatus200ResponseData)

	return err
}

type NullableGetNodesStatus200ResponseData struct {
	value *GetNodesStatus200ResponseData
	isSet bool
}

func (v NullableGetNodesStatus200ResponseData) Get() *GetNodesStatus200ResponseData {
	return v.value
}

func (v *NullableGetNodesStatus200ResponseData) Set(val *GetNodesStatus200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodesStatus200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodesStatus200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodesStatus200ResponseData(val *GetNodesStatus200ResponseData) *NullableGetNodesStatus200ResponseData {
	return &NullableGetNodesStatus200ResponseData{value: val, isSet: true}
}

func (v NullableGetNodesStatus200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodesStatus200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
