...
// checks if the UpdateCVE200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCVE200ResponseData{}

// UpdateCVE200ResponseData struct for UpdateCVE200ResponseData
type UpdateCVE200ResponseData struct {
	CVEs int32 `json:"CVEs"`
}

type _UpdateCVE200ResponseData UpdateCVE200ResponseData
...
func (o UpdateCVE200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o UpdateCVE200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["CVEs"] = o.CVEs
	return toSerialize, nil
}

func (o *UpdateCVE200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCVE200ResponseData := _UpdateCVE200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateCVE200ResponseData)

	if err != nil {
		return err
	}

	*o = UpdateCVE200ResponseData(varUpdateCVE200ResponseData)

	return err
}

type NullableUpdateCVE200ResponseData struct {
	value *UpdateCVE200ResponseData
	isSet bool
}

func (v NullableUpdateCVE200ResponseData) Get() *UpdateCVE200ResponseData {
	return v.value
}

func (v *NullableUpdateCVE200ResponseData) Set(val *UpdateCVE200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCVE200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCVE200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCVE200ResponseData(val *UpdateCVE200ResponseData) *NullableUpdateCVE200ResponseData {
	return &NullableUpdateCVE200ResponseData{value: val, isSet: true}
}

func (v NullableUpdateCVE200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCVE200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
