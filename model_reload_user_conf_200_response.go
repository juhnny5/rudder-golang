...
// checks if the ReloadUserConf200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadUserConf200Response{}

// ReloadUserConf200Response struct for ReloadUserConf200Response
type ReloadUserConf200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ReloadUserConf200ResponseData `json:"data"`
}

type _ReloadUserConf200Response ReloadUserConf200Response
...
func NewReloadUserConf200Response(result string, action string, data ReloadUserConf200ResponseData) *ReloadUserConf200Response {
	this := ReloadUserConf200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ReloadUserConf200Response) GetData() ReloadUserConf200ResponseData {
	if o == nil {
		var ret ReloadUserConf200ResponseData
		return ret
	}
...
func (o ReloadUserConf200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadUserConf200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadUserConf200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadUserConf200Response := _ReloadUserConf200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadUserConf200Response)

	if err != nil {
		return err
	}

	*o = ReloadUserConf200Response(varReloadUserConf200Response)

	return err
}

type NullableReloadUserConf200Response struct {
	value *ReloadUserConf200Response
	isSet bool
}

func (v NullableReloadUserConf200Response) Get() *ReloadUserConf200Response {
	return v.value
}

func (v *NullableReloadUserConf200Response) Set(val *ReloadUserConf200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadUserConf200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadUserConf200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadUserConf200Response(val *ReloadUserConf200Response) *NullableReloadUserConf200Response {
	return &NullableReloadUserConf200Response{value: val, isSet: true}
}

func (v NullableReloadUserConf200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadUserConf200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
