...
// checks if the ChangePendingNodeStatus200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangePendingNodeStatus200ResponseData{}

// ChangePendingNodeStatus200ResponseData Information about the node
type ChangePendingNodeStatus200ResponseData struct {
	Nodes []NodeFull `json:"nodes"`
}

type _ChangePendingNodeStatus200ResponseData ChangePendingNodeStatus200ResponseData
...
func NewChangePendingNodeStatus200ResponseData(nodes []NodeFull) *ChangePendingNodeStatus200ResponseData {
	this := ChangePendingNodeStatus200ResponseData{}
	this.Nodes = nodes
	return &this
}
...
func (o ChangePendingNodeStatus200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ChangePendingNodeStatus200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodes"] = o.Nodes
	return toSerialize, nil
}

func (o *ChangePendingNodeStatus200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varChangePendingNodeStatus200ResponseData := _ChangePendingNodeStatus200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChangePendingNodeStatus200ResponseData)

	if err != nil {
		return err
	}

	*o = ChangePendingNodeStatus200ResponseData(varChangePendingNodeStatus200ResponseData)

	return err
}

type NullableChangePendingNodeStatus200ResponseData struct {
	value *ChangePendingNodeStatus200ResponseData
	isSet bool
}

func (v NullableChangePendingNodeStatus200ResponseData) Get() *ChangePendingNodeStatus200ResponseData {
	return v.value
}

func (v *NullableChangePendingNodeStatus200ResponseData) Set(val *ChangePendingNodeStatus200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableChangePendingNodeStatus200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableChangePendingNodeStatus200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangePendingNodeStatus200ResponseData(val *ChangePendingNodeStatus200ResponseData) *NullableChangePendingNodeStatus200ResponseData {
	return &NullableChangePendingNodeStatus200ResponseData{value: val, isSet: true}
}

func (v NullableChangePendingNodeStatus200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangePendingNodeStatus200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
