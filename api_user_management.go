...
func (r ApiAddUserRequest) Users(users Users) ApiAddUserRequest {
	r.users = &users
	return r
}
...
*/
func (a *UserManagementAPIService) AddUser(ctx context.Context) ApiAddUserRequest {
	return ApiAddUserRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UserManagementAPIService) AddUserExecute(r ApiAddUserRequest) (*AddUser200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserManagementAPIService.AddUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/usermanagement"
...
*/
func (a *UserManagementAPIService) DeleteUser(ctx context.Context, username string) ApiDeleteUserRequest {
	return ApiDeleteUserRequest{
		ApiService: a,
		ctx: ctx,
		username: username,
...
func (a *UserManagementAPIService) DeleteUserExecute(r ApiDeleteUserRequest) (*DeleteUser200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/usermanagement/{username}"
...
*/
func (a *UserManagementAPIService) GetRole(ctx context.Context) ApiGetRoleRequest {
	return ApiGetRoleRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UserManagementAPIService) GetRoleExecute(r ApiGetRoleRequest) (*GetRole200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserManagementAPIService.GetRole")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/usermanagement/roles"
...
func (a *UserManagementAPIService) GetUserInfoExecute(r ApiGetUserInfoRequest) (*GetUserInfo200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/usermanagement/users"
...
type ApiReloadUserConfRequest struct {
	ctx context.Context
	ApiService *UserManagementAPIService
}

func (r ApiReloadUserConfRequest) Execute() (*ReloadUserConf200Response, *http.Response, error) {
	return r.ApiService.ReloadUserConfExecute(r)
}
...
Reload the users from the file system, in the configuration file
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReloadUserConfRequest
*/
func (a *UserManagementAPIService) ReloadUserConf(ctx context.Context) ApiReloadUserConfRequest {
	return ApiReloadUserConfRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ReloadUserConf200Response
func (a *UserManagementAPIService) ReloadUserConfExecute(r ApiReloadUserConfRequest) (*ReloadUserConf200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReloadUserConf200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserManagementAPIService.ReloadUserConf")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/usermanagement/users/reload"
...
func (r ApiUpdateUserRequest) Users(users Users) ApiUpdateUserRequest {
	r.users = &users
	return r
}
...
*/
func (a *UserManagementAPIService) UpdateUser(ctx context.Context, username string) ApiUpdateUserRequest {
	return ApiUpdateUserRequest{
		ApiService: a,
		ctx: ctx,
		username: username,
...
func (a *UserManagementAPIService) UpdateUserExecute(r ApiUpdateUserRequest) (*UpdateUser200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/usermanagement/update/{username}"
	localVarPath = strings.Replace(localVarPath, "{"+"username"+"}", url.PathEscape(parameterValueToString(r.username, "username")), -1)
