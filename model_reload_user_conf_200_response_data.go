...
// checks if the ReloadUserConf200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadUserConf200ResponseData{}

// ReloadUserConf200ResponseData struct for ReloadUserConf200ResponseData
type ReloadUserConf200ResponseData struct {
	Reload ReloadUserConf200ResponseDataReload `json:"reload"`
}

type _ReloadUserConf200ResponseData ReloadUserConf200ResponseData
...
func NewReloadUserConf200ResponseData(reload ReloadUserConf200ResponseDataReload) *ReloadUserConf200ResponseData {
	this := ReloadUserConf200ResponseData{}
	this.Reload = reload
	return &this
}
...
// GetReload returns the Reload field value
func (o *ReloadUserConf200ResponseData) GetReload() ReloadUserConf200ResponseDataReload {
	if o == nil {
		var ret ReloadUserConf200ResponseDataReload
		return ret
	}
...
// GetReloadOk returns a tuple with the Reload field value
...
// SetReload sets field value
func (o *ReloadUserConf200ResponseData) SetReload(v ReloadUserConf200ResponseDataReload) {
	o.Reload = v
}

func (o ReloadUserConf200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ReloadUserConf200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["reload"] = o.Reload
	return toSerialize, nil
}

func (o *ReloadUserConf200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadUserConf200ResponseData := _ReloadUserConf200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadUserConf200ResponseData)

	if err != nil {
		return err
	}

	*o = ReloadUserConf200ResponseData(varReloadUserConf200ResponseData)

	return err
}

type NullableReloadUserConf200ResponseData struct {
	value *ReloadUserConf200ResponseData
	isSet bool
}

func (v NullableReloadUserConf200ResponseData) Get() *ReloadUserConf200ResponseData {
	return v.value
}

func (v *NullableReloadUserConf200ResponseData) Set(val *ReloadUserConf200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadUserConf200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadUserConf200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadUserConf200ResponseData(val *ReloadUserConf200ResponseData) *NullableReloadUserConf200ResponseData {
	return &NullableReloadUserConf200ResponseData{value: val, isSet: true}
}

func (v NullableReloadUserConf200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadUserConf200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
