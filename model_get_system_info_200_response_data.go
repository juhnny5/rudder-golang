...
// checks if the GetSystemInfo200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSystemInfo200ResponseData{}

// GetSystemInfo200ResponseData Information about the service
type GetSystemInfo200ResponseData struct {
	Rudder GetSystemInfo200ResponseDataRudder `json:"rudder"`
}

type _GetSystemInfo200ResponseData GetSystemInfo200ResponseData
...
func NewGetSystemInfo200ResponseData(rudder GetSystemInfo200ResponseDataRudder) *GetSystemInfo200ResponseData {
	this := GetSystemInfo200ResponseData{}
	this.Rudder = rudder
	return &this
}
...
// GetRudder returns the Rudder field value
func (o *GetSystemInfo200ResponseData) GetRudder() GetSystemInfo200ResponseDataRudder {
	if o == nil {
		var ret GetSystemInfo200ResponseDataRudder
		return ret
	}
...
func (o GetSystemInfo200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["rudder"] = o.Rudder
	return toSerialize, nil
}

func (o *GetSystemInfo200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSystemInfo200ResponseData := _GetSystemInfo200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetSystemInfo200ResponseData)

	if err != nil {
		return err
	}

	*o = GetSystemInfo200ResponseData(varGetSystemInfo200ResponseData)

	return err
}

type NullableGetSystemInfo200ResponseData struct {
	value *GetSystemInfo200ResponseData
	isSet bool
}

func (v NullableGetSystemInfo200ResponseData) Get() *GetSystemInfo200ResponseData {
	return v.value
}

func (v *NullableGetSystemInfo200ResponseData) Set(val *GetSystemInfo200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSystemInfo200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSystemInfo200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSystemInfo200ResponseData(val *GetSystemInfo200ResponseData) *NullableGetSystemInfo200ResponseData {
	return &NullableGetSystemInfo200ResponseData{value: val, isSet: true}
}

func (v NullableGetSystemInfo200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSystemInfo200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
