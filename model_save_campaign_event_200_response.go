...
// checks if the SaveCampaignEvent200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveCampaignEvent200Response{}

// SaveCampaignEvent200Response struct for SaveCampaignEvent200Response
type SaveCampaignEvent200Response struct {
...
type _SaveCampaignEvent200Response SaveCampaignEvent200Response
...
func NewSaveCampaignEvent200Response(result string, action string, data GetAllCampaignEvents200ResponseData) *SaveCampaignEvent200Response {
	this := SaveCampaignEvent200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o SaveCampaignEvent200Response) MarshalJSON() ([]byte, error) {
...
func (o SaveCampaignEvent200Response) ToMap() (map[string]interface{}, error) {
...
func (o *SaveCampaignEvent200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSaveCampaignEvent200Response := _SaveCampaignEvent200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSaveCampaignEvent200Response)

	if err != nil {
		return err
	}

	*o = SaveCampaignEvent200Response(varSaveCampaignEvent200Response)

	return err
}

type NullableSaveCampaignEvent200Response struct {
	value *SaveCampaignEvent200Response
	isSet bool
}

func (v NullableSaveCampaignEvent200Response) Get() *SaveCampaignEvent200Response {
	return v.value
}

func (v *NullableSaveCampaignEvent200Response) Set(val *SaveCampaignEvent200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveCampaignEvent200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveCampaignEvent200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveCampaignEvent200Response(val *SaveCampaignEvent200Response) *NullableSaveCampaignEvent200Response {
	return &NullableSaveCampaignEvent200Response{value: val, isSet: true}
}

func (v NullableSaveCampaignEvent200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveCampaignEvent200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
