...
// checks if the CampaignEventNodeResultNodesInnerResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEventNodeResultNodesInnerResult{}

// CampaignEventNodeResultNodesInnerResult struct for CampaignEventNodeResultNodesInnerResult
type CampaignEventNodeResultNodesInnerResult struct {
	// Campaign result
	Status *string `json:"status,omitempty"`
	// List of updated software
	SoftwareUpdated []CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner `json:"software-updated,omitempty"`
...
func NewCampaignEventNodeResultNodesInnerResult() *CampaignEventNodeResultNodesInnerResult {
	this := CampaignEventNodeResultNodesInnerResult{}
	return &this
}
...
// GetSoftwareUpdated returns the SoftwareUpdated field value if set, zero value otherwise.
func (o *CampaignEventNodeResultNodesInnerResult) GetSoftwareUpdated() []CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner {
	if o == nil || IsNil(o.SoftwareUpdated) {
		var ret []CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner
		return ret
	}
	return o.SoftwareUpdated
}

// GetSoftwareUpdatedOk returns a tuple with the SoftwareUpdated field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSoftwareUpdated gets a reference to the given []CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner and assigns it to the SoftwareUpdated field.
...
func (o CampaignEventNodeResultNodesInnerResult) MarshalJSON() ([]byte, error) {
...
func (o CampaignEventNodeResultNodesInnerResult) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Status) {
		toSerialize["status"] = o.Status
	}
	if !IsNil(o.SoftwareUpdated) {
		toSerialize["software-updated"] = o.SoftwareUpdated
	}
	if !IsNil(o.Output) {
...
type NullableCampaignEventNodeResultNodesInnerResult struct {
	value *CampaignEventNodeResultNodesInnerResult
	isSet bool
}

func (v NullableCampaignEventNodeResultNodesInnerResult) Get() *CampaignEventNodeResultNodesInnerResult {
	return v.value
}

func (v *NullableCampaignEventNodeResultNodesInnerResult) Set(val *CampaignEventNodeResultNodesInnerResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignEventNodeResultNodesInnerResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignEventNodeResultNodesInnerResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignEventNodeResultNodesInnerResult(val *CampaignEventNodeResultNodesInnerResult) *NullableCampaignEventNodeResultNodesInnerResult {
	return &NullableCampaignEventNodeResultNodesInnerResult{value: val, isSet: true}
}

func (v NullableCampaignEventNodeResultNodesInnerResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignEventNodeResultNodesInnerResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
