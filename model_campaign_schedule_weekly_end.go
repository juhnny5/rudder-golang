...
// checks if the CampaignScheduleWeeklyEnd type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleWeeklyEnd{}

// CampaignScheduleWeeklyEnd Date when the campaign should end
type CampaignScheduleWeeklyEnd struct {
...
func NewCampaignScheduleWeeklyEnd() *CampaignScheduleWeeklyEnd {
	this := CampaignScheduleWeeklyEnd{}
	return &this
}
...
func (o CampaignScheduleWeeklyEnd) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleWeeklyEnd) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleWeeklyEnd struct {
	value *CampaignScheduleWeeklyEnd
	isSet bool
}

func (v NullableCampaignScheduleWeeklyEnd) Get() *CampaignScheduleWeeklyEnd {
	return v.value
}

func (v *NullableCampaignScheduleWeeklyEnd) Set(val *CampaignScheduleWeeklyEnd) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleWeeklyEnd) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleWeeklyEnd) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleWeeklyEnd(val *CampaignScheduleWeeklyEnd) *NullableCampaignScheduleWeeklyEnd {
	return &NullableCampaignScheduleWeeklyEnd{value: val, isSet: true}
}

func (v NullableCampaignScheduleWeeklyEnd) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleWeeklyEnd) UnmarshalJSON(src []byte) error {
	v.isSet = true
