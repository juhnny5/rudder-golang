...
// checks if the GetCVECheckConfiguration200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCVECheckConfiguration200Response{}

// GetCVECheckConfiguration200Response struct for GetCVECheckConfiguration200Response
type GetCVECheckConfiguration200Response struct {
...
type _GetCVECheckConfiguration200Response GetCVECheckConfiguration200Response
...
func NewGetCVECheckConfiguration200Response(result string, action string, data GetCVECheckConfiguration200ResponseData) *GetCVECheckConfiguration200Response {
	this := GetCVECheckConfiguration200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o GetCVECheckConfiguration200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCVECheckConfiguration200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetCVECheckConfiguration200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCVECheckConfiguration200Response := _GetCVECheckConfiguration200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCVECheckConfiguration200Response)

	if err != nil {
		return err
	}

	*o = GetCVECheckConfiguration200Response(varGetCVECheckConfiguration200Response)

	return err
}

type NullableGetCVECheckConfiguration200Response struct {
	value *GetCVECheckConfiguration200Response
	isSet bool
}

func (v NullableGetCVECheckConfiguration200Response) Get() *GetCVECheckConfiguration200Response {
	return v.value
}

func (v *NullableGetCVECheckConfiguration200Response) Set(val *GetCVECheckConfiguration200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCVECheckConfiguration200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCVECheckConfiguration200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCVECheckConfiguration200Response(val *GetCVECheckConfiguration200Response) *NullableGetCVECheckConfiguration200Response {
	return &NullableGetCVECheckConfiguration200Response{value: val, isSet: true}
}

func (v NullableGetCVECheckConfiguration200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCVECheckConfiguration200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
