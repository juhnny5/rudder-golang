...
// checks if the ReloadTechniques200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadTechniques200ResponseData{}

// ReloadTechniques200ResponseData struct for ReloadTechniques200ResponseData
type ReloadTechniques200ResponseData struct {
	Techniques string `json:"techniques"`
}

type _ReloadTechniques200ResponseData ReloadTechniques200ResponseData
...
func NewReloadTechniques200ResponseData(techniques string) *ReloadTechniques200ResponseData {
	this := ReloadTechniques200ResponseData{}
...
func (o ReloadTechniques200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ReloadTechniques200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["techniques"] = o.Techniques
	return toSerialize, nil
}

func (o *ReloadTechniques200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadTechniques200ResponseData := _ReloadTechniques200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadTechniques200ResponseData)

	if err != nil {
		return err
	}

	*o = ReloadTechniques200ResponseData(varReloadTechniques200ResponseData)

	return err
}

type NullableReloadTechniques200ResponseData struct {
	value *ReloadTechniques200ResponseData
	isSet bool
}

func (v NullableReloadTechniques200ResponseData) Get() *ReloadTechniques200ResponseData {
	return v.value
}

func (v *NullableReloadTechniques200ResponseData) Set(val *ReloadTechniques200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadTechniques200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadTechniques200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadTechniques200ResponseData(val *ReloadTechniques200ResponseData) *NullableReloadTechniques200ResponseData {
	return &NullableReloadTechniques200ResponseData{value: val, isSet: true}
}

func (v NullableReloadTechniques200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadTechniques200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
