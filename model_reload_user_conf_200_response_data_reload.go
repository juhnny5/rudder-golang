...
// checks if the ReloadUserConf200ResponseDataReload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadUserConf200ResponseDataReload{}

// ReloadUserConf200ResponseDataReload struct for ReloadUserConf200ResponseDataReload
type ReloadUserConf200ResponseDataReload struct {
	Status string `json:"status"`
}

type _ReloadUserConf200ResponseDataReload ReloadUserConf200ResponseDataReload
...
func NewReloadUserConf200ResponseDataReload(status string) *ReloadUserConf200ResponseDataReload {
	this := ReloadUserConf200ResponseDataReload{}
	this.Status = status
	return &this
}
...
func (o ReloadUserConf200ResponseDataReload) MarshalJSON() ([]byte, error) {
...
func (o ReloadUserConf200ResponseDataReload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["status"] = o.Status
	return toSerialize, nil
}

func (o *ReloadUserConf200ResponseDataReload) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadUserConf200ResponseDataReload := _ReloadUserConf200ResponseDataReload{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadUserConf200ResponseDataReload)

	if err != nil {
		return err
	}

	*o = ReloadUserConf200ResponseDataReload(varReloadUserConf200ResponseDataReload)

	return err
}

type NullableReloadUserConf200ResponseDataReload struct {
	value *ReloadUserConf200ResponseDataReload
	isSet bool
}

func (v NullableReloadUserConf200ResponseDataReload) Get() *ReloadUserConf200ResponseDataReload {
	return v.value
}

func (v *NullableReloadUserConf200ResponseDataReload) Set(val *ReloadUserConf200ResponseDataReload) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadUserConf200ResponseDataReload) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadUserConf200ResponseDataReload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadUserConf200ResponseDataReload(val *ReloadUserConf200ResponseDataReload) *NullableReloadUserConf200ResponseDataReload {
	return &NullableReloadUserConf200ResponseDataReload{value: val, isSet: true}
}

func (v NullableReloadUserConf200ResponseDataReload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadUserConf200ResponseDataReload) UnmarshalJSON(src []byte) error {
	v.isSet = true
