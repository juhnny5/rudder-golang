...
// checks if the FileWatcherStart200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileWatcherStart200Response{}

// FileWatcherStart200Response struct for FileWatcherStart200Response
type FileWatcherStart200Response struct {
...
type _FileWatcherStart200Response FileWatcherStart200Response
...
func NewFileWatcherStart200Response(result string, action string, data string) *FileWatcherStart200Response {
	this := FileWatcherStart200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o FileWatcherStart200Response) MarshalJSON() ([]byte, error) {
...
func (o FileWatcherStart200Response) ToMap() (map[string]interface{}, error) {
...
func (o *FileWatcherStart200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varFileWatcherStart200Response := _FileWatcherStart200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFileWatcherStart200Response)

	if err != nil {
		return err
	}

	*o = FileWatcherStart200Response(varFileWatcherStart200Response)

	return err
}

type NullableFileWatcherStart200Response struct {
	value *FileWatcherStart200Response
	isSet bool
}

func (v NullableFileWatcherStart200Response) Get() *FileWatcherStart200Response {
	return v.value
}

func (v *NullableFileWatcherStart200Response) Set(val *FileWatcherStart200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFileWatcherStart200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFileWatcherStart200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileWatcherStart200Response(val *FileWatcherStart200Response) *NullableFileWatcherStart200Response {
	return &NullableFileWatcherStart200Response{value: val, isSet: true}
}

func (v NullableFileWatcherStart200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileWatcherStart200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
