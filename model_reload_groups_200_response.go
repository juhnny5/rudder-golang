...
// checks if the ReloadGroups200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadGroups200Response{}

// ReloadGroups200Response struct for ReloadGroups200Response
type ReloadGroups200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ReloadGroups200ResponseData `json:"data"`
}

type _ReloadGroups200Response ReloadGroups200Response
...
func (o *ReloadGroups200Response) GetData() ReloadGroups200ResponseData {
	if o == nil {
		var ret ReloadGroups200ResponseData
		return ret
	}
...
func (o ReloadGroups200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadGroups200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadGroups200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadGroups200Response := _ReloadGroups200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadGroups200Response)

	if err != nil {
		return err
	}

	*o = ReloadGroups200Response(varReloadGroups200Response)

	return err
}

type NullableReloadGroups200Response struct {
	value *ReloadGroups200Response
	isSet bool
}

func (v NullableReloadGroups200Response) Get() *ReloadGroups200Response {
	return v.value
}

func (v *NullableReloadGroups200Response) Set(val *ReloadGroups200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadGroups200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadGroups200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadGroups200Response(val *ReloadGroups200Response) *NullableReloadGroups200Response {
	return &NullableReloadGroups200Response{value: val, isSet: true}
}

func (v NullableReloadGroups200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadGroups200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
