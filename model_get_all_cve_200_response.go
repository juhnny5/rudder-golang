...
// checks if the GetAllCve200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllCve200Response{}

// GetAllCve200Response struct for GetAllCve200Response
type GetAllCve200Response struct {
...
type _GetAllCve200Response GetAllCve200Response
...
func (o GetAllCve200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAllCve200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAllCve200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllCve200Response := _GetAllCve200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllCve200Response)

	if err != nil {
		return err
	}

	*o = GetAllCve200Response(varGetAllCve200Response)

	return err
}

type NullableGetAllCve200Response struct {
	value *GetAllCve200Response
	isSet bool
}

func (v NullableGetAllCve200Response) Get() *GetAllCve200Response {
	return v.value
}

func (v *NullableGetAllCve200Response) Set(val *GetAllCve200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllCve200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllCve200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllCve200Response(val *GetAllCve200Response) *NullableGetAllCve200Response {
	return &NullableGetAllCve200Response{value: val, isSet: true}
}

func (v NullableGetAllCve200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllCve200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
