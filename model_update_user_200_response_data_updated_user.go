...
// checks if the UpdateUser200ResponseDataUpdatedUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUser200ResponseDataUpdatedUser{}

// UpdateUser200ResponseDataUpdatedUser struct for UpdateUser200ResponseDataUpdatedUser
type UpdateUser200ResponseDataUpdatedUser struct {
	// New Username
...
type _UpdateUser200ResponseDataUpdatedUser UpdateUser200ResponseDataUpdatedUser
...
func NewUpdateUser200ResponseDataUpdatedUser(username string, password string, role []string) *UpdateUser200ResponseDataUpdatedUser {
	this := UpdateUser200ResponseDataUpdatedUser{}
...
func (o UpdateUser200ResponseDataUpdatedUser) MarshalJSON() ([]byte, error) {
...
func (o UpdateUser200ResponseDataUpdatedUser) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateUser200ResponseDataUpdatedUser) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateUser200ResponseDataUpdatedUser := _UpdateUser200ResponseDataUpdatedUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateUser200ResponseDataUpdatedUser)

	if err != nil {
		return err
	}

	*o = UpdateUser200ResponseDataUpdatedUser(varUpdateUser200ResponseDataUpdatedUser)

	return err
}

type NullableUpdateUser200ResponseDataUpdatedUser struct {
	value *UpdateUser200ResponseDataUpdatedUser
	isSet bool
}

func (v NullableUpdateUser200ResponseDataUpdatedUser) Get() *UpdateUser200ResponseDataUpdatedUser {
	return v.value
}

func (v *NullableUpdateUser200ResponseDataUpdatedUser) Set(val *UpdateUser200ResponseDataUpdatedUser) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUser200ResponseDataUpdatedUser) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUser200ResponseDataUpdatedUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUser200ResponseDataUpdatedUser(val *UpdateUser200ResponseDataUpdatedUser) *NullableUpdateUser200ResponseDataUpdatedUser {
	return &NullableUpdateUser200ResponseDataUpdatedUser{value: val, isSet: true}
}

func (v NullableUpdateUser200ResponseDataUpdatedUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUser200ResponseDataUpdatedUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
