...
// checks if the GetAllowedNetworks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllowedNetworks200Response{}

// GetAllowedNetworks200Response struct for GetAllowedNetworks200Response
type GetAllowedNetworks200Response struct {
	...
	Data GetAllowedNetworks200ResponseData `json:"data"`
}

type _GetAllowedNetworks200Response GetAllowedNetworks200Response
...
func NewGetAllowedNetworks200Response(id string, result string, action string, data GetAllowedNetworks200ResponseData) *GetAllowedNetworks200Response {
	this := GetAllowedNetworks200Response{}
	this.Id = id
	this.Result = result
	this.Action = action
	this.Data = data
...
func (o *GetAllowedNetworks200Response) GetData() GetAllowedNetworks200ResponseData {
	if o == nil {
		var ret GetAllowedNetworks200ResponseData
		return ret
	}
...
func (o GetAllowedNetworks200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAllowedNetworks200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAllowedNetworks200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllowedNetworks200Response := _GetAllowedNetworks200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllowedNetworks200Response)

	if err != nil {
		return err
	}

	*o = GetAllowedNetworks200Response(varGetAllowedNetworks200Response)

	return err
}

type NullableGetAllowedNetworks200Response struct {
	value *GetAllowedNetworks200Response
	isSet bool
}

func (v NullableGetAllowedNetworks200Response) Get() *GetAllowedNetworks200Response {
	return v.value
}

func (v *NullableGetAllowedNetworks200Response) Set(val *GetAllowedNetworks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllowedNetworks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllowedNetworks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllowedNetworks200Response(val *GetAllowedNetworks200Response) *NullableGetAllowedNetworks200Response {
	return &NullableGetAllowedNetworks200Response{value: val, isSet: true}
}

func (v NullableGetAllowedNetworks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllowedNetworks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
