...
// checks if the RuleCategoryUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleCategoryUpdate{}

// RuleCategoryUpdate struct for RuleCategoryUpdate
...
type _RuleCategoryUpdate RuleCategoryUpdate
...
func (o RuleCategoryUpdate) MarshalJSON() ([]byte, error) {
...
func (o RuleCategoryUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *RuleCategoryUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleCategoryUpdate := _RuleCategoryUpdate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleCategoryUpdate)

	if err != nil {
		return err
	}

	*o = RuleCategoryUpdate(varRuleCategoryUpdate)

	return err
}

type NullableRuleCategoryUpdate struct {
	value *RuleCategoryUpdate
	isSet bool
}

func (v NullableRuleCategoryUpdate) Get() *RuleCategoryUpdate {
	return v.value
}

func (v *NullableRuleCategoryUpdate) Set(val *RuleCategoryUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleCategoryUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleCategoryUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleCategoryUpdate(val *RuleCategoryUpdate) *NullableRuleCategoryUpdate {
	return &NullableRuleCategoryUpdate{value: val, isSet: true}
}

func (v NullableRuleCategoryUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleCategoryUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
