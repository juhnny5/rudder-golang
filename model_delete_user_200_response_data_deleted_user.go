...
// checks if the DeleteUser200ResponseDataDeletedUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteUser200ResponseDataDeletedUser{}

// DeleteUser200ResponseDataDeletedUser struct for DeleteUser200ResponseDataDeletedUser
type DeleteUser200ResponseDataDeletedUser struct {
	// Username of the deleted user
	Username string `json:"username"`
}

type _DeleteUser200ResponseDataDeletedUser DeleteUser200ResponseDataDeletedUser
...
func NewDeleteUser200ResponseDataDeletedUser(username string) *DeleteUser200ResponseDataDeletedUser {
	this := DeleteUser200ResponseDataDeletedUser{}
...
func (o DeleteUser200ResponseDataDeletedUser) MarshalJSON() ([]byte, error) {
...
func (o DeleteUser200ResponseDataDeletedUser) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["username"] = o.Username
	return toSerialize, nil
}

func (o *DeleteUser200ResponseDataDeletedUser) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteUser200ResponseDataDeletedUser := _DeleteUser200ResponseDataDeletedUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteUser200ResponseDataDeletedUser)

	if err != nil {
		return err
	}

	*o = DeleteUser200ResponseDataDeletedUser(varDeleteUser200ResponseDataDeletedUser)

	return err
}

type NullableDeleteUser200ResponseDataDeletedUser struct {
	value *DeleteUser200ResponseDataDeletedUser
	isSet bool
}

func (v NullableDeleteUser200ResponseDataDeletedUser) Get() *DeleteUser200ResponseDataDeletedUser {
	return v.value
}

func (v *NullableDeleteUser200ResponseDataDeletedUser) Set(val *DeleteUser200ResponseDataDeletedUser) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteUser200ResponseDataDeletedUser) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteUser200ResponseDataDeletedUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteUser200ResponseDataDeletedUser(val *DeleteUser200ResponseDataDeletedUser) *NullableDeleteUser200ResponseDataDeletedUser {
	return &NullableDeleteUser200ResponseDataDeletedUser{value: val, isSet: true}
}

func (v NullableDeleteUser200ResponseDataDeletedUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteUser200ResponseDataDeletedUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
