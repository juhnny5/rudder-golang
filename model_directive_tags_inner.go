...
// checks if the DirectiveTagsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectiveTagsInner{}

// DirectiveTagsInner struct for DirectiveTagsInner
type DirectiveTagsInner struct {
...
func (o DirectiveTagsInner) MarshalJSON() ([]byte, error) {
...
func (o DirectiveTagsInner) ToMap() (map[string]interface{}, error) {
...
type NullableDirectiveTagsInner struct {
	value *DirectiveTagsInner
	isSet bool
}

func (v NullableDirectiveTagsInner) Get() *DirectiveTagsInner {
	return v.value
}

func (v *NullableDirectiveTagsInner) Set(val *DirectiveTagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectiveTagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectiveTagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectiveTagsInner(val *DirectiveTagsInner) *NullableDirectiveTagsInner {
	return &NullableDirectiveTagsInner{value: val, isSet: true}
}

func (v NullableDirectiveTagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectiveTagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
