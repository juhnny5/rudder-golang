...
// checks if the NodeComplianceComponentValuesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeComplianceComponentValuesInner{}

// NodeComplianceComponentValuesInner struct for NodeComplianceComponentValuesInner
type NodeComplianceComponentValuesInner struct {
	Value string `json:"value"`
	Reports []NodeComplianceComponentValuesInnerReportsInner `json:"reports"`
}

type _NodeComplianceComponentValuesInner NodeComplianceComponentValuesInner
...
func NewNodeComplianceComponentValuesInner(value string, reports []NodeComplianceComponentValuesInnerReportsInner) *NodeComplianceComponentValuesInner {
	this := NodeComplianceComponentValuesInner{}
	this.Value = value
...
func (o *NodeComplianceComponentValuesInner) GetReports() []NodeComplianceComponentValuesInnerReportsInner {
	if o == nil {
		var ret []NodeComplianceComponentValuesInnerReportsInner
		return ret
	}
...
func (o NodeComplianceComponentValuesInner) MarshalJSON() ([]byte, error) {
...
func (o NodeComplianceComponentValuesInner) ToMap() (map[string]interface{}, error) {
...
func (o *NodeComplianceComponentValuesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeComplianceComponentValuesInner := _NodeComplianceComponentValuesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeComplianceComponentValuesInner)

	if err != nil {
		return err
	}

	*o = NodeComplianceComponentValuesInner(varNodeComplianceComponentValuesInner)

	return err
}

type NullableNodeComplianceComponentValuesInner struct {
	value *NodeComplianceComponentValuesInner
	isSet bool
}

func (v NullableNodeComplianceComponentValuesInner) Get() *NodeComplianceComponentValuesInner {
	return v.value
}

func (v *NullableNodeComplianceComponentValuesInner) Set(val *NodeComplianceComponentValuesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeComplianceComponentValuesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeComplianceComponentValuesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeComplianceComponentValuesInner(val *NodeComplianceComponentValuesInner) *NullableNodeComplianceComponentValuesInner {
	return &NullableNodeComplianceComponentValuesInner{value: val, isSet: true}
}

func (v NullableNodeComplianceComponentValuesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeComplianceComponentValuesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
