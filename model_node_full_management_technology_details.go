...
// checks if the NodeFullManagementTechnologyDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullManagementTechnologyDetails{}
...
func NewNodeFullManagementTechnologyDetails() *NodeFullManagementTechnologyDetails {
	this := NodeFullManagementTechnologyDetails{}
	return &this
}
...
// GetCfengineKeys returns the CfengineKeys field value if set, zero value otherwise.
func (o *NodeFullManagementTechnologyDetails) GetCfengineKeys() []string {
	if o == nil || IsNil(o.CfengineKeys) {
		var ret []string
		return ret
	}
...
// GetCfengineKeysOk returns a tuple with the CfengineKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeFullManagementTechnologyDetails) GetCfengineKeysOk() ([]string, bool) {
	if o == nil || IsNil(o.CfengineKeys) {
		return nil, false
	}
	return o.CfengineKeys, true
}
...
// SetCfengineKeys gets a reference to the given []string and assigns it to the CfengineKeys field.
func (o *NodeFullManagementTechnologyDetails) SetCfengineKeys(v []string) {
	o.CfengineKeys = v
}

// GetCfengineUser returns the CfengineUser field value if set, zero value otherwise.
func (o *NodeFullManagementTechnologyDetails) GetCfengineUser() string {
	if o == nil || IsNil(o.CfengineUser) {
		var ret string
		return ret
	}
...
// GetCfengineUserOk returns a tuple with the CfengineUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeFullManagementTechnologyDetails) GetCfengineUserOk() (*string, bool) {
	if o == nil || IsNil(o.CfengineUser) {
		return nil, false
	}
	return o.CfengineUser, true
}
...
// SetCfengineUser gets a reference to the given string and assigns it to the CfengineUser field.
func (o *NodeFullManagementTechnologyDetails) SetCfengineUser(v string) {
	o.CfengineUser = &v
}

func (o NodeFullManagementTechnologyDetails) MarshalJSON() ([]byte, error) {
...
func (o NodeFullManagementTechnologyDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CfengineKeys) {
		toSerialize["cfengineKeys"] = o.CfengineKeys
	}
	if !IsNil(o.CfengineUser) {
		toSerialize["cfengineUser"] = o.CfengineUser
	}
	return toSerialize, nil
}

type NullableNodeFullManagementTechnologyDetails struct {
	value *NodeFullManagementTechnologyDetails
	isSet bool
}

func (v NullableNodeFullManagementTechnologyDetails) Get() *NodeFullManagementTechnologyDetails {
	return v.value
}

func (v *NullableNodeFullManagementTechnologyDetails) Set(val *NodeFullManagementTechnologyDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullManagementTechnologyDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullManagementTechnologyDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullManagementTechnologyDetails(val *NodeFullManagementTechnologyDetails) *NullableNodeFullManagementTechnologyDetails {
	return &NullableNodeFullManagementTechnologyDetails{value: val, isSet: true}
}

func (v NullableNodeFullManagementTechnologyDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullManagementTechnologyDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
