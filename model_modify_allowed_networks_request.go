...
// checks if the ModifyAllowedNetworksRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyAllowedNetworksRequest{}

// ModifyAllowedNetworksRequest struct for ModifyAllowedNetworksRequest
type ModifyAllowedNetworksRequest struct {
	AllowedNetworks *ModifyAllowedNetworksRequestAllowedNetworks `json:"allowed_networks,omitempty"`
}
...
func NewModifyAllowedNetworksRequest() *ModifyAllowedNetworksRequest {
	this := ModifyAllowedNetworksRequest{}
	return &this
}
...
func (o *ModifyAllowedNetworksRequest) GetAllowedNetworks() ModifyAllowedNetworksRequestAllowedNetworks {
	if o == nil || IsNil(o.AllowedNetworks) {
		var ret ModifyAllowedNetworksRequestAllowedNetworks
		return ret
	}
...
// SetAllowedNetworks gets a reference to the given ModifyAllowedNetworksRequestAllowedNetworks and assigns it to the AllowedNetworks field.
func (o *ModifyAllowedNetworksRequest) SetAllowedNetworks(v ModifyAllowedNetworksRequestAllowedNetworks) {
	o.AllowedNetworks = &v
}

func (o ModifyAllowedNetworksRequest) MarshalJSON() ([]byte, error) {
...
func (o ModifyAllowedNetworksRequest) ToMap() (map[string]interface{}, error) {
...
type NullableModifyAllowedNetworksRequest struct {
	value *ModifyAllowedNetworksRequest
	isSet bool
}

func (v NullableModifyAllowedNetworksRequest) Get() *ModifyAllowedNetworksRequest {
	return v.value
}

func (v *NullableModifyAllowedNetworksRequest) Set(val *ModifyAllowedNetworksRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyAllowedNetworksRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyAllowedNetworksRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyAllowedNetworksRequest(val *ModifyAllowedNetworksRequest) *NullableModifyAllowedNetworksRequest {
	return &NullableModifyAllowedNetworksRequest{value: val, isSet: true}
}

func (v NullableModifyAllowedNetworksRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyAllowedNetworksRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
