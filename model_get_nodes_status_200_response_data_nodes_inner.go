...
// checks if the GetNodesStatus200ResponseDataNodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodesStatus200ResponseDataNodesInner{}

// GetNodesStatus200ResponseDataNodesInner struct for GetNodesStatus200ResponseDataNodesInner
type GetNodesStatus200ResponseDataNodesInner struct {
...
type _GetNodesStatus200ResponseDataNodesInner GetNodesStatus200ResponseDataNodesInner
...
func NewGetNodesStatus200ResponseDataNodesInner(id string, status string) *GetNodesStatus200ResponseDataNodesInner {
	this := GetNodesStatus200ResponseDataNodesInner{}
	this.Id = id
	this.Status = status
	return &this
}
...
func (o GetNodesStatus200ResponseDataNodesInner) MarshalJSON() ([]byte, error) {
...
func (o GetNodesStatus200ResponseDataNodesInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetNodesStatus200ResponseDataNodesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodesStatus200ResponseDataNodesInner := _GetNodesStatus200ResponseDataNodesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodesStatus200ResponseDataNodesInner)

	if err != nil {
		return err
	}

	*o = GetNodesStatus200ResponseDataNodesInner(varGetNodesStatus200ResponseDataNodesInner)

	return err
}

type NullableGetNodesStatus200ResponseDataNodesInner struct {
	value *GetNodesStatus200ResponseDataNodesInner
	isSet bool
}

func (v NullableGetNodesStatus200ResponseDataNodesInner) Get() *GetNodesStatus200ResponseDataNodesInner {
	return v.value
}

func (v *NullableGetNodesStatus200ResponseDataNodesInner) Set(val *GetNodesStatus200ResponseDataNodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodesStatus200ResponseDataNodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodesStatus200ResponseDataNodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodesStatus200ResponseDataNodesInner(val *GetNodesStatus200ResponseDataNodesInner) *NullableGetNodesStatus200ResponseDataNodesInner {
	return &NullableGetNodesStatus200ResponseDataNodesInner{value: val, isSet: true}
}

func (v NullableGetNodesStatus200ResponseDataNodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodesStatus200ResponseDataNodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
