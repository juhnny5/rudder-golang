...
// checks if the ChangeRequestChanges type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeRequestChanges{}

// ChangeRequestChanges struct for ChangeRequestChanges
type ChangeRequestChanges struct {
	Rules []ChangeRequestChangesRulesInner `json:"rules,omitempty"`
}
...
func (o *ChangeRequestChanges) GetRules() []ChangeRequestChangesRulesInner {
	if o == nil || IsNil(o.Rules) {
		var ret []ChangeRequestChangesRulesInner
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []ChangeRequestChangesRulesInner and assigns it to the Rules field.
func (o *ChangeRequestChanges) SetRules(v []ChangeRequestChangesRulesInner) {
	o.Rules = v
}

func (o ChangeRequestChanges) MarshalJSON() ([]byte, error) {
...
func (o ChangeRequestChanges) ToMap() (map[string]interface{}, error) {
...
type NullableChangeRequestChanges struct {
	value *ChangeRequestChanges
	isSet bool
}

func (v NullableChangeRequestChanges) Get() *ChangeRequestChanges {
	return v.value
}

func (v *NullableChangeRequestChanges) Set(val *ChangeRequestChanges) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeRequestChanges) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeRequestChanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeRequestChanges(val *ChangeRequestChanges) *NullableChangeRequestChanges {
	return &NullableChangeRequestChanges{value: val, isSet: true}
}

func (v NullableChangeRequestChanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeRequestChanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
