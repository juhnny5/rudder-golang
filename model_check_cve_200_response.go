...
// checks if the CheckCVE200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckCVE200Response{}

// CheckCVE200Response struct for CheckCVE200Response
type CheckCVE200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data CheckCVE200ResponseData `json:"data"`
}

type _CheckCVE200Response CheckCVE200Response
...
func (o *CheckCVE200Response) GetData() CheckCVE200ResponseData {
	if o == nil {
		var ret CheckCVE200ResponseData
		return ret
	}
...
func (o CheckCVE200Response) MarshalJSON() ([]byte, error) {
...
func (o CheckCVE200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CheckCVE200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCheckCVE200Response := _CheckCVE200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCheckCVE200Response)

	if err != nil {
		return err
	}

	*o = CheckCVE200Response(varCheckCVE200Response)

	return err
}

type NullableCheckCVE200Response struct {
	value *CheckCVE200Response
	isSet bool
}

func (v NullableCheckCVE200Response) Get() *CheckCVE200Response {
	return v.value
}

func (v *NullableCheckCVE200Response) Set(val *CheckCVE200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCVE200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCVE200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCVE200Response(val *CheckCVE200Response) *NullableCheckCVE200Response {
	return &NullableCheckCVE200Response{value: val, isSet: true}
}

func (v NullableCheckCVE200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCVE200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
