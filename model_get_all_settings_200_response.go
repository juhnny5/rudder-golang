...
// checks if the GetAllSettings200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllSettings200Response{}

// GetAllSettings200Response struct for GetAllSettings200Response
type GetAllSettings200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetAllSettings200ResponseData `json:"data"`
}

type _GetAllSettings200Response GetAllSettings200Response
...
func NewGetAllSettings200Response(result string, action string, data GetAllSettings200ResponseData) *GetAllSettings200Response {
	this := GetAllSettings200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetAllSettings200Response) GetData() GetAllSettings200ResponseData {
	if o == nil {
		var ret GetAllSettings200ResponseData
		return ret
	}
...
func (o GetAllSettings200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAllSettings200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAllSettings200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllSettings200Response := _GetAllSettings200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllSettings200Response)

	if err != nil {
		return err
	}

	*o = GetAllSettings200Response(varGetAllSettings200Response)

	return err
}

type NullableGetAllSettings200Response struct {
	value *GetAllSettings200Response
	isSet bool
}

func (v NullableGetAllSettings200Response) Get() *GetAllSettings200Response {
	return v.value
}

func (v *NullableGetAllSettings200Response) Set(val *GetAllSettings200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllSettings200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllSettings200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllSettings200Response(val *GetAllSettings200Response) *NullableGetAllSettings200Response {
	return &NullableGetAllSettings200Response{value: val, isSet: true}
}

func (v NullableGetAllSettings200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllSettings200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
