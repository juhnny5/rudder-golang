...
// checks if the CampaignEventNodeResultNodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEventNodeResultNodesInner{}

// CampaignEventNodeResultNodesInner struct for CampaignEventNodeResultNodesInner
type CampaignEventNodeResultNodesInner struct {
	// Node id
	NodeId *string `json:"nodeId,omitempty"`
	Result *CampaignEventNodeResultNodesInnerResult `json:"result,omitempty"`
...
func NewCampaignEventNodeResultNodesInner() *CampaignEventNodeResultNodesInner {
	this := CampaignEventNodeResultNodesInner{}
	return &this
}
...
func (o *CampaignEventNodeResultNodesInner) GetResult() CampaignEventNodeResultNodesInnerResult {
	if o == nil || IsNil(o.Result) {
		var ret CampaignEventNodeResultNodesInnerResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CampaignEventNodeResultNodesInnerResult and assigns it to the Result field.
...
func (o CampaignEventNodeResultNodesInner) MarshalJSON() ([]byte, error) {
...
func (o CampaignEventNodeResultNodesInner) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignEventNodeResultNodesInner struct {
	value *CampaignEventNodeResultNodesInner
	isSet bool
}

func (v NullableCampaignEventNodeResultNodesInner) Get() *CampaignEventNodeResultNodesInner {
	return v.value
}

func (v *NullableCampaignEventNodeResultNodesInner) Set(val *CampaignEventNodeResultNodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignEventNodeResultNodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignEventNodeResultNodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignEventNodeResultNodesInner(val *CampaignEventNodeResultNodesInner) *NullableCampaignEventNodeResultNodesInner {
	return &NullableCampaignEventNodeResultNodesInner{value: val, isSet: true}
}

func (v NullableCampaignEventNodeResultNodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignEventNodeResultNodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
