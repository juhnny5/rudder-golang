...
// checks if the UploadInventory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UploadInventory200Response{}

// UploadInventory200Response struct for UploadInventory200Response
type UploadInventory200Response struct {
...
type _UploadInventory200Response UploadInventory200Response
...
func NewUploadInventory200Response(result string, action string, data string) *UploadInventory200Response {
	this := UploadInventory200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o UploadInventory200Response) MarshalJSON() ([]byte, error) {
...
func (o UploadInventory200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UploadInventory200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUploadInventory200Response := _UploadInventory200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUploadInventory200Response)

	if err != nil {
		return err
	}

	*o = UploadInventory200Response(varUploadInventory200Response)

	return err
}

type NullableUploadInventory200Response struct {
	value *UploadInventory200Response
	isSet bool
}

func (v NullableUploadInventory200Response) Get() *UploadInventory200Response {
	return v.value
}

func (v *NullableUploadInventory200Response) Set(val *UploadInventory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUploadInventory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUploadInventory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUploadInventory200Response(val *UploadInventory200Response) *NullableUploadInventory200Response {
	return &NullableUploadInventory200Response{value: val, isSet: true}
}

func (v NullableUploadInventory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUploadInventory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
