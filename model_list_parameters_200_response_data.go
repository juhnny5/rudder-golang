...
// checks if the ListParameters200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListParameters200ResponseData{}

// ListParameters200ResponseData Parameters
type ListParameters200ResponseData struct {
	Parameters []Parameter `json:"parameters"`
}

type _ListParameters200ResponseData ListParameters200ResponseData
...
func NewListParameters200ResponseData(parameters []Parameter) *ListParameters200ResponseData {
	this := ListParameters200ResponseData{}
...
func (o ListParameters200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ListParameters200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["parameters"] = o.Parameters
	return toSerialize, nil
}

func (o *ListParameters200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListParameters200ResponseData := _ListParameters200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListParameters200ResponseData)

	if err != nil {
		return err
	}

	*o = ListParameters200ResponseData(varListParameters200ResponseData)

	return err
}

type NullableListParameters200ResponseData struct {
	value *ListParameters200ResponseData
	isSet bool
}

func (v NullableListParameters200ResponseData) Get() *ListParameters200ResponseData {
	return v.value
}

func (v *NullableListParameters200ResponseData) Set(val *ListParameters200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListParameters200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListParameters200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListParameters200ResponseData(val *ListParameters200ResponseData) *NullableListParameters200ResponseData {
	return &NullableListParameters200ResponseData{value: val, isSet: true}
}

func (v NullableListParameters200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListParameters200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
