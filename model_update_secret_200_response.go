...
// checks if the UpdateSecret200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSecret200Response{}

// UpdateSecret200Response struct for UpdateSecret200Response
type UpdateSecret200Response struct {
...
type _UpdateSecret200Response UpdateSecret200Response
...
func (o UpdateSecret200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateSecret200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateSecret200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateSecret200Response := _UpdateSecret200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateSecret200Response)

	if err != nil {
		return err
	}

	*o = UpdateSecret200Response(varUpdateSecret200Response)

	return err
}

type NullableUpdateSecret200Response struct {
	value *UpdateSecret200Response
	isSet bool
}

func (v NullableUpdateSecret200Response) Get() *UpdateSecret200Response {
	return v.value
}

func (v *NullableUpdateSecret200Response) Set(val *UpdateSecret200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSecret200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSecret200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSecret200Response(val *UpdateSecret200Response) *NullableUpdateSecret200Response {
	return &NullableUpdateSecret200Response{value: val, isSet: true}
}

func (v NullableUpdateSecret200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSecret200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
