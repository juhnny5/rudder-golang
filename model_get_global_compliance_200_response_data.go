...
// checks if the GetGlobalCompliance200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGlobalCompliance200ResponseData{}

// GetGlobalCompliance200ResponseData struct for GetGlobalCompliance200ResponseData
type GetGlobalCompliance200ResponseData struct {
	GlobalCompliance GetGlobalCompliance200ResponseDataGlobalCompliance `json:"globalCompliance"`
}

type _GetGlobalCompliance200ResponseData GetGlobalCompliance200ResponseData
...
func NewGetGlobalCompliance200ResponseData(globalCompliance GetGlobalCompliance200ResponseDataGlobalCompliance) *GetGlobalCompliance200ResponseData {
	this := GetGlobalCompliance200ResponseData{}
...
// GetGlobalCompliance returns the GlobalCompliance field value
func (o *GetGlobalCompliance200ResponseData) GetGlobalCompliance() GetGlobalCompliance200ResponseDataGlobalCompliance {
	if o == nil {
		var ret GetGlobalCompliance200ResponseDataGlobalCompliance
		return ret
	}
...
// GetGlobalComplianceOk returns a tuple with the GlobalCompliance field value
...
func (o *GetGlobalCompliance200ResponseData) GetGlobalComplianceOk() (*GetGlobalCompliance200ResponseDataGlobalCompliance, bool) {
	...
	return &o.GlobalCompliance, true
}

// SetGlobalCompliance sets field value
func (o *GetGlobalCompliance200ResponseData) SetGlobalCompliance(v GetGlobalCompliance200ResponseDataGlobalCompliance) {
	o.GlobalCompliance = v
}

func (o GetGlobalCompliance200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetGlobalCompliance200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["globalCompliance"] = o.GlobalCompliance
	return toSerialize, nil
}

func (o *GetGlobalCompliance200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGlobalCompliance200ResponseData := _GetGlobalCompliance200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetGlobalCompliance200ResponseData)

	if err != nil {
		return err
	}

	*o = GetGlobalCompliance200ResponseData(varGetGlobalCompliance200ResponseData)

	return err
}

type NullableGetGlobalCompliance200ResponseData struct {
	value *GetGlobalCompliance200ResponseData
	isSet bool
}

func (v NullableGetGlobalCompliance200ResponseData) Get() *GetGlobalCompliance200ResponseData {
	return v.value
}

func (v *NullableGetGlobalCompliance200ResponseData) Set(val *GetGlobalCompliance200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGlobalCompliance200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGlobalCompliance200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGlobalCompliance200ResponseData(val *GetGlobalCompliance200ResponseData) *NullableGetGlobalCompliance200ResponseData {
	return &NullableGetGlobalCompliance200ResponseData{value: val, isSet: true}
}

func (v NullableGetGlobalCompliance200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGlobalCompliance200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
