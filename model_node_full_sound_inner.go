...
// checks if the NodeFullSoundInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullSoundInner{}

// NodeFullSoundInner struct for NodeFullSoundInner
type NodeFullSoundInner struct {
	// Sound card name
...
func (o NodeFullSoundInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullSoundInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullSoundInner struct {
	value *NodeFullSoundInner
	isSet bool
}

func (v NullableNodeFullSoundInner) Get() *NodeFullSoundInner {
	return v.value
}

func (v *NullableNodeFullSoundInner) Set(val *NodeFullSoundInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullSoundInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullSoundInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullSoundInner(val *NodeFullSoundInner) *NullableNodeFullSoundInner {
	return &NullableNodeFullSoundInner{value: val, isSet: true}
}

func (v NullableNodeFullSoundInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullSoundInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
