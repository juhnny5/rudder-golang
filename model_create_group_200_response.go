...
type _CreateGroup200Response CreateGroup200Response
...
func (o *CreateGroup200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGroup200Response := _CreateGroup200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGroup200Response)

	if err != nil {
		return err
	}

	*o = CreateGroup200Response(varCreateGroup200Response)
