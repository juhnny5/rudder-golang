...
// checks if the GetBrandingConf200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBrandingConf200ResponseData{}

// GetBrandingConf200ResponseData struct for GetBrandingConf200ResponseData
type GetBrandingConf200ResponseData struct {
	Branding BrandingConf `json:"branding"`
}

type _GetBrandingConf200ResponseData GetBrandingConf200ResponseData
...
func NewGetBrandingConf200ResponseData(branding BrandingConf) *GetBrandingConf200ResponseData {
	this := GetBrandingConf200ResponseData{}
...
func (o GetBrandingConf200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetBrandingConf200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["branding"] = o.Branding
	return toSerialize, nil
}

func (o *GetBrandingConf200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetBrandingConf200ResponseData := _GetBrandingConf200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetBrandingConf200ResponseData)

	if err != nil {
		return err
	}

	*o = GetBrandingConf200ResponseData(varGetBrandingConf200ResponseData)

	return err
}

type NullableGetBrandingConf200ResponseData struct {
	value *GetBrandingConf200ResponseData
	isSet bool
}

func (v NullableGetBrandingConf200ResponseData) Get() *GetBrandingConf200ResponseData {
	return v.value
}

func (v *NullableGetBrandingConf200ResponseData) Set(val *GetBrandingConf200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBrandingConf200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBrandingConf200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBrandingConf200ResponseData(val *GetBrandingConf200ResponseData) *NullableGetBrandingConf200ResponseData {
	return &NullableGetBrandingConf200ResponseData{value: val, isSet: true}
}

func (v NullableGetBrandingConf200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBrandingConf200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
