...
// checks if the GetRulesCompliance200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRulesCompliance200ResponseData{}

// GetRulesCompliance200ResponseData struct for GetRulesCompliance200ResponseData
type GetRulesCompliance200ResponseData struct {
	Rules []GetRulesCompliance200ResponseDataRulesInner `json:"rules"`
}

type _GetRulesCompliance200ResponseData GetRulesCompliance200ResponseData
...
func NewGetRulesCompliance200ResponseData(rules []GetRulesCompliance200ResponseDataRulesInner) *GetRulesCompliance200ResponseData {
	this := GetRulesCompliance200ResponseData{}
	this.Rules = rules
	return &this
}
...
func (o *GetRulesCompliance200ResponseData) GetRules() []GetRulesCompliance200ResponseDataRulesInner {
	if o == nil {
		var ret []GetRulesCompliance200ResponseDataRulesInner
		return ret
	}
...
func (o GetRulesCompliance200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetRulesCompliance200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["rules"] = o.Rules
	return toSerialize, nil
}

func (o *GetRulesCompliance200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRulesCompliance200ResponseData := _GetRulesCompliance200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRulesCompliance200ResponseData)

	if err != nil {
		return err
	}

	*o = GetRulesCompliance200ResponseData(varGetRulesCompliance200ResponseData)

	return err
}

type NullableGetRulesCompliance200ResponseData struct {
	value *GetRulesCompliance200ResponseData
	isSet bool
}

func (v NullableGetRulesCompliance200ResponseData) Get() *GetRulesCompliance200ResponseData {
	return v.value
}

func (v *NullableGetRulesCompliance200ResponseData) Set(val *GetRulesCompliance200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRulesCompliance200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRulesCompliance200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRulesCompliance200ResponseData(val *GetRulesCompliance200ResponseData) *NullableGetRulesCompliance200ResponseData {
	return &NullableGetRulesCompliance200ResponseData{value: val, isSet: true}
}

func (v NullableGetRulesCompliance200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRulesCompliance200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
