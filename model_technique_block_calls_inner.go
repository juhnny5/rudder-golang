...
// TechniqueBlockCallsInner - struct for TechniqueBlockCallsInner
type TechniqueBlockCallsInner struct {
	TechniqueBlock *TechniqueBlock
	TechniqueMethodCall *TechniqueMethodCall
}

// TechniqueBlockAsTechniqueBlockCallsInner is a convenience function that returns TechniqueBlock wrapped in TechniqueBlockCallsInner
func TechniqueBlockAsTechniqueBlockCallsInner(v *TechniqueBlock) TechniqueBlockCallsInner {
	return TechniqueBlockCallsInner{
		TechniqueBlock: v,
	}
}

// TechniqueMethodCallAsTechniqueBlockCallsInner is a convenience function that returns TechniqueMethodCall wrapped in TechniqueBlockCallsInner
func TechniqueMethodCallAsTechniqueBlockCallsInner(v *TechniqueMethodCall) TechniqueBlockCallsInner {
	return TechniqueBlockCallsInner{
		TechniqueMethodCall: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *TechniqueBlockCallsInner) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into TechniqueBlock
	err = newStrictDecoder(data).Decode(&dst.TechniqueBlock)
	if err == nil {
		jsonTechniqueBlock, _ := json.Marshal(dst.TechniqueBlock)
		if string(jsonTechniqueBlock) == "{}" { // empty struct
			dst.TechniqueBlock = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into TechniqueMethodCall
	err = newStrictDecoder(data).Decode(&dst.TechniqueMethodCall)
	if err == nil {
		jsonTechniqueMethodCall, _ := json.Marshal(dst.TechniqueMethodCall)
		if string(jsonTechniqueMethodCall) == "{}" { // empty struct
			dst.TechniqueMethodCall = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TechniqueBlockCallsInner)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TechniqueBlockCallsInner)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src TechniqueBlockCallsInner) MarshalJSON() ([]byte, error) {
	if src.TechniqueBlock != nil {
		return json.Marshal(&src.TechniqueBlock)
	}

	if src.TechniqueMethodCall != nil {
		return json.Marshal(&src.TechniqueMethodCall)
	}
...
func (obj *TechniqueBlockCallsInner) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.TechniqueBlock != nil {
		return obj.TechniqueBlock
	}

	if obj.TechniqueMethodCall != nil {
		return obj.TechniqueMethodCall
	}
...
type NullableTechniqueBlockCallsInner struct {
	value *TechniqueBlockCallsInner
	isSet bool
}

func (v NullableTechniqueBlockCallsInner) Get() *TechniqueBlockCallsInner {
	return v.value
}

func (v *NullableTechniqueBlockCallsInner) Set(val *TechniqueBlockCallsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueBlockCallsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueBlockCallsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueBlockCallsInner(val *TechniqueBlockCallsInner) *NullableTechniqueBlockCallsInner {
	return &NullableTechniqueBlockCallsInner{value: val, isSet: true}
}

func (v NullableTechniqueBlockCallsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueBlockCallsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
