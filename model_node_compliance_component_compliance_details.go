...
// checks if the NodeComplianceComponentComplianceDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeComplianceComponentComplianceDetails{}

// NodeComplianceComponentComplianceDetails struct for NodeComplianceComponentComplianceDetails
...
func NewNodeComplianceComponentComplianceDetails() *NodeComplianceComponentComplianceDetails {
	this := NodeComplianceComponentComplianceDetails{}
	return &this
}
...
func (o NodeComplianceComponentComplianceDetails) MarshalJSON() ([]byte, error) {
...
func (o NodeComplianceComponentComplianceDetails) ToMap() (map[string]interface{}, error) {
...
type NullableNodeComplianceComponentComplianceDetails struct {
	value *NodeComplianceComponentComplianceDetails
	isSet bool
}

func (v NullableNodeComplianceComponentComplianceDetails) Get() *NodeComplianceComponentComplianceDetails {
	return v.value
}

func (v *NullableNodeComplianceComponentComplianceDetails) Set(val *NodeComplianceComponentComplianceDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeComplianceComponentComplianceDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeComplianceComponentComplianceDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeComplianceComponentComplianceDetails(val *NodeComplianceComponentComplianceDetails) *NullableNodeComplianceComponentComplianceDetails {
	return &NullableNodeComplianceComponentComplianceDetails{value: val, isSet: true}
}

func (v NullableNodeComplianceComponentComplianceDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeComplianceComponentComplianceDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
