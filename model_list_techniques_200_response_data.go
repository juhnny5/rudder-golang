...
// checks if the ListTechniques200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTechniques200ResponseData{}

// ListTechniques200ResponseData struct for ListTechniques200ResponseData
type ListTechniques200ResponseData struct {
	Techniques []EditorTechnique `json:"techniques"`
}

type _ListTechniques200ResponseData ListTechniques200ResponseData
...
func NewListTechniques200ResponseData(techniques []EditorTechnique) *ListTechniques200ResponseData {
	this := ListTechniques200ResponseData{}
...
func (o ListTechniques200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ListTechniques200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["techniques"] = o.Techniques
	return toSerialize, nil
}

func (o *ListTechniques200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListTechniques200ResponseData := _ListTechniques200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTechniques200ResponseData)

	if err != nil {
		return err
	}

	*o = ListTechniques200ResponseData(varListTechniques200ResponseData)

	return err
}

type NullableListTechniques200ResponseData struct {
	value *ListTechniques200ResponseData
	isSet bool
}

func (v NullableListTechniques200ResponseData) Get() *ListTechniques200ResponseData {
	return v.value
}

func (v *NullableListTechniques200ResponseData) Set(val *ListTechniques200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTechniques200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTechniques200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTechniques200ResponseData(val *ListTechniques200ResponseData) *NullableListTechniques200ResponseData {
	return &NullableListTechniques200ResponseData{value: val, isSet: true}
}

func (v NullableListTechniques200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTechniques200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
