...
// checks if the ListRules200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListRules200ResponseData{}

// ListRules200ResponseData struct for ListRules200ResponseData
type ListRules200ResponseData struct {
	Rules []Rule `json:"rules"`
}

type _ListRules200ResponseData ListRules200ResponseData
...
func (o ListRules200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ListRules200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["rules"] = o.Rules
	return toSerialize, nil
}

func (o *ListRules200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListRules200ResponseData := _ListRules200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListRules200ResponseData)

	if err != nil {
		return err
	}

	*o = ListRules200ResponseData(varListRules200ResponseData)

	return err
}

type NullableListRules200ResponseData struct {
	value *ListRules200ResponseData
	isSet bool
}

func (v NullableListRules200ResponseData) Get() *ListRules200ResponseData {
	return v.value
}

func (v *NullableListRules200ResponseData) Set(val *ListRules200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListRules200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListRules200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListRules200ResponseData(val *ListRules200ResponseData) *NullableListRules200ResponseData {
	return &NullableListRules200ResponseData{value: val, isSet: true}
}

func (v NullableListRules200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListRules200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
