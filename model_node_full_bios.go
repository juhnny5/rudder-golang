...
// checks if the NodeFullBios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullBios{}
...
func (o NodeFullBios) MarshalJSON() ([]byte, error) {
...
func (o NodeFullBios) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullBios struct {
	value *NodeFullBios
	isSet bool
}

func (v NullableNodeFullBios) Get() *NodeFullBios {
	return v.value
}

func (v *NullableNodeFullBios) Set(val *NodeFullBios) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullBios) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullBios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullBios(val *NodeFullBios) *NullableNodeFullBios {
	return &NullableNodeFullBios{value: val, isSet: true}
}

func (v NullableNodeFullBios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullBios) UnmarshalJSON(src []byte) error {
	v.isSet = true
