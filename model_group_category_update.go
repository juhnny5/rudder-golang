...
// checks if the GroupCategoryUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupCategoryUpdate{}

// GroupCategoryUpdate struct for GroupCategoryUpdate
...
type _GroupCategoryUpdate GroupCategoryUpdate
...
func (o GroupCategoryUpdate) MarshalJSON() ([]byte, error) {
...
func (o GroupCategoryUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *GroupCategoryUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupCategoryUpdate := _GroupCategoryUpdate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupCategoryUpdate)

	if err != nil {
		return err
	}

	*o = GroupCategoryUpdate(varGroupCategoryUpdate)

	return err
}

type NullableGroupCategoryUpdate struct {
	value *GroupCategoryUpdate
	isSet bool
}

func (v NullableGroupCategoryUpdate) Get() *GroupCategoryUpdate {
	return v.value
}

func (v *NullableGroupCategoryUpdate) Set(val *GroupCategoryUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupCategoryUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupCategoryUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupCategoryUpdate(val *GroupCategoryUpdate) *NullableGroupCategoryUpdate {
	return &NullableGroupCategoryUpdate{value: val, isSet: true}
}

func (v NullableGroupCategoryUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupCategoryUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
