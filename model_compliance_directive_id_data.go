...
// checks if the ComplianceDirectiveIdData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComplianceDirectiveIdData{}

// ComplianceDirectiveIdData struct for ComplianceDirectiveIdData
type ComplianceDirectiveIdData struct {
	DirectiveCompliance GetDirectivesCompliance200ResponseDataDirectivesCompliance `json:"directiveCompliance"`
}

type _ComplianceDirectiveIdData ComplianceDirectiveIdData
...
func NewComplianceDirectiveIdData(directiveCompliance GetDirectivesCompliance200ResponseDataDirectivesCompliance) *ComplianceDirectiveIdData {
	this := ComplianceDirectiveIdData{}
	this.DirectiveCompliance = directiveCompliance
	return &this
}
...
// GetDirectiveCompliance returns the DirectiveCompliance field value
...
// GetDirectiveComplianceOk returns a tuple with the DirectiveCompliance field value
...
func (o *ComplianceDirectiveIdData) GetDirectiveComplianceOk() (*GetDirectivesCompliance200ResponseDataDirectivesCompliance, bool) {
	...
	return &o.DirectiveCompliance, true
}

// SetDirectiveCompliance sets field value
func (o *ComplianceDirectiveIdData) SetDirectiveCompliance(v GetDirectivesCompliance200ResponseDataDirectivesCompliance) {
	o.DirectiveCompliance = v
}

func (o ComplianceDirectiveIdData) MarshalJSON() ([]byte, error) {
...
func (o ComplianceDirectiveIdData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["directiveCompliance"] = o.DirectiveCompliance
	return toSerialize, nil
}

func (o *ComplianceDirectiveIdData) UnmarshalJSON(data []byte) (err error) {
	...
	varComplianceDirectiveIdData := _ComplianceDirectiveIdData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varComplianceDirectiveIdData)

	if err != nil {
		return err
	}

	*o = ComplianceDirectiveIdData(varComplianceDirectiveIdData)

	return err
}

type NullableComplianceDirectiveIdData struct {
	value *ComplianceDirectiveIdData
	isSet bool
}

func (v NullableComplianceDirectiveIdData) Get() *ComplianceDirectiveIdData {
	return v.value
}

func (v *NullableComplianceDirectiveIdData) Set(val *ComplianceDirectiveIdData) {
	v.value = val
	v.isSet = true
}

func (v NullableComplianceDirectiveIdData) IsSet() bool {
	return v.isSet
}

func (v *NullableComplianceDirectiveIdData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComplianceDirectiveIdData(val *ComplianceDirectiveIdData) *NullableComplianceDirectiveIdData {
	return &NullableComplianceDirectiveIdData{value: val, isSet: true}
}

func (v NullableComplianceDirectiveIdData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComplianceDirectiveIdData) UnmarshalJSON(src []byte) error {
	v.isSet = true
