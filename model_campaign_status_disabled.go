...
// checks if the CampaignStatusDisabled type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignStatusDisabled{}

// CampaignStatusDisabled Campaign status
type CampaignStatusDisabled struct {
...
func (o CampaignStatusDisabled) MarshalJSON() ([]byte, error) {
...
func (o CampaignStatusDisabled) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignStatusDisabled struct {
	value *CampaignStatusDisabled
	isSet bool
}

func (v NullableCampaignStatusDisabled) Get() *CampaignStatusDisabled {
	return v.value
}

func (v *NullableCampaignStatusDisabled) Set(val *CampaignStatusDisabled) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignStatusDisabled) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignStatusDisabled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignStatusDisabled(val *CampaignStatusDisabled) *NullableCampaignStatusDisabled {
	return &NullableCampaignStatusDisabled{value: val, isSet: true}
}

func (v NullableCampaignStatusDisabled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignStatusDisabled) UnmarshalJSON(src []byte) error {
	v.isSet = true
