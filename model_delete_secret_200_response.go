...
// checks if the DeleteSecret200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteSecret200Response{}

// DeleteSecret200Response struct for DeleteSecret200Response
type DeleteSecret200Response struct {
...
type _DeleteSecret200Response DeleteSecret200Response
...
func (o DeleteSecret200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteSecret200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteSecret200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteSecret200Response := _DeleteSecret200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteSecret200Response)

	if err != nil {
		return err
	}

	*o = DeleteSecret200Response(varDeleteSecret200Response)

	return err
}

type NullableDeleteSecret200Response struct {
	value *DeleteSecret200Response
	isSet bool
}

func (v NullableDeleteSecret200Response) Get() *DeleteSecret200Response {
	return v.value
}

func (v *NullableDeleteSecret200Response) Set(val *DeleteSecret200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteSecret200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteSecret200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteSecret200Response(val *DeleteSecret200Response) *NullableDeleteSecret200Response {
	return &NullableDeleteSecret200Response{value: val, isSet: true}
}

func (v NullableDeleteSecret200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteSecret200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
