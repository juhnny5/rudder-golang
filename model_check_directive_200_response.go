...
// checks if the CheckDirective200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckDirective200Response{}

// CheckDirective200Response struct for CheckDirective200Response
type CheckDirective200Response struct {
...
type _CheckDirective200Response CheckDirective200Response
...
func NewCheckDirective200Response(result string, action string, data ListDirectives200ResponseData) *CheckDirective200Response {
	this := CheckDirective200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o CheckDirective200Response) MarshalJSON() ([]byte, error) {
...
func (o CheckDirective200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CheckDirective200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCheckDirective200Response := _CheckDirective200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCheckDirective200Response)

	if err != nil {
		return err
	}

	*o = CheckDirective200Response(varCheckDirective200Response)

	return err
}

type NullableCheckDirective200Response struct {
	value *CheckDirective200Response
	isSet bool
}

func (v NullableCheckDirective200Response) Get() *CheckDirective200Response {
	return v.value
}

func (v *NullableCheckDirective200Response) Set(val *CheckDirective200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckDirective200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckDirective200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckDirective200Response(val *CheckDirective200Response) *NullableCheckDirective200Response {
	return &NullableCheckDirective200Response{value: val, isSet: true}
}

func (v NullableCheckDirective200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckDirective200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
