...
// checks if the GetRuleTree200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRuleTree200ResponseData{}

// GetRuleTree200ResponseData struct for GetRuleTree200ResponseData
type GetRuleTree200ResponseData struct {
	// Rule tree
	RuleCategories map[string]interface{} `json:"ruleCategories"`
}

type _GetRuleTree200ResponseData GetRuleTree200ResponseData
...
func NewGetRuleTree200ResponseData(ruleCategories map[string]interface{}) *GetRuleTree200ResponseData {
	this := GetRuleTree200ResponseData{}
...
func (o GetRuleTree200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetRuleTree200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["ruleCategories"] = o.RuleCategories
	return toSerialize, nil
}

func (o *GetRuleTree200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRuleTree200ResponseData := _GetRuleTree200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRuleTree200ResponseData)

	if err != nil {
		return err
	}

	*o = GetRuleTree200ResponseData(varGetRuleTree200ResponseData)

	return err
}

type NullableGetRuleTree200ResponseData struct {
	value *GetRuleTree200ResponseData
	isSet bool
}

func (v NullableGetRuleTree200ResponseData) Get() *GetRuleTree200ResponseData {
	return v.value
}

func (v *NullableGetRuleTree200ResponseData) Set(val *GetRuleTree200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRuleTree200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRuleTree200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRuleTree200ResponseData(val *GetRuleTree200ResponseData) *NullableGetRuleTree200ResponseData {
	return &NullableGetRuleTree200ResponseData{value: val, isSet: true}
}

func (v NullableGetRuleTree200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRuleTree200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
