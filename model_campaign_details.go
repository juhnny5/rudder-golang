...
// checks if the CampaignDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignDetails{}

// CampaignDetails struct for CampaignDetails
type CampaignDetails struct {
	Info *CampaignDetailsInfo `json:"info,omitempty"`
	...
	Details *CampaignDetailsDetails `json:"details,omitempty"`
}
...
// SetInfo gets a reference to the given CampaignDetailsInfo and assigns it to the Info field.
...
func (o *CampaignDetails) GetDetails() CampaignDetailsDetails {
	if o == nil || IsNil(o.Details) {
		var ret CampaignDetailsDetails
		return ret
	}
	return *o.Details
}
...
// SetDetails gets a reference to the given CampaignDetailsDetails and assigns it to the Details field.
func (o *CampaignDetails) SetDetails(v CampaignDetailsDetails) {
	o.Details = &v
}

func (o CampaignDetails) MarshalJSON() ([]byte, error) {
...
func (o CampaignDetails) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignDetails struct {
	value *CampaignDetails
	isSet bool
}

func (v NullableCampaignDetails) Get() *CampaignDetails {
	return v.value
}

func (v *NullableCampaignDetails) Set(val *CampaignDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignDetails(val *CampaignDetails) *NullableCampaignDetails {
	return &NullableCampaignDetails{value: val, isSet: true}
}

func (v NullableCampaignDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
