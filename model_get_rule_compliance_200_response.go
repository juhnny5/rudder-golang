...
// checks if the GetRuleCompliance200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRuleCompliance200Response{}

// GetRuleCompliance200Response struct for GetRuleCompliance200Response
type GetRuleCompliance200Response struct {
...
type _GetRuleCompliance200Response GetRuleCompliance200Response
...
func NewGetRuleCompliance200Response(result string, action string, data GetRulesCompliance200ResponseData) *GetRuleCompliance200Response {
	this := GetRuleCompliance200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o GetRuleCompliance200Response) MarshalJSON() ([]byte, error) {
...
func (o GetRuleCompliance200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetRuleCompliance200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRuleCompliance200Response := _GetRuleCompliance200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRuleCompliance200Response)

	if err != nil {
		return err
	}

	*o = GetRuleCompliance200Response(varGetRuleCompliance200Response)

	return err
}

type NullableGetRuleCompliance200Response struct {
	value *GetRuleCompliance200Response
	isSet bool
}

func (v NullableGetRuleCompliance200Response) Get() *GetRuleCompliance200Response {
	return v.value
}

func (v *NullableGetRuleCompliance200Response) Set(val *GetRuleCompliance200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRuleCompliance200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRuleCompliance200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRuleCompliance200Response(val *GetRuleCompliance200Response) *NullableGetRuleCompliance200Response {
	return &NullableGetRuleCompliance200Response{value: val, isSet: true}
}

func (v NullableGetRuleCompliance200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRuleCompliance200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
