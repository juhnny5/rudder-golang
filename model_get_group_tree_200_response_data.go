...
// checks if the GetGroupTree200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGroupTree200ResponseData{}

// GetGroupTree200ResponseData struct for GetGroupTree200ResponseData
type GetGroupTree200ResponseData struct {
	// Group tree
	GroupCategories map[string]interface{} `json:"groupCategories"`
}

type _GetGroupTree200ResponseData GetGroupTree200ResponseData
...
func NewGetGroupTree200ResponseData(groupCategories map[string]interface{}) *GetGroupTree200ResponseData {
	this := GetGroupTree200ResponseData{}
...
func (o GetGroupTree200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetGroupTree200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["groupCategories"] = o.GroupCategories
	return toSerialize, nil
}

func (o *GetGroupTree200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGroupTree200ResponseData := _GetGroupTree200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetGroupTree200ResponseData)

	if err != nil {
		return err
	}

	*o = GetGroupTree200ResponseData(varGetGroupTree200ResponseData)

	return err
}

type NullableGetGroupTree200ResponseData struct {
	value *GetGroupTree200ResponseData
	isSet bool
}

func (v NullableGetGroupTree200ResponseData) Get() *GetGroupTree200ResponseData {
	return v.value
}

func (v *NullableGetGroupTree200ResponseData) Set(val *GetGroupTree200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGroupTree200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGroupTree200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGroupTree200ResponseData(val *GetGroupTree200ResponseData) *NullableGetGroupTree200ResponseData {
	return &NullableGetGroupTree200ResponseData{value: val, isSet: true}
}

func (v NullableGetGroupTree200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGroupTree200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
