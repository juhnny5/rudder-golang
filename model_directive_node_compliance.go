...
// checks if the DirectiveNodeCompliance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectiveNodeCompliance{}

// DirectiveNodeCompliance struct for DirectiveNodeCompliance
...
type _DirectiveNodeCompliance DirectiveNodeCompliance
...
func (o *DirectiveNodeCompliance) GetRules() RuleComplianceComponent {
	if o == nil {
		var ret RuleComplianceComponent
		return ret
	}
...
func (o DirectiveNodeCompliance) MarshalJSON() ([]byte, error) {
...
func (o DirectiveNodeCompliance) ToMap() (map[string]interface{}, error) {
...
func (o *DirectiveNodeCompliance) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectiveNodeCompliance := _DirectiveNodeCompliance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDirectiveNodeCompliance)

	if err != nil {
		return err
	}

	*o = DirectiveNodeCompliance(varDirectiveNodeCompliance)

	return err
}

type NullableDirectiveNodeCompliance struct {
	value *DirectiveNodeCompliance
	isSet bool
}

func (v NullableDirectiveNodeCompliance) Get() *DirectiveNodeCompliance {
	return v.value
}

func (v *NullableDirectiveNodeCompliance) Set(val *DirectiveNodeCompliance) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectiveNodeCompliance) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectiveNodeCompliance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectiveNodeCompliance(val *DirectiveNodeCompliance) *NullableDirectiveNodeCompliance {
	return &NullableDirectiveNodeCompliance{value: val, isSet: true}
}

func (v NullableDirectiveNodeCompliance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectiveNodeCompliance) UnmarshalJSON(src []byte) error {
	v.isSet = true
