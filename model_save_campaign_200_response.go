...
// checks if the SaveCampaign200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveCampaign200Response{}

// SaveCampaign200Response struct for SaveCampaign200Response
type SaveCampaign200Response struct {
...
type _SaveCampaign200Response SaveCampaign200Response
...
func (o SaveCampaign200Response) MarshalJSON() ([]byte, error) {
...
func (o SaveCampaign200Response) ToMap() (map[string]interface{}, error) {
...
func (o *SaveCampaign200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSaveCampaign200Response := _SaveCampaign200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSaveCampaign200Response)

	if err != nil {
		return err
	}

	*o = SaveCampaign200Response(varSaveCampaign200Response)

	return err
}

type NullableSaveCampaign200Response struct {
	value *SaveCampaign200Response
	isSet bool
}

func (v NullableSaveCampaign200Response) Get() *SaveCampaign200Response {
	return v.value
}

func (v *NullableSaveCampaign200Response) Set(val *SaveCampaign200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveCampaign200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveCampaign200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveCampaign200Response(val *SaveCampaign200Response) *NullableSaveCampaign200Response {
	return &NullableSaveCampaign200Response{value: val, isSet: true}
}

func (v NullableSaveCampaign200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveCampaign200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
