...
// checks if the GetCampaignEventResult200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCampaignEventResult200Response{}

// GetCampaignEventResult200Response struct for GetCampaignEventResult200Response
type GetCampaignEventResult200Response struct {
	...
	Data GetCampaignEventResult200ResponseData `json:"data"`
}

type _GetCampaignEventResult200Response GetCampaignEventResult200Response
...
func NewGetCampaignEventResult200Response(result string, action string, data GetCampaignEventResult200ResponseData) *GetCampaignEventResult200Response {
	this := GetCampaignEventResult200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetCampaignEventResult200Response) GetData() GetCampaignEventResult200ResponseData {
	if o == nil {
		var ret GetCampaignEventResult200ResponseData
		return ret
	}
...
func (o GetCampaignEventResult200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCampaignEventResult200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetCampaignEventResult200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCampaignEventResult200Response := _GetCampaignEventResult200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCampaignEventResult200Response)

	if err != nil {
		return err
	}

	*o = GetCampaignEventResult200Response(varGetCampaignEventResult200Response)

	return err
}

type NullableGetCampaignEventResult200Response struct {
	value *GetCampaignEventResult200Response
	isSet bool
}

func (v NullableGetCampaignEventResult200Response) Get() *GetCampaignEventResult200Response {
	return v.value
}

func (v *NullableGetCampaignEventResult200Response) Set(val *GetCampaignEventResult200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCampaignEventResult200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCampaignEventResult200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCampaignEventResult200Response(val *GetCampaignEventResult200Response) *NullableGetCampaignEventResult200Response {
	return &NullableGetCampaignEventResult200Response{value: val, isSet: true}
}

func (v NullableGetCampaignEventResult200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCampaignEventResult200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
