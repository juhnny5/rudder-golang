...
// checks if the TechniqueResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueResource{}

// TechniqueResource struct for TechniqueResource
...
func (o TechniqueResource) MarshalJSON() ([]byte, error) {
...
func (o TechniqueResource) ToMap() (map[string]interface{}, error) {
...
type NullableTechniqueResource struct {
	value *TechniqueResource
	isSet bool
}

func (v NullableTechniqueResource) Get() *TechniqueResource {
	return v.value
}

func (v *NullableTechniqueResource) Set(val *TechniqueResource) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueResource) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueResource(val *TechniqueResource) *NullableTechniqueResource {
	return &NullableTechniqueResource{value: val, isSet: true}
}

func (v NullableTechniqueResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
