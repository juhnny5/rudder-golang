...
// checks if the UpdateDirective200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDirective200Response{}

// UpdateDirective200Response struct for UpdateDirective200Response
type UpdateDirective200Response struct {
...
type _UpdateDirective200Response UpdateDirective200Response
...
func NewUpdateDirective200Response(result string, action string, data ListDirectives200ResponseData) *UpdateDirective200Response {
	this := UpdateDirective200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o UpdateDirective200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateDirective200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateDirective200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDirective200Response := _UpdateDirective200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDirective200Response)

	if err != nil {
		return err
	}

	*o = UpdateDirective200Response(varUpdateDirective200Response)

	return err
}

type NullableUpdateDirective200Response struct {
	value *UpdateDirective200Response
	isSet bool
}

func (v NullableUpdateDirective200Response) Get() *UpdateDirective200Response {
	return v.value
}

func (v *NullableUpdateDirective200Response) Set(val *UpdateDirective200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDirective200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDirective200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDirective200Response(val *UpdateDirective200Response) *NullableUpdateDirective200Response {
	return &NullableUpdateDirective200Response{value: val, isSet: true}
}

func (v NullableUpdateDirective200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDirective200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
