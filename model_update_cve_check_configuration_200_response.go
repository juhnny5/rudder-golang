...
// checks if the UpdateCVECheckConfiguration200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCVECheckConfiguration200Response{}

// UpdateCVECheckConfiguration200Response struct for UpdateCVECheckConfiguration200Response
type UpdateCVECheckConfiguration200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetCVECheckConfiguration200ResponseData `json:"data"`
}

type _UpdateCVECheckConfiguration200Response UpdateCVECheckConfiguration200Response
...
func NewUpdateCVECheckConfiguration200Response(result string, action string, data GetCVECheckConfiguration200ResponseData) *UpdateCVECheckConfiguration200Response {
	this := UpdateCVECheckConfiguration200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *UpdateCVECheckConfiguration200Response) GetData() GetCVECheckConfiguration200ResponseData {
	if o == nil {
		var ret GetCVECheckConfiguration200ResponseData
		return ret
	}
...
func (o UpdateCVECheckConfiguration200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateCVECheckConfiguration200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateCVECheckConfiguration200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCVECheckConfiguration200Response := _UpdateCVECheckConfiguration200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateCVECheckConfiguration200Response)

	if err != nil {
		return err
	}

	*o = UpdateCVECheckConfiguration200Response(varUpdateCVECheckConfiguration200Response)

	return err
}

type NullableUpdateCVECheckConfiguration200Response struct {
	value *UpdateCVECheckConfiguration200Response
	isSet bool
}

func (v NullableUpdateCVECheckConfiguration200Response) Get() *UpdateCVECheckConfiguration200Response {
	return v.value
}

func (v *NullableUpdateCVECheckConfiguration200Response) Set(val *UpdateCVECheckConfiguration200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCVECheckConfiguration200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCVECheckConfiguration200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCVECheckConfiguration200Response(val *UpdateCVECheckConfiguration200Response) *NullableUpdateCVECheckConfiguration200Response {
	return &NullableUpdateCVECheckConfiguration200Response{value: val, isSet: true}
}

func (v NullableUpdateCVECheckConfiguration200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCVECheckConfiguration200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
