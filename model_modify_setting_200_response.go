...
// checks if the ModifySetting200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifySetting200Response{}

// ModifySetting200Response struct for ModifySetting200Response
type ModifySetting200Response struct {
	// Id of the setting
	Id string `json:"id"`
	...
	Data GetSetting200ResponseData `json:"data"`
}

type _ModifySetting200Response ModifySetting200Response
...
func (o *ModifySetting200Response) GetData() GetSetting200ResponseData {
	if o == nil {
		var ret GetSetting200ResponseData
		return ret
	}
...
func (o ModifySetting200Response) MarshalJSON() ([]byte, error) {
...
func (o ModifySetting200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ModifySetting200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varModifySetting200Response := _ModifySetting200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModifySetting200Response)

	if err != nil {
		return err
	}

	*o = ModifySetting200Response(varModifySetting200Response)

	return err
}

type NullableModifySetting200Response struct {
	value *ModifySetting200Response
	isSet bool
}

func (v NullableModifySetting200Response) Get() *ModifySetting200Response {
	return v.value
}

func (v *NullableModifySetting200Response) Set(val *ModifySetting200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableModifySetting200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableModifySetting200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifySetting200Response(val *ModifySetting200Response) *NullableModifySetting200Response {
	return &NullableModifySetting200Response{value: val, isSet: true}
}

func (v NullableModifySetting200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifySetting200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
