...
// checks if the CampaignScheduleMonthlyStart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleMonthlyStart{}

// CampaignScheduleMonthlyStart Date when the campaign should start
type CampaignScheduleMonthlyStart struct {
...
func NewCampaignScheduleMonthlyStart() *CampaignScheduleMonthlyStart {
	this := CampaignScheduleMonthlyStart{}
	return &this
}
...
func (o CampaignScheduleMonthlyStart) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleMonthlyStart) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleMonthlyStart struct {
	value *CampaignScheduleMonthlyStart
	isSet bool
}

func (v NullableCampaignScheduleMonthlyStart) Get() *CampaignScheduleMonthlyStart {
	return v.value
}

func (v *NullableCampaignScheduleMonthlyStart) Set(val *CampaignScheduleMonthlyStart) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleMonthlyStart) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleMonthlyStart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleMonthlyStart(val *CampaignScheduleMonthlyStart) *NullableCampaignScheduleMonthlyStart {
	return &NullableCampaignScheduleMonthlyStart{value: val, isSet: true}
}

func (v NullableCampaignScheduleMonthlyStart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleMonthlyStart) UnmarshalJSON(src []byte) error {
	v.isSet = true
