...
// GetIsPreHahed returns the IsPreHahed field value if set, zero value otherwise.
func (o *Users) GetIsPreHahed() bool {
	if o == nil || IsNil(o.IsPreHahed) {
		var ret bool
		return ret
	}
	return *o.IsPreHahed
...
// GetIsPreHahedOk returns a tuple with the IsPreHahed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Users) GetIsPreHahedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPreHahed) {
		return nil, false
	}
	return o.IsPreHahed, true
}
...
// SetIsPreHahed gets a reference to the given bool and assigns it to the IsPreHahed field.
...
func (o Users) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsPreHahed) {
		toSerialize["isPreHahed"] = o.IsPreHahed
	}
	if !IsNil(o.Username) {
