...
// checks if the ListTechniquesVersions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTechniquesVersions200Response{}

// ListTechniquesVersions200Response struct for ListTechniquesVersions200Response
type ListTechniquesVersions200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ListTechniquesVersions200ResponseData `json:"data"`
}

type _ListTechniquesVersions200Response ListTechniquesVersions200Response
...
func NewListTechniquesVersions200Response(result string, action string, data ListTechniquesVersions200ResponseData) *ListTechniquesVersions200Response {
	this := ListTechniquesVersions200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ListTechniquesVersions200Response) GetData() ListTechniquesVersions200ResponseData {
	if o == nil {
		var ret ListTechniquesVersions200ResponseData
		return ret
	}
...
func (o ListTechniquesVersions200Response) MarshalJSON() ([]byte, error) {
...
func (o ListTechniquesVersions200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListTechniquesVersions200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListTechniquesVersions200Response := _ListTechniquesVersions200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTechniquesVersions200Response)

	if err != nil {
		return err
	}

	*o = ListTechniquesVersions200Response(varListTechniquesVersions200Response)

	return err
}

type NullableListTechniquesVersions200Response struct {
	value *ListTechniquesVersions200Response
	isSet bool
}

func (v NullableListTechniquesVersions200Response) Get() *ListTechniquesVersions200Response {
	return v.value
}

func (v *NullableListTechniquesVersions200Response) Set(val *ListTechniquesVersions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTechniquesVersions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTechniquesVersions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTechniquesVersions200Response(val *ListTechniquesVersions200Response) *NullableListTechniquesVersions200Response {
	return &NullableListTechniquesVersions200Response{value: val, isSet: true}
}

func (v NullableListTechniquesVersions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTechniquesVersions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
