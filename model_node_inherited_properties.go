...
// checks if the NodeInheritedProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeInheritedProperties{}

// NodeInheritedProperties struct for NodeInheritedProperties
type NodeInheritedProperties struct {
	// Unique id of the node
	Id string `json:"id"`
	// Node properties (either set by user or filled by third party sources)
	Properties []NodeInheritedPropertiesPropertiesInner `json:"properties"`
}

type _NodeInheritedProperties NodeInheritedProperties
...
func (o *NodeInheritedProperties) GetProperties() []NodeInheritedPropertiesPropertiesInner {
	if o == nil {
		var ret []NodeInheritedPropertiesPropertiesInner
		return ret
	}
...
func (o NodeInheritedProperties) MarshalJSON() ([]byte, error) {
...
func (o NodeInheritedProperties) ToMap() (map[string]interface{}, error) {
...
func (o *NodeInheritedProperties) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeInheritedProperties := _NodeInheritedProperties{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeInheritedProperties)

	if err != nil {
		return err
	}

	*o = NodeInheritedProperties(varNodeInheritedProperties)

	return err
}

type NullableNodeInheritedProperties struct {
	value *NodeInheritedProperties
	isSet bool
}

func (v NullableNodeInheritedProperties) Get() *NodeInheritedProperties {
	return v.value
}

func (v *NullableNodeInheritedProperties) Set(val *NodeInheritedProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeInheritedProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeInheritedProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeInheritedProperties(val *NodeInheritedProperties) *NullableNodeInheritedProperties {
	return &NullableNodeInheritedProperties{value: val, isSet: true}
}

func (v NullableNodeInheritedProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeInheritedProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
