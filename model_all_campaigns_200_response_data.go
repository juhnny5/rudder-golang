...
// checks if the AllCampaigns200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllCampaigns200ResponseData{}

// AllCampaigns200ResponseData struct for AllCampaigns200ResponseData
type AllCampaigns200ResponseData struct {
	Campaigns []CampaignDetails `json:"campaigns"`
}

type _AllCampaigns200ResponseData AllCampaigns200ResponseData
...
func NewAllCampaigns200ResponseData(campaigns []CampaignDetails) *AllCampaigns200ResponseData {
	this := AllCampaigns200ResponseData{}
...
func (o AllCampaigns200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o AllCampaigns200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["campaigns"] = o.Campaigns
	return toSerialize, nil
}

func (o *AllCampaigns200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varAllCampaigns200ResponseData := _AllCampaigns200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllCampaigns200ResponseData)

	if err != nil {
		return err
	}

	*o = AllCampaigns200ResponseData(varAllCampaigns200ResponseData)

	return err
}

type NullableAllCampaigns200ResponseData struct {
	value *AllCampaigns200ResponseData
	isSet bool
}

func (v NullableAllCampaigns200ResponseData) Get() *AllCampaigns200ResponseData {
	return v.value
}

func (v *NullableAllCampaigns200ResponseData) Set(val *AllCampaigns200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableAllCampaigns200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableAllCampaigns200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllCampaigns200ResponseData(val *AllCampaigns200ResponseData) *NullableAllCampaigns200ResponseData {
	return &NullableAllCampaigns200ResponseData{value: val, isSet: true}
}

func (v NullableAllCampaigns200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllCampaigns200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
