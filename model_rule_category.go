...
// checks if the RuleCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleCategory{}

// RuleCategory struct for RuleCategory
...
type _RuleCategory RuleCategory
...
func (o RuleCategory) MarshalJSON() ([]byte, error) {
...
func (o RuleCategory) ToMap() (map[string]interface{}, error) {
...
func (o *RuleCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleCategory := _RuleCategory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleCategory)

	if err != nil {
		return err
	}

	*o = RuleCategory(varRuleCategory)

	return err
}

type NullableRuleCategory struct {
	value *RuleCategory
	isSet bool
}

func (v NullableRuleCategory) Get() *RuleCategory {
	return v.value
}

func (v *NullableRuleCategory) Set(val *RuleCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleCategory(val *RuleCategory) *NullableRuleCategory {
	return &NullableRuleCategory{value: val, isSet: true}
}

func (v NullableRuleCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
