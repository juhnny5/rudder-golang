...
// checks if the GetSystemUpdateResultForNode200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSystemUpdateResultForNode200Response{}

// GetSystemUpdateResultForNode200Response struct for GetSystemUpdateResultForNode200Response
type GetSystemUpdateResultForNode200Response struct {
	...
	Data GetSystemUpdateResultForNode200ResponseData `json:"data"`
}

type _GetSystemUpdateResultForNode200Response GetSystemUpdateResultForNode200Response
...
func NewGetSystemUpdateResultForNode200Response(result string, action string, data GetSystemUpdateResultForNode200ResponseData) *GetSystemUpdateResultForNode200Response {
	this := GetSystemUpdateResultForNode200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetSystemUpdateResultForNode200Response) GetData() GetSystemUpdateResultForNode200ResponseData {
	if o == nil {
		var ret GetSystemUpdateResultForNode200ResponseData
		return ret
	}
...
func (o GetSystemUpdateResultForNode200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSystemUpdateResultForNode200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetSystemUpdateResultForNode200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSystemUpdateResultForNode200Response := _GetSystemUpdateResultForNode200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetSystemUpdateResultForNode200Response)

	if err != nil {
		return err
	}

	*o = GetSystemUpdateResultForNode200Response(varGetSystemUpdateResultForNode200Response)

	return err
}

type NullableGetSystemUpdateResultForNode200Response struct {
	value *GetSystemUpdateResultForNode200Response
	isSet bool
}

func (v NullableGetSystemUpdateResultForNode200Response) Get() *GetSystemUpdateResultForNode200Response {
	return v.value
}

func (v *NullableGetSystemUpdateResultForNode200Response) Set(val *GetSystemUpdateResultForNode200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSystemUpdateResultForNode200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSystemUpdateResultForNode200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSystemUpdateResultForNode200Response(val *GetSystemUpdateResultForNode200Response) *NullableGetSystemUpdateResultForNode200Response {
	return &NullableGetSystemUpdateResultForNode200Response{value: val, isSet: true}
}

func (v NullableGetSystemUpdateResultForNode200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSystemUpdateResultForNode200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
