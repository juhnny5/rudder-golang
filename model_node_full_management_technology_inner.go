...
// checks if the NodeFullManagementTechnologyInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullManagementTechnologyInner{}

// NodeFullManagementTechnologyInner struct for NodeFullManagementTechnologyInner
type NodeFullManagementTechnologyInner struct {
	// Agent name
...
type _NodeFullManagementTechnologyInner NodeFullManagementTechnologyInner
...
func NewNodeFullManagementTechnologyInner(name string) *NodeFullManagementTechnologyInner {
	this := NodeFullManagementTechnologyInner{}
	this.Name = name
	return &this
}
...
// GetRootComponents returns the RootComponents field value if set, zero value otherwise.
func (o *NodeFullManagementTechnologyInner) GetRootComponents() []string {
	if o == nil || IsNil(o.RootComponents) {
		var ret []string
		return ret
	}
...
// GetRootComponentsOk returns a tuple with the RootComponents field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeFullManagementTechnologyInner) GetRootComponentsOk() ([]string, bool) {
	if o == nil || IsNil(o.RootComponents) {
		return nil, false
	}
	return o.RootComponents, true
}
...
// SetRootComponents gets a reference to the given []string and assigns it to the RootComponents field.
func (o *NodeFullManagementTechnologyInner) SetRootComponents(v []string) {
	o.RootComponents = v
}

func (o NodeFullManagementTechnologyInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullManagementTechnologyInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NodeKind) {
		toSerialize["nodeKind"] = o.NodeKind
	}
	if !IsNil(o.RootComponents) {
		toSerialize["rootComponents"] = o.RootComponents
	}
	return toSerialize, nil
}

func (o *NodeFullManagementTechnologyInner) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeFullManagementTechnologyInner := _NodeFullManagementTechnologyInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeFullManagementTechnologyInner)

	if err != nil {
		return err
	}

	*o = NodeFullManagementTechnologyInner(varNodeFullManagementTechnologyInner)

	return err
}

type NullableNodeFullManagementTechnologyInner struct {
	value *NodeFullManagementTechnologyInner
	isSet bool
}

func (v NullableNodeFullManagementTechnologyInner) Get() *NodeFullManagementTechnologyInner {
	return v.value
}

func (v *NullableNodeFullManagementTechnologyInner) Set(val *NodeFullManagementTechnologyInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullManagementTechnologyInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullManagementTechnologyInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullManagementTechnologyInner(val *NodeFullManagementTechnologyInner) *NullableNodeFullManagementTechnologyInner {
	return &NullableNodeFullManagementTechnologyInner{value: val, isSet: true}
}

func (v NullableNodeFullManagementTechnologyInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullManagementTechnologyInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
