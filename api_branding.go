...
type ApiGetBrandingConfRequest struct {
	ctx context.Context
	ApiService *BrandingAPIService
}

func (r ApiGetBrandingConfRequest) Execute() (*GetBrandingConf200Response, *http.Response, error) {
	return r.ApiService.GetBrandingConfExecute(r)
}
...
Get all web interface customization parameters
 ...
 @return ApiGetBrandingConfRequest
*/
func (a *BrandingAPIService) GetBrandingConf(ctx context.Context) ApiGetBrandingConfRequest {
	return ApiGetBrandingConfRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return GetBrandingConf200Response
func (a *BrandingAPIService) GetBrandingConfExecute(r ApiGetBrandingConfRequest) (*GetBrandingConf200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetBrandingConf200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BrandingAPIService.GetBrandingConf")
	if err != nil {
...
type ApiReloadBrandingConfRequest struct {
	ctx context.Context
	ApiService *BrandingAPIService
}

func (r ApiReloadBrandingConfRequest) Execute() (*GetBrandingConf200Response, *http.Response, error) {
	return r.ApiService.ReloadBrandingConfExecute(r)
}
...
Reload the configuration from file
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReloadBrandingConfRequest
*/
func (a *BrandingAPIService) ReloadBrandingConf(ctx context.Context) ApiReloadBrandingConfRequest {
	return ApiReloadBrandingConfRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetBrandingConf200Response
func (a *BrandingAPIService) ReloadBrandingConfExecute(r ApiReloadBrandingConfRequest) (*GetBrandingConf200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BrandingAPIService.ReloadBrandingConf")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/branding/reload"
...
type ApiUpdateBRandingConfRequest struct {
	ctx context.Context
	ApiService *BrandingAPIService
	brandingConf *BrandingConf
}

func (r ApiUpdateBRandingConfRequest) BrandingConf(brandingConf BrandingConf) ApiUpdateBRandingConfRequest {
	r.brandingConf = &brandingConf
	return r
}

func (r ApiUpdateBRandingConfRequest) Execute() (*UpdateBRandingConf200Response, *http.Response, error) {
	return r.ApiService.UpdateBRandingConfExecute(r)
}
...
change color, logo, label etc.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUpdateBRandingConfRequest
*/
func (a *BrandingAPIService) UpdateBRandingConf(ctx context.Context) ApiUpdateBRandingConfRequest {
	return ApiUpdateBRandingConfRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return UpdateBRandingConf200Response
func (a *BrandingAPIService) UpdateBRandingConfExecute(r ApiUpdateBRandingConfRequest) (*UpdateBRandingConf200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateBRandingConf200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BrandingAPIService.UpdateBRandingConf")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.brandingConf == nil {
		return localVarReturnValue, nil, reportError("brandingConf is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.brandingConf
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["API-Tokens"]; ok {
