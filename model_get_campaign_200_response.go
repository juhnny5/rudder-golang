...
// checks if the GetCampaign200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCampaign200Response{}
...
type _GetCampaign200Response GetCampaign200Response
...
func (o GetCampaign200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCampaign200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetCampaign200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCampaign200Response := _GetCampaign200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCampaign200Response)

	if err != nil {
		return err
	}

	*o = GetCampaign200Response(varGetCampaign200Response)
