...
type ApiCheckDirectiveRequest struct {
	ctx context.Context
...
func (r ApiCheckDirectiveRequest) Directive(directive Directive) ApiCheckDirectiveRequest {
	r.directive = &directive
	return r
}

func (r ApiCheckDirectiveRequest) Execute() (*CheckDirective200Response, *http.Response, error) {
	return r.ApiService.CheckDirectiveExecute(r)
}
...
Check that update on a directive is valid
 ...
 @return ApiCheckDirectiveRequest
*/
func (a *DirectivesAPIService) CheckDirective(ctx context.Context, directiveId string) ApiCheckDirectiveRequest {
	return ApiCheckDirectiveRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return CheckDirective200Response
func (a *DirectivesAPIService) CheckDirectiveExecute(r ApiCheckDirectiveRequest) (*CheckDirective200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CheckDirective200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DirectivesAPIService.CheckDirective")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/directives/{directiveId}/check"
	...
	if r.directive == nil {
		return localVarReturnValue, nil, reportError("directive is required and must be specified")
	}
...
func (r ApiCreateDirectiveRequest) DirectiveNew(directiveNew DirectiveNew) ApiCreateDirectiveRequest {
	r.directiveNew = &directiveNew
	return r
}

func (r ApiCreateDirectiveRequest) Execute() (*CreateDirective200Response, *http.Response, error) {
...
*/
func (a *DirectivesAPIService) CreateDirective(ctx context.Context) ApiCreateDirectiveRequest {
	return ApiCreateDirectiveRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CreateDirective200Response
func (a *DirectivesAPIService) CreateDirectiveExecute(r ApiCreateDirectiveRequest) (*CreateDirective200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateDirective200Response
	)
	...
	localVarPath := localBasePath + "/directives"
	...
	// body params
	localVarPostBody = r.directiveNew
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["API-Tokens"]; ok {
...
func (r ApiDeleteDirectiveRequest) Execute() (*DeleteDirective200Response, *http.Response, error) {
...
*/
func (a *DirectivesAPIService) DeleteDirective(ctx context.Context, directiveId string) ApiDeleteDirectiveRequest {
	return ApiDeleteDirectiveRequest{
		ApiService: a,
		ctx: ctx,
		directiveId: directiveId,
...
// Execute executes the request
//  @return DeleteDirective200Response
func (a *DirectivesAPIService) DeleteDirectiveExecute(r ApiDeleteDirectiveRequest) (*DeleteDirective200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteDirective200Response
	)
	...
	localVarPath := localBasePath + "/directives/{directiveId}"
	localVarPath = strings.Replace(localVarPath, "{"+"directiveId"+"}", url.PathEscape(parameterValueToString(r.directiveId, "directiveId")), -1)
...
type ApiDirectiveDetailsRequest struct {
	ctx context.Context
	ApiService *DirectivesAPIService
	directiveId string
}

func (r ApiDirectiveDetailsRequest) Execute() (*DirectiveDetails200Response, *http.Response, error) {
	return r.ApiService.DirectiveDetailsExecute(r)
}
...
Get all information about a given directive
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param directiveId Id of the directive
 @return ApiDirectiveDetailsRequest
*/
func (a *DirectivesAPIService) DirectiveDetails(ctx context.Context, directiveId string) ApiDirectiveDetailsRequest {
	return ApiDirectiveDetailsRequest{
		ApiService: a,
		ctx: ctx,
		directiveId: directiveId,
...
// Execute executes the request
//  @return DirectiveDetails200Response
func (a *DirectivesAPIService) DirectiveDetailsExecute(r ApiDirectiveDetailsRequest) (*DirectiveDetails200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DirectiveDetails200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DirectivesAPIService.DirectiveDetails")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListDirectivesRequest) Execute() (*ListDirectives200Response, *http.Response, error) {
...
*/
func (a *DirectivesAPIService) ListDirectives(ctx context.Context) ApiListDirectivesRequest {
	return ApiListDirectivesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListDirectives200Response
func (a *DirectivesAPIService) ListDirectivesExecute(r ApiListDirectivesRequest) (*ListDirectives200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListDirectives200Response
	)
...
func (r ApiUpdateDirectiveRequest) Directive(directive Directive) ApiUpdateDirectiveRequest {
	r.directive = &directive
	return r
}

func (r ApiUpdateDirectiveRequest) Execute() (*UpdateDirective200Response, *http.Response, error) {
...
*/
func (a *DirectivesAPIService) UpdateDirective(ctx context.Context, directiveId string) ApiUpdateDirectiveRequest {
	return ApiUpdateDirectiveRequest{
		ApiService: a,
		ctx: ctx,
		directiveId: directiveId,
...
// Execute executes the request
//  @return UpdateDirective200Response
func (a *DirectivesAPIService) UpdateDirectiveExecute(r ApiUpdateDirectiveRequest) (*UpdateDirective200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateDirective200Response
	)
