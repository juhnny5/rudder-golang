...
// checks if the NodeFullOs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullOs{}
...
func (o NodeFullOs) MarshalJSON() ([]byte, error) {
...
func (o NodeFullOs) ToMap() (map[string]interface{}, error) {
...
func (o *NodeFullOs) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeFullOs := _NodeFullOs{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeFullOs)

	if err != nil {
		return err
	}

	*o = NodeFullOs(varNodeFullOs)

	return err
}

type NullableNodeFullOs struct {
	value *NodeFullOs
	isSet bool
}

func (v NullableNodeFullOs) Get() *NodeFullOs {
	return v.value
}

func (v *NullableNodeFullOs) Set(val *NodeFullOs) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullOs) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullOs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullOs(val *NodeFullOs) *NullableNodeFullOs {
	return &NullableNodeFullOs{value: val, isSet: true}
}

func (v NullableNodeFullOs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullOs) UnmarshalJSON(src []byte) error {
	v.isSet = true
