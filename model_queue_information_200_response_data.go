...
// checks if the QueueInformation200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueueInformation200ResponseData{}

// QueueInformation200ResponseData Information about the service
type QueueInformation200ResponseData struct {
	QueueMaxSize int32 `json:"queueMaxSize"`
	// Is the inventory queue full
	QueueSaturated bool `json:"queueSaturated"`
}

type _QueueInformation200ResponseData QueueInformation200ResponseData
...
func NewQueueInformation200ResponseData(queueMaxSize int32, queueSaturated bool) *QueueInformation200ResponseData {
	this := QueueInformation200ResponseData{}
...
// GetQueueMaxSize returns the QueueMaxSize field value
...
// GetQueueMaxSizeOk returns a tuple with the QueueMaxSize field value
// and a boolean to check if the value has been set.
func (o *QueueInformation200ResponseData) GetQueueMaxSizeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.QueueMaxSize, true
}

// SetQueueMaxSize sets field value
func (o *QueueInformation200ResponseData) SetQueueMaxSize(v int32) {
	o.QueueMaxSize = v
}

// GetQueueSaturated returns the QueueSaturated field value
...
// GetQueueSaturatedOk returns a tuple with the QueueSaturated field value
// and a boolean to check if the value has been set.
func (o *QueueInformation200ResponseData) GetQueueSaturatedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.QueueSaturated, true
}

// SetQueueSaturated sets field value
func (o *QueueInformation200ResponseData) SetQueueSaturated(v bool) {
	o.QueueSaturated = v
}

func (o QueueInformation200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o QueueInformation200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["queueMaxSize"] = o.QueueMaxSize
	toSerialize["queueSaturated"] = o.QueueSaturated
	return toSerialize, nil
}

func (o *QueueInformation200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varQueueInformation200ResponseData := _QueueInformation200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueueInformation200ResponseData)

	if err != nil {
		return err
	}

	*o = QueueInformation200ResponseData(varQueueInformation200ResponseData)

	return err
}

type NullableQueueInformation200ResponseData struct {
	value *QueueInformation200ResponseData
	isSet bool
}

func (v NullableQueueInformation200ResponseData) Get() *QueueInformation200ResponseData {
	return v.value
}

func (v *NullableQueueInformation200ResponseData) Set(val *QueueInformation200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableQueueInformation200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableQueueInformation200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueueInformation200ResponseData(val *QueueInformation200ResponseData) *NullableQueueInformation200ResponseData {
	return &NullableQueueInformation200ResponseData{value: val, isSet: true}
}

func (v NullableQueueInformation200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueueInformation200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
