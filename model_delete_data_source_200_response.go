...
// checks if the DeleteDataSource200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteDataSource200Response{}

// DeleteDataSource200Response struct for DeleteDataSource200Response
type DeleteDataSource200Response struct {
...
type _DeleteDataSource200Response DeleteDataSource200Response
...
func NewDeleteDataSource200Response(result string, action string, data GetAllDataSources200ResponseData) *DeleteDataSource200Response {
	this := DeleteDataSource200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o DeleteDataSource200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteDataSource200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteDataSource200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteDataSource200Response := _DeleteDataSource200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteDataSource200Response)

	if err != nil {
		return err
	}

	*o = DeleteDataSource200Response(varDeleteDataSource200Response)

	return err
}

type NullableDeleteDataSource200Response struct {
	value *DeleteDataSource200Response
	isSet bool
}

func (v NullableDeleteDataSource200Response) Get() *DeleteDataSource200Response {
	return v.value
}

func (v *NullableDeleteDataSource200Response) Set(val *DeleteDataSource200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteDataSource200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteDataSource200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteDataSource200Response(val *DeleteDataSource200Response) *NullableDeleteDataSource200Response {
	return &NullableDeleteDataSource200Response{value: val, isSet: true}
}

func (v NullableDeleteDataSource200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteDataSource200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
