...
// checks if the CampaignEventResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEventResult{}

// CampaignEventResult struct for CampaignEventResult
type CampaignEventResult struct {
	// Campaign event id
	Id *string `json:"id,omitempty"`
	// Campaign result for all Nodes
	Nodes []CampaignEventResultNodesInner `json:"nodes,omitempty"`
}
...
func (o *CampaignEventResult) GetNodes() []CampaignEventResultNodesInner {
	if o == nil || IsNil(o.Nodes) {
		var ret []CampaignEventResultNodesInner
		return ret
	}
	return o.Nodes
}
...
// SetNodes gets a reference to the given []CampaignEventResultNodesInner and assigns it to the Nodes field.
func (o *CampaignEventResult) SetNodes(v []CampaignEventResultNodesInner) {
	o.Nodes = v
}

func (o CampaignEventResult) MarshalJSON() ([]byte, error) {
...
func (o CampaignEventResult) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignEventResult struct {
	value *CampaignEventResult
	isSet bool
}

func (v NullableCampaignEventResult) Get() *CampaignEventResult {
	return v.value
}

func (v *NullableCampaignEventResult) Set(val *CampaignEventResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignEventResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignEventResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignEventResult(val *CampaignEventResult) *NullableCampaignEventResult {
	return &NullableCampaignEventResult{value: val, isSet: true}
}

func (v NullableCampaignEventResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignEventResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
