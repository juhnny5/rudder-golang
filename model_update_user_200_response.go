...
type UpdateUser200Response struct {
	...
	Data UpdateUser200ResponseData `json:"data"`
}
...
func (o *UpdateUser200Response) GetData() UpdateUser200ResponseData {
	if o == nil {
		var ret UpdateUser200ResponseData
		return ret
	}
...
func (o *UpdateUser200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateUser200Response := _UpdateUser200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateUser200Response)

	if err != nil {
		return err
	}

	*o = UpdateUser200Response(varUpdateUser200Response)
