...
// checks if the TechniqueParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueParameter{}

// TechniqueParameter struct for TechniqueParameter
...
// GetMayBeEmpty returns the MayBeEmpty field value if set, zero value otherwise.
func (o *TechniqueParameter) GetMayBeEmpty() bool {
	if o == nil || IsNil(o.MayBeEmpty) {
		var ret bool
		return ret
	}
	return *o.MayBeEmpty
...
// GetMayBeEmptyOk returns a tuple with the MayBeEmpty field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TechniqueParameter) GetMayBeEmptyOk() (*bool, bool) {
	if o == nil || IsNil(o.MayBeEmpty) {
		return nil, false
	}
	return o.MayBeEmpty, true
}
...
// SetMayBeEmpty gets a reference to the given bool and assigns it to the MayBeEmpty field.
func (o *TechniqueParameter) SetMayBeEmpty(v bool) {
	o.MayBeEmpty = &v
}

func (o TechniqueParameter) MarshalJSON() ([]byte, error) {
...
func (o TechniqueParameter) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MayBeEmpty) {
		toSerialize["mayBeEmpty"] = o.MayBeEmpty
	}
	return toSerialize, nil
}

type NullableTechniqueParameter struct {
	value *TechniqueParameter
	isSet bool
}

func (v NullableTechniqueParameter) Get() *TechniqueParameter {
	return v.value
}

func (v *NullableTechniqueParameter) Set(val *TechniqueParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueParameter(val *TechniqueParameter) *NullableTechniqueParameter {
	return &NullableTechniqueParameter{value: val, isSet: true}
}

func (v NullableTechniqueParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
