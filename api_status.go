...
type ApiNoneRequest struct {
	ctx context.Context
	ApiService *StatusAPIService
}

func (r ApiNoneRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.NoneExecute(r)
}
...
- it returns a plain text message.
 ...
 @return ApiNoneRequest
*/
func (a *StatusAPIService) None(ctx context.Context) ApiNoneRequest {
	return ApiNoneRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return string
func (a *StatusAPIService) NoneExecute(r ApiNoneRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatusAPIService.None")
	if err != nil {
