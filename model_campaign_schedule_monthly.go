...
// checks if the CampaignScheduleMonthly type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleMonthly{}

// CampaignScheduleMonthly struct for CampaignScheduleMonthly
type CampaignScheduleMonthly struct {
	Start *CampaignScheduleMonthlyStart `json:"start,omitempty"`
	End *CampaignScheduleMonthlyEnd `json:"end,omitempty"`
...
func (o *CampaignScheduleMonthly) GetStart() CampaignScheduleMonthlyStart {
	if o == nil || IsNil(o.Start) {
		var ret CampaignScheduleMonthlyStart
		return ret
	}
	return *o.Start
}
...
// SetStart gets a reference to the given CampaignScheduleMonthlyStart and assigns it to the Start field.
...
func (o *CampaignScheduleMonthly) GetEnd() CampaignScheduleMonthlyEnd {
	if o == nil || IsNil(o.End) {
		var ret CampaignScheduleMonthlyEnd
		return ret
	}
	return *o.End
}
...
// SetEnd gets a reference to the given CampaignScheduleMonthlyEnd and assigns it to the End field.
...
func (o CampaignScheduleMonthly) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleMonthly) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleMonthly struct {
	value *CampaignScheduleMonthly
	isSet bool
}

func (v NullableCampaignScheduleMonthly) Get() *CampaignScheduleMonthly {
	return v.value
}

func (v *NullableCampaignScheduleMonthly) Set(val *CampaignScheduleMonthly) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleMonthly) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleMonthly) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleMonthly(val *CampaignScheduleMonthly) *NullableCampaignScheduleMonthly {
	return &NullableCampaignScheduleMonthly{value: val, isSet: true}
}

func (v NullableCampaignScheduleMonthly) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleMonthly) UnmarshalJSON(src []byte) error {
	v.isSet = true
