...
// checks if the CreateTechnique200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTechnique200Response{}

// CreateTechnique200Response struct for CreateTechnique200Response
type CreateTechnique200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data CreateTechnique200ResponseData `json:"data"`
}

type _CreateTechnique200Response CreateTechnique200Response
...
func NewCreateTechnique200Response(result string, action string, data CreateTechnique200ResponseData) *CreateTechnique200Response {
	this := CreateTechnique200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *CreateTechnique200Response) GetData() CreateTechnique200ResponseData {
	if o == nil {
		var ret CreateTechnique200ResponseData
		return ret
	}
...
func (o CreateTechnique200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateTechnique200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTechnique200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTechnique200Response := _CreateTechnique200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTechnique200Response)

	if err != nil {
		return err
	}

	*o = CreateTechnique200Response(varCreateTechnique200Response)

	return err
}

type NullableCreateTechnique200Response struct {
	value *CreateTechnique200Response
	isSet bool
}

func (v NullableCreateTechnique200Response) Get() *CreateTechnique200Response {
	return v.value
}

func (v *NullableCreateTechnique200Response) Set(val *CreateTechnique200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTechnique200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTechnique200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTechnique200Response(val *CreateTechnique200Response) *NullableCreateTechnique200Response {
	return &NullableCreateTechnique200Response{value: val, isSet: true}
}

func (v NullableCreateTechnique200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTechnique200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
