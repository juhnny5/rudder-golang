...
// CampaignDetailsDetails - struct for CampaignDetailsDetails
type CampaignDetailsDetails struct {
	CampaignSoftwareUpdate *CampaignSoftwareUpdate
	CampaignSystemUpdate *CampaignSystemUpdate
}

// CampaignSoftwareUpdateAsCampaignDetailsDetails is a convenience function that returns CampaignSoftwareUpdate wrapped in CampaignDetailsDetails
func CampaignSoftwareUpdateAsCampaignDetailsDetails(v *CampaignSoftwareUpdate) CampaignDetailsDetails {
	return CampaignDetailsDetails{
		CampaignSoftwareUpdate: v,
	}
}

// CampaignSystemUpdateAsCampaignDetailsDetails is a convenience function that returns CampaignSystemUpdate wrapped in CampaignDetailsDetails
func CampaignSystemUpdateAsCampaignDetailsDetails(v *CampaignSystemUpdate) CampaignDetailsDetails {
	return CampaignDetailsDetails{
		CampaignSystemUpdate: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *CampaignDetailsDetails) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into CampaignSoftwareUpdate
	err = newStrictDecoder(data).Decode(&dst.CampaignSoftwareUpdate)
	if err == nil {
		jsonCampaignSoftwareUpdate, _ := json.Marshal(dst.CampaignSoftwareUpdate)
		if string(jsonCampaignSoftwareUpdate) == "{}" { // empty struct
			dst.CampaignSoftwareUpdate = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into CampaignSystemUpdate
	err = newStrictDecoder(data).Decode(&dst.CampaignSystemUpdate)
	if err == nil {
		jsonCampaignSystemUpdate, _ := json.Marshal(dst.CampaignSystemUpdate)
		if string(jsonCampaignSystemUpdate) == "{}" { // empty struct
			dst.CampaignSystemUpdate = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(CampaignDetailsDetails)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(CampaignDetailsDetails)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CampaignDetailsDetails) MarshalJSON() ([]byte, error) {
	if src.CampaignSoftwareUpdate != nil {
		return json.Marshal(&src.CampaignSoftwareUpdate)
	}

	if src.CampaignSystemUpdate != nil {
		return json.Marshal(&src.CampaignSystemUpdate)
	}
...
func (obj *CampaignDetailsDetails) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.CampaignSoftwareUpdate != nil {
		return obj.CampaignSoftwareUpdate
	}

	if obj.CampaignSystemUpdate != nil {
		return obj.CampaignSystemUpdate
	}
...
type NullableCampaignDetailsDetails struct {
	value *CampaignDetailsDetails
	isSet bool
}

func (v NullableCampaignDetailsDetails) Get() *CampaignDetailsDetails {
	return v.value
}

func (v *NullableCampaignDetailsDetails) Set(val *CampaignDetailsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignDetailsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignDetailsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignDetailsDetails(val *CampaignDetailsDetails) *NullableCampaignDetailsDetails {
	return &NullableCampaignDetailsDetails{value: val, isSet: true}
}

func (v NullableCampaignDetailsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignDetailsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
