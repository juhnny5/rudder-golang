...
// checks if the AddSecret200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddSecret200Response{}

// AddSecret200Response struct for AddSecret200Response
type AddSecret200Response struct {
...
type _AddSecret200Response AddSecret200Response
...
func (o AddSecret200Response) MarshalJSON() ([]byte, error) {
...
func (o AddSecret200Response) ToMap() (map[string]interface{}, error) {
...
func (o *AddSecret200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varAddSecret200Response := _AddSecret200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddSecret200Response)

	if err != nil {
		return err
	}

	*o = AddSecret200Response(varAddSecret200Response)

	return err
}

type NullableAddSecret200Response struct {
	value *AddSecret200Response
	isSet bool
}

func (v NullableAddSecret200Response) Get() *AddSecret200Response {
	return v.value
}

func (v *NullableAddSecret200Response) Set(val *AddSecret200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAddSecret200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAddSecret200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddSecret200Response(val *AddSecret200Response) *NullableAddSecret200Response {
	return &NullableAddSecret200Response{value: val, isSet: true}
}

func (v NullableAddSecret200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddSecret200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
