...
// checks if the ReloadOneDatasourceAllNodes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadOneDatasourceAllNodes200Response{}

// ReloadOneDatasourceAllNodes200Response struct for ReloadOneDatasourceAllNodes200Response
type ReloadOneDatasourceAllNodes200Response struct {
...
type _ReloadOneDatasourceAllNodes200Response ReloadOneDatasourceAllNodes200Response
...
func NewReloadOneDatasourceAllNodes200Response(result string, action string, data string) *ReloadOneDatasourceAllNodes200Response {
	this := ReloadOneDatasourceAllNodes200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ReloadOneDatasourceAllNodes200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadOneDatasourceAllNodes200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadOneDatasourceAllNodes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadOneDatasourceAllNodes200Response := _ReloadOneDatasourceAllNodes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadOneDatasourceAllNodes200Response)

	if err != nil {
		return err
	}

	*o = ReloadOneDatasourceAllNodes200Response(varReloadOneDatasourceAllNodes200Response)

	return err
}

type NullableReloadOneDatasourceAllNodes200Response struct {
	value *ReloadOneDatasourceAllNodes200Response
	isSet bool
}

func (v NullableReloadOneDatasourceAllNodes200Response) Get() *ReloadOneDatasourceAllNodes200Response {
	return v.value
}

func (v *NullableReloadOneDatasourceAllNodes200Response) Set(val *ReloadOneDatasourceAllNodes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadOneDatasourceAllNodes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadOneDatasourceAllNodes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadOneDatasourceAllNodes200Response(val *ReloadOneDatasourceAllNodes200Response) *NullableReloadOneDatasourceAllNodes200Response {
	return &NullableReloadOneDatasourceAllNodes200Response{value: val, isSet: true}
}

func (v NullableReloadOneDatasourceAllNodes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadOneDatasourceAllNodes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
