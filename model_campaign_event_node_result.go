...
// checks if the CampaignEventNodeResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEventNodeResult{}

// CampaignEventNodeResult struct for CampaignEventNodeResult
type CampaignEventNodeResult struct {
	// Campaign event id
	Id *string `json:"id,omitempty"`
	Nodes []CampaignEventNodeResultNodesInner `json:"nodes,omitempty"`
}
...
func (o *CampaignEventNodeResult) GetNodes() []CampaignEventNodeResultNodesInner {
	if o == nil || IsNil(o.Nodes) {
		var ret []CampaignEventNodeResultNodesInner
		return ret
	}
	return o.Nodes
}
...
// SetNodes gets a reference to the given []CampaignEventNodeResultNodesInner and assigns it to the Nodes field.
func (o *CampaignEventNodeResult) SetNodes(v []CampaignEventNodeResultNodesInner) {
	o.Nodes = v
}

func (o CampaignEventNodeResult) MarshalJSON() ([]byte, error) {
...
func (o CampaignEventNodeResult) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignEventNodeResult struct {
	value *CampaignEventNodeResult
	isSet bool
}

func (v NullableCampaignEventNodeResult) Get() *CampaignEventNodeResult {
	return v.value
}

func (v *NullableCampaignEventNodeResult) Set(val *CampaignEventNodeResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignEventNodeResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignEventNodeResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignEventNodeResult(val *CampaignEventNodeResult) *NullableCampaignEventNodeResult {
	return &NullableCampaignEventNodeResult{value: val, isSet: true}
}

func (v NullableCampaignEventNodeResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignEventNodeResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
