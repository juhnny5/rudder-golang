...
// checks if the CreateRule200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRule200Response{}

// CreateRule200Response struct for CreateRule200Response
type CreateRule200Response struct {
...
type _CreateRule200Response CreateRule200Response
...
func (o CreateRule200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateRule200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateRule200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateRule200Response := _CreateRule200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateRule200Response)

	if err != nil {
		return err
	}

	*o = CreateRule200Response(varCreateRule200Response)

	return err
}

type NullableCreateRule200Response struct {
	value *CreateRule200Response
	isSet bool
}

func (v NullableCreateRule200Response) Get() *CreateRule200Response {
	return v.value
}

func (v *NullableCreateRule200Response) Set(val *CreateRule200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRule200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRule200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRule200Response(val *CreateRule200Response) *NullableCreateRule200Response {
	return &NullableCreateRule200Response{value: val, isSet: true}
}

func (v NullableCreateRule200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRule200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
