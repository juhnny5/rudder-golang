...
// checks if the TechniqueRevisions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueRevisions200Response{}

// TechniqueRevisions200Response struct for TechniqueRevisions200Response
type TechniqueRevisions200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data TechniqueRevisions200ResponseData `json:"data"`
}

type _TechniqueRevisions200Response TechniqueRevisions200Response
...
func NewTechniqueRevisions200Response(result string, action string, data TechniqueRevisions200ResponseData) *TechniqueRevisions200Response {
	this := TechniqueRevisions200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *TechniqueRevisions200Response) GetData() TechniqueRevisions200ResponseData {
	if o == nil {
		var ret TechniqueRevisions200ResponseData
		return ret
	}
...
func (o TechniqueRevisions200Response) MarshalJSON() ([]byte, error) {
...
func (o TechniqueRevisions200Response) ToMap() (map[string]interface{}, error) {
...
func (o *TechniqueRevisions200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varTechniqueRevisions200Response := _TechniqueRevisions200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTechniqueRevisions200Response)

	if err != nil {
		return err
	}

	*o = TechniqueRevisions200Response(varTechniqueRevisions200Response)

	return err
}

type NullableTechniqueRevisions200Response struct {
	value *TechniqueRevisions200Response
	isSet bool
}

func (v NullableTechniqueRevisions200Response) Get() *TechniqueRevisions200Response {
	return v.value
}

func (v *NullableTechniqueRevisions200Response) Set(val *TechniqueRevisions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueRevisions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueRevisions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueRevisions200Response(val *TechniqueRevisions200Response) *NullableTechniqueRevisions200Response {
	return &NullableTechniqueRevisions200Response{value: val, isSet: true}
}

func (v NullableTechniqueRevisions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueRevisions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
