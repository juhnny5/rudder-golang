...
// checks if the ApiInformations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiInformations200Response{}

// ApiInformations200Response struct for ApiInformations200Response
type ApiInformations200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ApiInformations200ResponseData `json:"data"`
}

type _ApiInformations200Response ApiInformations200Response
...
func NewApiInformations200Response(result string, action string, data ApiInformations200ResponseData) *ApiInformations200Response {
	this := ApiInformations200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ApiInformations200Response) GetData() ApiInformations200ResponseData {
	if o == nil {
		var ret ApiInformations200ResponseData
		return ret
	}
...
func (o ApiInformations200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiInformations200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ApiInformations200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varApiInformations200Response := _ApiInformations200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiInformations200Response)

	if err != nil {
		return err
	}

	*o = ApiInformations200Response(varApiInformations200Response)

	return err
}

type NullableApiInformations200Response struct {
	value *ApiInformations200Response
	isSet bool
}

func (v NullableApiInformations200Response) Get() *ApiInformations200Response {
	return v.value
}

func (v *NullableApiInformations200Response) Set(val *ApiInformations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiInformations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiInformations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiInformations200Response(val *ApiInformations200Response) *NullableApiInformations200Response {
	return &NullableApiInformations200Response{value: val, isSet: true}
}

func (v NullableApiInformations200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiInformations200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
