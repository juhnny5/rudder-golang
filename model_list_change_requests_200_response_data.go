...
// checks if the ListChangeRequests200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListChangeRequests200ResponseData{}

// ListChangeRequests200ResponseData struct for ListChangeRequests200ResponseData
type ListChangeRequests200ResponseData struct {
	Rules []ChangeRequest `json:"rules"`
}

type _ListChangeRequests200ResponseData ListChangeRequests200ResponseData

// NewListChangeRequests200ResponseData instantiates a new ListChangeRequests200ResponseData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListChangeRequests200ResponseData(rules []ChangeRequest) *ListChangeRequests200ResponseData {
	this := ListChangeRequests200ResponseData{}
	this.Rules = rules
	return &this
}

// NewListChangeRequests200ResponseDataWithDefaults instantiates a new ListChangeRequests200ResponseData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListChangeRequests200ResponseDataWithDefaults() *ListChangeRequests200ResponseData {
	this := ListChangeRequests200ResponseData{}
	return &this
}

// GetRules returns the Rules field value
func (o *ListChangeRequests200ResponseData) GetRules() []ChangeRequest {
	if o == nil {
...
func (o *ListChangeRequests200ResponseData) GetRulesOk() ([]ChangeRequest, bool) {
	if o == nil {
		return nil, false
	}
	return o.Rules, true
...
func (o *ListChangeRequests200ResponseData) SetRules(v []ChangeRequest) {
	o.Rules = v
}

func (o ListChangeRequests200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ListChangeRequests200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["rules"] = o.Rules
	return toSerialize, nil
}

func (o *ListChangeRequests200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListChangeRequests200ResponseData := _ListChangeRequests200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListChangeRequests200ResponseData)

	if err != nil {
		return err
	}

	*o = ListChangeRequests200ResponseData(varListChangeRequests200ResponseData)

	return err
}

type NullableListChangeRequests200ResponseData struct {
	value *ListChangeRequests200ResponseData
	isSet bool
}

func (v NullableListChangeRequests200ResponseData) Get() *ListChangeRequests200ResponseData {
	return v.value
}

func (v *NullableListChangeRequests200ResponseData) Set(val *ListChangeRequests200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListChangeRequests200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListChangeRequests200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListChangeRequests200ResponseData(val *ListChangeRequests200ResponseData) *NullableListChangeRequests200ResponseData {
	return &NullableListChangeRequests200ResponseData{value: val, isSet: true}
}

func (v NullableListChangeRequests200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListChangeRequests200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
