...
// checks if the GroupQueryWhereInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupQueryWhereInner{}

// GroupQueryWhereInner struct for GroupQueryWhereInner
type GroupQueryWhereInner struct {
	// Type of the object
...
func (o GroupQueryWhereInner) MarshalJSON() ([]byte, error) {
...
func (o GroupQueryWhereInner) ToMap() (map[string]interface{}, error) {
...
type NullableGroupQueryWhereInner struct {
	value *GroupQueryWhereInner
	isSet bool
}

func (v NullableGroupQueryWhereInner) Get() *GroupQueryWhereInner {
	return v.value
}

func (v *NullableGroupQueryWhereInner) Set(val *GroupQueryWhereInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupQueryWhereInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupQueryWhereInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupQueryWhereInner(val *GroupQueryWhereInner) *NullableGroupQueryWhereInner {
	return &NullableGroupQueryWhereInner{value: val, isSet: true}
}

func (v NullableGroupQueryWhereInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupQueryWhereInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
