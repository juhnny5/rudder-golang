...
// checks if the GetGlobalCompliance200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGlobalCompliance200Response{}

// GetGlobalCompliance200Response struct for GetGlobalCompliance200Response
type GetGlobalCompliance200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetGlobalCompliance200ResponseData `json:"data"`
}

type _GetGlobalCompliance200Response GetGlobalCompliance200Response
...
func NewGetGlobalCompliance200Response(result string, action string, data GetGlobalCompliance200ResponseData) *GetGlobalCompliance200Response {
	this := GetGlobalCompliance200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetGlobalCompliance200Response) GetData() GetGlobalCompliance200ResponseData {
	if o == nil {
		var ret GetGlobalCompliance200ResponseData
		return ret
	}
...
func (o GetGlobalCompliance200Response) MarshalJSON() ([]byte, error) {
...
func (o GetGlobalCompliance200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetGlobalCompliance200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGlobalCompliance200Response := _GetGlobalCompliance200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetGlobalCompliance200Response)

	if err != nil {
		return err
	}

	*o = GetGlobalCompliance200Response(varGetGlobalCompliance200Response)

	return err
}

type NullableGetGlobalCompliance200Response struct {
	value *GetGlobalCompliance200Response
	isSet bool
}

func (v NullableGetGlobalCompliance200Response) Get() *GetGlobalCompliance200Response {
	return v.value
}

func (v *NullableGetGlobalCompliance200Response) Set(val *GetGlobalCompliance200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGlobalCompliance200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGlobalCompliance200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGlobalCompliance200Response(val *GetGlobalCompliance200Response) *NullableGetGlobalCompliance200Response {
	return &NullableGetGlobalCompliance200Response{value: val, isSet: true}
}

func (v NullableGetGlobalCompliance200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGlobalCompliance200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
