...
// checks if the GetLastCVECheck200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLastCVECheck200Response{}

// GetLastCVECheck200Response struct for GetLastCVECheck200Response
type GetLastCVECheck200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetLastCVECheck200ResponseData `json:"data"`
}

type _GetLastCVECheck200Response GetLastCVECheck200Response
...
func NewGetLastCVECheck200Response(result string, action string, data GetLastCVECheck200ResponseData) *GetLastCVECheck200Response {
	this := GetLastCVECheck200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetLastCVECheck200Response) GetData() GetLastCVECheck200ResponseData {
	if o == nil {
		var ret GetLastCVECheck200ResponseData
		return ret
	}
...
func (o GetLastCVECheck200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLastCVECheck200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetLastCVECheck200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetLastCVECheck200Response := _GetLastCVECheck200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetLastCVECheck200Response)

	if err != nil {
		return err
	}

	*o = GetLastCVECheck200Response(varGetLastCVECheck200Response)

	return err
}

type NullableGetLastCVECheck200Response struct {
	value *GetLastCVECheck200Response
	isSet bool
}

func (v NullableGetLastCVECheck200Response) Get() *GetLastCVECheck200Response {
	return v.value
}

func (v *NullableGetLastCVECheck200Response) Set(val *GetLastCVECheck200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLastCVECheck200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLastCVECheck200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLastCVECheck200Response(val *GetLastCVECheck200Response) *NullableGetLastCVECheck200Response {
	return &NullableGetLastCVECheck200Response{value: val, isSet: true}
}

func (v NullableGetLastCVECheck200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLastCVECheck200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
