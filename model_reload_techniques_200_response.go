...
// checks if the ReloadTechniques200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadTechniques200Response{}

// ReloadTechniques200Response struct for ReloadTechniques200Response
type ReloadTechniques200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ReloadTechniques200ResponseData `json:"data"`
}

type _ReloadTechniques200Response ReloadTechniques200Response
...
func NewReloadTechniques200Response(result string, action string, data ReloadTechniques200ResponseData) *ReloadTechniques200Response {
	this := ReloadTechniques200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ReloadTechniques200Response) GetData() ReloadTechniques200ResponseData {
	if o == nil {
		var ret ReloadTechniques200ResponseData
		return ret
	}
...
func (o ReloadTechniques200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadTechniques200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadTechniques200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadTechniques200Response := _ReloadTechniques200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadTechniques200Response)

	if err != nil {
		return err
	}

	*o = ReloadTechniques200Response(varReloadTechniques200Response)

	return err
}

type NullableReloadTechniques200Response struct {
	value *ReloadTechniques200Response
	isSet bool
}

func (v NullableReloadTechniques200Response) Get() *ReloadTechniques200Response {
	return v.value
}

func (v *NullableReloadTechniques200Response) Set(val *ReloadTechniques200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadTechniques200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadTechniques200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadTechniques200Response(val *ReloadTechniques200Response) *NullableReloadTechniques200Response {
	return &NullableReloadTechniques200Response{value: val, isSet: true}
}

func (v NullableReloadTechniques200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadTechniques200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
