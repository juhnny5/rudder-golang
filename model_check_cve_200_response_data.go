...
// checks if the CheckCVE200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckCVE200ResponseData{}

// CheckCVE200ResponseData struct for CheckCVE200ResponseData
type CheckCVE200ResponseData struct {
	CveChecks []CveCheck `json:"cveChecks"`
}

type _CheckCVE200ResponseData CheckCVE200ResponseData
...
func (o CheckCVE200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CheckCVE200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cveChecks"] = o.CveChecks
	return toSerialize, nil
}

func (o *CheckCVE200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varCheckCVE200ResponseData := _CheckCVE200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCheckCVE200ResponseData)

	if err != nil {
		return err
	}

	*o = CheckCVE200ResponseData(varCheckCVE200ResponseData)

	return err
}

type NullableCheckCVE200ResponseData struct {
	value *CheckCVE200ResponseData
	isSet bool
}

func (v NullableCheckCVE200ResponseData) Get() *CheckCVE200ResponseData {
	return v.value
}

func (v *NullableCheckCVE200ResponseData) Set(val *CheckCVE200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCVE200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCVE200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCVE200ResponseData(val *CheckCVE200ResponseData) *NullableCheckCVE200ResponseData {
	return &NullableCheckCVE200ResponseData{value: val, isSet: true}
}

func (v NullableCheckCVE200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCVE200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
