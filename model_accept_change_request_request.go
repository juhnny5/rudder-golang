...
// checks if the AcceptChangeRequestRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcceptChangeRequestRequest{}

// AcceptChangeRequestRequest struct for AcceptChangeRequestRequest
...
func NewAcceptChangeRequestRequest() *AcceptChangeRequestRequest {
	this := AcceptChangeRequestRequest{}
	return &this
}
...
func (o AcceptChangeRequestRequest) MarshalJSON() ([]byte, error) {
...
func (o AcceptChangeRequestRequest) ToMap() (map[string]interface{}, error) {
...
type NullableAcceptChangeRequestRequest struct {
	value *AcceptChangeRequestRequest
	isSet bool
}

func (v NullableAcceptChangeRequestRequest) Get() *AcceptChangeRequestRequest {
	return v.value
}

func (v *NullableAcceptChangeRequestRequest) Set(val *AcceptChangeRequestRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAcceptChangeRequestRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAcceptChangeRequestRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcceptChangeRequestRequest(val *AcceptChangeRequestRequest) *NullableAcceptChangeRequestRequest {
	return &NullableAcceptChangeRequestRequest{value: val, isSet: true}
}

func (v NullableAcceptChangeRequestRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcceptChangeRequestRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
