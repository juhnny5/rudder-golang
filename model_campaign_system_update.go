...
// checks if the CampaignSystemUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignSystemUpdate{}

// CampaignSystemUpdate System update campaign details (type system-update, version 2)
type CampaignSystemUpdate struct {
...
func (o CampaignSystemUpdate) MarshalJSON() ([]byte, error) {
...
func (o CampaignSystemUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignSystemUpdate struct {
	value *CampaignSystemUpdate
	isSet bool
}

func (v NullableCampaignSystemUpdate) Get() *CampaignSystemUpdate {
	return v.value
}

func (v *NullableCampaignSystemUpdate) Set(val *CampaignSystemUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignSystemUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignSystemUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignSystemUpdate(val *CampaignSystemUpdate) *NullableCampaignSystemUpdate {
	return &NullableCampaignSystemUpdate{value: val, isSet: true}
}

func (v NullableCampaignSystemUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignSystemUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
