...
// checks if the TechniquesVersionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniquesVersionsInner{}

// TechniquesVersionsInner struct for TechniquesVersionsInner
type TechniquesVersionsInner struct {
	// Technique name
...
func (o TechniquesVersionsInner) MarshalJSON() ([]byte, error) {
...
func (o TechniquesVersionsInner) ToMap() (map[string]interface{}, error) {
...
type NullableTechniquesVersionsInner struct {
	value *TechniquesVersionsInner
	isSet bool
}

func (v NullableTechniquesVersionsInner) Get() *TechniquesVersionsInner {
	return v.value
}

func (v *NullableTechniquesVersionsInner) Set(val *TechniquesVersionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniquesVersionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniquesVersionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniquesVersionsInner(val *TechniquesVersionsInner) *NullableTechniquesVersionsInner {
	return &NullableTechniquesVersionsInner{value: val, isSet: true}
}

func (v NullableTechniquesVersionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniquesVersionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
