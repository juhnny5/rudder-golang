...
// checks if the NodeFullVirtualMachinesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullVirtualMachinesInner{}

// NodeFullVirtualMachinesInner struct for NodeFullVirtualMachinesInner
type NodeFullVirtualMachinesInner struct {
...
func NewNodeFullVirtualMachinesInner() *NodeFullVirtualMachinesInner {
	this := NodeFullVirtualMachinesInner{}
	return &this
}
...
func (o NodeFullVirtualMachinesInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullVirtualMachinesInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullVirtualMachinesInner struct {
	value *NodeFullVirtualMachinesInner
	isSet bool
}

func (v NullableNodeFullVirtualMachinesInner) Get() *NodeFullVirtualMachinesInner {
	return v.value
}

func (v *NullableNodeFullVirtualMachinesInner) Set(val *NodeFullVirtualMachinesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullVirtualMachinesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullVirtualMachinesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullVirtualMachinesInner(val *NodeFullVirtualMachinesInner) *NullableNodeFullVirtualMachinesInner {
	return &NullableNodeFullVirtualMachinesInner{value: val, isSet: true}
}

func (v NullableNodeFullVirtualMachinesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullVirtualMachinesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
