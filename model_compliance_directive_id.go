...
// checks if the ComplianceDirectiveId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComplianceDirectiveId{}

// ComplianceDirectiveId struct for ComplianceDirectiveId
type ComplianceDirectiveId struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ComplianceDirectiveIdData `json:"data"`
}

type _ComplianceDirectiveId ComplianceDirectiveId
...
func (o *ComplianceDirectiveId) GetData() ComplianceDirectiveIdData {
	if o == nil {
		var ret ComplianceDirectiveIdData
		return ret
	}
...
func (o ComplianceDirectiveId) MarshalJSON() ([]byte, error) {
...
func (o ComplianceDirectiveId) ToMap() (map[string]interface{}, error) {
...
func (o *ComplianceDirectiveId) UnmarshalJSON(data []byte) (err error) {
	...
	varComplianceDirectiveId := _ComplianceDirectiveId{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varComplianceDirectiveId)

	if err != nil {
		return err
	}

	*o = ComplianceDirectiveId(varComplianceDirectiveId)

	return err
}

type NullableComplianceDirectiveId struct {
	value *ComplianceDirectiveId
	isSet bool
}

func (v NullableComplianceDirectiveId) Get() *ComplianceDirectiveId {
	return v.value
}

func (v *NullableComplianceDirectiveId) Set(val *ComplianceDirectiveId) {
	v.value = val
	v.isSet = true
}

func (v NullableComplianceDirectiveId) IsSet() bool {
	return v.isSet
}

func (v *NullableComplianceDirectiveId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComplianceDirectiveId(val *ComplianceDirectiveId) *NullableComplianceDirectiveId {
	return &NullableComplianceDirectiveId{value: val, isSet: true}
}

func (v NullableComplianceDirectiveId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComplianceDirectiveId) UnmarshalJSON(src []byte) error {
	v.isSet = true
