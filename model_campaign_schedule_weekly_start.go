...
// checks if the CampaignScheduleWeeklyStart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleWeeklyStart{}

// CampaignScheduleWeeklyStart Date when the campaign should start
type CampaignScheduleWeeklyStart struct {
...
func NewCampaignScheduleWeeklyStart() *CampaignScheduleWeeklyStart {
	this := CampaignScheduleWeeklyStart{}
	return &this
}
...
func (o CampaignScheduleWeeklyStart) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleWeeklyStart) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleWeeklyStart struct {
	value *CampaignScheduleWeeklyStart
	isSet bool
}

func (v NullableCampaignScheduleWeeklyStart) Get() *CampaignScheduleWeeklyStart {
	return v.value
}

func (v *NullableCampaignScheduleWeeklyStart) Set(val *CampaignScheduleWeeklyStart) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleWeeklyStart) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleWeeklyStart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleWeeklyStart(val *CampaignScheduleWeeklyStart) *NullableCampaignScheduleWeeklyStart {
	return &NullableCampaignScheduleWeeklyStart{value: val, isSet: true}
}

func (v NullableCampaignScheduleWeeklyStart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleWeeklyStart) UnmarshalJSON(src []byte) error {
	v.isSet = true
