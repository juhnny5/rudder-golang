...
// checks if the GetGroupTree200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGroupTree200Response{}

// GetGroupTree200Response struct for GetGroupTree200Response
type GetGroupTree200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetGroupTree200ResponseData `json:"data"`
}

type _GetGroupTree200Response GetGroupTree200Response
...
func (o *GetGroupTree200Response) GetData() GetGroupTree200ResponseData {
	if o == nil {
		var ret GetGroupTree200ResponseData
		return ret
	}
...
func (o GetGroupTree200Response) MarshalJSON() ([]byte, error) {
...
func (o GetGroupTree200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetGroupTree200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGroupTree200Response := _GetGroupTree200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetGroupTree200Response)

	if err != nil {
		return err
	}

	*o = GetGroupTree200Response(varGetGroupTree200Response)

	return err
}

type NullableGetGroupTree200Response struct {
	value *GetGroupTree200Response
	isSet bool
}

func (v NullableGetGroupTree200Response) Get() *GetGroupTree200Response {
	return v.value
}

func (v *NullableGetGroupTree200Response) Set(val *GetGroupTree200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGroupTree200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGroupTree200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGroupTree200Response(val *GetGroupTree200Response) *NullableGetGroupTree200Response {
	return &NullableGetGroupTree200Response{value: val, isSet: true}
}

func (v NullableGetGroupTree200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGroupTree200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
