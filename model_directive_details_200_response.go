...
// checks if the DirectiveDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectiveDetails200Response{}

// DirectiveDetails200Response struct for DirectiveDetails200Response
type DirectiveDetails200Response struct {
...
type _DirectiveDetails200Response DirectiveDetails200Response
...
func NewDirectiveDetails200Response(result string, action string, data ListDirectives200ResponseData) *DirectiveDetails200Response {
	this := DirectiveDetails200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o DirectiveDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o DirectiveDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DirectiveDetails200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectiveDetails200Response := _DirectiveDetails200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDirectiveDetails200Response)

	if err != nil {
		return err
	}

	*o = DirectiveDetails200Response(varDirectiveDetails200Response)

	return err
}

type NullableDirectiveDetails200Response struct {
	value *DirectiveDetails200Response
	isSet bool
}

func (v NullableDirectiveDetails200Response) Get() *DirectiveDetails200Response {
	return v.value
}

func (v *NullableDirectiveDetails200Response) Set(val *DirectiveDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectiveDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectiveDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectiveDetails200Response(val *DirectiveDetails200Response) *NullableDirectiveDetails200Response {
	return &NullableDirectiveDetails200Response{value: val, isSet: true}
}

func (v NullableDirectiveDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectiveDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
