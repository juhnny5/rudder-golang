...
// checks if the RestoreArchive200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestoreArchive200Response{}

// RestoreArchive200Response struct for RestoreArchive200Response
type RestoreArchive200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The kind of the archive
	Action string `json:"action"`
	Data RestoreArchive200ResponseData `json:"data"`
}

type _RestoreArchive200Response RestoreArchive200Response
...
func NewRestoreArchive200Response(result string, action string, data RestoreArchive200ResponseData) *RestoreArchive200Response {
	this := RestoreArchive200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *RestoreArchive200Response) GetData() RestoreArchive200ResponseData {
	if o == nil {
		var ret RestoreArchive200ResponseData
		return ret
	}
...
func (o RestoreArchive200Response) MarshalJSON() ([]byte, error) {
...
func (o RestoreArchive200Response) ToMap() (map[string]interface{}, error) {
...
func (o *RestoreArchive200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRestoreArchive200Response := _RestoreArchive200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestoreArchive200Response)

	if err != nil {
		return err
	}

	*o = RestoreArchive200Response(varRestoreArchive200Response)

	return err
}

type NullableRestoreArchive200Response struct {
	value *RestoreArchive200Response
	isSet bool
}

func (v NullableRestoreArchive200Response) Get() *RestoreArchive200Response {
	return v.value
}

func (v *NullableRestoreArchive200Response) Set(val *RestoreArchive200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRestoreArchive200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRestoreArchive200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestoreArchive200Response(val *RestoreArchive200Response) *NullableRestoreArchive200Response {
	return &NullableRestoreArchive200Response{value: val, isSet: true}
}

func (v NullableRestoreArchive200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestoreArchive200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
