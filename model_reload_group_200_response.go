...
// checks if the ReloadGroup200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadGroup200Response{}

// ReloadGroup200Response struct for ReloadGroup200Response
type ReloadGroup200Response struct {
...
type _ReloadGroup200Response ReloadGroup200Response
...
func (o ReloadGroup200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadGroup200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadGroup200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadGroup200Response := _ReloadGroup200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadGroup200Response)

	if err != nil {
		return err
	}

	*o = ReloadGroup200Response(varReloadGroup200Response)

	return err
}

type NullableReloadGroup200Response struct {
	value *ReloadGroup200Response
	isSet bool
}

func (v NullableReloadGroup200Response) Get() *ReloadGroup200Response {
	return v.value
}

func (v *NullableReloadGroup200Response) Set(val *ReloadGroup200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadGroup200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadGroup200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadGroup200Response(val *ReloadGroup200Response) *NullableReloadGroup200Response {
	return &NullableReloadGroup200Response{value: val, isSet: true}
}

func (v NullableReloadGroup200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadGroup200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
