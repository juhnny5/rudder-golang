...
// checks if the DatasourceTypeParametersRequestMode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasourceTypeParametersRequestMode{}
...
func NewDatasourceTypeParametersRequestMode() *DatasourceTypeParametersRequestMode {
	this := DatasourceTypeParametersRequestMode{}
	return &this
}
...
func (o DatasourceTypeParametersRequestMode) MarshalJSON() ([]byte, error) {
...
func (o DatasourceTypeParametersRequestMode) ToMap() (map[string]interface{}, error) {
...
type NullableDatasourceTypeParametersRequestMode struct {
	value *DatasourceTypeParametersRequestMode
	isSet bool
}

func (v NullableDatasourceTypeParametersRequestMode) Get() *DatasourceTypeParametersRequestMode {
	return v.value
}

func (v *NullableDatasourceTypeParametersRequestMode) Set(val *DatasourceTypeParametersRequestMode) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasourceTypeParametersRequestMode) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasourceTypeParametersRequestMode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasourceTypeParametersRequestMode(val *DatasourceTypeParametersRequestMode) *NullableDatasourceTypeParametersRequestMode {
	return &NullableDatasourceTypeParametersRequestMode{value: val, isSet: true}
}

func (v NullableDatasourceTypeParametersRequestMode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasourceTypeParametersRequestMode) UnmarshalJSON(src []byte) error {
	v.isSet = true
