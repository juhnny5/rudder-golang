...
// checks if the ApiGeneralInformations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiGeneralInformations200Response{}

// ApiGeneralInformations200Response struct for ApiGeneralInformations200Response
type ApiGeneralInformations200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ApiGeneralInformations200ResponseData `json:"data"`
}

type _ApiGeneralInformations200Response ApiGeneralInformations200Response
...
func NewApiGeneralInformations200Response(result string, action string, data ApiGeneralInformations200ResponseData) *ApiGeneralInformations200Response {
	this := ApiGeneralInformations200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ApiGeneralInformations200Response) GetData() ApiGeneralInformations200ResponseData {
	if o == nil {
		var ret ApiGeneralInformations200ResponseData
		return ret
	}
...
func (o ApiGeneralInformations200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiGeneralInformations200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ApiGeneralInformations200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varApiGeneralInformations200Response := _ApiGeneralInformations200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiGeneralInformations200Response)

	if err != nil {
		return err
	}

	*o = ApiGeneralInformations200Response(varApiGeneralInformations200Response)

	return err
}

type NullableApiGeneralInformations200Response struct {
	value *ApiGeneralInformations200Response
	isSet bool
}

func (v NullableApiGeneralInformations200Response) Get() *ApiGeneralInformations200Response {
	return v.value
}

func (v *NullableApiGeneralInformations200Response) Set(val *ApiGeneralInformations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiGeneralInformations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiGeneralInformations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiGeneralInformations200Response(val *ApiGeneralInformations200Response) *NullableApiGeneralInformations200Response {
	return &NullableApiGeneralInformations200Response{value: val, isSet: true}
}

func (v NullableApiGeneralInformations200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiGeneralInformations200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
