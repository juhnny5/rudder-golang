...
// checks if the NodeFullPropertiesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullPropertiesInner{}

// NodeFullPropertiesInner struct for NodeFullPropertiesInner
type NodeFullPropertiesInner struct {
	// Property name
...
type _NodeFullPropertiesInner NodeFullPropertiesInner
...
func (o NodeFullPropertiesInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullPropertiesInner) ToMap() (map[string]interface{}, error) {
...
func (o *NodeFullPropertiesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeFullPropertiesInner := _NodeFullPropertiesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeFullPropertiesInner)

	if err != nil {
		return err
	}

	*o = NodeFullPropertiesInner(varNodeFullPropertiesInner)

	return err
}

type NullableNodeFullPropertiesInner struct {
	value *NodeFullPropertiesInner
	isSet bool
}

func (v NullableNodeFullPropertiesInner) Get() *NodeFullPropertiesInner {
	return v.value
}

func (v *NullableNodeFullPropertiesInner) Set(val *NodeFullPropertiesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullPropertiesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullPropertiesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullPropertiesInner(val *NodeFullPropertiesInner) *NullableNodeFullPropertiesInner {
	return &NullableNodeFullPropertiesInner{value: val, isSet: true}
}

func (v NullableNodeFullPropertiesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullPropertiesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
