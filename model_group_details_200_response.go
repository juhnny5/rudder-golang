...
// checks if the GroupDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupDetails200Response{}

// GroupDetails200Response struct for GroupDetails200Response
type GroupDetails200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ListGroups200ResponseData `json:"data"`
}

type _GroupDetails200Response GroupDetails200Response
...
func (o *GroupDetails200Response) GetData() ListGroups200ResponseData {
	if o == nil {
		var ret ListGroups200ResponseData
		return ret
	}
...
func (o GroupDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o GroupDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GroupDetails200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupDetails200Response := _GroupDetails200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupDetails200Response)

	if err != nil {
		return err
	}

	*o = GroupDetails200Response(varGroupDetails200Response)

	return err
}

type NullableGroupDetails200Response struct {
	value *GroupDetails200Response
	isSet bool
}

func (v NullableGroupDetails200Response) Get() *GroupDetails200Response {
	return v.value
}

func (v *NullableGroupDetails200Response) Set(val *GroupDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupDetails200Response(val *GroupDetails200Response) *NullableGroupDetails200Response {
	return &NullableGroupDetails200Response{value: val, isSet: true}
}

func (v NullableGroupDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
