...
// checks if the CreateArchive200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateArchive200ResponseData{}

// CreateArchive200ResponseData struct for CreateArchive200ResponseData
type CreateArchive200ResponseData struct {
	Full ListArchives200ResponseDataFullInner `json:"full"`
}

type _CreateArchive200ResponseData CreateArchive200ResponseData
...
func NewCreateArchive200ResponseData(full ListArchives200ResponseDataFullInner) *CreateArchive200ResponseData {
	this := CreateArchive200ResponseData{}
	this.Full = full
	return &this
}
...
func (o *CreateArchive200ResponseData) GetFull() ListArchives200ResponseDataFullInner {
	if o == nil {
		var ret ListArchives200ResponseDataFullInner
		return ret
	}
...
func (o CreateArchive200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CreateArchive200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["full"] = o.Full
	return toSerialize, nil
}

func (o *CreateArchive200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateArchive200ResponseData := _CreateArchive200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateArchive200ResponseData)

	if err != nil {
		return err
	}

	*o = CreateArchive200ResponseData(varCreateArchive200ResponseData)

	return err
}

type NullableCreateArchive200ResponseData struct {
	value *CreateArchive200ResponseData
	isSet bool
}

func (v NullableCreateArchive200ResponseData) Get() *CreateArchive200ResponseData {
	return v.value
}

func (v *NullableCreateArchive200ResponseData) Set(val *CreateArchive200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateArchive200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateArchive200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateArchive200ResponseData(val *CreateArchive200ResponseData) *NullableCreateArchive200ResponseData {
	return &NullableCreateArchive200ResponseData{value: val, isSet: true}
}

func (v NullableCreateArchive200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateArchive200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
