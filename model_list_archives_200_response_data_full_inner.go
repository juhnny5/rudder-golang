...
// checks if the ListArchives200ResponseDataFullInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListArchives200ResponseDataFullInner{}

// ListArchives200ResponseDataFullInner struct for ListArchives200ResponseDataFullInner
type ListArchives200ResponseDataFullInner struct {
	Commiter string `json:"commiter"`
	GitCommit string `json:"gitCommit"`
	Id string `json:"id"`
}

type _ListArchives200ResponseDataFullInner ListArchives200ResponseDataFullInner
...
func NewListArchives200ResponseDataFullInner(commiter string, gitCommit string, id string) *ListArchives200ResponseDataFullInner {
	this := ListArchives200ResponseDataFullInner{}
...
func (o ListArchives200ResponseDataFullInner) MarshalJSON() ([]byte, error) {
...
func (o ListArchives200ResponseDataFullInner) ToMap() (map[string]interface{}, error) {
...
func (o *ListArchives200ResponseDataFullInner) UnmarshalJSON(data []byte) (err error) {
	...
	varListArchives200ResponseDataFullInner := _ListArchives200ResponseDataFullInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListArchives200ResponseDataFullInner)

	if err != nil {
		return err
	}

	*o = ListArchives200ResponseDataFullInner(varListArchives200ResponseDataFullInner)

	return err
}

type NullableListArchives200ResponseDataFullInner struct {
	value *ListArchives200ResponseDataFullInner
	isSet bool
}

func (v NullableListArchives200ResponseDataFullInner) Get() *ListArchives200ResponseDataFullInner {
	return v.value
}

func (v *NullableListArchives200ResponseDataFullInner) Set(val *ListArchives200ResponseDataFullInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListArchives200ResponseDataFullInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListArchives200ResponseDataFullInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListArchives200ResponseDataFullInner(val *ListArchives200ResponseDataFullInner) *NullableListArchives200ResponseDataFullInner {
	return &NullableListArchives200ResponseDataFullInner{value: val, isSet: true}
}

func (v NullableListArchives200ResponseDataFullInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListArchives200ResponseDataFullInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
