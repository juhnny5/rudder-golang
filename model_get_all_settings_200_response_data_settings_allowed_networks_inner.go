...
// checks if the GetAllSettings200ResponseDataSettingsAllowedNetworksInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllSettings200ResponseDataSettingsAllowedNetworksInner{}

// GetAllSettings200ResponseDataSettingsAllowedNetworksInner struct for GetAllSettings200ResponseDataSettingsAllowedNetworksInner
type GetAllSettings200ResponseDataSettingsAllowedNetworksInner struct {
...
func NewGetAllSettings200ResponseDataSettingsAllowedNetworksInner() *GetAllSettings200ResponseDataSettingsAllowedNetworksInner {
	this := GetAllSettings200ResponseDataSettingsAllowedNetworksInner{}
	return &this
}
...
func (o GetAllSettings200ResponseDataSettingsAllowedNetworksInner) MarshalJSON() ([]byte, error) {
...
func (o GetAllSettings200ResponseDataSettingsAllowedNetworksInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner struct {
	value *GetAllSettings200ResponseDataSettingsAllowedNetworksInner
	isSet bool
}

func (v NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner) Get() *GetAllSettings200ResponseDataSettingsAllowedNetworksInner {
	return v.value
}

func (v *NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner) Set(val *GetAllSettings200ResponseDataSettingsAllowedNetworksInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner(val *GetAllSettings200ResponseDataSettingsAllowedNetworksInner) *NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner {
	return &NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner{value: val, isSet: true}
}

func (v NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllSettings200ResponseDataSettingsAllowedNetworksInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
