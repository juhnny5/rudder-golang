...
// checks if the CampaignStatusEnabled type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignStatusEnabled{}

// CampaignStatusEnabled Campaign status
type CampaignStatusEnabled struct {
...
func (o CampaignStatusEnabled) MarshalJSON() ([]byte, error) {
...
func (o CampaignStatusEnabled) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignStatusEnabled struct {
	value *CampaignStatusEnabled
	isSet bool
}

func (v NullableCampaignStatusEnabled) Get() *CampaignStatusEnabled {
	return v.value
}

func (v *NullableCampaignStatusEnabled) Set(val *CampaignStatusEnabled) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignStatusEnabled) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignStatusEnabled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignStatusEnabled(val *CampaignStatusEnabled) *NullableCampaignStatusEnabled {
	return &NullableCampaignStatusEnabled{value: val, isSet: true}
}

func (v NullableCampaignStatusEnabled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignStatusEnabled) UnmarshalJSON(src []byte) error {
	v.isSet = true
