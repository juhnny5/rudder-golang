...
// RuleTarget Node and special groups targeted by that rule
type RuleTarget string

// List of rule-target
const (
	SPECIALALL RuleTarget = "special:all"
	SPECIALALL_EXCEPT_POLICY_SERVERS RuleTarget = "special:all_exceptPolicyServers"
	SPECIALALL_POLICY_SERVERS RuleTarget = "special:all_policyServers"
	POLICY_SERVER__POLICY_SERVER_ID RuleTarget = "policyServer:${policyServerId}"
	GROUP__NODE_GROUP_ID RuleTarget = "group:${nodeGroupId}"
)
...
// Ptr returns reference to rule-target value
