...
// checks if the DeleteParameter200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteParameter200Response{}

// DeleteParameter200Response struct for DeleteParameter200Response
type DeleteParameter200Response struct {
...
type _DeleteParameter200Response DeleteParameter200Response
...
func NewDeleteParameter200Response(id string, result string, action string, data ListParameters200ResponseData) *DeleteParameter200Response {
	this := DeleteParameter200Response{}
	this.Id = id
	this.Result = result
	this.Action = action
	this.Data = data
...
func (o DeleteParameter200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteParameter200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteParameter200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteParameter200Response := _DeleteParameter200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteParameter200Response)

	if err != nil {
		return err
	}

	*o = DeleteParameter200Response(varDeleteParameter200Response)

	return err
}

type NullableDeleteParameter200Response struct {
	value *DeleteParameter200Response
	isSet bool
}

func (v NullableDeleteParameter200Response) Get() *DeleteParameter200Response {
	return v.value
}

func (v *NullableDeleteParameter200Response) Set(val *DeleteParameter200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteParameter200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteParameter200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteParameter200Response(val *DeleteParameter200Response) *NullableDeleteParameter200Response {
	return &NullableDeleteParameter200Response{value: val, isSet: true}
}

func (v NullableDeleteParameter200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteParameter200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
