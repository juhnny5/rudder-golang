...
// checks if the TechniqueCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueCategory{}

// TechniqueCategory struct for TechniqueCategory
type TechniqueCategory struct {
	// Category's name
	...
	Subcategories []TechniqueCategory `json:"subcategories"`
}

type _TechniqueCategory TechniqueCategory
...
func (o TechniqueCategory) MarshalJSON() ([]byte, error) {
...
func (o TechniqueCategory) ToMap() (map[string]interface{}, error) {
...
func (o *TechniqueCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varTechniqueCategory := _TechniqueCategory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTechniqueCategory)

	if err != nil {
		return err
	}

	*o = TechniqueCategory(varTechniqueCategory)

	return err
}

type NullableTechniqueCategory struct {
	value *TechniqueCategory
	isSet bool
}

func (v NullableTechniqueCategory) Get() *TechniqueCategory {
	return v.value
}

func (v *NullableTechniqueCategory) Set(val *TechniqueCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueCategory(val *TechniqueCategory) *NullableTechniqueCategory {
	return &NullableTechniqueCategory{value: val, isSet: true}
}

func (v NullableTechniqueCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
