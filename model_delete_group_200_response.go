...
// checks if the DeleteGroup200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteGroup200Response{}

// DeleteGroup200Response struct for DeleteGroup200Response
...
type _DeleteGroup200Response DeleteGroup200Response
...
func (o DeleteGroup200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteGroup200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteGroup200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteGroup200Response := _DeleteGroup200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteGroup200Response)

	if err != nil {
		return err
	}

	*o = DeleteGroup200Response(varDeleteGroup200Response)

	return err
}

type NullableDeleteGroup200Response struct {
	value *DeleteGroup200Response
	isSet bool
}

func (v NullableDeleteGroup200Response) Get() *DeleteGroup200Response {
	return v.value
}

func (v *NullableDeleteGroup200Response) Set(val *DeleteGroup200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteGroup200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteGroup200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteGroup200Response(val *DeleteGroup200Response) *NullableDeleteGroup200Response {
	return &NullableDeleteGroup200Response{value: val, isSet: true}
}

func (v NullableDeleteGroup200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteGroup200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
