...
// checks if the UpdateDataSource200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDataSource200Response{}

// UpdateDataSource200Response struct for UpdateDataSource200Response
type UpdateDataSource200Response struct {
...
type _UpdateDataSource200Response UpdateDataSource200Response
...
func NewUpdateDataSource200Response(result string, action string, data GetAllDataSources200ResponseData) *UpdateDataSource200Response {
	this := UpdateDataSource200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o UpdateDataSource200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateDataSource200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateDataSource200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDataSource200Response := _UpdateDataSource200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDataSource200Response)

	if err != nil {
		return err
	}

	*o = UpdateDataSource200Response(varUpdateDataSource200Response)

	return err
}

type NullableUpdateDataSource200Response struct {
	value *UpdateDataSource200Response
	isSet bool
}

func (v NullableUpdateDataSource200Response) Get() *UpdateDataSource200Response {
	return v.value
}

func (v *NullableUpdateDataSource200Response) Set(val *UpdateDataSource200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDataSource200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDataSource200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDataSource200Response(val *UpdateDataSource200Response) *NullableUpdateDataSource200Response {
	return &NullableUpdateDataSource200Response{value: val, isSet: true}
}

func (v NullableUpdateDataSource200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDataSource200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
