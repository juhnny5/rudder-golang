...
// GetDirectiveComplianceId200Response - struct for GetDirectiveComplianceId200Response
type GetDirectiveComplianceId200Response struct {
	*OsFile **os.File
	ComplianceDirectiveId *ComplianceDirectiveId
}

// *os.FileAsGetDirectiveComplianceId200Response is a convenience function that returns *os.File wrapped in GetDirectiveComplianceId200Response
func *OsFileAsGetDirectiveComplianceId200Response(v **os.File) GetDirectiveComplianceId200Response {
	return GetDirectiveComplianceId200Response{
		*OsFile: v,
	}
}

// ComplianceDirectiveIdAsGetDirectiveComplianceId200Response is a convenience function that returns ComplianceDirectiveId wrapped in GetDirectiveComplianceId200Response
func ComplianceDirectiveIdAsGetDirectiveComplianceId200Response(v *ComplianceDirectiveId) GetDirectiveComplianceId200Response {
	return GetDirectiveComplianceId200Response{
		ComplianceDirectiveId: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *GetDirectiveComplianceId200Response) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	// try to unmarshal data into ComplianceDirectiveId
	err = newStrictDecoder(data).Decode(&dst.ComplianceDirectiveId)
	if err == nil {
		jsonComplianceDirectiveId, _ := json.Marshal(dst.ComplianceDirectiveId)
		if string(jsonComplianceDirectiveId) == "{}" { // empty struct
			dst.ComplianceDirectiveId = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(GetDirectiveComplianceId200Response)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(GetDirectiveComplianceId200Response)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetDirectiveComplianceId200Response) MarshalJSON() ([]byte, error) {
	if src.*OsFile != nil {
		return json.Marshal(&src.*OsFile)
	}

	if src.ComplianceDirectiveId != nil {
		return json.Marshal(&src.ComplianceDirectiveId)
	}
...
func (obj *GetDirectiveComplianceId200Response) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.*OsFile != nil {
	...
	if obj.ComplianceDirectiveId != nil {
		return obj.ComplianceDirectiveId
	}
...
type NullableGetDirectiveComplianceId200Response struct {
	value *GetDirectiveComplianceId200Response
	isSet bool
}

func (v NullableGetDirectiveComplianceId200Response) Get() *GetDirectiveComplianceId200Response {
	return v.value
}

func (v *NullableGetDirectiveComplianceId200Response) Set(val *GetDirectiveComplianceId200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDirectiveComplianceId200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDirectiveComplianceId200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDirectiveComplianceId200Response(val *GetDirectiveComplianceId200Response) *NullableGetDirectiveComplianceId200Response {
	return &NullableGetDirectiveComplianceId200Response{value: val, isSet: true}
}

func (v NullableGetDirectiveComplianceId200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDirectiveComplianceId200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
