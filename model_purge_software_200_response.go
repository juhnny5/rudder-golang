...
// checks if the PurgeSoftware200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PurgeSoftware200Response{}

// PurgeSoftware200Response struct for PurgeSoftware200Response
type PurgeSoftware200Response struct {
...
type _PurgeSoftware200Response PurgeSoftware200Response
...
func (o PurgeSoftware200Response) MarshalJSON() ([]byte, error) {
...
func (o PurgeSoftware200Response) ToMap() (map[string]interface{}, error) {
...
func (o *PurgeSoftware200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPurgeSoftware200Response := _PurgeSoftware200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPurgeSoftware200Response)

	if err != nil {
		return err
	}

	*o = PurgeSoftware200Response(varPurgeSoftware200Response)

	return err
}

type NullablePurgeSoftware200Response struct {
	value *PurgeSoftware200Response
	isSet bool
}

func (v NullablePurgeSoftware200Response) Get() *PurgeSoftware200Response {
	return v.value
}

func (v *NullablePurgeSoftware200Response) Set(val *PurgeSoftware200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePurgeSoftware200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePurgeSoftware200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePurgeSoftware200Response(val *PurgeSoftware200Response) *NullablePurgeSoftware200Response {
	return &NullablePurgeSoftware200Response{value: val, isSet: true}
}

func (v NullablePurgeSoftware200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePurgeSoftware200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
