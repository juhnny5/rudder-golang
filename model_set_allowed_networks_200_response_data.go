...
// checks if the SetAllowedNetworks200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetAllowedNetworks200ResponseData{}

// SetAllowedNetworks200ResponseData Information about the allowed_networks settings
type SetAllowedNetworks200ResponseData struct {
	// Array of allowed networks
	Settings []string `json:"settings"`
}

type _SetAllowedNetworks200ResponseData SetAllowedNetworks200ResponseData
...
func NewSetAllowedNetworks200ResponseData(settings []string) *SetAllowedNetworks200ResponseData {
	this := SetAllowedNetworks200ResponseData{}
...
func (o SetAllowedNetworks200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o SetAllowedNetworks200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["settings"] = o.Settings
	return toSerialize, nil
}

func (o *SetAllowedNetworks200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varSetAllowedNetworks200ResponseData := _SetAllowedNetworks200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetAllowedNetworks200ResponseData)

	if err != nil {
		return err
	}

	*o = SetAllowedNetworks200ResponseData(varSetAllowedNetworks200ResponseData)

	return err
}

type NullableSetAllowedNetworks200ResponseData struct {
	value *SetAllowedNetworks200ResponseData
	isSet bool
}

func (v NullableSetAllowedNetworks200ResponseData) Get() *SetAllowedNetworks200ResponseData {
	return v.value
}

func (v *NullableSetAllowedNetworks200ResponseData) Set(val *SetAllowedNetworks200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableSetAllowedNetworks200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableSetAllowedNetworks200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetAllowedNetworks200ResponseData(val *SetAllowedNetworks200ResponseData) *NullableSetAllowedNetworks200ResponseData {
	return &NullableSetAllowedNetworks200ResponseData{value: val, isSet: true}
}

func (v NullableSetAllowedNetworks200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetAllowedNetworks200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
