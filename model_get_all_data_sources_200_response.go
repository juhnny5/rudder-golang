...
// checks if the GetAllDataSources200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllDataSources200Response{}

// GetAllDataSources200Response struct for GetAllDataSources200Response
type GetAllDataSources200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetAllDataSources200ResponseData `json:"data"`
}

type _GetAllDataSources200Response GetAllDataSources200Response
...
func NewGetAllDataSources200Response(result string, action string, data GetAllDataSources200ResponseData) *GetAllDataSources200Response {
	this := GetAllDataSources200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetAllDataSources200Response) GetData() GetAllDataSources200ResponseData {
	if o == nil {
		var ret GetAllDataSources200ResponseData
		return ret
	}
...
func (o GetAllDataSources200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAllDataSources200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAllDataSources200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllDataSources200Response := _GetAllDataSources200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllDataSources200Response)

	if err != nil {
		return err
	}

	*o = GetAllDataSources200Response(varGetAllDataSources200Response)

	return err
}

type NullableGetAllDataSources200Response struct {
	value *GetAllDataSources200Response
	isSet bool
}

func (v NullableGetAllDataSources200Response) Get() *GetAllDataSources200Response {
	return v.value
}

func (v *NullableGetAllDataSources200Response) Set(val *GetAllDataSources200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllDataSources200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllDataSources200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllDataSources200Response(val *GetAllDataSources200Response) *NullableGetAllDataSources200Response {
	return &NullableGetAllDataSources200Response{value: val, isSet: true}
}

func (v NullableGetAllDataSources200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllDataSources200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
