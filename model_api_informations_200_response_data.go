...
// checks if the ApiInformations200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiInformations200ResponseData{}

// ApiInformations200ResponseData struct for ApiInformations200ResponseData
type ApiInformations200ResponseData struct {
	// Link to Rudder API description
	Documentation string `json:"documentation"`
	// The endpoint name as key and the endpoint description as value
	EndpointName string `json:"endpointName"`
	Endpoints []ApiInformations200ResponseDataEndpointsInner `json:"endpoints"`
}

type _ApiInformations200ResponseData ApiInformations200ResponseData
...
func NewApiInformations200ResponseData(documentation string, endpointName string, endpoints []ApiInformations200ResponseDataEndpointsInner) *ApiInformations200ResponseData {
	this := ApiInformations200ResponseData{}
...
func (o *ApiInformations200ResponseData) GetEndpoints() []ApiInformations200ResponseDataEndpointsInner {
	if o == nil {
		var ret []ApiInformations200ResponseDataEndpointsInner
		return ret
	}
...
func (o ApiInformations200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ApiInformations200ResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *ApiInformations200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varApiInformations200ResponseData := _ApiInformations200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiInformations200ResponseData)

	if err != nil {
		return err
	}

	*o = ApiInformations200ResponseData(varApiInformations200ResponseData)

	return err
}

type NullableApiInformations200ResponseData struct {
	value *ApiInformations200ResponseData
	isSet bool
}

func (v NullableApiInformations200ResponseData) Get() *ApiInformations200ResponseData {
	return v.value
}

func (v *NullableApiInformations200ResponseData) Set(val *ApiInformations200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableApiInformations200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableApiInformations200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiInformations200ResponseData(val *ApiInformations200ResponseData) *NullableApiInformations200ResponseData {
	return &NullableApiInformations200ResponseData{value: val, isSet: true}
}

func (v NullableApiInformations200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiInformations200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
