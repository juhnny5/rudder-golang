...
// GetUpdateTimeout returns the UpdateTimeout field value if set, zero value otherwise.
func (o *Datasource) GetUpdateTimeout() int32 {
	if o == nil || IsNil(o.UpdateTimeout) {
		var ret int32
		return ret
	}
...
// GetUpdateTimeoutOk returns a tuple with the UpdateTimeout field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Datasource) GetUpdateTimeoutOk() (*int32, bool) {
	if o == nil || IsNil(o.UpdateTimeout) {
		return nil, false
	}
	return o.UpdateTimeout, true
}
...
// SetUpdateTimeout gets a reference to the given int32 and assigns it to the UpdateTimeout field.
func (o *Datasource) SetUpdateTimeout(v int32) {
	o.UpdateTimeout = &v
}

// GetRunParameters returns the RunParameters field value if set, zero value otherwise.
func (o *Datasource) GetRunParameters() DatasourceRunParameters {
	if o == nil || IsNil(o.RunParameters) {
		var ret DatasourceRunParameters
		return ret
	}
	return *o.RunParameters
}

// GetRunParametersOk returns a tuple with the RunParameters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Datasource) GetRunParametersOk() (*DatasourceRunParameters, bool) {
	if o == nil || IsNil(o.RunParameters) {
		return nil, false
	}
	return o.RunParameters, true
}
...
// SetRunParameters gets a reference to the given DatasourceRunParameters and assigns it to the RunParameters field.
...
func (o Datasource) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UpdateTimeout) {
		toSerialize["updateTimeout"] = o.UpdateTimeout
	}
	if !IsNil(o.RunParameters) {
		toSerialize["runParameters"] = o.RunParameters
	}
	if !IsNil(o.Type) {
