...
// checks if the RuleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleStatus{}

// RuleStatus struct for RuleStatus
...
func (o RuleStatus) MarshalJSON() ([]byte, error) {
...
func (o RuleStatus) ToMap() (map[string]interface{}, error) {
