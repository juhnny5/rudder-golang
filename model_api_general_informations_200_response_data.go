...
// checks if the ApiGeneralInformations200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiGeneralInformations200ResponseData{}

// ApiGeneralInformations200ResponseData struct for ApiGeneralInformations200ResponseData
type ApiGeneralInformations200ResponseData struct {
	// Link to Rudder API description
	Documentation string `json:"documentation"`
	AvailableVersions []ApiVersions `json:"availableVersions"`
	Endpoints [][]ApiEndpointsInner `json:"endpoints"`
}

type _ApiGeneralInformations200ResponseData ApiGeneralInformations200ResponseData
...
func NewApiGeneralInformations200ResponseData(documentation string, availableVersions []ApiVersions, endpoints [][]ApiEndpointsInner) *ApiGeneralInformations200ResponseData {
	this := ApiGeneralInformations200ResponseData{}
...
func (o ApiGeneralInformations200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ApiGeneralInformations200ResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *ApiGeneralInformations200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varApiGeneralInformations200ResponseData := _ApiGeneralInformations200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiGeneralInformations200ResponseData)

	if err != nil {
		return err
	}

	*o = ApiGeneralInformations200ResponseData(varApiGeneralInformations200ResponseData)

	return err
}

type NullableApiGeneralInformations200ResponseData struct {
	value *ApiGeneralInformations200ResponseData
	isSet bool
}

func (v NullableApiGeneralInformations200ResponseData) Get() *ApiGeneralInformations200ResponseData {
	return v.value
}

func (v *NullableApiGeneralInformations200ResponseData) Set(val *ApiGeneralInformations200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableApiGeneralInformations200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableApiGeneralInformations200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiGeneralInformations200ResponseData(val *ApiGeneralInformations200ResponseData) *NullableApiGeneralInformations200ResponseData {
	return &NullableApiGeneralInformations200ResponseData{value: val, isSet: true}
}

func (v NullableApiGeneralInformations200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiGeneralInformations200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
