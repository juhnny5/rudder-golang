...
// checks if the CreateNodes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNodes200Response{}

// CreateNodes200Response struct for CreateNodes200Response
type CreateNodes200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data CreateNodes200ResponseData `json:"data"`
}

type _CreateNodes200Response CreateNodes200Response
...
func (o *CreateNodes200Response) GetData() CreateNodes200ResponseData {
	if o == nil {
		var ret CreateNodes200ResponseData
		return ret
	}
...
func (o CreateNodes200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateNodes200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateNodes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNodes200Response := _CreateNodes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNodes200Response)

	if err != nil {
		return err
	}

	*o = CreateNodes200Response(varCreateNodes200Response)

	return err
}

type NullableCreateNodes200Response struct {
	value *CreateNodes200Response
	isSet bool
}

func (v NullableCreateNodes200Response) Get() *CreateNodes200Response {
	return v.value
}

func (v *NullableCreateNodes200Response) Set(val *CreateNodes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNodes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNodes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNodes200Response(val *CreateNodes200Response) *NullableCreateNodes200Response {
	return &NullableCreateNodes200Response{value: val, isSet: true}
}

func (v NullableCreateNodes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNodes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
