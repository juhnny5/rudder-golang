...
// checks if the SetAllowedNetworksRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetAllowedNetworksRequest{}

// SetAllowedNetworksRequest struct for SetAllowedNetworksRequest
...
func NewSetAllowedNetworksRequest() *SetAllowedNetworksRequest {
	this := SetAllowedNetworksRequest{}
	return &this
}
...
func (o SetAllowedNetworksRequest) MarshalJSON() ([]byte, error) {
...
func (o SetAllowedNetworksRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSetAllowedNetworksRequest struct {
	value *SetAllowedNetworksRequest
	isSet bool
}

func (v NullableSetAllowedNetworksRequest) Get() *SetAllowedNetworksRequest {
	return v.value
}

func (v *NullableSetAllowedNetworksRequest) Set(val *SetAllowedNetworksRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetAllowedNetworksRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetAllowedNetworksRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetAllowedNetworksRequest(val *SetAllowedNetworksRequest) *NullableSetAllowedNetworksRequest {
	return &NullableSetAllowedNetworksRequest{value: val, isSet: true}
}

func (v NullableSetAllowedNetworksRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetAllowedNetworksRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
