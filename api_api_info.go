...
type ApiApiGeneralInformationsRequest struct {
	ctx context.Context
	ApiService *APIInfoAPIService
}

func (r ApiApiGeneralInformationsRequest) Execute() (*ApiGeneralInformations200Response, *http.Response, error) {
	return r.ApiService.ApiGeneralInformationsExecute(r)
}
...
List all endpoints and their version
 ...
 @return ApiApiGeneralInformationsRequest
*/
func (a *APIInfoAPIService) ApiGeneralInformations(ctx context.Context) ApiApiGeneralInformationsRequest {
	return ApiApiGeneralInformationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return ApiGeneralInformations200Response
func (a *APIInfoAPIService) ApiGeneralInformationsExecute(r ApiApiGeneralInformationsRequest) (*ApiGeneralInformations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiGeneralInformations200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "APIInfoAPIService.ApiGeneralInformations")
	if err != nil {
...
type ApiApiInformationsRequest struct {
	ctx context.Context
	ApiService *APIInfoAPIService
	endpointName string
}

func (r ApiApiInformationsRequest) Execute() (*ApiInformations200Response, *http.Response, error) {
	return r.ApiService.ApiInformationsExecute(r)
}
...
Get the description and the list of supported version for one API endpoint
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param endpointName Name of the endpoint for which one wants information
 @return ApiApiInformationsRequest
*/
func (a *APIInfoAPIService) ApiInformations(ctx context.Context, endpointName string) ApiApiInformationsRequest {
	return ApiApiInformationsRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return ApiInformations200Response
func (a *APIInfoAPIService) ApiInformationsExecute(r ApiApiInformationsRequest) (*ApiInformations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiInformations200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "APIInfoAPIService.ApiInformations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/info/details/{endpointName}"
	localVarPath = strings.Replace(localVarPath, "{"+"endpointName"+"}", url.PathEscape(parameterValueToString(r.endpointName, "endpointName")), -1)
...
type ApiApiSubInformationsRequest struct {
	ctx context.Context
	ApiService *APIInfoAPIService
	sectionId string
}

func (r ApiApiSubInformationsRequest) Execute() (*ApiSubInformations200Response, *http.Response, error) {
	return r.ApiService.ApiSubInformationsExecute(r)
}
...
Get all endpoints in the given section with their supported version.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param sectionId Id of the API section
 @return ApiApiSubInformationsRequest
*/
func (a *APIInfoAPIService) ApiSubInformations(ctx context.Context, sectionId string) ApiApiSubInformationsRequest {
	return ApiApiSubInformationsRequest{
		ApiService: a,
		ctx: ctx,
		sectionId: sectionId,
...
// Execute executes the request
//  @return ApiSubInformations200Response
func (a *APIInfoAPIService) ApiSubInformationsExecute(r ApiApiSubInformationsRequest) (*ApiSubInformations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiSubInformations200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "APIInfoAPIService.ApiSubInformations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/info/{sectionId}"
