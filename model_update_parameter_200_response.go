...
// checks if the UpdateParameter200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateParameter200Response{}

// UpdateParameter200Response struct for UpdateParameter200Response
type UpdateParameter200Response struct {
...
type _UpdateParameter200Response UpdateParameter200Response
...
func NewUpdateParameter200Response(id string, result string, action string, data ListParameters200ResponseData) *UpdateParameter200Response {
	this := UpdateParameter200Response{}
	this.Id = id
	this.Result = result
	this.Action = action
	this.Data = data
...
func (o UpdateParameter200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateParameter200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateParameter200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateParameter200Response := _UpdateParameter200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateParameter200Response)

	if err != nil {
		return err
	}

	*o = UpdateParameter200Response(varUpdateParameter200Response)

	return err
}

type NullableUpdateParameter200Response struct {
	value *UpdateParameter200Response
	isSet bool
}

func (v NullableUpdateParameter200Response) Get() *UpdateParameter200Response {
	return v.value
}

func (v *NullableUpdateParameter200Response) Set(val *UpdateParameter200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateParameter200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateParameter200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateParameter200Response(val *UpdateParameter200Response) *NullableUpdateParameter200Response {
	return &NullableUpdateParameter200Response{value: val, isSet: true}
}

func (v NullableUpdateParameter200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateParameter200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
