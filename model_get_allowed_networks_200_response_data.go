...
// checks if the GetAllowedNetworks200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllowedNetworks200ResponseData{}

// GetAllowedNetworks200ResponseData Information about the allowed_networks settings
type GetAllowedNetworks200ResponseData struct {
	// Array of allowed networks
	AllowedNetwork []string `json:"allowed_network"`
}

type _GetAllowedNetworks200ResponseData GetAllowedNetworks200ResponseData
...
func NewGetAllowedNetworks200ResponseData(allowedNetwork []string) *GetAllowedNetworks200ResponseData {
	this := GetAllowedNetworks200ResponseData{}
...
// GetAllowedNetwork returns the AllowedNetwork field value
...
// GetAllowedNetworkOk returns a tuple with the AllowedNetwork field value
// and a boolean to check if the value has been set.
func (o *GetAllowedNetworks200ResponseData) GetAllowedNetworkOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.AllowedNetwork, true
}

// SetAllowedNetwork sets field value
func (o *GetAllowedNetworks200ResponseData) SetAllowedNetwork(v []string) {
	o.AllowedNetwork = v
}

func (o GetAllowedNetworks200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetAllowedNetworks200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["allowed_network"] = o.AllowedNetwork
	return toSerialize, nil
}

func (o *GetAllowedNetworks200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllowedNetworks200ResponseData := _GetAllowedNetworks200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllowedNetworks200ResponseData)

	if err != nil {
		return err
	}

	*o = GetAllowedNetworks200ResponseData(varGetAllowedNetworks200ResponseData)

	return err
}

type NullableGetAllowedNetworks200ResponseData struct {
	value *GetAllowedNetworks200ResponseData
	isSet bool
}

func (v NullableGetAllowedNetworks200ResponseData) Get() *GetAllowedNetworks200ResponseData {
	return v.value
}

func (v *NullableGetAllowedNetworks200ResponseData) Set(val *GetAllowedNetworks200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllowedNetworks200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllowedNetworks200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllowedNetworks200ResponseData(val *GetAllowedNetworks200ResponseData) *NullableGetAllowedNetworks200ResponseData {
	return &NullableGetAllowedNetworks200ResponseData{value: val, isSet: true}
}

func (v NullableGetAllowedNetworks200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllowedNetworks200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
