...
// checks if the UpdateGroupCategory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGroupCategory200Response{}

// UpdateGroupCategory200Response struct for UpdateGroupCategory200Response
type UpdateGroupCategory200Response struct {
...
type _UpdateGroupCategory200Response UpdateGroupCategory200Response
...
func NewUpdateGroupCategory200Response(result string, action string, data CreateGroupCategory200ResponseData) *UpdateGroupCategory200Response {
	this := UpdateGroupCategory200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o UpdateGroupCategory200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateGroupCategory200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateGroupCategory200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateGroupCategory200Response := _UpdateGroupCategory200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateGroupCategory200Response)

	if err != nil {
		return err
	}

	*o = UpdateGroupCategory200Response(varUpdateGroupCategory200Response)

	return err
}

type NullableUpdateGroupCategory200Response struct {
	value *UpdateGroupCategory200Response
	isSet bool
}

func (v NullableUpdateGroupCategory200Response) Get() *UpdateGroupCategory200Response {
	return v.value
}

func (v *NullableUpdateGroupCategory200Response) Set(val *UpdateGroupCategory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateGroupCategory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateGroupCategory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateGroupCategory200Response(val *UpdateGroupCategory200Response) *NullableUpdateGroupCategory200Response {
	return &NullableUpdateGroupCategory200Response{value: val, isSet: true}
}

func (v NullableUpdateGroupCategory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateGroupCategory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
