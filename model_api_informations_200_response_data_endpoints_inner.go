...
// checks if the ApiInformations200ResponseDataEndpointsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiInformations200ResponseDataEndpointsInner{}

// ApiInformations200ResponseDataEndpointsInner Supported path and version for that endpoint
type ApiInformations200ResponseDataEndpointsInner struct {
...
func NewApiInformations200ResponseDataEndpointsInner() *ApiInformations200ResponseDataEndpointsInner {
	this := ApiInformations200ResponseDataEndpointsInner{}
	return &this
}
...
// GetHttpVerb returns the HttpVerb field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetHttpVerb gets a reference to the given interface{} and assigns it to the HttpVerb field.
...
// SetVersion gets a reference to the given ApiVersion and assigns it to the Version field.
func (o *ApiInformations200ResponseDataEndpointsInner) SetVersion(v ApiVersion) {
	o.Version = &v
}

func (o ApiInformations200ResponseDataEndpointsInner) MarshalJSON() ([]byte, error) {
...
func (o ApiInformations200ResponseDataEndpointsInner) ToMap() (map[string]interface{}, error) {
...
type NullableApiInformations200ResponseDataEndpointsInner struct {
	value *ApiInformations200ResponseDataEndpointsInner
	isSet bool
}

func (v NullableApiInformations200ResponseDataEndpointsInner) Get() *ApiInformations200ResponseDataEndpointsInner {
	return v.value
}

func (v *NullableApiInformations200ResponseDataEndpointsInner) Set(val *ApiInformations200ResponseDataEndpointsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiInformations200ResponseDataEndpointsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiInformations200ResponseDataEndpointsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiInformations200ResponseDataEndpointsInner(val *ApiInformations200ResponseDataEndpointsInner) *NullableApiInformations200ResponseDataEndpointsInner {
	return &NullableApiInformations200ResponseDataEndpointsInner{value: val, isSet: true}
}

func (v NullableApiInformations200ResponseDataEndpointsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiInformations200ResponseDataEndpointsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
