...
// checks if the GetTechniquesResources200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTechniquesResources200Response{}

// GetTechniquesResources200Response struct for GetTechniquesResources200Response
type GetTechniquesResources200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetTechniquesResources200ResponseData `json:"data"`
}

type _GetTechniquesResources200Response GetTechniquesResources200Response
...
func NewGetTechniquesResources200Response(result string, action string, data GetTechniquesResources200ResponseData) *GetTechniquesResources200Response {
	this := GetTechniquesResources200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetTechniquesResources200Response) GetData() GetTechniquesResources200ResponseData {
	if o == nil {
		var ret GetTechniquesResources200ResponseData
		return ret
	}
...
func (o GetTechniquesResources200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTechniquesResources200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetTechniquesResources200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTechniquesResources200Response := _GetTechniquesResources200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTechniquesResources200Response)

	if err != nil {
		return err
	}

	*o = GetTechniquesResources200Response(varGetTechniquesResources200Response)

	return err
}

type NullableGetTechniquesResources200Response struct {
	value *GetTechniquesResources200Response
	isSet bool
}

func (v NullableGetTechniquesResources200Response) Get() *GetTechniquesResources200Response {
	return v.value
}

func (v *NullableGetTechniquesResources200Response) Set(val *GetTechniquesResources200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTechniquesResources200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTechniquesResources200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTechniquesResources200Response(val *GetTechniquesResources200Response) *NullableGetTechniquesResources200Response {
	return &NullableGetTechniquesResources200Response{value: val, isSet: true}
}

func (v NullableGetTechniquesResources200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTechniquesResources200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
