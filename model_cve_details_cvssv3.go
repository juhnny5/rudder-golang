...
// checks if the CveDetailsCvssv3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CveDetailsCvssv3{}
...
func (o CveDetailsCvssv3) MarshalJSON() ([]byte, error) {
...
func (o CveDetailsCvssv3) ToMap() (map[string]interface{}, error) {
...
type NullableCveDetailsCvssv3 struct {
	value *CveDetailsCvssv3
	isSet bool
}

func (v NullableCveDetailsCvssv3) Get() *CveDetailsCvssv3 {
	return v.value
}

func (v *NullableCveDetailsCvssv3) Set(val *CveDetailsCvssv3) {
	v.value = val
	v.isSet = true
}

func (v NullableCveDetailsCvssv3) IsSet() bool {
	return v.isSet
}

func (v *NullableCveDetailsCvssv3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCveDetailsCvssv3(val *CveDetailsCvssv3) *NullableCveDetailsCvssv3 {
	return &NullableCveDetailsCvssv3{value: val, isSet: true}
}

func (v NullableCveDetailsCvssv3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCveDetailsCvssv3) UnmarshalJSON(src []byte) error {
	v.isSet = true
