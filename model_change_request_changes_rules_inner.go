...
// checks if the ChangeRequestChangesRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeRequestChangesRulesInner{}

// ChangeRequestChangesRulesInner struct for ChangeRequestChangesRulesInner
type ChangeRequestChangesRulesInner struct {
...
func NewChangeRequestChangesRulesInner() *ChangeRequestChangesRulesInner {
	this := ChangeRequestChangesRulesInner{}
	return &this
}
...
func (o ChangeRequestChangesRulesInner) MarshalJSON() ([]byte, error) {
...
func (o ChangeRequestChangesRulesInner) ToMap() (map[string]interface{}, error) {
...
type NullableChangeRequestChangesRulesInner struct {
	value *ChangeRequestChangesRulesInner
	isSet bool
}

func (v NullableChangeRequestChangesRulesInner) Get() *ChangeRequestChangesRulesInner {
	return v.value
}

func (v *NullableChangeRequestChangesRulesInner) Set(val *ChangeRequestChangesRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeRequestChangesRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeRequestChangesRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeRequestChangesRulesInner(val *ChangeRequestChangesRulesInner) *NullableChangeRequestChangesRulesInner {
	return &NullableChangeRequestChangesRulesInner{value: val, isSet: true}
}

func (v NullableChangeRequestChangesRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeRequestChangesRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
