...
// checks if the FileWatcherStop200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileWatcherStop200Response{}

// FileWatcherStop200Response struct for FileWatcherStop200Response
type FileWatcherStop200Response struct {
...
type _FileWatcherStop200Response FileWatcherStop200Response
...
func NewFileWatcherStop200Response(result string, action string, data string) *FileWatcherStop200Response {
	this := FileWatcherStop200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o FileWatcherStop200Response) MarshalJSON() ([]byte, error) {
...
func (o FileWatcherStop200Response) ToMap() (map[string]interface{}, error) {
...
func (o *FileWatcherStop200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varFileWatcherStop200Response := _FileWatcherStop200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFileWatcherStop200Response)

	if err != nil {
		return err
	}

	*o = FileWatcherStop200Response(varFileWatcherStop200Response)

	return err
}

type NullableFileWatcherStop200Response struct {
	value *FileWatcherStop200Response
	isSet bool
}

func (v NullableFileWatcherStop200Response) Get() *FileWatcherStop200Response {
	return v.value
}

func (v *NullableFileWatcherStop200Response) Set(val *FileWatcherStop200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFileWatcherStop200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFileWatcherStop200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileWatcherStop200Response(val *FileWatcherStop200Response) *NullableFileWatcherStop200Response {
	return &NullableFileWatcherStop200Response{value: val, isSet: true}
}

func (v NullableFileWatcherStop200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileWatcherStop200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
