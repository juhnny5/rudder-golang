...
// checks if the CategoriesTree type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoriesTree{}

// CategoriesTree struct for CategoriesTree
...
type _CategoriesTree CategoriesTree
...
func (o CategoriesTree) MarshalJSON() ([]byte, error) {
...
func (o CategoriesTree) ToMap() (map[string]interface{}, error) {
...
func (o *CategoriesTree) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoriesTree := _CategoriesTree{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCategoriesTree)

	if err != nil {
		return err
	}

	*o = CategoriesTree(varCategoriesTree)

	return err
}

type NullableCategoriesTree struct {
	value *CategoriesTree
	isSet bool
}

func (v NullableCategoriesTree) Get() *CategoriesTree {
	return v.value
}

func (v *NullableCategoriesTree) Set(val *CategoriesTree) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoriesTree) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoriesTree) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoriesTree(val *CategoriesTree) *NullableCategoriesTree {
	return &NullableCategoriesTree{value: val, isSet: true}
}

func (v NullableCategoriesTree) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoriesTree) UnmarshalJSON(src []byte) error {
	v.isSet = true
