...
// checks if the ChangeRequestDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeRequestDetails200Response{}

// ChangeRequestDetails200Response struct for ChangeRequestDetails200Response
type ChangeRequestDetails200Response struct {
...
type _ChangeRequestDetails200Response ChangeRequestDetails200Response
...
func NewChangeRequestDetails200Response(result string, action string, data ListChangeRequests200ResponseData) *ChangeRequestDetails200Response {
	this := ChangeRequestDetails200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ChangeRequestDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o ChangeRequestDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ChangeRequestDetails200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varChangeRequestDetails200Response := _ChangeRequestDetails200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChangeRequestDetails200Response)

	if err != nil {
		return err
	}

	*o = ChangeRequestDetails200Response(varChangeRequestDetails200Response)

	return err
}

type NullableChangeRequestDetails200Response struct {
	value *ChangeRequestDetails200Response
	isSet bool
}

func (v NullableChangeRequestDetails200Response) Get() *ChangeRequestDetails200Response {
	return v.value
}

func (v *NullableChangeRequestDetails200Response) Set(val *ChangeRequestDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeRequestDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeRequestDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeRequestDetails200Response(val *ChangeRequestDetails200Response) *NullableChangeRequestDetails200Response {
	return &NullableChangeRequestDetails200Response{value: val, isSet: true}
}

func (v NullableChangeRequestDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeRequestDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
