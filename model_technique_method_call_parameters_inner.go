...
// checks if the TechniqueMethodCallParametersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueMethodCallParametersInner{}

// TechniqueMethodCallParametersInner struct for TechniqueMethodCallParametersInner
type TechniqueMethodCallParametersInner struct {
	// Parameter name
...
func NewTechniqueMethodCallParametersInner() *TechniqueMethodCallParametersInner {
	this := TechniqueMethodCallParametersInner{}
	return &this
}
...
func (o TechniqueMethodCallParametersInner) MarshalJSON() ([]byte, error) {
...
func (o TechniqueMethodCallParametersInner) ToMap() (map[string]interface{}, error) {
...
type NullableTechniqueMethodCallParametersInner struct {
	value *TechniqueMethodCallParametersInner
	isSet bool
}

func (v NullableTechniqueMethodCallParametersInner) Get() *TechniqueMethodCallParametersInner {
	return v.value
}

func (v *NullableTechniqueMethodCallParametersInner) Set(val *TechniqueMethodCallParametersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueMethodCallParametersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueMethodCallParametersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueMethodCallParametersInner(val *TechniqueMethodCallParametersInner) *NullableTechniqueMethodCallParametersInner {
	return &NullableTechniqueMethodCallParametersInner{value: val, isSet: true}
}

func (v NullableTechniqueMethodCallParametersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueMethodCallParametersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
