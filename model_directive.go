...
// checks if the Directive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Directive{}
...
func (o Directive) ToMap() (map[string]interface{}, error) {
