...
// checks if the CveCheckPackagesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CveCheckPackagesInner{}

// CveCheckPackagesInner Packages affected by this CVE
type CveCheckPackagesInner struct {
...
func (o CveCheckPackagesInner) MarshalJSON() ([]byte, error) {
...
func (o CveCheckPackagesInner) ToMap() (map[string]interface{}, error) {
...
type NullableCveCheckPackagesInner struct {
	value *CveCheckPackagesInner
	isSet bool
}

func (v NullableCveCheckPackagesInner) Get() *CveCheckPackagesInner {
	return v.value
}

func (v *NullableCveCheckPackagesInner) Set(val *CveCheckPackagesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCveCheckPackagesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCveCheckPackagesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCveCheckPackagesInner(val *CveCheckPackagesInner) *NullableCveCheckPackagesInner {
	return &NullableCveCheckPackagesInner{value: val, isSet: true}
}

func (v NullableCveCheckPackagesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCveCheckPackagesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
