...
// checks if the ListDirectives200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDirectives200Response{}

// ListDirectives200Response struct for ListDirectives200Response
type ListDirectives200Response struct {
...
type _ListDirectives200Response ListDirectives200Response
...
func NewListDirectives200Response(result string, action string, data ListDirectives200ResponseData) *ListDirectives200Response {
	this := ListDirectives200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ListDirectives200Response) MarshalJSON() ([]byte, error) {
...
func (o ListDirectives200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListDirectives200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDirectives200Response := _ListDirectives200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListDirectives200Response)

	if err != nil {
		return err
	}

	*o = ListDirectives200Response(varListDirectives200Response)

	return err
}

type NullableListDirectives200Response struct {
	value *ListDirectives200Response
	isSet bool
}

func (v NullableListDirectives200Response) Get() *ListDirectives200Response {
	return v.value
}

func (v *NullableListDirectives200Response) Set(val *ListDirectives200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDirectives200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDirectives200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDirectives200Response(val *ListDirectives200Response) *NullableListDirectives200Response {
	return &NullableListDirectives200Response{value: val, isSet: true}
}

func (v NullableListDirectives200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDirectives200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
