...
// checks if the UpdateRule200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateRule200Response{}

// UpdateRule200Response struct for UpdateRule200Response
type UpdateRule200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data UpdateRule200ResponseData `json:"data"`
}

type _UpdateRule200Response UpdateRule200Response
...
func (o *UpdateRule200Response) GetData() UpdateRule200ResponseData {
	if o == nil {
		var ret UpdateRule200ResponseData
		return ret
	}
...
func (o UpdateRule200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateRule200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateRule200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateRule200Response := _UpdateRule200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateRule200Response)

	if err != nil {
		return err
	}

	*o = UpdateRule200Response(varUpdateRule200Response)

	return err
}

type NullableUpdateRule200Response struct {
	value *UpdateRule200Response
	isSet bool
}

func (v NullableUpdateRule200Response) Get() *UpdateRule200Response {
	return v.value
}

func (v *NullableUpdateRule200Response) Set(val *UpdateRule200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRule200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRule200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRule200Response(val *UpdateRule200Response) *NullableUpdateRule200Response {
	return &NullableUpdateRule200Response{value: val, isSet: true}
}

func (v NullableUpdateRule200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRule200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
