...
// checks if the GetAllDataSources200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllDataSources200ResponseData{}

// GetAllDataSources200ResponseData struct for GetAllDataSources200ResponseData
type GetAllDataSources200ResponseData struct {
	Datasources []Datasource `json:"datasources"`
}

type _GetAllDataSources200ResponseData GetAllDataSources200ResponseData
...
func NewGetAllDataSources200ResponseData(datasources []Datasource) *GetAllDataSources200ResponseData {
	this := GetAllDataSources200ResponseData{}
...
func (o GetAllDataSources200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetAllDataSources200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["datasources"] = o.Datasources
	return toSerialize, nil
}

func (o *GetAllDataSources200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllDataSources200ResponseData := _GetAllDataSources200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllDataSources200ResponseData)

	if err != nil {
		return err
	}

	*o = GetAllDataSources200ResponseData(varGetAllDataSources200ResponseData)

	return err
}

type NullableGetAllDataSources200ResponseData struct {
	value *GetAllDataSources200ResponseData
	isSet bool
}

func (v NullableGetAllDataSources200ResponseData) Get() *GetAllDataSources200ResponseData {
	return v.value
}

func (v *NullableGetAllDataSources200ResponseData) Set(val *GetAllDataSources200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllDataSources200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllDataSources200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllDataSources200ResponseData(val *GetAllDataSources200ResponseData) *NullableGetAllDataSources200ResponseData {
	return &NullableGetAllDataSources200ResponseData{value: val, isSet: true}
}

func (v NullableGetAllDataSources200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllDataSources200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
