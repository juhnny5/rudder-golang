...
func (r ApiCreateParameterRequest) Parameter(parameter Parameter) ApiCreateParameterRequest {
	r.parameter = &parameter
	return r
}

func (r ApiCreateParameterRequest) Execute() (*CreateParameter200Response, *http.Response, error) {
	return r.ApiService.CreateParameterExecute(r)
}

/*
CreateParameter Create a new property
...
//  @return CreateParameter200Response
func (a *ParametersAPIService) CreateParameterExecute(r ApiCreateParameterRequest) (*CreateParameter200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateParameter200Response
	)
...
func (r ApiDeleteParameterRequest) Execute() (*DeleteParameter200Response, *http.Response, error) {
...
Delete an existing global parameter
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param parameterId Id of the parameter to manage
 @return ApiDeleteParameterRequest
*/
func (a *ParametersAPIService) DeleteParameter(ctx context.Context, parameterId string) ApiDeleteParameterRequest {
	return ApiDeleteParameterRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return DeleteParameter200Response
func (a *ParametersAPIService) DeleteParameterExecute(r ApiDeleteParameterRequest) (*DeleteParameter200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteParameter200Response
	)
	...
	localVarPath := localBasePath + "/parameters/{parameterId}"
	localVarPath = strings.Replace(localVarPath, "{"+"parameterId"+"}", url.PathEscape(parameterValueToString(r.parameterId, "parameterId")), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v DeleteParameter500Response
...
type ApiListParametersRequest struct {
	ctx context.Context
	ApiService *ParametersAPIService
}

func (r ApiListParametersRequest) Execute() (*ListParameters200Response, *http.Response, error) {
	return r.ApiService.ListParametersExecute(r)
}
...
Get the current value of all the global properties (a.k.a. global parameters)
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListParametersRequest
*/
func (a *ParametersAPIService) ListParameters(ctx context.Context) ApiListParametersRequest {
	return ApiListParametersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListParameters200Response
func (a *ParametersAPIService) ListParametersExecute(r ApiListParametersRequest) (*ListParameters200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListParameters200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ParametersAPIService.ListParameters")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiParameterDetailsRequest struct {
	ctx context.Context
	ApiService *ParametersAPIService
	parameterId string
}

func (r ApiParameterDetailsRequest) Execute() (*ParameterDetails200Response, *http.Response, error) {
	return r.ApiService.ParameterDetailsExecute(r)
}
...
Get the current value of a given global property (a.k.a. global parameter)
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param parameterId Id of the parameter to manage
 @return ApiParameterDetailsRequest
*/
func (a *ParametersAPIService) ParameterDetails(ctx context.Context, parameterId string) ApiParameterDetailsRequest {
	return ApiParameterDetailsRequest{
		ApiService: a,
		ctx: ctx,
		parameterId: parameterId,
...
// Execute executes the request
//  @return ParameterDetails200Response
func (a *ParametersAPIService) ParameterDetailsExecute(r ApiParameterDetailsRequest) (*ParameterDetails200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ParameterDetails200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ParametersAPIService.ParameterDetails")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateParameterRequest) Execute() (*UpdateParameter200Response, *http.Response, error) {
...
*/
func (a *ParametersAPIService) UpdateParameter(ctx context.Context, parameterId string) ApiUpdateParameterRequest {
	return ApiUpdateParameterRequest{
		ApiService: a,
		ctx: ctx,
		parameterId: parameterId,
...
func (a *ParametersAPIService) UpdateParameterExecute(r ApiUpdateParameterRequest) (*UpdateParameter200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateParameter200Response
	)
