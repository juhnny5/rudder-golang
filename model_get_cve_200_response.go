...
// checks if the GetCve200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCve200Response{}

// GetCve200Response struct for GetCve200Response
type GetCve200Response struct {
...
type _GetCve200Response GetCve200Response
...
func (o GetCve200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCve200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetCve200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCve200Response := _GetCve200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCve200Response)

	if err != nil {
		return err
	}

	*o = GetCve200Response(varGetCve200Response)

	return err
}

type NullableGetCve200Response struct {
	value *GetCve200Response
	isSet bool
}

func (v NullableGetCve200Response) Get() *GetCve200Response {
	return v.value
}

func (v *NullableGetCve200Response) Set(val *GetCve200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCve200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCve200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCve200Response(val *GetCve200Response) *NullableGetCve200Response {
	return &NullableGetCve200Response{value: val, isSet: true}
}

func (v NullableGetCve200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCve200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
