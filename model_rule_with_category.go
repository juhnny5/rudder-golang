...
// checks if the RuleWithCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleWithCategory{}

// RuleWithCategory struct for RuleWithCategory
...
func (o RuleWithCategory) MarshalJSON() ([]byte, error) {
...
func (o RuleWithCategory) ToMap() (map[string]interface{}, error) {
...
type NullableRuleWithCategory struct {
	value *RuleWithCategory
	isSet bool
}

func (v NullableRuleWithCategory) Get() *RuleWithCategory {
	return v.value
}

func (v *NullableRuleWithCategory) Set(val *RuleWithCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleWithCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleWithCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleWithCategory(val *RuleWithCategory) *NullableRuleWithCategory {
	return &NullableRuleWithCategory{value: val, isSet: true}
}

func (v NullableRuleWithCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleWithCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
