...
// checks if the QueueInformation200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueueInformation200Response{}

// QueueInformation200Response struct for QueueInformation200Response
type QueueInformation200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data QueueInformation200ResponseData `json:"data"`
}

type _QueueInformation200Response QueueInformation200Response
...
func NewQueueInformation200Response(result string, action string, data QueueInformation200ResponseData) *QueueInformation200Response {
	this := QueueInformation200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *QueueInformation200Response) GetData() QueueInformation200ResponseData {
	if o == nil {
		var ret QueueInformation200ResponseData
		return ret
	}
...
func (o QueueInformation200Response) MarshalJSON() ([]byte, error) {
...
func (o QueueInformation200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QueueInformation200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQueueInformation200Response := _QueueInformation200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueueInformation200Response)

	if err != nil {
		return err
	}

	*o = QueueInformation200Response(varQueueInformation200Response)

	return err
}

type NullableQueueInformation200Response struct {
	value *QueueInformation200Response
	isSet bool
}

func (v NullableQueueInformation200Response) Get() *QueueInformation200Response {
	return v.value
}

func (v *NullableQueueInformation200Response) Set(val *QueueInformation200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQueueInformation200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQueueInformation200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueueInformation200Response(val *QueueInformation200Response) *NullableQueueInformation200Response {
	return &NullableQueueInformation200Response{value: val, isSet: true}
}

func (v NullableQueueInformation200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueueInformation200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
