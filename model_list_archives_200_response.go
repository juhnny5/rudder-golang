...
// checks if the ListArchives200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListArchives200Response{}

// ListArchives200Response struct for ListArchives200Response
type ListArchives200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The kind of the archive
	Action string `json:"action"`
	Data ListArchives200ResponseData `json:"data"`
}

type _ListArchives200Response ListArchives200Response
...
func (o *ListArchives200Response) GetData() ListArchives200ResponseData {
	if o == nil {
		var ret ListArchives200ResponseData
		return ret
	}
...
func (o ListArchives200Response) MarshalJSON() ([]byte, error) {
...
func (o ListArchives200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListArchives200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListArchives200Response := _ListArchives200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListArchives200Response)

	if err != nil {
		return err
	}

	*o = ListArchives200Response(varListArchives200Response)

	return err
}

type NullableListArchives200Response struct {
	value *ListArchives200Response
	isSet bool
}

func (v NullableListArchives200Response) Get() *ListArchives200Response {
	return v.value
}

func (v *NullableListArchives200Response) Set(val *ListArchives200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListArchives200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListArchives200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListArchives200Response(val *ListArchives200Response) *NullableListArchives200Response {
	return &NullableListArchives200Response{value: val, isSet: true}
}

func (v NullableListArchives200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListArchives200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
