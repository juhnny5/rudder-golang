...
// checks if the NodeFullPortsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullPortsInner{}

// NodeFullPortsInner struct for NodeFullPortsInner
type NodeFullPortsInner struct {
	// Port name
...
func (o NodeFullPortsInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullPortsInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullPortsInner struct {
	value *NodeFullPortsInner
	isSet bool
}

func (v NullableNodeFullPortsInner) Get() *NodeFullPortsInner {
	return v.value
}

func (v *NullableNodeFullPortsInner) Set(val *NodeFullPortsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullPortsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullPortsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullPortsInner(val *NodeFullPortsInner) *NullableNodeFullPortsInner {
	return &NullableNodeFullPortsInner{value: val, isSet: true}
}

func (v NullableNodeFullPortsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullPortsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
