...
// checks if the RuleComplianceComponentComponentsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleComplianceComponentComponentsInner{}

// RuleComplianceComponentComponentsInner struct for RuleComplianceComponentComponentsInner
type RuleComplianceComponentComponentsInner struct {
	...
	Values []RuleComplianceComponentComponentsInnerValuesInner `json:"values"`
}

type _RuleComplianceComponentComponentsInner RuleComplianceComponentComponentsInner
...
func NewRuleComplianceComponentComponentsInner(name string, compliance float32, complianceDetails RuleComplianceComponentComplianceDetails, values []RuleComplianceComponentComponentsInnerValuesInner) *RuleComplianceComponentComponentsInner {
	this := RuleComplianceComponentComponentsInner{}
	this.Name = name
...
func (o *RuleComplianceComponentComponentsInner) GetComplianceDetails() RuleComplianceComponentComplianceDetails {
	if o == nil {
		var ret RuleComplianceComponentComplianceDetails
		return ret
	}
...
func (o *RuleComplianceComponentComponentsInner) GetValues() []RuleComplianceComponentComponentsInnerValuesInner {
	if o == nil {
		var ret []RuleComplianceComponentComponentsInnerValuesInner
		return ret
	}
...
func (o RuleComplianceComponentComponentsInner) MarshalJSON() ([]byte, error) {
...
func (o RuleComplianceComponentComponentsInner) ToMap() (map[string]interface{}, error) {
...
func (o *RuleComplianceComponentComponentsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleComplianceComponentComponentsInner := _RuleComplianceComponentComponentsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleComplianceComponentComponentsInner)

	if err != nil {
		return err
	}

	*o = RuleComplianceComponentComponentsInner(varRuleComplianceComponentComponentsInner)

	return err
}

type NullableRuleComplianceComponentComponentsInner struct {
	value *RuleComplianceComponentComponentsInner
	isSet bool
}

func (v NullableRuleComplianceComponentComponentsInner) Get() *RuleComplianceComponentComponentsInner {
	return v.value
}

func (v *NullableRuleComplianceComponentComponentsInner) Set(val *RuleComplianceComponentComponentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleComplianceComponentComponentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleComplianceComponentComponentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleComplianceComponentComponentsInner(val *RuleComplianceComponentComponentsInner) *NullableRuleComplianceComponentComponentsInner {
	return &NullableRuleComplianceComponentComponentsInner{value: val, isSet: true}
}

func (v NullableRuleComplianceComponentComponentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleComplianceComponentComponentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
