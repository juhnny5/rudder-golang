...
// checks if the CampaignSoftwareUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignSoftwareUpdate{}

// CampaignSoftwareUpdate Software update campaign details (type software-update, version 1)
type CampaignSoftwareUpdate struct {
	...
	SoftwareUpdate []CampaignSoftwareUpdateSoftwareUpdateInner `json:"softwareUpdate,omitempty"`
}
...
// SetReboot gets a reference to the given string and assigns it to the Reboot field.
...
func (o *CampaignSoftwareUpdate) GetSoftwareUpdate() []CampaignSoftwareUpdateSoftwareUpdateInner {
	if o == nil || IsNil(o.SoftwareUpdate) {
		var ret []CampaignSoftwareUpdateSoftwareUpdateInner
		return ret
	}
...
// SetSoftwareUpdate gets a reference to the given []CampaignSoftwareUpdateSoftwareUpdateInner and assigns it to the SoftwareUpdate field.
func (o *CampaignSoftwareUpdate) SetSoftwareUpdate(v []CampaignSoftwareUpdateSoftwareUpdateInner) {
	o.SoftwareUpdate = v
}

func (o CampaignSoftwareUpdate) MarshalJSON() ([]byte, error) {
...
func (o CampaignSoftwareUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignSoftwareUpdate struct {
	value *CampaignSoftwareUpdate
	isSet bool
}

func (v NullableCampaignSoftwareUpdate) Get() *CampaignSoftwareUpdate {
	return v.value
}

func (v *NullableCampaignSoftwareUpdate) Set(val *CampaignSoftwareUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignSoftwareUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignSoftwareUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignSoftwareUpdate(val *CampaignSoftwareUpdate) *NullableCampaignSoftwareUpdate {
	return &NullableCampaignSoftwareUpdate{value: val, isSet: true}
}

func (v NullableCampaignSoftwareUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignSoftwareUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
