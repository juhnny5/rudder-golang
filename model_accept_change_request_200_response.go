...
// checks if the AcceptChangeRequest200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcceptChangeRequest200Response{}

// AcceptChangeRequest200Response struct for AcceptChangeRequest200Response
type AcceptChangeRequest200Response struct {
...
type _AcceptChangeRequest200Response AcceptChangeRequest200Response
...
func NewAcceptChangeRequest200Response(result string, action string, data ListChangeRequests200ResponseData) *AcceptChangeRequest200Response {
	this := AcceptChangeRequest200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o AcceptChangeRequest200Response) MarshalJSON() ([]byte, error) {
...
func (o AcceptChangeRequest200Response) ToMap() (map[string]interface{}, error) {
...
func (o *AcceptChangeRequest200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varAcceptChangeRequest200Response := _AcceptChangeRequest200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAcceptChangeRequest200Response)

	if err != nil {
		return err
	}

	*o = AcceptChangeRequest200Response(varAcceptChangeRequest200Response)

	return err
}

type NullableAcceptChangeRequest200Response struct {
	value *AcceptChangeRequest200Response
	isSet bool
}

func (v NullableAcceptChangeRequest200Response) Get() *AcceptChangeRequest200Response {
	return v.value
}

func (v *NullableAcceptChangeRequest200Response) Set(val *AcceptChangeRequest200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAcceptChangeRequest200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAcceptChangeRequest200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcceptChangeRequest200Response(val *AcceptChangeRequest200Response) *NullableAcceptChangeRequest200Response {
	return &NullableAcceptChangeRequest200Response{value: val, isSet: true}
}

func (v NullableAcceptChangeRequest200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcceptChangeRequest200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
