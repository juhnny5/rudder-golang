...
// checks if the NodeFullTimezone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullTimezone{}

// NodeFullTimezone struct for NodeFullTimezone
...
type _NodeFullTimezone NodeFullTimezone
...
func (o NodeFullTimezone) MarshalJSON() ([]byte, error) {
...
func (o NodeFullTimezone) ToMap() (map[string]interface{}, error) {
...
func (o *NodeFullTimezone) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeFullTimezone := _NodeFullTimezone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeFullTimezone)

	if err != nil {
		return err
	}

	*o = NodeFullTimezone(varNodeFullTimezone)

	return err
}

type NullableNodeFullTimezone struct {
	value *NodeFullTimezone
	isSet bool
}

func (v NullableNodeFullTimezone) Get() *NodeFullTimezone {
	return v.value
}

func (v *NullableNodeFullTimezone) Set(val *NodeFullTimezone) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullTimezone) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullTimezone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullTimezone(val *NodeFullTimezone) *NullableNodeFullTimezone {
	return &NullableNodeFullTimezone{value: val, isSet: true}
}

func (v NullableNodeFullTimezone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullTimezone) UnmarshalJSON(src []byte) error {
	v.isSet = true
