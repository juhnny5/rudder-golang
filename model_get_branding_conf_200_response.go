...
// checks if the GetBrandingConf200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBrandingConf200Response{}

// GetBrandingConf200Response struct for GetBrandingConf200Response
type GetBrandingConf200Response struct {
...
type _GetBrandingConf200Response GetBrandingConf200Response
...
func NewGetBrandingConf200Response(result string, action string, data GetBrandingConf200ResponseData) *GetBrandingConf200Response {
	this := GetBrandingConf200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o GetBrandingConf200Response) MarshalJSON() ([]byte, error) {
...
func (o GetBrandingConf200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetBrandingConf200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetBrandingConf200Response := _GetBrandingConf200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetBrandingConf200Response)

	if err != nil {
		return err
	}

	*o = GetBrandingConf200Response(varGetBrandingConf200Response)

	return err
}

type NullableGetBrandingConf200Response struct {
	value *GetBrandingConf200Response
	isSet bool
}

func (v NullableGetBrandingConf200Response) Get() *GetBrandingConf200Response {
	return v.value
}

func (v *NullableGetBrandingConf200Response) Set(val *GetBrandingConf200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBrandingConf200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBrandingConf200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBrandingConf200Response(val *GetBrandingConf200Response) *NullableGetBrandingConf200Response {
	return &NullableGetBrandingConf200Response{value: val, isSet: true}
}

func (v NullableGetBrandingConf200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBrandingConf200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
