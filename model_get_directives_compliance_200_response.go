...
// checks if the GetDirectivesCompliance200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDirectivesCompliance200Response{}

// GetDirectivesCompliance200Response struct for GetDirectivesCompliance200Response
type GetDirectivesCompliance200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetDirectivesCompliance200ResponseData `json:"data"`
}

type _GetDirectivesCompliance200Response GetDirectivesCompliance200Response
...
func NewGetDirectivesCompliance200Response(result string, action string, data GetDirectivesCompliance200ResponseData) *GetDirectivesCompliance200Response {
	this := GetDirectivesCompliance200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetDirectivesCompliance200Response) GetData() GetDirectivesCompliance200ResponseData {
	if o == nil {
		var ret GetDirectivesCompliance200ResponseData
		return ret
	}
...
func (o GetDirectivesCompliance200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDirectivesCompliance200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetDirectivesCompliance200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDirectivesCompliance200Response := _GetDirectivesCompliance200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDirectivesCompliance200Response)

	if err != nil {
		return err
	}

	*o = GetDirectivesCompliance200Response(varGetDirectivesCompliance200Response)

	return err
}

type NullableGetDirectivesCompliance200Response struct {
	value *GetDirectivesCompliance200Response
	isSet bool
}

func (v NullableGetDirectivesCompliance200Response) Get() *GetDirectivesCompliance200Response {
	return v.value
}

func (v *NullableGetDirectivesCompliance200Response) Set(val *GetDirectivesCompliance200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDirectivesCompliance200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDirectivesCompliance200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDirectivesCompliance200Response(val *GetDirectivesCompliance200Response) *NullableGetDirectivesCompliance200Response {
	return &NullableGetDirectivesCompliance200Response{value: val, isSet: true}
}

func (v NullableGetDirectivesCompliance200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDirectivesCompliance200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
