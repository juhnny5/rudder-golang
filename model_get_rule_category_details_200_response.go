...
// checks if the GetRuleCategoryDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRuleCategoryDetails200Response{}

// GetRuleCategoryDetails200Response struct for GetRuleCategoryDetails200Response
type GetRuleCategoryDetails200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetRuleCategoryDetails200ResponseData `json:"data"`
}

type _GetRuleCategoryDetails200Response GetRuleCategoryDetails200Response
...
func NewGetRuleCategoryDetails200Response(result string, action string, data GetRuleCategoryDetails200ResponseData) *GetRuleCategoryDetails200Response {
	this := GetRuleCategoryDetails200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetRuleCategoryDetails200Response) GetData() GetRuleCategoryDetails200ResponseData {
	if o == nil {
		var ret GetRuleCategoryDetails200ResponseData
		return ret
	}
...
func (o GetRuleCategoryDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o GetRuleCategoryDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetRuleCategoryDetails200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRuleCategoryDetails200Response := _GetRuleCategoryDetails200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRuleCategoryDetails200Response)

	if err != nil {
		return err
	}

	*o = GetRuleCategoryDetails200Response(varGetRuleCategoryDetails200Response)

	return err
}

type NullableGetRuleCategoryDetails200Response struct {
	value *GetRuleCategoryDetails200Response
	isSet bool
}

func (v NullableGetRuleCategoryDetails200Response) Get() *GetRuleCategoryDetails200Response {
	return v.value
}

func (v *NullableGetRuleCategoryDetails200Response) Set(val *GetRuleCategoryDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRuleCategoryDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRuleCategoryDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRuleCategoryDetails200Response(val *GetRuleCategoryDetails200Response) *NullableGetRuleCategoryDetails200Response {
	return &NullableGetRuleCategoryDetails200Response{value: val, isSet: true}
}

func (v NullableGetRuleCategoryDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRuleCategoryDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
