...
// checks if the UpdateNode200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNode200Response{}

// UpdateNode200Response struct for UpdateNode200Response
type UpdateNode200Response struct {
...
type _UpdateNode200Response UpdateNode200Response
...
func (o UpdateNode200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateNode200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateNode200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNode200Response := _UpdateNode200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNode200Response)

	if err != nil {
		return err
	}

	*o = UpdateNode200Response(varUpdateNode200Response)

	return err
}

type NullableUpdateNode200Response struct {
	value *UpdateNode200Response
	isSet bool
}

func (v NullableUpdateNode200Response) Get() *UpdateNode200Response {
	return v.value
}

func (v *NullableUpdateNode200Response) Set(val *UpdateNode200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNode200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNode200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNode200Response(val *UpdateNode200Response) *NullableUpdateNode200Response {
	return &NullableUpdateNode200Response{value: val, isSet: true}
}

func (v NullableUpdateNode200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNode200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
