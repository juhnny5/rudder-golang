...
// checks if the ReloadAllDatasourcesOneNode200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadAllDatasourcesOneNode200Response{}

// ReloadAllDatasourcesOneNode200Response struct for ReloadAllDatasourcesOneNode200Response
type ReloadAllDatasourcesOneNode200Response struct {
...
type _ReloadAllDatasourcesOneNode200Response ReloadAllDatasourcesOneNode200Response
...
func NewReloadAllDatasourcesOneNode200Response(result string, action string, data string) *ReloadAllDatasourcesOneNode200Response {
	this := ReloadAllDatasourcesOneNode200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ReloadAllDatasourcesOneNode200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadAllDatasourcesOneNode200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadAllDatasourcesOneNode200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadAllDatasourcesOneNode200Response := _ReloadAllDatasourcesOneNode200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadAllDatasourcesOneNode200Response)

	if err != nil {
		return err
	}

	*o = ReloadAllDatasourcesOneNode200Response(varReloadAllDatasourcesOneNode200Response)

	return err
}

type NullableReloadAllDatasourcesOneNode200Response struct {
	value *ReloadAllDatasourcesOneNode200Response
	isSet bool
}

func (v NullableReloadAllDatasourcesOneNode200Response) Get() *ReloadAllDatasourcesOneNode200Response {
	return v.value
}

func (v *NullableReloadAllDatasourcesOneNode200Response) Set(val *ReloadAllDatasourcesOneNode200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadAllDatasourcesOneNode200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadAllDatasourcesOneNode200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadAllDatasourcesOneNode200Response(val *ReloadAllDatasourcesOneNode200Response) *NullableReloadAllDatasourcesOneNode200Response {
	return &NullableReloadAllDatasourcesOneNode200Response{value: val, isSet: true}
}

func (v NullableReloadAllDatasourcesOneNode200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadAllDatasourcesOneNode200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
