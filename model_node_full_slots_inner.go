...
// checks if the NodeFullSlotsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullSlotsInner{}

// NodeFullSlotsInner struct for NodeFullSlotsInner
type NodeFullSlotsInner struct {
...
func (o NodeFullSlotsInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullSlotsInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullSlotsInner struct {
	value *NodeFullSlotsInner
	isSet bool
}

func (v NullableNodeFullSlotsInner) Get() *NodeFullSlotsInner {
	return v.value
}

func (v *NullableNodeFullSlotsInner) Set(val *NodeFullSlotsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullSlotsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullSlotsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullSlotsInner(val *NodeFullSlotsInner) *NullableNodeFullSlotsInner {
	return &NullableNodeFullSlotsInner{value: val, isSet: true}
}

func (v NullableNodeFullSlotsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullSlotsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
