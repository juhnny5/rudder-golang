...
// checks if the GetCampaignResults200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCampaignResults200ResponseData{}

// GetCampaignResults200ResponseData struct for GetCampaignResults200ResponseData
type GetCampaignResults200ResponseData struct {
	CampaignHistory []CampaignEventResult `json:"campaignHistory"`
}

type _GetCampaignResults200ResponseData GetCampaignResults200ResponseData
...
func NewGetCampaignResults200ResponseData(campaignHistory []CampaignEventResult) *GetCampaignResults200ResponseData {
	this := GetCampaignResults200ResponseData{}
...
// GetCampaignHistory returns the CampaignHistory field value
...
// GetCampaignHistoryOk returns a tuple with the CampaignHistory field value
// and a boolean to check if the value has been set.
func (o *GetCampaignResults200ResponseData) GetCampaignHistoryOk() ([]CampaignEventResult, bool) {
	if o == nil {
		return nil, false
	}
	return o.CampaignHistory, true
}

// SetCampaignHistory sets field value
func (o *GetCampaignResults200ResponseData) SetCampaignHistory(v []CampaignEventResult) {
	o.CampaignHistory = v
}

func (o GetCampaignResults200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetCampaignResults200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["campaignHistory"] = o.CampaignHistory
	return toSerialize, nil
}

func (o *GetCampaignResults200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCampaignResults200ResponseData := _GetCampaignResults200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCampaignResults200ResponseData)

	if err != nil {
		return err
	}

	*o = GetCampaignResults200ResponseData(varGetCampaignResults200ResponseData)

	return err
}

type NullableGetCampaignResults200ResponseData struct {
	value *GetCampaignResults200ResponseData
	isSet bool
}

func (v NullableGetCampaignResults200ResponseData) Get() *GetCampaignResults200ResponseData {
	return v.value
}

func (v *NullableGetCampaignResults200ResponseData) Set(val *GetCampaignResults200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCampaignResults200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCampaignResults200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCampaignResults200ResponseData(val *GetCampaignResults200ResponseData) *NullableGetCampaignResults200ResponseData {
	return &NullableGetCampaignResults200ResponseData{value: val, isSet: true}
}

func (v NullableGetCampaignResults200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCampaignResults200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
