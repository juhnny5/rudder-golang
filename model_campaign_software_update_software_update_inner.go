...
// checks if the CampaignSoftwareUpdateSoftwareUpdateInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignSoftwareUpdateSoftwareUpdateInner{}

// CampaignSoftwareUpdateSoftwareUpdateInner struct for CampaignSoftwareUpdateSoftwareUpdateInner
type CampaignSoftwareUpdateSoftwareUpdateInner struct {
	// Name of the package  to update
	Name *string `json:"name,omitempty"`
	// Target version of the package to update to
	Version *string `json:"version,omitempty"`
	// Architecture of the package to update
...
func NewCampaignSoftwareUpdateSoftwareUpdateInner() *CampaignSoftwareUpdateSoftwareUpdateInner {
	this := CampaignSoftwareUpdateSoftwareUpdateInner{}
	return &this
}
...
func (o CampaignSoftwareUpdateSoftwareUpdateInner) MarshalJSON() ([]byte, error) {
...
func (o CampaignSoftwareUpdateSoftwareUpdateInner) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignSoftwareUpdateSoftwareUpdateInner struct {
	value *CampaignSoftwareUpdateSoftwareUpdateInner
	isSet bool
}

func (v NullableCampaignSoftwareUpdateSoftwareUpdateInner) Get() *CampaignSoftwareUpdateSoftwareUpdateInner {
	return v.value
}

func (v *NullableCampaignSoftwareUpdateSoftwareUpdateInner) Set(val *CampaignSoftwareUpdateSoftwareUpdateInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignSoftwareUpdateSoftwareUpdateInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignSoftwareUpdateSoftwareUpdateInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignSoftwareUpdateSoftwareUpdateInner(val *CampaignSoftwareUpdateSoftwareUpdateInner) *NullableCampaignSoftwareUpdateSoftwareUpdateInner {
	return &NullableCampaignSoftwareUpdateSoftwareUpdateInner{value: val, isSet: true}
}

func (v NullableCampaignSoftwareUpdateSoftwareUpdateInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignSoftwareUpdateSoftwareUpdateInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
