...
// checks if the CreateTechnique200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTechnique200ResponseData{}

// CreateTechnique200ResponseData struct for CreateTechnique200ResponseData
type CreateTechnique200ResponseData struct {
	Techniques CreateTechnique200ResponseDataTechniques `json:"techniques"`
}

type _CreateTechnique200ResponseData CreateTechnique200ResponseData
...
func NewCreateTechnique200ResponseData(techniques CreateTechnique200ResponseDataTechniques) *CreateTechnique200ResponseData {
	this := CreateTechnique200ResponseData{}
...
func (o *CreateTechnique200ResponseData) GetTechniques() CreateTechnique200ResponseDataTechniques {
	if o == nil {
		var ret CreateTechnique200ResponseDataTechniques
		return ret
	}
...
func (o CreateTechnique200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CreateTechnique200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["techniques"] = o.Techniques
	return toSerialize, nil
}

func (o *CreateTechnique200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTechnique200ResponseData := _CreateTechnique200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTechnique200ResponseData)

	if err != nil {
		return err
	}

	*o = CreateTechnique200ResponseData(varCreateTechnique200ResponseData)

	return err
}

type NullableCreateTechnique200ResponseData struct {
	value *CreateTechnique200ResponseData
	isSet bool
}

func (v NullableCreateTechnique200ResponseData) Get() *CreateTechnique200ResponseData {
	return v.value
}

func (v *NullableCreateTechnique200ResponseData) Set(val *CreateTechnique200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTechnique200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTechnique200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTechnique200ResponseData(val *CreateTechnique200ResponseData) *NullableCreateTechnique200ResponseData {
	return &NullableCreateTechnique200ResponseData{value: val, isSet: true}
}

func (v NullableCreateTechnique200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTechnique200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
