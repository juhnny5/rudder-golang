...
func (o *UpdatePolicies200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdatePolicies200Response := _UpdatePolicies200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdatePolicies200Response)

	if err != nil {
		return err
	}

	*o = UpdatePolicies200Response(varUpdatePolicies200Response)
