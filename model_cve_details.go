...
// checks if the CveDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CveDetails{}

// CveDetails struct for CveDetails
...
// SetCvssv3 gets a reference to the given CveDetailsCvssv3 and assigns it to the Cvssv3 field.
...
// SetCvssv2 gets a reference to the given CveDetailsCvssv2 and assigns it to the Cvssv2 field.
func (o *CveDetails) SetCvssv2(v CveDetailsCvssv2) {
	o.Cvssv2 = &v
}

func (o CveDetails) MarshalJSON() ([]byte, error) {
...
func (o CveDetails) ToMap() (map[string]interface{}, error) {
...
type NullableCveDetails struct {
	value *CveDetails
	isSet bool
}

func (v NullableCveDetails) Get() *CveDetails {
	return v.value
}

func (v *NullableCveDetails) Set(val *CveDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCveDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCveDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCveDetails(val *CveDetails) *NullableCveDetails {
	return &NullableCveDetails{value: val, isSet: true}
}

func (v NullableCveDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCveDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
