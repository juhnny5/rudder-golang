...
// checks if the GetNodesCompliance200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodesCompliance200Response{}

// GetNodesCompliance200Response struct for GetNodesCompliance200Response
type GetNodesCompliance200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetNodesCompliance200ResponseData `json:"data"`
}

type _GetNodesCompliance200Response GetNodesCompliance200Response
...
func NewGetNodesCompliance200Response(result string, action string, data GetNodesCompliance200ResponseData) *GetNodesCompliance200Response {
	this := GetNodesCompliance200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetNodesCompliance200Response) GetData() GetNodesCompliance200ResponseData {
	if o == nil {
		var ret GetNodesCompliance200ResponseData
		return ret
	}
...
func (o GetNodesCompliance200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNodesCompliance200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetNodesCompliance200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodesCompliance200Response := _GetNodesCompliance200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodesCompliance200Response)

	if err != nil {
		return err
	}

	*o = GetNodesCompliance200Response(varGetNodesCompliance200Response)

	return err
}

type NullableGetNodesCompliance200Response struct {
	value *GetNodesCompliance200Response
	isSet bool
}

func (v NullableGetNodesCompliance200Response) Get() *GetNodesCompliance200Response {
	return v.value
}

func (v *NullableGetNodesCompliance200Response) Set(val *GetNodesCompliance200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodesCompliance200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodesCompliance200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodesCompliance200Response(val *GetNodesCompliance200Response) *NullableGetNodesCompliance200Response {
	return &NullableGetNodesCompliance200Response{value: val, isSet: true}
}

func (v NullableGetNodesCompliance200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodesCompliance200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
