...
// checks if the CampaignEventDetailsStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEventDetailsStatus{}

// CampaignEventDetailsStatus struct for CampaignEventDetailsStatus
...
func NewCampaignEventDetailsStatus() *CampaignEventDetailsStatus {
	this := CampaignEventDetailsStatus{}
	return &this
}
...
func (o CampaignEventDetailsStatus) MarshalJSON() ([]byte, error) {
...
func (o CampaignEventDetailsStatus) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignEventDetailsStatus struct {
	value *CampaignEventDetailsStatus
	isSet bool
}

func (v NullableCampaignEventDetailsStatus) Get() *CampaignEventDetailsStatus {
	return v.value
}

func (v *NullableCampaignEventDetailsStatus) Set(val *CampaignEventDetailsStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignEventDetailsStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignEventDetailsStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignEventDetailsStatus(val *CampaignEventDetailsStatus) *NullableCampaignEventDetailsStatus {
	return &NullableCampaignEventDetailsStatus{value: val, isSet: true}
}

func (v NullableCampaignEventDetailsStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignEventDetailsStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
