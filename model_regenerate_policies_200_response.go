...
// checks if the RegeneratePolicies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegeneratePolicies200Response{}

// RegeneratePolicies200Response struct for RegeneratePolicies200Response
type RegeneratePolicies200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data RegeneratePolicies200ResponseData `json:"data"`
}

type _RegeneratePolicies200Response RegeneratePolicies200Response
...
func NewRegeneratePolicies200Response(result string, action string, data RegeneratePolicies200ResponseData) *RegeneratePolicies200Response {
	this := RegeneratePolicies200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *RegeneratePolicies200Response) GetData() RegeneratePolicies200ResponseData {
	if o == nil {
		var ret RegeneratePolicies200ResponseData
		return ret
	}
...
func (o RegeneratePolicies200Response) MarshalJSON() ([]byte, error) {
...
func (o RegeneratePolicies200Response) ToMap() (map[string]interface{}, error) {
...
func (o *RegeneratePolicies200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRegeneratePolicies200Response := _RegeneratePolicies200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegeneratePolicies200Response)

	if err != nil {
		return err
	}

	*o = RegeneratePolicies200Response(varRegeneratePolicies200Response)

	return err
}

type NullableRegeneratePolicies200Response struct {
	value *RegeneratePolicies200Response
	isSet bool
}

func (v NullableRegeneratePolicies200Response) Get() *RegeneratePolicies200Response {
	return v.value
}

func (v *NullableRegeneratePolicies200Response) Set(val *RegeneratePolicies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRegeneratePolicies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRegeneratePolicies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegeneratePolicies200Response(val *RegeneratePolicies200Response) *NullableRegeneratePolicies200Response {
	return &NullableRegeneratePolicies200Response{value: val, isSet: true}
}

func (v NullableRegeneratePolicies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegeneratePolicies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
