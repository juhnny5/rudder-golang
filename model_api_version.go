...
type ApiVersion struct {
	...
	All []ApiVersionAllInner `json:"all,omitempty"`
}
...
// SetAll gets a reference to the given []ApiVersionAllInner and assigns it to the All field.
