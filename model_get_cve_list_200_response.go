...
// checks if the GetCVEList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCVEList200Response{}

// GetCVEList200Response struct for GetCVEList200Response
type GetCVEList200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetAllCve200ResponseData `json:"data"`
}

type _GetCVEList200Response GetCVEList200Response
...
func (o *GetCVEList200Response) GetData() GetAllCve200ResponseData {
	if o == nil {
		var ret GetAllCve200ResponseData
		return ret
	}
...
func (o GetCVEList200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCVEList200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetCVEList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCVEList200Response := _GetCVEList200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCVEList200Response)

	if err != nil {
		return err
	}

	*o = GetCVEList200Response(varGetCVEList200Response)

	return err
}

type NullableGetCVEList200Response struct {
	value *GetCVEList200Response
	isSet bool
}

func (v NullableGetCVEList200Response) Get() *GetCVEList200Response {
	return v.value
}

func (v *NullableGetCVEList200Response) Set(val *GetCVEList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCVEList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCVEList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCVEList200Response(val *GetCVEList200Response) *NullableGetCVEList200Response {
	return &NullableGetCVEList200Response{value: val, isSet: true}
}

func (v NullableGetCVEList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCVEList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
