...
// checks if the ListChangeRequests200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListChangeRequests200Response{}

// ListChangeRequests200Response struct for ListChangeRequests200Response
type ListChangeRequests200Response struct {
...
type _ListChangeRequests200Response ListChangeRequests200Response
...
func NewListChangeRequests200Response(result string, action string, data ListChangeRequests200ResponseData) *ListChangeRequests200Response {
	this := ListChangeRequests200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ListChangeRequests200Response) MarshalJSON() ([]byte, error) {
...
func (o ListChangeRequests200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListChangeRequests200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListChangeRequests200Response := _ListChangeRequests200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListChangeRequests200Response)

	if err != nil {
		return err
	}

	*o = ListChangeRequests200Response(varListChangeRequests200Response)

	return err
}

type NullableListChangeRequests200Response struct {
	value *ListChangeRequests200Response
	isSet bool
}

func (v NullableListChangeRequests200Response) Get() *ListChangeRequests200Response {
	return v.value
}

func (v *NullableListChangeRequests200Response) Set(val *ListChangeRequests200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListChangeRequests200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListChangeRequests200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListChangeRequests200Response(val *ListChangeRequests200Response) *NullableListChangeRequests200Response {
	return &NullableListChangeRequests200Response{value: val, isSet: true}
}

func (v NullableListChangeRequests200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListChangeRequests200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
