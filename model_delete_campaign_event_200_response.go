...
// checks if the DeleteCampaignEvent200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteCampaignEvent200Response{}

// DeleteCampaignEvent200Response struct for DeleteCampaignEvent200Response
type DeleteCampaignEvent200Response struct {
...
type _DeleteCampaignEvent200Response DeleteCampaignEvent200Response
...
func NewDeleteCampaignEvent200Response(result string, action string, data GetAllCampaignEvents200ResponseData) *DeleteCampaignEvent200Response {
	this := DeleteCampaignEvent200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o DeleteCampaignEvent200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteCampaignEvent200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteCampaignEvent200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteCampaignEvent200Response := _DeleteCampaignEvent200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteCampaignEvent200Response)

	if err != nil {
		return err
	}

	*o = DeleteCampaignEvent200Response(varDeleteCampaignEvent200Response)

	return err
}

type NullableDeleteCampaignEvent200Response struct {
	value *DeleteCampaignEvent200Response
	isSet bool
}

func (v NullableDeleteCampaignEvent200Response) Get() *DeleteCampaignEvent200Response {
	return v.value
}

func (v *NullableDeleteCampaignEvent200Response) Set(val *DeleteCampaignEvent200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteCampaignEvent200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteCampaignEvent200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteCampaignEvent200Response(val *DeleteCampaignEvent200Response) *NullableDeleteCampaignEvent200Response {
	return &NullableDeleteCampaignEvent200Response{value: val, isSet: true}
}

func (v NullableDeleteCampaignEvent200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteCampaignEvent200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
