...
// checks if the NodeSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeSettings{}

// NodeSettings struct for NodeSettings
type NodeSettings struct {
	Properties []NodeFullPropertiesInner `json:"properties,omitempty"`
...
// SetProperties gets a reference to the given []NodeFullPropertiesInner and assigns it to the Properties field.
...
func (o NodeSettings) MarshalJSON() ([]byte, error) {
...
func (o NodeSettings) ToMap() (map[string]interface{}, error) {
...
type NullableNodeSettings struct {
	value *NodeSettings
	isSet bool
}

func (v NullableNodeSettings) Get() *NodeSettings {
	return v.value
}

func (v *NullableNodeSettings) Set(val *NodeSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeSettings(val *NodeSettings) *NullableNodeSettings {
	return &NullableNodeSettings{value: val, isSet: true}
}

func (v NullableNodeSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
