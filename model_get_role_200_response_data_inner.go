...
// checks if the GetRole200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRole200ResponseDataInner{}

// GetRole200ResponseDataInner struct for GetRole200ResponseDataInner
type GetRole200ResponseDataInner struct {
	// Name of the role
	Id string `json:"id"`
	// Role's rights
...
type _GetRole200ResponseDataInner GetRole200ResponseDataInner
...
func NewGetRole200ResponseDataInner(id string, rights []string) *GetRole200ResponseDataInner {
	this := GetRole200ResponseDataInner{}
	this.Id = id
	this.Rights = rights
	return &this
}
...
func (o GetRole200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetRole200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetRole200ResponseDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRole200ResponseDataInner := _GetRole200ResponseDataInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRole200ResponseDataInner)

	if err != nil {
		return err
	}

	*o = GetRole200ResponseDataInner(varGetRole200ResponseDataInner)

	return err
}

type NullableGetRole200ResponseDataInner struct {
	value *GetRole200ResponseDataInner
	isSet bool
}

func (v NullableGetRole200ResponseDataInner) Get() *GetRole200ResponseDataInner {
	return v.value
}

func (v *NullableGetRole200ResponseDataInner) Set(val *GetRole200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRole200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRole200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRole200ResponseDataInner(val *GetRole200ResponseDataInner) *NullableGetRole200ResponseDataInner {
	return &NullableGetRole200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetRole200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRole200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
