...
// checks if the GetDataSource200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDataSource200Response{}
...
func (o *GetDataSource200Response) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varGetDataSource200Response)
