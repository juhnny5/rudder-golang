...
// checks if the DeleteNode200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteNode200Response{}

// DeleteNode200Response struct for DeleteNode200Response
type DeleteNode200Response struct {
...
type _DeleteNode200Response DeleteNode200Response
...
func (o DeleteNode200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteNode200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteNode200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteNode200Response := _DeleteNode200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteNode200Response)

	if err != nil {
		return err
	}

	*o = DeleteNode200Response(varDeleteNode200Response)

	return err
}

type NullableDeleteNode200Response struct {
	value *DeleteNode200Response
	isSet bool
}

func (v NullableDeleteNode200Response) Get() *DeleteNode200Response {
	return v.value
}

func (v *NullableDeleteNode200Response) Set(val *DeleteNode200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteNode200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteNode200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteNode200Response(val *DeleteNode200Response) *NullableDeleteNode200Response {
	return &NullableDeleteNode200Response{value: val, isSet: true}
}

func (v NullableDeleteNode200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteNode200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
