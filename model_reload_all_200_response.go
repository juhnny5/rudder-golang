...
// checks if the ReloadAll200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadAll200Response{}

// ReloadAll200Response struct for ReloadAll200Response
type ReloadAll200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ReloadAll200ResponseData `json:"data"`
}

type _ReloadAll200Response ReloadAll200Response
...
func (o *ReloadAll200Response) GetData() ReloadAll200ResponseData {
	if o == nil {
		var ret ReloadAll200ResponseData
		return ret
	}
...
func (o ReloadAll200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadAll200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadAll200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadAll200Response := _ReloadAll200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadAll200Response)

	if err != nil {
		return err
	}

	*o = ReloadAll200Response(varReloadAll200Response)

	return err
}

type NullableReloadAll200Response struct {
	value *ReloadAll200Response
	isSet bool
}

func (v NullableReloadAll200Response) Get() *ReloadAll200Response {
	return v.value
}

func (v *NullableReloadAll200Response) Set(val *ReloadAll200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadAll200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadAll200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadAll200Response(val *ReloadAll200Response) *NullableReloadAll200Response {
	return &NullableReloadAll200Response{value: val, isSet: true}
}

func (v NullableReloadAll200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadAll200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
