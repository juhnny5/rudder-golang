...
// checks if the GetRuleTree200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRuleTree200Response{}

// GetRuleTree200Response struct for GetRuleTree200Response
type GetRuleTree200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetRuleTree200ResponseData `json:"data"`
}

type _GetRuleTree200Response GetRuleTree200Response
...
func (o *GetRuleTree200Response) GetData() GetRuleTree200ResponseData {
	if o == nil {
		var ret GetRuleTree200ResponseData
		return ret
	}
...
func (o GetRuleTree200Response) MarshalJSON() ([]byte, error) {
...
func (o GetRuleTree200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetRuleTree200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRuleTree200Response := _GetRuleTree200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRuleTree200Response)

	if err != nil {
		return err
	}

	*o = GetRuleTree200Response(varGetRuleTree200Response)

	return err
}

type NullableGetRuleTree200Response struct {
	value *GetRuleTree200Response
	isSet bool
}

func (v NullableGetRuleTree200Response) Get() *GetRuleTree200Response {
	return v.value
}

func (v *NullableGetRuleTree200Response) Set(val *GetRuleTree200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRuleTree200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRuleTree200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRuleTree200Response(val *GetRuleTree200Response) *NullableGetRuleTree200Response {
	return &NullableGetRuleTree200Response{value: val, isSet: true}
}

func (v NullableGetRuleTree200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRuleTree200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
