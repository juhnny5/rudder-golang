...
// checks if the NodeInheritedProperties200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeInheritedProperties200Response{}

// NodeInheritedProperties200Response struct for NodeInheritedProperties200Response
type NodeInheritedProperties200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	// Information about the node inherited properties
	Data []NodeInheritedProperties `json:"data"`
}

type _NodeInheritedProperties200Response NodeInheritedProperties200Response
...
func NewNodeInheritedProperties200Response(result string, action string, data []NodeInheritedProperties) *NodeInheritedProperties200Response {
	this := NodeInheritedProperties200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *NodeInheritedProperties200Response) GetData() []NodeInheritedProperties {
	if o == nil {
		var ret []NodeInheritedProperties
		return ret
	}
...
func (o NodeInheritedProperties200Response) MarshalJSON() ([]byte, error) {
...
func (o NodeInheritedProperties200Response) ToMap() (map[string]interface{}, error) {
...
func (o *NodeInheritedProperties200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeInheritedProperties200Response := _NodeInheritedProperties200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeInheritedProperties200Response)

	if err != nil {
		return err
	}

	*o = NodeInheritedProperties200Response(varNodeInheritedProperties200Response)

	return err
}

type NullableNodeInheritedProperties200Response struct {
	value *NodeInheritedProperties200Response
	isSet bool
}

func (v NullableNodeInheritedProperties200Response) Get() *NodeInheritedProperties200Response {
	return v.value
}

func (v *NullableNodeInheritedProperties200Response) Set(val *NodeInheritedProperties200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeInheritedProperties200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeInheritedProperties200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeInheritedProperties200Response(val *NodeInheritedProperties200Response) *NullableNodeInheritedProperties200Response {
	return &NullableNodeInheritedProperties200Response{value: val, isSet: true}
}

func (v NullableNodeInheritedProperties200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeInheritedProperties200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
