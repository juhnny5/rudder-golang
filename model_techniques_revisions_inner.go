...
// checks if the TechniquesRevisionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniquesRevisionsInner{}

// TechniquesRevisionsInner struct for TechniquesRevisionsInner
type TechniquesRevisionsInner struct {
	// Revision ID
...
type _TechniquesRevisionsInner TechniquesRevisionsInner
...
func (o TechniquesRevisionsInner) MarshalJSON() ([]byte, error) {
...
func (o TechniquesRevisionsInner) ToMap() (map[string]interface{}, error) {
...
func (o *TechniquesRevisionsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varTechniquesRevisionsInner := _TechniquesRevisionsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTechniquesRevisionsInner)

	if err != nil {
		return err
	}

	*o = TechniquesRevisionsInner(varTechniquesRevisionsInner)

	return err
}

type NullableTechniquesRevisionsInner struct {
	value *TechniquesRevisionsInner
	isSet bool
}

func (v NullableTechniquesRevisionsInner) Get() *TechniquesRevisionsInner {
	return v.value
}

func (v *NullableTechniquesRevisionsInner) Set(val *TechniquesRevisionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniquesRevisionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniquesRevisionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniquesRevisionsInner(val *TechniquesRevisionsInner) *NullableTechniquesRevisionsInner {
	return &NullableTechniquesRevisionsInner{value: val, isSet: true}
}

func (v NullableTechniquesRevisionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniquesRevisionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
