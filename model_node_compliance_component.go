...
// checks if the NodeComplianceComponent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeComplianceComponent{}

// NodeComplianceComponent struct for NodeComplianceComponent
type NodeComplianceComponent struct {
	...
	Values []NodeComplianceComponentValuesInner `json:"values"`
}

type _NodeComplianceComponent NodeComplianceComponent
...
func (o *NodeComplianceComponent) GetValues() []NodeComplianceComponentValuesInner {
	if o == nil {
		var ret []NodeComplianceComponentValuesInner
		return ret
	}
...
func (o NodeComplianceComponent) MarshalJSON() ([]byte, error) {
...
func (o NodeComplianceComponent) ToMap() (map[string]interface{}, error) {
...
func (o *NodeComplianceComponent) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeComplianceComponent := _NodeComplianceComponent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeComplianceComponent)

	if err != nil {
		return err
	}

	*o = NodeComplianceComponent(varNodeComplianceComponent)

	return err
}

type NullableNodeComplianceComponent struct {
	value *NodeComplianceComponent
	isSet bool
}

func (v NullableNodeComplianceComponent) Get() *NodeComplianceComponent {
	return v.value
}

func (v *NullableNodeComplianceComponent) Set(val *NodeComplianceComponent) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeComplianceComponent) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeComplianceComponent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeComplianceComponent(val *NodeComplianceComponent) *NullableNodeComplianceComponent {
	return &NullableNodeComplianceComponent{value: val, isSet: true}
}

func (v NullableNodeComplianceComponent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeComplianceComponent) UnmarshalJSON(src []byte) error {
	v.isSet = true
