...
// checks if the TechniqueBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueBlock{}

// TechniqueBlock struct for TechniqueBlock
type TechniqueBlock struct {
	...
	ReportingLogic *TechniqueBlockReportingLogic `json:"reportingLogic,omitempty"`
}
...
// GetReportingLogic returns the ReportingLogic field value if set, zero value otherwise.
func (o *TechniqueBlock) GetReportingLogic() TechniqueBlockReportingLogic {
	if o == nil || IsNil(o.ReportingLogic) {
		var ret TechniqueBlockReportingLogic
		return ret
	}
	return *o.ReportingLogic
}

// GetReportingLogicOk returns a tuple with the ReportingLogic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TechniqueBlock) GetReportingLogicOk() (*TechniqueBlockReportingLogic, bool) {
	if o == nil || IsNil(o.ReportingLogic) {
		return nil, false
	}
	return o.ReportingLogic, true
}
...
// SetReportingLogic gets a reference to the given TechniqueBlockReportingLogic and assigns it to the ReportingLogic field.
func (o *TechniqueBlock) SetReportingLogic(v TechniqueBlockReportingLogic) {
	o.ReportingLogic = &v
}

func (o TechniqueBlock) MarshalJSON() ([]byte, error) {
...
func (o TechniqueBlock) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReportingLogic) {
		toSerialize["reportingLogic"] = o.ReportingLogic
	}
	return toSerialize, nil
}

type NullableTechniqueBlock struct {
	value *TechniqueBlock
	isSet bool
}

func (v NullableTechniqueBlock) Get() *TechniqueBlock {
	return v.value
}

func (v *NullableTechniqueBlock) Set(val *TechniqueBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueBlock(val *TechniqueBlock) *NullableTechniqueBlock {
	return &NullableTechniqueBlock{value: val, isSet: true}
}

func (v NullableTechniqueBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
