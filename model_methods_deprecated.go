...
// checks if the MethodsDeprecated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MethodsDeprecated{}

// MethodsDeprecated Is this method deprecated?
type MethodsDeprecated struct {
...
func (o MethodsDeprecated) MarshalJSON() ([]byte, error) {
...
func (o MethodsDeprecated) ToMap() (map[string]interface{}, error) {
...
type NullableMethodsDeprecated struct {
	value *MethodsDeprecated
	isSet bool
}

func (v NullableMethodsDeprecated) Get() *MethodsDeprecated {
	return v.value
}

func (v *NullableMethodsDeprecated) Set(val *MethodsDeprecated) {
	v.value = val
	v.isSet = true
}

func (v NullableMethodsDeprecated) IsSet() bool {
	return v.isSet
}

func (v *NullableMethodsDeprecated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMethodsDeprecated(val *MethodsDeprecated) *NullableMethodsDeprecated {
	return &NullableMethodsDeprecated{value: val, isSet: true}
}

func (v NullableMethodsDeprecated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMethodsDeprecated) UnmarshalJSON(src []byte) error {
	v.isSet = true
