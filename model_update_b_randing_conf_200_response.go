...
// checks if the UpdateBRandingConf200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateBRandingConf200Response{}

// UpdateBRandingConf200Response struct for UpdateBRandingConf200Response
type UpdateBRandingConf200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetBrandingConf200ResponseData `json:"data"`
}

type _UpdateBRandingConf200Response UpdateBRandingConf200Response
...
func NewUpdateBRandingConf200Response(result string, action string, data GetBrandingConf200ResponseData) *UpdateBRandingConf200Response {
	this := UpdateBRandingConf200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *UpdateBRandingConf200Response) GetData() GetBrandingConf200ResponseData {
	if o == nil {
		var ret GetBrandingConf200ResponseData
		return ret
	}
...
func (o UpdateBRandingConf200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateBRandingConf200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateBRandingConf200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateBRandingConf200Response := _UpdateBRandingConf200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateBRandingConf200Response)

	if err != nil {
		return err
	}

	*o = UpdateBRandingConf200Response(varUpdateBRandingConf200Response)

	return err
}

type NullableUpdateBRandingConf200Response struct {
	value *UpdateBRandingConf200Response
	isSet bool
}

func (v NullableUpdateBRandingConf200Response) Get() *UpdateBRandingConf200Response {
	return v.value
}

func (v *NullableUpdateBRandingConf200Response) Set(val *UpdateBRandingConf200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateBRandingConf200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateBRandingConf200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateBRandingConf200Response(val *UpdateBRandingConf200Response) *NullableUpdateBRandingConf200Response {
	return &NullableUpdateBRandingConf200Response{value: val, isSet: true}
}

func (v NullableUpdateBRandingConf200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateBRandingConf200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
