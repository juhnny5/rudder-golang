...
// checks if the GetTechniqueAllVersion200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTechniqueAllVersion200Response{}

// GetTechniqueAllVersion200Response struct for GetTechniqueAllVersion200Response
type GetTechniqueAllVersion200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetTechniqueAllVersion200ResponseData `json:"data"`
}

type _GetTechniqueAllVersion200Response GetTechniqueAllVersion200Response
...
func NewGetTechniqueAllVersion200Response(result string, action string, data GetTechniqueAllVersion200ResponseData) *GetTechniqueAllVersion200Response {
	this := GetTechniqueAllVersion200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetTechniqueAllVersion200Response) GetData() GetTechniqueAllVersion200ResponseData {
	if o == nil {
		var ret GetTechniqueAllVersion200ResponseData
		return ret
	}
...
func (o GetTechniqueAllVersion200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTechniqueAllVersion200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetTechniqueAllVersion200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTechniqueAllVersion200Response := _GetTechniqueAllVersion200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTechniqueAllVersion200Response)

	if err != nil {
		return err
	}

	*o = GetTechniqueAllVersion200Response(varGetTechniqueAllVersion200Response)

	return err
}

type NullableGetTechniqueAllVersion200Response struct {
	value *GetTechniqueAllVersion200Response
	isSet bool
}

func (v NullableGetTechniqueAllVersion200Response) Get() *GetTechniqueAllVersion200Response {
	return v.value
}

func (v *NullableGetTechniqueAllVersion200Response) Set(val *GetTechniqueAllVersion200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTechniqueAllVersion200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTechniqueAllVersion200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTechniqueAllVersion200Response(val *GetTechniqueAllVersion200Response) *NullableGetTechniqueAllVersion200Response {
	return &NullableGetTechniqueAllVersion200Response{value: val, isSet: true}
}

func (v NullableGetTechniqueAllVersion200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTechniqueAllVersion200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
