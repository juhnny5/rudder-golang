...
type ApiFileWatcherRestartRequest struct {
	ctx context.Context
	ApiService *InventoriesAPIService
}

func (r ApiFileWatcherRestartRequest) Execute() (*FileWatcherRestart200Response, *http.Response, error) {
	return r.ApiService.FileWatcherRestartExecute(r)
}
...
Restart the inventory watcher if necessary
 ...
 @return ApiFileWatcherRestartRequest
*/
func (a *InventoriesAPIService) FileWatcherRestart(ctx context.Context) ApiFileWatcherRestartRequest {
	return ApiFileWatcherRestartRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return FileWatcherRestart200Response
func (a *InventoriesAPIService) FileWatcherRestartExecute(r ApiFileWatcherRestartRequest) (*FileWatcherRestart200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FileWatcherRestart200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InventoriesAPIService.FileWatcherRestart")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/inventories/watcher/restart"
...
type ApiFileWatcherStartRequest struct {
	ctx context.Context
	ApiService *InventoriesAPIService
}

func (r ApiFileWatcherStartRequest) Execute() (*FileWatcherStart200Response, *http.Response, error) {
	return r.ApiService.FileWatcherStartExecute(r)
}
...
Start the inventory watcher if necessary
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiFileWatcherStartRequest
*/
func (a *InventoriesAPIService) FileWatcherStart(ctx context.Context) ApiFileWatcherStartRequest {
	return ApiFileWatcherStartRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return FileWatcherStart200Response
func (a *InventoriesAPIService) FileWatcherStartExecute(r ApiFileWatcherStartRequest) (*FileWatcherStart200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FileWatcherStart200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InventoriesAPIService.FileWatcherStart")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/inventories/watcher/start"
...
type ApiFileWatcherStopRequest struct {
	ctx context.Context
	ApiService *InventoriesAPIService
}

func (r ApiFileWatcherStopRequest) Execute() (*FileWatcherStop200Response, *http.Response, error) {
	return r.ApiService.FileWatcherStopExecute(r)
}
...
Stop the inventory watcher if necessary
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiFileWatcherStopRequest
*/
func (a *InventoriesAPIService) FileWatcherStop(ctx context.Context) ApiFileWatcherStopRequest {
	return ApiFileWatcherStopRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return FileWatcherStop200Response
func (a *InventoriesAPIService) FileWatcherStopExecute(r ApiFileWatcherStopRequest) (*FileWatcherStop200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FileWatcherStop200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InventoriesAPIService.FileWatcherStop")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/inventories/watcher/stop"
...
type ApiQueueInformationRequest struct {
	ctx context.Context
	ApiService *InventoriesAPIService
}

func (r ApiQueueInformationRequest) Execute() (*QueueInformation200Response, *http.Response, error) {
	return r.ApiService.QueueInformationExecute(r)
}
...
Provide information about the current state of the inventory processor
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiQueueInformationRequest
*/
func (a *InventoriesAPIService) QueueInformation(ctx context.Context) ApiQueueInformationRequest {
	return ApiQueueInformationRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return QueueInformation200Response
func (a *InventoriesAPIService) QueueInformationExecute(r ApiQueueInformationRequest) (*QueueInformation200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *QueueInformation200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InventoriesAPIService.QueueInformation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/inventories/info"
...
type ApiUploadInventoryRequest struct {
	ctx context.Context
	ApiService *InventoriesAPIService
	file *os.File
	signature *os.File
...
func (r ApiUploadInventoryRequest) File(file *os.File) ApiUploadInventoryRequest {
	r.file = file
	return r
}

// The signature file. The original file name is used to check extension, that should be ${originalInventoryFileName}.sign[.gz]
func (r ApiUploadInventoryRequest) Signature(signature *os.File) ApiUploadInventoryRequest {
	r.signature = signature
	return r
}

func (r ApiUploadInventoryRequest) Execute() (*UploadInventory200Response, *http.Response, error) {
	return r.ApiService.UploadInventoryExecute(r)
}
...
Upload an inventory to the web application
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUploadInventoryRequest
*/
func (a *InventoriesAPIService) UploadInventory(ctx context.Context) ApiUploadInventoryRequest {
	return ApiUploadInventoryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return UploadInventory200Response
func (a *InventoriesAPIService) UploadInventoryExecute(r ApiUploadInventoryRequest) (*UploadInventory200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UploadInventory200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InventoriesAPIService.UploadInventory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/inventories/upload"
