...
// checks if the CveDetailsCvssv2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CveDetailsCvssv2{}
...
func (o CveDetailsCvssv2) MarshalJSON() ([]byte, error) {
...
func (o CveDetailsCvssv2) ToMap() (map[string]interface{}, error) {
...
type NullableCveDetailsCvssv2 struct {
	value *CveDetailsCvssv2
	isSet bool
}

func (v NullableCveDetailsCvssv2) Get() *CveDetailsCvssv2 {
	return v.value
}

func (v *NullableCveDetailsCvssv2) Set(val *CveDetailsCvssv2) {
	v.value = val
	v.isSet = true
}

func (v NullableCveDetailsCvssv2) IsSet() bool {
	return v.isSet
}

func (v *NullableCveDetailsCvssv2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCveDetailsCvssv2(val *CveDetailsCvssv2) *NullableCveDetailsCvssv2 {
	return &NullableCveDetailsCvssv2{value: val, isSet: true}
}

func (v NullableCveDetailsCvssv2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCveDetailsCvssv2) UnmarshalJSON(src []byte) error {
	v.isSet = true
