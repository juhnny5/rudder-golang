...
// checks if the NodeInheritedPropertiesPropertiesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeInheritedPropertiesPropertiesInner{}

// NodeInheritedPropertiesPropertiesInner struct for NodeInheritedPropertiesPropertiesInner
type NodeInheritedPropertiesPropertiesInner struct {
	// Property name
	...
	Hierarchy []NodeInheritedPropertiesPropertiesInnerHierarchyInner `json:"hierarchy,omitempty"`
	// The original value (ie, before overriding and inheritance resolution) for that node
	Origval interface{} `json:"origval,omitempty"`
}

type _NodeInheritedPropertiesPropertiesInner NodeInheritedPropertiesPropertiesInner
...
func NewNodeInheritedPropertiesPropertiesInner(name string, value interface{}) *NodeInheritedPropertiesPropertiesInner {
	this := NodeInheritedPropertiesPropertiesInner{}
	this.Name = name
	this.Value = value
	return &this
}
...
func (o *NodeInheritedPropertiesPropertiesInner) GetHierarchy() []NodeInheritedPropertiesPropertiesInnerHierarchyInner {
	if o == nil || IsNil(o.Hierarchy) {
		var ret []NodeInheritedPropertiesPropertiesInnerHierarchyInner
		return ret
	}
	return o.Hierarchy
}
...
// SetHierarchy gets a reference to the given []NodeInheritedPropertiesPropertiesInnerHierarchyInner and assigns it to the Hierarchy field.
func (o *NodeInheritedPropertiesPropertiesInner) SetHierarchy(v []NodeInheritedPropertiesPropertiesInnerHierarchyInner) {
	o.Hierarchy = v
}

// GetOrigval returns the Origval field value if set, zero value otherwise (both if not set or set to explicit null).
...
// GetOrigvalOk returns a tuple with the Origval field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodeInheritedPropertiesPropertiesInner) GetOrigvalOk() (*interface{}, bool) {
	if o == nil || IsNil(o.Origval) {
		return nil, false
	}
	return &o.Origval, true
}
...
// SetOrigval gets a reference to the given interface{} and assigns it to the Origval field.
func (o *NodeInheritedPropertiesPropertiesInner) SetOrigval(v interface{}) {
	o.Origval = v
}

func (o NodeInheritedPropertiesPropertiesInner) MarshalJSON() ([]byte, error) {
...
func (o NodeInheritedPropertiesPropertiesInner) ToMap() (map[string]interface{}, error) {
	...
	if o.Origval != nil {
		toSerialize["origval"] = o.Origval
	}
	return toSerialize, nil
}

func (o *NodeInheritedPropertiesPropertiesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeInheritedPropertiesPropertiesInner := _NodeInheritedPropertiesPropertiesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeInheritedPropertiesPropertiesInner)

	if err != nil {
		return err
	}

	*o = NodeInheritedPropertiesPropertiesInner(varNodeInheritedPropertiesPropertiesInner)

	return err
}

type NullableNodeInheritedPropertiesPropertiesInner struct {
	value *NodeInheritedPropertiesPropertiesInner
	isSet bool
}

func (v NullableNodeInheritedPropertiesPropertiesInner) Get() *NodeInheritedPropertiesPropertiesInner {
	return v.value
}

func (v *NullableNodeInheritedPropertiesPropertiesInner) Set(val *NodeInheritedPropertiesPropertiesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeInheritedPropertiesPropertiesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeInheritedPropertiesPropertiesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeInheritedPropertiesPropertiesInner(val *NodeInheritedPropertiesPropertiesInner) *NullableNodeInheritedPropertiesPropertiesInner {
	return &NullableNodeInheritedPropertiesPropertiesInner{value: val, isSet: true}
}

func (v NullableNodeInheritedPropertiesPropertiesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeInheritedPropertiesPropertiesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
