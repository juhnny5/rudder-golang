...
// checks if the GetNodesStatus200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodesStatus200Response{}

// GetNodesStatus200Response struct for GetNodesStatus200Response
type GetNodesStatus200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetNodesStatus200ResponseData `json:"data"`
}

type _GetNodesStatus200Response GetNodesStatus200Response
...
func NewGetNodesStatus200Response(result string, action string, data GetNodesStatus200ResponseData) *GetNodesStatus200Response {
	this := GetNodesStatus200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetNodesStatus200Response) GetData() GetNodesStatus200ResponseData {
	if o == nil {
		var ret GetNodesStatus200ResponseData
		return ret
	}
...
func (o GetNodesStatus200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNodesStatus200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetNodesStatus200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodesStatus200Response := _GetNodesStatus200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodesStatus200Response)

	if err != nil {
		return err
	}

	*o = GetNodesStatus200Response(varGetNodesStatus200Response)

	return err
}

type NullableGetNodesStatus200Response struct {
	value *GetNodesStatus200Response
	isSet bool
}

func (v NullableGetNodesStatus200Response) Get() *GetNodesStatus200Response {
	return v.value
}

func (v *NullableGetNodesStatus200Response) Set(val *GetNodesStatus200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodesStatus200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodesStatus200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodesStatus200Response(val *GetNodesStatus200Response) *NullableGetNodesStatus200Response {
	return &NullableGetNodesStatus200Response{value: val, isSet: true}
}

func (v NullableGetNodesStatus200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodesStatus200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
