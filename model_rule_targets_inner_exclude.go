...
// checks if the RuleTargetsInnerExclude type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleTargetsInnerExclude{}

// RuleTargetsInnerExclude list of groups to exclude from rule application
type RuleTargetsInnerExclude struct {
	Or []RuleTarget `json:"or,omitempty"`
}
...
// SetOr gets a reference to the given []RuleTarget and assigns it to the Or field.
func (o *RuleTargetsInnerExclude) SetOr(v []RuleTarget) {
	o.Or = v
}

func (o RuleTargetsInnerExclude) MarshalJSON() ([]byte, error) {
...
func (o RuleTargetsInnerExclude) ToMap() (map[string]interface{}, error) {
...
type NullableRuleTargetsInnerExclude struct {
	value *RuleTargetsInnerExclude
	isSet bool
}

func (v NullableRuleTargetsInnerExclude) Get() *RuleTargetsInnerExclude {
	return v.value
}

func (v *NullableRuleTargetsInnerExclude) Set(val *RuleTargetsInnerExclude) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleTargetsInnerExclude) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleTargetsInnerExclude) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleTargetsInnerExclude(val *RuleTargetsInnerExclude) *NullableRuleTargetsInnerExclude {
	return &NullableRuleTargetsInnerExclude{value: val, isSet: true}
}

func (v NullableRuleTargetsInnerExclude) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleTargetsInnerExclude) UnmarshalJSON(src []byte) error {
	v.isSet = true
