...
// checks if the ListAcceptedNodes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAcceptedNodes200Response{}

// ListAcceptedNodes200Response struct for ListAcceptedNodes200Response
type ListAcceptedNodes200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ListAcceptedNodes200ResponseData `json:"data"`
}

type _ListAcceptedNodes200Response ListAcceptedNodes200Response
...
func NewListAcceptedNodes200Response(result string, action string, data ListAcceptedNodes200ResponseData) *ListAcceptedNodes200Response {
	this := ListAcceptedNodes200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ListAcceptedNodes200Response) GetData() ListAcceptedNodes200ResponseData {
	if o == nil {
		var ret ListAcceptedNodes200ResponseData
		return ret
	}
...
func (o ListAcceptedNodes200Response) MarshalJSON() ([]byte, error) {
...
func (o ListAcceptedNodes200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListAcceptedNodes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListAcceptedNodes200Response := _ListAcceptedNodes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListAcceptedNodes200Response)

	if err != nil {
		return err
	}

	*o = ListAcceptedNodes200Response(varListAcceptedNodes200Response)

	return err
}

type NullableListAcceptedNodes200Response struct {
	value *ListAcceptedNodes200Response
	isSet bool
}

func (v NullableListAcceptedNodes200Response) Get() *ListAcceptedNodes200Response {
	return v.value
}

func (v *NullableListAcceptedNodes200Response) Set(val *ListAcceptedNodes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAcceptedNodes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAcceptedNodes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAcceptedNodes200Response(val *ListAcceptedNodes200Response) *NullableListAcceptedNodes200Response {
	return &NullableListAcceptedNodes200Response{value: val, isSet: true}
}

func (v NullableListAcceptedNodes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAcceptedNodes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
