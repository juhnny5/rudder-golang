...
// checks if the TechniqueCategories200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueCategories200ResponseData{}

// TechniqueCategories200ResponseData struct for TechniqueCategories200ResponseData
type TechniqueCategories200ResponseData struct {
	TechniqueCategories CategoriesTree `json:"techniqueCategories"`
}

type _TechniqueCategories200ResponseData TechniqueCategories200ResponseData
...
func NewTechniqueCategories200ResponseData(techniqueCategories CategoriesTree) *TechniqueCategories200ResponseData {
	this := TechniqueCategories200ResponseData{}
	this.TechniqueCategories = techniqueCategories
	return &this
}
...
// GetTechniqueCategories returns the TechniqueCategories field value
func (o *TechniqueCategories200ResponseData) GetTechniqueCategories() CategoriesTree {
	if o == nil {
		var ret CategoriesTree
		return ret
	}

	return o.TechniqueCategories
}

// GetTechniqueCategoriesOk returns a tuple with the TechniqueCategories field value
// and a boolean to check if the value has been set.
func (o *TechniqueCategories200ResponseData) GetTechniqueCategoriesOk() (*CategoriesTree, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TechniqueCategories, true
}

// SetTechniqueCategories sets field value
func (o *TechniqueCategories200ResponseData) SetTechniqueCategories(v CategoriesTree) {
	o.TechniqueCategories = v
}

func (o TechniqueCategories200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o TechniqueCategories200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["techniqueCategories"] = o.TechniqueCategories
	return toSerialize, nil
}

func (o *TechniqueCategories200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varTechniqueCategories200ResponseData := _TechniqueCategories200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTechniqueCategories200ResponseData)

	if err != nil {
		return err
	}

	*o = TechniqueCategories200ResponseData(varTechniqueCategories200ResponseData)

	return err
}

type NullableTechniqueCategories200ResponseData struct {
	value *TechniqueCategories200ResponseData
	isSet bool
}

func (v NullableTechniqueCategories200ResponseData) Get() *TechniqueCategories200ResponseData {
	return v.value
}

func (v *NullableTechniqueCategories200ResponseData) Set(val *TechniqueCategories200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueCategories200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueCategories200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueCategories200ResponseData(val *TechniqueCategories200ResponseData) *NullableTechniqueCategories200ResponseData {
	return &NullableTechniqueCategories200ResponseData{value: val, isSet: true}
}

func (v NullableTechniqueCategories200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueCategories200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
