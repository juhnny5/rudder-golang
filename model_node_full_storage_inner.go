...
// checks if the NodeFullStorageInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullStorageInner{}

// NodeFullStorageInner struct for NodeFullStorageInner
type NodeFullStorageInner struct {
	// Storage name
...
func (o NodeFullStorageInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullStorageInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullStorageInner struct {
	value *NodeFullStorageInner
	isSet bool
}

func (v NullableNodeFullStorageInner) Get() *NodeFullStorageInner {
	return v.value
}

func (v *NullableNodeFullStorageInner) Set(val *NodeFullStorageInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullStorageInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullStorageInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullStorageInner(val *NodeFullStorageInner) *NullableNodeFullStorageInner {
	return &NullableNodeFullStorageInner{value: val, isSet: true}
}

func (v NullableNodeFullStorageInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullStorageInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
