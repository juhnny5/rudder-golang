...
// checks if the GroupNewQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupNewQuery{}
...
type GroupNewQuery struct {
	...
	// List of criteria
	Where []GroupQueryWhereInner `json:"where,omitempty"`
}
...
func NewGroupNewQuery() *GroupNewQuery {
	this := GroupNewQuery{}
	var select_ string = "node"
	this.Select = &select_
	var composition string = "and"
...
// SetWhere gets a reference to the given []GroupQueryWhereInner and assigns it to the Where field.
func (o *GroupNewQuery) SetWhere(v []GroupQueryWhereInner) {
	o.Where = v
}

func (o GroupNewQuery) MarshalJSON() ([]byte, error) {
...
func (o GroupNewQuery) ToMap() (map[string]interface{}, error) {
...
type NullableGroupNewQuery struct {
	value *GroupNewQuery
	isSet bool
}

func (v NullableGroupNewQuery) Get() *GroupNewQuery {
	return v.value
}

func (v *NullableGroupNewQuery) Set(val *GroupNewQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupNewQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupNewQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupNewQuery(val *GroupNewQuery) *NullableGroupNewQuery {
	return &NullableGroupNewQuery{value: val, isSet: true}
}

func (v NullableGroupNewQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupNewQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
