...
// SystemUpdateCampaignsAPIService SystemUpdateCampaignsAPI service
type SystemUpdateCampaignsAPIService service

type ApiGetCampaignEventResultRequest struct {
	ctx context.Context
	ApiService *SystemUpdateCampaignsAPIService
	id string
}

func (r ApiGetCampaignEventResultRequest) Execute() (*GetCampaignEventResult200Response, *http.Response, error) {
	return r.ApiService.GetCampaignEventResultExecute(r)
}
...
Get a campaign event result
 ...
 @return ApiGetCampaignEventResultRequest
*/
func (a *SystemUpdateCampaignsAPIService) GetCampaignEventResult(ctx context.Context, id string) ApiGetCampaignEventResultRequest {
	return ApiGetCampaignEventResultRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *SystemUpdateCampaignsAPIService) GetCampaignEventResultExecute(r ApiGetCampaignEventResultRequest) (*GetCampaignEventResult200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetCampaignEventResult200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SystemUpdateCampaignsAPIService.GetCampaignEventResult")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/systemUpdate/events/{id}/result"
...
type ApiGetCampaignResultsRequest struct {
	ctx context.Context
	ApiService *SystemUpdateCampaignsAPIService
	id string
	limit *int32
...
func (r ApiGetCampaignResultsRequest) Limit(limit int32) ApiGetCampaignResultsRequest {
	r.limit = &limit
	return r
}

// Offset of data in response (skip X elements)
func (r ApiGetCampaignResultsRequest) Offset(offset int32) ApiGetCampaignResultsRequest {
	r.offset = &offset
	return r
}

func (r ApiGetCampaignResultsRequest) Before(before string) ApiGetCampaignResultsRequest {
	r.before = &before
	return r
}

func (r ApiGetCampaignResultsRequest) After(after string) ApiGetCampaignResultsRequest {
	r.after = &after
	return r
}

func (r ApiGetCampaignResultsRequest) Order(order string) ApiGetCampaignResultsRequest {
	r.order = &order
	return r
}

func (r ApiGetCampaignResultsRequest) Asc(asc string) ApiGetCampaignResultsRequest {
	r.asc = &asc
	return r
}

func (r ApiGetCampaignResultsRequest) Execute() (*GetCampaignResults200Response, *http.Response, error) {
	return r.ApiService.GetCampaignResultsExecute(r)
}
...
Get a campaign result history
 ...
 @return ApiGetCampaignResultsRequest
*/
func (a *SystemUpdateCampaignsAPIService) GetCampaignResults(ctx context.Context, id string) ApiGetCampaignResultsRequest {
	return ApiGetCampaignResultsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetCampaignResults200Response
func (a *SystemUpdateCampaignsAPIService) GetCampaignResultsExecute(r ApiGetCampaignResultsRequest) (*GetCampaignResults200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetCampaignResults200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SystemUpdateCampaignsAPIService.GetCampaignResults")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/systemUpdate/campaign/{id}/history"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiGetSystemUpdateResultForNodeRequest struct {
	ctx context.Context
	ApiService *SystemUpdateCampaignsAPIService
	id string
	nodeId string
...
func (r ApiGetSystemUpdateResultForNodeRequest) Execute() (*GetSystemUpdateResultForNode200Response, *http.Response, error) {
	return r.ApiService.GetSystemUpdateResultForNodeExecute(r)
}
...
Get detailed campaign event result for a Node
 ...
 @return ApiGetSystemUpdateResultForNodeRequest
*/
func (a *SystemUpdateCampaignsAPIService) GetSystemUpdateResultForNode(ctx context.Context, id string, nodeId string) ApiGetSystemUpdateResultForNodeRequest {
	return ApiGetSystemUpdateResultForNodeRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetSystemUpdateResultForNode200Response
func (a *SystemUpdateCampaignsAPIService) GetSystemUpdateResultForNodeExecute(r ApiGetSystemUpdateResultForNodeRequest) (*GetSystemUpdateResultForNode200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSystemUpdateResultForNode200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SystemUpdateCampaignsAPIService.GetSystemUpdateResultForNode")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/systemUpdate/events/{id}/result/{nodeId}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
