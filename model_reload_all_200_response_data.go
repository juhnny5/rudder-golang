...
// checks if the ReloadAll200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadAll200ResponseData{}

// ReloadAll200ResponseData struct for ReloadAll200ResponseData
type ReloadAll200ResponseData struct {
	Groups string `json:"groups"`
	Techniques string `json:"techniques"`
}

type _ReloadAll200ResponseData ReloadAll200ResponseData
...
func (o ReloadAll200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ReloadAll200ResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadAll200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadAll200ResponseData := _ReloadAll200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadAll200ResponseData)

	if err != nil {
		return err
	}

	*o = ReloadAll200ResponseData(varReloadAll200ResponseData)

	return err
}

type NullableReloadAll200ResponseData struct {
	value *ReloadAll200ResponseData
	isSet bool
}

func (v NullableReloadAll200ResponseData) Get() *ReloadAll200ResponseData {
	return v.value
}

func (v *NullableReloadAll200ResponseData) Set(val *ReloadAll200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadAll200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadAll200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadAll200ResponseData(val *ReloadAll200ResponseData) *NullableReloadAll200ResponseData {
	return &NullableReloadAll200ResponseData{value: val, isSet: true}
}

func (v NullableReloadAll200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadAll200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
