...
// checks if the UpdateCVECheckConfigurationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCVECheckConfigurationRequest{}

// UpdateCVECheckConfigurationRequest CVE check config
...
func NewUpdateCVECheckConfigurationRequest() *UpdateCVECheckConfigurationRequest {
	this := UpdateCVECheckConfigurationRequest{}
	return &this
}
...
func (o UpdateCVECheckConfigurationRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateCVECheckConfigurationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateCVECheckConfigurationRequest struct {
	value *UpdateCVECheckConfigurationRequest
	isSet bool
}

func (v NullableUpdateCVECheckConfigurationRequest) Get() *UpdateCVECheckConfigurationRequest {
	return v.value
}

func (v *NullableUpdateCVECheckConfigurationRequest) Set(val *UpdateCVECheckConfigurationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCVECheckConfigurationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCVECheckConfigurationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCVECheckConfigurationRequest(val *UpdateCVECheckConfigurationRequest) *NullableUpdateCVECheckConfigurationRequest {
	return &NullableUpdateCVECheckConfigurationRequest{value: val, isSet: true}
}

func (v NullableUpdateCVECheckConfigurationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCVECheckConfigurationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
