...
// checks if the ChangePendingNodeStatusRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangePendingNodeStatusRequest{}

// ChangePendingNodeStatusRequest struct for ChangePendingNodeStatusRequest
...
func NewChangePendingNodeStatusRequest() *ChangePendingNodeStatusRequest {
	this := ChangePendingNodeStatusRequest{}
	return &this
}
...
func (o ChangePendingNodeStatusRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangePendingNodeStatusRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangePendingNodeStatusRequest struct {
	value *ChangePendingNodeStatusRequest
	isSet bool
}

func (v NullableChangePendingNodeStatusRequest) Get() *ChangePendingNodeStatusRequest {
	return v.value
}

func (v *NullableChangePendingNodeStatusRequest) Set(val *ChangePendingNodeStatusRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangePendingNodeStatusRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangePendingNodeStatusRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangePendingNodeStatusRequest(val *ChangePendingNodeStatusRequest) *NullableChangePendingNodeStatusRequest {
	return &NullableChangePendingNodeStatusRequest{value: val, isSet: true}
}

func (v NullableChangePendingNodeStatusRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangePendingNodeStatusRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
