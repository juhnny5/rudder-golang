...
// checks if the UpdateRuleCategory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateRuleCategory200Response{}

// UpdateRuleCategory200Response struct for UpdateRuleCategory200Response
type UpdateRuleCategory200Response struct {
...
type _UpdateRuleCategory200Response UpdateRuleCategory200Response
...
func NewUpdateRuleCategory200Response(result string, action string, data CreateRuleCategory200ResponseData) *UpdateRuleCategory200Response {
	this := UpdateRuleCategory200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o UpdateRuleCategory200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateRuleCategory200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateRuleCategory200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateRuleCategory200Response := _UpdateRuleCategory200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateRuleCategory200Response)

	if err != nil {
		return err
	}

	*o = UpdateRuleCategory200Response(varUpdateRuleCategory200Response)

	return err
}

type NullableUpdateRuleCategory200Response struct {
	value *UpdateRuleCategory200Response
	isSet bool
}

func (v NullableUpdateRuleCategory200Response) Get() *UpdateRuleCategory200Response {
	return v.value
}

func (v *NullableUpdateRuleCategory200Response) Set(val *UpdateRuleCategory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRuleCategory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRuleCategory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRuleCategory200Response(val *UpdateRuleCategory200Response) *NullableUpdateRuleCategory200Response {
	return &NullableUpdateRuleCategory200Response{value: val, isSet: true}
}

func (v NullableUpdateRuleCategory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRuleCategory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
