...
// checks if the CreateDataSource200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDataSource200Response{}

// CreateDataSource200Response struct for CreateDataSource200Response
type CreateDataSource200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data CreateDataSource200ResponseData `json:"data"`
}

type _CreateDataSource200Response CreateDataSource200Response
...
func NewCreateDataSource200Response(result string, action string, data CreateDataSource200ResponseData) *CreateDataSource200Response {
	this := CreateDataSource200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *CreateDataSource200Response) GetData() CreateDataSource200ResponseData {
	if o == nil {
		var ret CreateDataSource200ResponseData
		return ret
	}
...
func (o CreateDataSource200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateDataSource200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateDataSource200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateDataSource200Response := _CreateDataSource200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateDataSource200Response)

	if err != nil {
		return err
	}

	*o = CreateDataSource200Response(varCreateDataSource200Response)

	return err
}

type NullableCreateDataSource200Response struct {
	value *CreateDataSource200Response
	isSet bool
}

func (v NullableCreateDataSource200Response) Get() *CreateDataSource200Response {
	return v.value
}

func (v *NullableCreateDataSource200Response) Set(val *CreateDataSource200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDataSource200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDataSource200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDataSource200Response(val *CreateDataSource200Response) *NullableCreateDataSource200Response {
	return &NullableCreateDataSource200Response{value: val, isSet: true}
}

func (v NullableCreateDataSource200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDataSource200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
