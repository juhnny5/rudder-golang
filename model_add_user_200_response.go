...
type AddUser200Response struct {
	...
	Data AddUser200ResponseData `json:"data"`
}
...
func (o *AddUser200Response) GetData() AddUser200ResponseData {
	if o == nil {
		var ret AddUser200ResponseData
		return ret
	}
...
func (o *AddUser200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varAddUser200Response := _AddUser200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddUser200Response)

	if err != nil {
		return err
	}

	*o = AddUser200Response(varAddUser200Response)
