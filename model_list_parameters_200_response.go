...
// checks if the ListParameters200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListParameters200Response{}

// ListParameters200Response struct for ListParameters200Response
type ListParameters200Response struct {
...
type _ListParameters200Response ListParameters200Response
...
func NewListParameters200Response(result string, action string, data ListParameters200ResponseData) *ListParameters200Response {
	this := ListParameters200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ListParameters200Response) MarshalJSON() ([]byte, error) {
...
func (o ListParameters200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListParameters200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListParameters200Response := _ListParameters200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListParameters200Response)

	if err != nil {
		return err
	}

	*o = ListParameters200Response(varListParameters200Response)

	return err
}

type NullableListParameters200Response struct {
	value *ListParameters200Response
	isSet bool
}

func (v NullableListParameters200Response) Get() *ListParameters200Response {
	return v.value
}

func (v *NullableListParameters200Response) Set(val *ListParameters200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListParameters200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListParameters200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListParameters200Response(val *ListParameters200Response) *NullableListParameters200Response {
	return &NullableListParameters200Response{value: val, isSet: true}
}

func (v NullableListParameters200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListParameters200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
