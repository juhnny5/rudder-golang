...
func (r ApiCallImportRequest) Archive(archive *os.File) ApiCallImportRequest {
	r.archive = archive
	return r
}
...
func (r ApiCallImportRequest) Merge(merge string) ApiCallImportRequest {
	r.merge = &merge
	return r
}

func (r ApiCallImportRequest) Execute() (*Import200Response, *http.Response, error) {
	return r.ApiService.CallImportExecute(r)
}

/*
CallImport Import a ZIP archive of policies into Rudder
...
*/
func (a *ArchivesAPIService) CallImport(ctx context.Context) ApiCallImportRequest {
	return ApiCallImportRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Import200Response
func (a *ArchivesAPIService) CallImportExecute(r ApiCallImportRequest) (*Import200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Import200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ArchivesAPIService.CallImport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/archives/import"
	...
	if r.merge != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "merge", r.merge, "")
	}
	if r.ctx != nil {
...
func (r ApiExportRequest) Rules(rules []string) ApiExportRequest {
	r.rules = &rules
	return r
}

// IDs (optionally with revision, &#39;+&#39; need to be escaped as &#39;%2B&#39;) of directives to include
func (r ApiExportRequest) Directives(directives []string) ApiExportRequest {
...
func (r ApiExportRequest) Techniques(techniques []string) ApiExportRequest {
	r.techniques = &techniques
	return r
}

// IDs (optionally with revision, &#39;+&#39; need to be escaped as &#39;%2B&#39;) of groups to include
func (r ApiExportRequest) Groups(groups []string) ApiExportRequest {
	r.groups = &groups
	return r
}
...
func (r ApiExportRequest) Include(include []string) ApiExportRequest {
	r.include = &include
	return r
}
...
*/
func (a *ArchivesAPIService) Export(ctx context.Context) ApiExportRequest {
	return ApiExportRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return *os.File
func (a *ArchivesAPIService) ExportExecute(r ApiExportRequest) (*os.File, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ArchivesAPIService.Export")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/archives/export"
	...
	if r.directives != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "directives", r.directives, "csv")
	}
	if r.techniques != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "techniques", r.techniques, "csv")
	}
	if r.groups != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "groups", r.groups, "csv")
	}
	if r.include != nil {
