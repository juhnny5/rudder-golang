...
// checks if the ReloadAllDatasourcesAllNodes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadAllDatasourcesAllNodes200Response{}

// ReloadAllDatasourcesAllNodes200Response struct for ReloadAllDatasourcesAllNodes200Response
type ReloadAllDatasourcesAllNodes200Response struct {
...
type _ReloadAllDatasourcesAllNodes200Response ReloadAllDatasourcesAllNodes200Response
...
func NewReloadAllDatasourcesAllNodes200Response(result string, action string, data string) *ReloadAllDatasourcesAllNodes200Response {
	this := ReloadAllDatasourcesAllNodes200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ReloadAllDatasourcesAllNodes200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadAllDatasourcesAllNodes200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadAllDatasourcesAllNodes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadAllDatasourcesAllNodes200Response := _ReloadAllDatasourcesAllNodes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadAllDatasourcesAllNodes200Response)

	if err != nil {
		return err
	}

	*o = ReloadAllDatasourcesAllNodes200Response(varReloadAllDatasourcesAllNodes200Response)

	return err
}

type NullableReloadAllDatasourcesAllNodes200Response struct {
	value *ReloadAllDatasourcesAllNodes200Response
	isSet bool
}

func (v NullableReloadAllDatasourcesAllNodes200Response) Get() *ReloadAllDatasourcesAllNodes200Response {
	return v.value
}

func (v *NullableReloadAllDatasourcesAllNodes200Response) Set(val *ReloadAllDatasourcesAllNodes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadAllDatasourcesAllNodes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadAllDatasourcesAllNodes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadAllDatasourcesAllNodes200Response(val *ReloadAllDatasourcesAllNodes200Response) *NullableReloadAllDatasourcesAllNodes200Response {
	return &NullableReloadAllDatasourcesAllNodes200Response{value: val, isSet: true}
}

func (v NullableReloadAllDatasourcesAllNodes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadAllDatasourcesAllNodes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
