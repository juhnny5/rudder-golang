...
// checks if the GetNodesCompliance200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodesCompliance200ResponseData{}

// GetNodesCompliance200ResponseData struct for GetNodesCompliance200ResponseData
type GetNodesCompliance200ResponseData struct {
	Nodes []GetNodesCompliance200ResponseDataNodesInner `json:"nodes"`
}

type _GetNodesCompliance200ResponseData GetNodesCompliance200ResponseData
...
func NewGetNodesCompliance200ResponseData(nodes []GetNodesCompliance200ResponseDataNodesInner) *GetNodesCompliance200ResponseData {
	this := GetNodesCompliance200ResponseData{}
	this.Nodes = nodes
	return &this
}
...
func (o *GetNodesCompliance200ResponseData) GetNodes() []GetNodesCompliance200ResponseDataNodesInner {
	if o == nil {
		var ret []GetNodesCompliance200ResponseDataNodesInner
		return ret
	}
...
func (o GetNodesCompliance200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetNodesCompliance200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodes"] = o.Nodes
	return toSerialize, nil
}

func (o *GetNodesCompliance200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodesCompliance200ResponseData := _GetNodesCompliance200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodesCompliance200ResponseData)

	if err != nil {
		return err
	}

	*o = GetNodesCompliance200ResponseData(varGetNodesCompliance200ResponseData)

	return err
}

type NullableGetNodesCompliance200ResponseData struct {
	value *GetNodesCompliance200ResponseData
	isSet bool
}

func (v NullableGetNodesCompliance200ResponseData) Get() *GetNodesCompliance200ResponseData {
	return v.value
}

func (v *NullableGetNodesCompliance200ResponseData) Set(val *GetNodesCompliance200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodesCompliance200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodesCompliance200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodesCompliance200ResponseData(val *GetNodesCompliance200ResponseData) *NullableGetNodesCompliance200ResponseData {
	return &NullableGetNodesCompliance200ResponseData{value: val, isSet: true}
}

func (v NullableGetNodesCompliance200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodesCompliance200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
