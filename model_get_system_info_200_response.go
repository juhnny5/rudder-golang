...
// checks if the GetSystemInfo200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSystemInfo200Response{}

// GetSystemInfo200Response struct for GetSystemInfo200Response
type GetSystemInfo200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetSystemInfo200ResponseData `json:"data"`
}

type _GetSystemInfo200Response GetSystemInfo200Response
...
func (o *GetSystemInfo200Response) GetData() GetSystemInfo200ResponseData {
	if o == nil {
		var ret GetSystemInfo200ResponseData
		return ret
	}
...
func (o GetSystemInfo200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSystemInfo200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetSystemInfo200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSystemInfo200Response := _GetSystemInfo200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetSystemInfo200Response)

	if err != nil {
		return err
	}

	*o = GetSystemInfo200Response(varGetSystemInfo200Response)

	return err
}

type NullableGetSystemInfo200Response struct {
	value *GetSystemInfo200Response
	isSet bool
}

func (v NullableGetSystemInfo200Response) Get() *GetSystemInfo200Response {
	return v.value
}

func (v *NullableGetSystemInfo200Response) Set(val *GetSystemInfo200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSystemInfo200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSystemInfo200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSystemInfo200Response(val *GetSystemInfo200Response) *NullableGetSystemInfo200Response {
	return &NullableGetSystemInfo200Response{value: val, isSet: true}
}

func (v NullableGetSystemInfo200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSystemInfo200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
