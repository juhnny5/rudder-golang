...
// checks if the DeleteRuleCategory200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteRuleCategory200ResponseData{}

// DeleteRuleCategory200ResponseData struct for DeleteRuleCategory200ResponseData
type DeleteRuleCategory200ResponseData struct {
	GroupCategories []RuleCategory `json:"groupCategories"`
}

type _DeleteRuleCategory200ResponseData DeleteRuleCategory200ResponseData
...
func NewDeleteRuleCategory200ResponseData(groupCategories []RuleCategory) *DeleteRuleCategory200ResponseData {
	this := DeleteRuleCategory200ResponseData{}
...
func (o DeleteRuleCategory200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o DeleteRuleCategory200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["groupCategories"] = o.GroupCategories
	return toSerialize, nil
}

func (o *DeleteRuleCategory200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteRuleCategory200ResponseData := _DeleteRuleCategory200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteRuleCategory200ResponseData)

	if err != nil {
		return err
	}

	*o = DeleteRuleCategory200ResponseData(varDeleteRuleCategory200ResponseData)

	return err
}

type NullableDeleteRuleCategory200ResponseData struct {
	value *DeleteRuleCategory200ResponseData
	isSet bool
}

func (v NullableDeleteRuleCategory200ResponseData) Get() *DeleteRuleCategory200ResponseData {
	return v.value
}

func (v *NullableDeleteRuleCategory200ResponseData) Set(val *DeleteRuleCategory200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteRuleCategory200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteRuleCategory200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteRuleCategory200ResponseData(val *DeleteRuleCategory200ResponseData) *NullableDeleteRuleCategory200ResponseData {
	return &NullableDeleteRuleCategory200ResponseData{value: val, isSet: true}
}

func (v NullableDeleteRuleCategory200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteRuleCategory200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
