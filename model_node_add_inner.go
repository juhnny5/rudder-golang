...
// checks if the NodeAddInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeAddInner{}

// NodeAddInner struct for NodeAddInner
type NodeAddInner struct {
...
type _NodeAddInner NodeAddInner
...
// GetPolicyServerId returns the PolicyServerId field value if set, zero value otherwise.
func (o *NodeAddInner) GetPolicyServerId() string {
	if o == nil || IsNil(o.PolicyServerId) {
		var ret string
		return ret
	}
...
// GetPolicyServerIdOk returns a tuple with the PolicyServerId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPolicyServerId gets a reference to the given string and assigns it to the PolicyServerId field.
...
// SetAgentKey gets a reference to the given AgentKey and assigns it to the AgentKey field.
...
func (o NodeAddInner) MarshalJSON() ([]byte, error) {
...
func (o NodeAddInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["hostname"] = o.Hostname
	toSerialize["status"] = o.Status
	toSerialize["os"] = o.Os
	if !IsNil(o.PolicyServerId) {
...
func (o *NodeAddInner) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeAddInner := _NodeAddInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeAddInner)

	if err != nil {
		return err
	}

	*o = NodeAddInner(varNodeAddInner)

	return err
}

type NullableNodeAddInner struct {
	value *NodeAddInner
	isSet bool
}

func (v NullableNodeAddInner) Get() *NodeAddInner {
	return v.value
}

func (v *NullableNodeAddInner) Set(val *NodeAddInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeAddInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeAddInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeAddInner(val *NodeAddInner) *NullableNodeAddInner {
	return &NullableNodeAddInner{value: val, isSet: true}
}

func (v NullableNodeAddInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeAddInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
