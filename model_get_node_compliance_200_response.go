...
// checks if the GetNodeCompliance200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodeCompliance200Response{}

// GetNodeCompliance200Response struct for GetNodeCompliance200Response
type GetNodeCompliance200Response struct {
...
type _GetNodeCompliance200Response GetNodeCompliance200Response
...
func NewGetNodeCompliance200Response(result string, action string, data GetNodesCompliance200ResponseData) *GetNodeCompliance200Response {
	this := GetNodeCompliance200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o GetNodeCompliance200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNodeCompliance200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetNodeCompliance200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodeCompliance200Response := _GetNodeCompliance200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodeCompliance200Response)

	if err != nil {
		return err
	}

	*o = GetNodeCompliance200Response(varGetNodeCompliance200Response)

	return err
}

type NullableGetNodeCompliance200Response struct {
	value *GetNodeCompliance200Response
	isSet bool
}

func (v NullableGetNodeCompliance200Response) Get() *GetNodeCompliance200Response {
	return v.value
}

func (v *NullableGetNodeCompliance200Response) Set(val *GetNodeCompliance200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodeCompliance200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodeCompliance200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodeCompliance200Response(val *GetNodeCompliance200Response) *NullableGetNodeCompliance200Response {
	return &NullableGetNodeCompliance200Response{value: val, isSet: true}
}

func (v NullableGetNodeCompliance200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodeCompliance200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
