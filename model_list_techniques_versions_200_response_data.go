...
// checks if the ListTechniquesVersions200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTechniquesVersions200ResponseData{}

// ListTechniquesVersions200ResponseData struct for ListTechniquesVersions200ResponseData
type ListTechniquesVersions200ResponseData struct {
	Techniques []TechniquesVersionsInner `json:"techniques"`
}

type _ListTechniquesVersions200ResponseData ListTechniquesVersions200ResponseData
...
func NewListTechniquesVersions200ResponseData(techniques []TechniquesVersionsInner) *ListTechniquesVersions200ResponseData {
	this := ListTechniquesVersions200ResponseData{}
...
func (o *ListTechniquesVersions200ResponseData) GetTechniques() []TechniquesVersionsInner {
	if o == nil {
		var ret []TechniquesVersionsInner
		return ret
	}
...
func (o ListTechniquesVersions200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ListTechniquesVersions200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["techniques"] = o.Techniques
	return toSerialize, nil
}

func (o *ListTechniquesVersions200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListTechniquesVersions200ResponseData := _ListTechniquesVersions200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTechniquesVersions200ResponseData)

	if err != nil {
		return err
	}

	*o = ListTechniquesVersions200ResponseData(varListTechniquesVersions200ResponseData)

	return err
}

type NullableListTechniquesVersions200ResponseData struct {
	value *ListTechniquesVersions200ResponseData
	isSet bool
}

func (v NullableListTechniquesVersions200ResponseData) Get() *ListTechniquesVersions200ResponseData {
	return v.value
}

func (v *NullableListTechniquesVersions200ResponseData) Set(val *ListTechniquesVersions200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTechniquesVersions200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTechniquesVersions200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTechniquesVersions200ResponseData(val *ListTechniquesVersions200ResponseData) *NullableListTechniquesVersions200ResponseData {
	return &NullableListTechniquesVersions200ResponseData{value: val, isSet: true}
}

func (v NullableListTechniquesVersions200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTechniquesVersions200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
