...
// checks if the AllCampaigns200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllCampaigns200Response{}

// AllCampaigns200Response struct for AllCampaigns200Response
type AllCampaigns200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data AllCampaigns200ResponseData `json:"data"`
}

type _AllCampaigns200Response AllCampaigns200Response
...
func (o *AllCampaigns200Response) GetData() AllCampaigns200ResponseData {
	if o == nil {
		var ret AllCampaigns200ResponseData
		return ret
	}
...
func (o AllCampaigns200Response) MarshalJSON() ([]byte, error) {
...
func (o AllCampaigns200Response) ToMap() (map[string]interface{}, error) {
...
func (o *AllCampaigns200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varAllCampaigns200Response := _AllCampaigns200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAllCampaigns200Response)

	if err != nil {
		return err
	}

	*o = AllCampaigns200Response(varAllCampaigns200Response)

	return err
}

type NullableAllCampaigns200Response struct {
	value *AllCampaigns200Response
	isSet bool
}

func (v NullableAllCampaigns200Response) Get() *AllCampaigns200Response {
	return v.value
}

func (v *NullableAllCampaigns200Response) Set(val *AllCampaigns200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAllCampaigns200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAllCampaigns200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllCampaigns200Response(val *AllCampaigns200Response) *NullableAllCampaigns200Response {
	return &NullableAllCampaigns200Response{value: val, isSet: true}
}

func (v NullableAllCampaigns200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllCampaigns200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
