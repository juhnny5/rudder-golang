...
// checks if the CreateDataSource200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDataSource200ResponseData{}

// CreateDataSource200ResponseData Information about the data sources
type CreateDataSource200ResponseData struct {
	Datasources []Datasource `json:"datasources"`
}

type _CreateDataSource200ResponseData CreateDataSource200ResponseData
...
func NewCreateDataSource200ResponseData(datasources []Datasource) *CreateDataSource200ResponseData {
	this := CreateDataSource200ResponseData{}
...
func (o CreateDataSource200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CreateDataSource200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["datasources"] = o.Datasources
	return toSerialize, nil
}

func (o *CreateDataSource200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateDataSource200ResponseData := _CreateDataSource200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateDataSource200ResponseData)

	if err != nil {
		return err
	}

	*o = CreateDataSource200ResponseData(varCreateDataSource200ResponseData)

	return err
}

type NullableCreateDataSource200ResponseData struct {
	value *CreateDataSource200ResponseData
	isSet bool
}

func (v NullableCreateDataSource200ResponseData) Get() *CreateDataSource200ResponseData {
	return v.value
}

func (v *NullableCreateDataSource200ResponseData) Set(val *CreateDataSource200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDataSource200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDataSource200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDataSource200ResponseData(val *CreateDataSource200ResponseData) *NullableCreateDataSource200ResponseData {
	return &NullableCreateDataSource200ResponseData{value: val, isSet: true}
}

func (v NullableCreateDataSource200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDataSource200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
