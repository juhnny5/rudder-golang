...
type _ListGroups200ResponseData ListGroups200ResponseData
...
func (o *ListGroups200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListGroups200ResponseData := _ListGroups200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListGroups200ResponseData)

	if err != nil {
		return err
	}

	*o = ListGroups200ResponseData(varListGroups200ResponseData)
