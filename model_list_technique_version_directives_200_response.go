...
// checks if the ListTechniqueVersionDirectives200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTechniqueVersionDirectives200Response{}

// ListTechniqueVersionDirectives200Response struct for ListTechniqueVersionDirectives200Response
type ListTechniqueVersionDirectives200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ListDirectives200ResponseData `json:"data"`
}

type _ListTechniqueVersionDirectives200Response ListTechniqueVersionDirectives200Response
...
func NewListTechniqueVersionDirectives200Response(result string, action string, data ListDirectives200ResponseData) *ListTechniqueVersionDirectives200Response {
	this := ListTechniqueVersionDirectives200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ListTechniqueVersionDirectives200Response) GetData() ListDirectives200ResponseData {
	if o == nil {
		var ret ListDirectives200ResponseData
		return ret
	}
...
func (o ListTechniqueVersionDirectives200Response) MarshalJSON() ([]byte, error) {
...
func (o ListTechniqueVersionDirectives200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListTechniqueVersionDirectives200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListTechniqueVersionDirectives200Response := _ListTechniqueVersionDirectives200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTechniqueVersionDirectives200Response)

	if err != nil {
		return err
	}

	*o = ListTechniqueVersionDirectives200Response(varListTechniqueVersionDirectives200Response)

	return err
}

type NullableListTechniqueVersionDirectives200Response struct {
	value *ListTechniqueVersionDirectives200Response
	isSet bool
}

func (v NullableListTechniqueVersionDirectives200Response) Get() *ListTechniqueVersionDirectives200Response {
	return v.value
}

func (v *NullableListTechniqueVersionDirectives200Response) Set(val *ListTechniqueVersionDirectives200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTechniqueVersionDirectives200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTechniqueVersionDirectives200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTechniqueVersionDirectives200Response(val *ListTechniqueVersionDirectives200Response) *NullableListTechniqueVersionDirectives200Response {
	return &NullableListTechniqueVersionDirectives200Response{value: val, isSet: true}
}

func (v NullableListTechniqueVersionDirectives200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTechniqueVersionDirectives200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
