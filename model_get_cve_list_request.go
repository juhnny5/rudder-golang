...
// checks if the GetCVEListRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCVEListRequest{}

// GetCVEListRequest List of CVE ids you want
type GetCVEListRequest struct {
	CveIds []string `json:"cveIds,omitempty"`
	// Only send score of the cve, and not the whole detailed list
	OnlyScore *bool `json:"onlyScore,omitempty"`
...
func NewGetCVEListRequest() *GetCVEListRequest {
	this := GetCVEListRequest{}
	var onlyScore bool = false
...
// GetOnlyScore returns the OnlyScore field value if set, zero value otherwise.
func (o *GetCVEListRequest) GetOnlyScore() bool {
	if o == nil || IsNil(o.OnlyScore) {
		var ret bool
		return ret
	}
	return *o.OnlyScore
...
// GetOnlyScoreOk returns a tuple with the OnlyScore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetCVEListRequest) GetOnlyScoreOk() (*bool, bool) {
	if o == nil || IsNil(o.OnlyScore) {
		return nil, false
	}
	return o.OnlyScore, true
}
...
// SetOnlyScore gets a reference to the given bool and assigns it to the OnlyScore field.
...
// SetMinScore gets a reference to the given string and assigns it to the MinScore field.
...
func (o GetCVEListRequest) MarshalJSON() ([]byte, error) {
...
func (o GetCVEListRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CveIds) {
		toSerialize["cveIds"] = o.CveIds
	}
	if !IsNil(o.OnlyScore) {
		toSerialize["onlyScore"] = o.OnlyScore
	}
	if !IsNil(o.MinScore) {
...
type NullableGetCVEListRequest struct {
	value *GetCVEListRequest
	isSet bool
}

func (v NullableGetCVEListRequest) Get() *GetCVEListRequest {
	return v.value
}

func (v *NullableGetCVEListRequest) Set(val *GetCVEListRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCVEListRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCVEListRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCVEListRequest(val *GetCVEListRequest) *NullableGetCVEListRequest {
	return &NullableGetCVEListRequest{value: val, isSet: true}
}

func (v NullableGetCVEListRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCVEListRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
