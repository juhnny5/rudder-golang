...
// checks if the GetTechniqueAllVersion200ResponseDataTechniquesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTechniqueAllVersion200ResponseDataTechniquesInner{}

// GetTechniqueAllVersion200ResponseDataTechniquesInner struct for GetTechniqueAllVersion200ResponseDataTechniquesInner
type GetTechniqueAllVersion200ResponseDataTechniquesInner struct {
	JREditorTechnique EditorTechnique `json:"JREditorTechnique"`
}

type _GetTechniqueAllVersion200ResponseDataTechniquesInner GetTechniqueAllVersion200ResponseDataTechniquesInner
...
func NewGetTechniqueAllVersion200ResponseDataTechniquesInner(jREditorTechnique EditorTechnique) *GetTechniqueAllVersion200ResponseDataTechniquesInner {
	this := GetTechniqueAllVersion200ResponseDataTechniquesInner{}
	this.JREditorTechnique = jREditorTechnique
	return &this
}
...
// GetJREditorTechniqueOk returns a tuple with the JREditorTechnique field value
// and a boolean to check if the value has been set.
func (o *GetTechniqueAllVersion200ResponseDataTechniquesInner) GetJREditorTechniqueOk() (*EditorTechnique, bool) {
	if o == nil {
		return nil, false
	}
	return &o.JREditorTechnique, true
}

// SetJREditorTechnique sets field value
func (o *GetTechniqueAllVersion200ResponseDataTechniquesInner) SetJREditorTechnique(v EditorTechnique) {
	o.JREditorTechnique = v
}

func (o GetTechniqueAllVersion200ResponseDataTechniquesInner) MarshalJSON() ([]byte, error) {
...
func (o GetTechniqueAllVersion200ResponseDataTechniquesInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["JREditorTechnique"] = o.JREditorTechnique
	return toSerialize, nil
}

func (o *GetTechniqueAllVersion200ResponseDataTechniquesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTechniqueAllVersion200ResponseDataTechniquesInner := _GetTechniqueAllVersion200ResponseDataTechniquesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTechniqueAllVersion200ResponseDataTechniquesInner)

	if err != nil {
		return err
	}

	*o = GetTechniqueAllVersion200ResponseDataTechniquesInner(varGetTechniqueAllVersion200ResponseDataTechniquesInner)

	return err
}

type NullableGetTechniqueAllVersion200ResponseDataTechniquesInner struct {
	value *GetTechniqueAllVersion200ResponseDataTechniquesInner
	isSet bool
}

func (v NullableGetTechniqueAllVersion200ResponseDataTechniquesInner) Get() *GetTechniqueAllVersion200ResponseDataTechniquesInner {
	return v.value
}

func (v *NullableGetTechniqueAllVersion200ResponseDataTechniquesInner) Set(val *GetTechniqueAllVersion200ResponseDataTechniquesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTechniqueAllVersion200ResponseDataTechniquesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTechniqueAllVersion200ResponseDataTechniquesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTechniqueAllVersion200ResponseDataTechniquesInner(val *GetTechniqueAllVersion200ResponseDataTechniquesInner) *NullableGetTechniqueAllVersion200ResponseDataTechniquesInner {
	return &NullableGetTechniqueAllVersion200ResponseDataTechniquesInner{value: val, isSet: true}
}

func (v NullableGetTechniqueAllVersion200ResponseDataTechniquesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTechniqueAllVersion200ResponseDataTechniquesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
