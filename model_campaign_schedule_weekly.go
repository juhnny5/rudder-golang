...
// checks if the CampaignScheduleWeekly type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleWeekly{}

// CampaignScheduleWeekly struct for CampaignScheduleWeekly
type CampaignScheduleWeekly struct {
	Start *CampaignScheduleWeeklyStart `json:"start,omitempty"`
	End *CampaignScheduleWeeklyEnd `json:"end,omitempty"`
...
func (o *CampaignScheduleWeekly) GetStart() CampaignScheduleWeeklyStart {
	if o == nil || IsNil(o.Start) {
		var ret CampaignScheduleWeeklyStart
		return ret
	}
	return *o.Start
}
...
// SetStart gets a reference to the given CampaignScheduleWeeklyStart and assigns it to the Start field.
...
func (o *CampaignScheduleWeekly) GetEnd() CampaignScheduleWeeklyEnd {
	if o == nil || IsNil(o.End) {
		var ret CampaignScheduleWeeklyEnd
		return ret
	}
	return *o.End
}
...
// SetEnd gets a reference to the given CampaignScheduleWeeklyEnd and assigns it to the End field.
...
func (o CampaignScheduleWeekly) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleWeekly) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleWeekly struct {
	value *CampaignScheduleWeekly
	isSet bool
}

func (v NullableCampaignScheduleWeekly) Get() *CampaignScheduleWeekly {
	return v.value
}

func (v *NullableCampaignScheduleWeekly) Set(val *CampaignScheduleWeekly) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleWeekly) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleWeekly) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleWeekly(val *CampaignScheduleWeekly) *NullableCampaignScheduleWeekly {
	return &NullableCampaignScheduleWeekly{value: val, isSet: true}
}

func (v NullableCampaignScheduleWeekly) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleWeekly) UnmarshalJSON(src []byte) error {
	v.isSet = true
