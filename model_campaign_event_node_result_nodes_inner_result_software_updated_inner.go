...
// checks if the CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner{}

// CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner struct for CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner
type CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner struct {
...
func NewCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner() *CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner {
	this := CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner{}
	return &this
}
...
func (o CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) MarshalJSON() ([]byte, error) {
...
func (o CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner struct {
	value *CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner
	isSet bool
}

func (v NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) Get() *CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner {
	return v.value
}

func (v *NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) Set(val *CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner(val *CampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) *NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner {
	return &NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner{value: val, isSet: true}
}

func (v NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignEventNodeResultNodesInnerResultSoftwareUpdatedInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
