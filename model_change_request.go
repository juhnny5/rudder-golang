...
// GetAcceptable returns the Acceptable field value if set, zero value otherwise.
func (o *ChangeRequest) GetAcceptable() bool {
	if o == nil || IsNil(o.Acceptable) {
		var ret bool
		return ret
	}
	return *o.Acceptable
...
// GetAcceptableOk returns a tuple with the Acceptable field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ChangeRequest) GetAcceptableOk() (*bool, bool) {
	if o == nil || IsNil(o.Acceptable) {
		return nil, false
	}
	return o.Acceptable, true
}
...
// SetAcceptable gets a reference to the given bool and assigns it to the Acceptable field.
...
// SetChanges gets a reference to the given ChangeRequestChanges and assigns it to the Changes field.
...
func (o ChangeRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Acceptable) {
		toSerialize["acceptable"] = o.Acceptable
	}
	if !IsNil(o.CreatedBy) {
		toSerialize["created by"] = o.CreatedBy
	}
	if !IsNil(o.Changes) {
