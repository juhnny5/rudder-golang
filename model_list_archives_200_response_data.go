...
// checks if the ListArchives200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListArchives200ResponseData{}

// ListArchives200ResponseData struct for ListArchives200ResponseData
type ListArchives200ResponseData struct {
	Full []ListArchives200ResponseDataFullInner `json:"full"`
}

type _ListArchives200ResponseData ListArchives200ResponseData
...
func NewListArchives200ResponseData(full []ListArchives200ResponseDataFullInner) *ListArchives200ResponseData {
	this := ListArchives200ResponseData{}
	this.Full = full
	return &this
}
...
func (o ListArchives200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ListArchives200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["full"] = o.Full
	return toSerialize, nil
}

func (o *ListArchives200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListArchives200ResponseData := _ListArchives200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListArchives200ResponseData)

	if err != nil {
		return err
	}

	*o = ListArchives200ResponseData(varListArchives200ResponseData)

	return err
}

type NullableListArchives200ResponseData struct {
	value *ListArchives200ResponseData
	isSet bool
}

func (v NullableListArchives200ResponseData) Get() *ListArchives200ResponseData {
	return v.value
}

func (v *NullableListArchives200ResponseData) Set(val *ListArchives200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListArchives200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListArchives200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListArchives200ResponseData(val *ListArchives200ResponseData) *NullableListArchives200ResponseData {
	return &NullableListArchives200ResponseData{value: val, isSet: true}
}

func (v NullableListArchives200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListArchives200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
