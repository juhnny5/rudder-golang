...
// checks if the ApplyPolicyAllNodes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplyPolicyAllNodes200Response{}

// ApplyPolicyAllNodes200Response struct for ApplyPolicyAllNodes200Response
type ApplyPolicyAllNodes200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data []ApplyPolicyAllNodes200ResponseDataInner `json:"data"`
}

type _ApplyPolicyAllNodes200Response ApplyPolicyAllNodes200Response
...
func NewApplyPolicyAllNodes200Response(result string, action string, data []ApplyPolicyAllNodes200ResponseDataInner) *ApplyPolicyAllNodes200Response {
	this := ApplyPolicyAllNodes200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ApplyPolicyAllNodes200Response) GetData() []ApplyPolicyAllNodes200ResponseDataInner {
	if o == nil {
		var ret []ApplyPolicyAllNodes200ResponseDataInner
		return ret
	}
...
func (o ApplyPolicyAllNodes200Response) MarshalJSON() ([]byte, error) {
...
func (o ApplyPolicyAllNodes200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ApplyPolicyAllNodes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varApplyPolicyAllNodes200Response := _ApplyPolicyAllNodes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplyPolicyAllNodes200Response)

	if err != nil {
		return err
	}

	*o = ApplyPolicyAllNodes200Response(varApplyPolicyAllNodes200Response)

	return err
}

type NullableApplyPolicyAllNodes200Response struct {
	value *ApplyPolicyAllNodes200Response
	isSet bool
}

func (v NullableApplyPolicyAllNodes200Response) Get() *ApplyPolicyAllNodes200Response {
	return v.value
}

func (v *NullableApplyPolicyAllNodes200Response) Set(val *ApplyPolicyAllNodes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApplyPolicyAllNodes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApplyPolicyAllNodes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplyPolicyAllNodes200Response(val *ApplyPolicyAllNodes200Response) *NullableApplyPolicyAllNodes200Response {
	return &NullableApplyPolicyAllNodes200Response{value: val, isSet: true}
}

func (v NullableApplyPolicyAllNodes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplyPolicyAllNodes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
