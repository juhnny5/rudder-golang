...
// checks if the ListAcceptedNodes200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAcceptedNodes200ResponseData{}

// ListAcceptedNodes200ResponseData Information about the nodes
type ListAcceptedNodes200ResponseData struct {
	Nodes []NodeFull `json:"nodes"`
}

type _ListAcceptedNodes200ResponseData ListAcceptedNodes200ResponseData
...
func NewListAcceptedNodes200ResponseData(nodes []NodeFull) *ListAcceptedNodes200ResponseData {
	this := ListAcceptedNodes200ResponseData{}
	this.Nodes = nodes
	return &this
}
...
func (o ListAcceptedNodes200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ListAcceptedNodes200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodes"] = o.Nodes
	return toSerialize, nil
}

func (o *ListAcceptedNodes200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListAcceptedNodes200ResponseData := _ListAcceptedNodes200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListAcceptedNodes200ResponseData)

	if err != nil {
		return err
	}

	*o = ListAcceptedNodes200ResponseData(varListAcceptedNodes200ResponseData)

	return err
}

type NullableListAcceptedNodes200ResponseData struct {
	value *ListAcceptedNodes200ResponseData
	isSet bool
}

func (v NullableListAcceptedNodes200ResponseData) Get() *ListAcceptedNodes200ResponseData {
	return v.value
}

func (v *NullableListAcceptedNodes200ResponseData) Set(val *ListAcceptedNodes200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListAcceptedNodes200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListAcceptedNodes200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAcceptedNodes200ResponseData(val *ListAcceptedNodes200ResponseData) *NullableListAcceptedNodes200ResponseData {
	return &NullableListAcceptedNodes200ResponseData{value: val, isSet: true}
}

func (v NullableListAcceptedNodes200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAcceptedNodes200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
