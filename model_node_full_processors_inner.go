...
// checks if the NodeFullProcessorsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullProcessorsInner{}

// NodeFullProcessorsInner struct for NodeFullProcessorsInner
type NodeFullProcessorsInner struct {
	// CPU name
...
// SetThread gets a reference to the given int32 and assigns it to the Thread field.
...
// SetStepping gets a reference to the given int32 and assigns it to the Stepping field.
...
// GetExternalClock returns the ExternalClock field value if set, zero value otherwise.
func (o *NodeFullProcessorsInner) GetExternalClock() string {
	if o == nil || IsNil(o.ExternalClock) {
		var ret string
		return ret
	}
...
// GetExternalClockOk returns a tuple with the ExternalClock field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeFullProcessorsInner) GetExternalClockOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalClock) {
		return nil, false
	}
	return o.ExternalClock, true
}
...
// SetExternalClock gets a reference to the given string and assigns it to the ExternalClock field.
...
func (o NodeFullProcessorsInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullProcessorsInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExternalClock) {
		toSerialize["externalClock"] = o.ExternalClock
	}
...
type NullableNodeFullProcessorsInner struct {
	value *NodeFullProcessorsInner
	isSet bool
}

func (v NullableNodeFullProcessorsInner) Get() *NodeFullProcessorsInner {
	return v.value
}

func (v *NullableNodeFullProcessorsInner) Set(val *NodeFullProcessorsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullProcessorsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullProcessorsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullProcessorsInner(val *NodeFullProcessorsInner) *NullableNodeFullProcessorsInner {
	return &NullableNodeFullProcessorsInner{value: val, isSet: true}
}

func (v NullableNodeFullProcessorsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullProcessorsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
