...
// checks if the GetTechniquesResources200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTechniquesResources200ResponseData{}

// GetTechniquesResources200ResponseData struct for GetTechniquesResources200ResponseData
type GetTechniquesResources200ResponseData struct {
	Resources []TechniquesResourcesInner `json:"resources"`
}

type _GetTechniquesResources200ResponseData GetTechniquesResources200ResponseData
...
func NewGetTechniquesResources200ResponseData(resources []TechniquesResourcesInner) *GetTechniquesResources200ResponseData {
	this := GetTechniquesResources200ResponseData{}
...
func (o *GetTechniquesResources200ResponseData) GetResources() []TechniquesResourcesInner {
	if o == nil {
		var ret []TechniquesResourcesInner
		return ret
	}
...
func (o GetTechniquesResources200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetTechniquesResources200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["resources"] = o.Resources
	return toSerialize, nil
}

func (o *GetTechniquesResources200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTechniquesResources200ResponseData := _GetTechniquesResources200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTechniquesResources200ResponseData)

	if err != nil {
		return err
	}

	*o = GetTechniquesResources200ResponseData(varGetTechniquesResources200ResponseData)

	return err
}

type NullableGetTechniquesResources200ResponseData struct {
	value *GetTechniquesResources200ResponseData
	isSet bool
}

func (v NullableGetTechniquesResources200ResponseData) Get() *GetTechniquesResources200ResponseData {
	return v.value
}

func (v *NullableGetTechniquesResources200ResponseData) Set(val *GetTechniquesResources200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTechniquesResources200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTechniquesResources200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTechniquesResources200ResponseData(val *GetTechniquesResources200ResponseData) *NullableGetTechniquesResources200ResponseData {
	return &NullableGetTechniquesResources200ResponseData{value: val, isSet: true}
}

func (v NullableGetTechniquesResources200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTechniquesResources200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
