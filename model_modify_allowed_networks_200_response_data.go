...
// checks if the ModifyAllowedNetworks200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyAllowedNetworks200ResponseData{}

// ModifyAllowedNetworks200ResponseData Information about the allowed_networks settings
type ModifyAllowedNetworks200ResponseData struct {
	// Array of allowed networks
	Settings []string `json:"settings"`
}

type _ModifyAllowedNetworks200ResponseData ModifyAllowedNetworks200ResponseData
...
func NewModifyAllowedNetworks200ResponseData(settings []string) *ModifyAllowedNetworks200ResponseData {
	this := ModifyAllowedNetworks200ResponseData{}
...
func (o ModifyAllowedNetworks200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ModifyAllowedNetworks200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["settings"] = o.Settings
	return toSerialize, nil
}

func (o *ModifyAllowedNetworks200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varModifyAllowedNetworks200ResponseData := _ModifyAllowedNetworks200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModifyAllowedNetworks200ResponseData)

	if err != nil {
		return err
	}

	*o = ModifyAllowedNetworks200ResponseData(varModifyAllowedNetworks200ResponseData)

	return err
}

type NullableModifyAllowedNetworks200ResponseData struct {
	value *ModifyAllowedNetworks200ResponseData
	isSet bool
}

func (v NullableModifyAllowedNetworks200ResponseData) Get() *ModifyAllowedNetworks200ResponseData {
	return v.value
}

func (v *NullableModifyAllowedNetworks200ResponseData) Set(val *ModifyAllowedNetworks200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyAllowedNetworks200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyAllowedNetworks200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyAllowedNetworks200ResponseData(val *ModifyAllowedNetworks200ResponseData) *NullableModifyAllowedNetworks200ResponseData {
	return &NullableModifyAllowedNetworks200ResponseData{value: val, isSet: true}
}

func (v NullableModifyAllowedNetworks200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyAllowedNetworks200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
