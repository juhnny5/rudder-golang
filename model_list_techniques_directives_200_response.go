...
// checks if the ListTechniquesDirectives200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTechniquesDirectives200Response{}

// ListTechniquesDirectives200Response struct for ListTechniquesDirectives200Response
type ListTechniquesDirectives200Response struct {
...
type _ListTechniquesDirectives200Response ListTechniquesDirectives200Response
...
func NewListTechniquesDirectives200Response(result string, action string, data ListDirectives200ResponseData) *ListTechniquesDirectives200Response {
	this := ListTechniquesDirectives200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ListTechniquesDirectives200Response) MarshalJSON() ([]byte, error) {
...
func (o ListTechniquesDirectives200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListTechniquesDirectives200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListTechniquesDirectives200Response := _ListTechniquesDirectives200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTechniquesDirectives200Response)

	if err != nil {
		return err
	}

	*o = ListTechniquesDirectives200Response(varListTechniquesDirectives200Response)

	return err
}

type NullableListTechniquesDirectives200Response struct {
	value *ListTechniquesDirectives200Response
	isSet bool
}

func (v NullableListTechniquesDirectives200Response) Get() *ListTechniquesDirectives200Response {
	return v.value
}

func (v *NullableListTechniquesDirectives200Response) Set(val *ListTechniquesDirectives200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTechniquesDirectives200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTechniquesDirectives200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTechniquesDirectives200Response(val *ListTechniquesDirectives200Response) *NullableListTechniquesDirectives200Response {
	return &NullableListTechniquesDirectives200Response{value: val, isSet: true}
}

func (v NullableListTechniquesDirectives200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTechniquesDirectives200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
