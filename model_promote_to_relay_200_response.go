...
// checks if the PromoteToRelay200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromoteToRelay200Response{}

// PromoteToRelay200Response struct for PromoteToRelay200Response
type PromoteToRelay200Response struct {
...
type _PromoteToRelay200Response PromoteToRelay200Response
...
func NewPromoteToRelay200Response(action string, result string, data string) *PromoteToRelay200Response {
	this := PromoteToRelay200Response{}
	this.Action = action
	this.Result = result
	this.Data = data
	return &this
...
func (o PromoteToRelay200Response) MarshalJSON() ([]byte, error) {
...
func (o PromoteToRelay200Response) ToMap() (map[string]interface{}, error) {
...
func (o *PromoteToRelay200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPromoteToRelay200Response := _PromoteToRelay200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromoteToRelay200Response)

	if err != nil {
		return err
	}

	*o = PromoteToRelay200Response(varPromoteToRelay200Response)

	return err
}

type NullablePromoteToRelay200Response struct {
	value *PromoteToRelay200Response
	isSet bool
}

func (v NullablePromoteToRelay200Response) Get() *PromoteToRelay200Response {
	return v.value
}

func (v *NullablePromoteToRelay200Response) Set(val *PromoteToRelay200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePromoteToRelay200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePromoteToRelay200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromoteToRelay200Response(val *PromoteToRelay200Response) *NullablePromoteToRelay200Response {
	return &NullablePromoteToRelay200Response{value: val, isSet: true}
}

func (v NullablePromoteToRelay200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromoteToRelay200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
