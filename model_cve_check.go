...
// checks if the CveCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CveCheck{}

// CveCheck struct for CveCheck
type CveCheck struct {
	// CVE id
	CveId *string `json:"cveId,omitempty"`
	Score *CveCheckScore `json:"score,omitempty"`
	// Id of Nodes affected by this CVE
	Nodes []string `json:"nodes,omitempty"`
	// Packages affected by this CVE
	Packages []CveCheckPackagesInner `json:"packages,omitempty"`
}
...
// SetScore gets a reference to the given CveCheckScore and assigns it to the Score field.
...
// SetPackages gets a reference to the given []CveCheckPackagesInner and assigns it to the Packages field.
func (o *CveCheck) SetPackages(v []CveCheckPackagesInner) {
	o.Packages = v
}

func (o CveCheck) MarshalJSON() ([]byte, error) {
...
func (o CveCheck) ToMap() (map[string]interface{}, error) {
...
type NullableCveCheck struct {
	value *CveCheck
	isSet bool
}

func (v NullableCveCheck) Get() *CveCheck {
	return v.value
}

func (v *NullableCveCheck) Set(val *CveCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableCveCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableCveCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCveCheck(val *CveCheck) *NullableCveCheck {
	return &NullableCveCheck{value: val, isSet: true}
}

func (v NullableCveCheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCveCheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
