...
// checks if the GroupQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupQuery{}
...
func (o GroupQuery) MarshalJSON() ([]byte, error) {
...
func (o GroupQuery) ToMap() (map[string]interface{}, error) {
...
type NullableGroupQuery struct {
	value *GroupQuery
	isSet bool
}

func (v NullableGroupQuery) Get() *GroupQuery {
	return v.value
}

func (v *NullableGroupQuery) Set(val *GroupQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupQuery(val *GroupQuery) *NullableGroupQuery {
	return &NullableGroupQuery{value: val, isSet: true}
}

func (v NullableGroupQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
