...
// checks if the ApiEndpointsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiEndpointsInner{}

// ApiEndpointsInner objects with two fields, the first one has the endpoint name as key and its description as value, the second one has HTTP verb to use (GET, POST PUT, DELETE) as key and the supported version an API path for value.
type ApiEndpointsInner struct {
...
func (o ApiEndpointsInner) MarshalJSON() ([]byte, error) {
...
func (o ApiEndpointsInner) ToMap() (map[string]interface{}, error) {
...
type NullableApiEndpointsInner struct {
	value *ApiEndpointsInner
	isSet bool
}

func (v NullableApiEndpointsInner) Get() *ApiEndpointsInner {
	return v.value
}

func (v *NullableApiEndpointsInner) Set(val *ApiEndpointsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiEndpointsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiEndpointsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiEndpointsInner(val *ApiEndpointsInner) *NullableApiEndpointsInner {
	return &NullableApiEndpointsInner{value: val, isSet: true}
}

func (v NullableApiEndpointsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiEndpointsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
