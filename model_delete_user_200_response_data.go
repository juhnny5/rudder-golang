...
// checks if the DeleteUser200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteUser200ResponseData{}

// DeleteUser200ResponseData struct for DeleteUser200ResponseData
type DeleteUser200ResponseData struct {
	DeletedUser DeleteUser200ResponseDataDeletedUser `json:"deletedUser"`
}

type _DeleteUser200ResponseData DeleteUser200ResponseData
...
func NewDeleteUser200ResponseData(deletedUser DeleteUser200ResponseDataDeletedUser) *DeleteUser200ResponseData {
	this := DeleteUser200ResponseData{}
...
// GetDeletedUser returns the DeletedUser field value
func (o *DeleteUser200ResponseData) GetDeletedUser() DeleteUser200ResponseDataDeletedUser {
	if o == nil {
		var ret DeleteUser200ResponseDataDeletedUser
		return ret
	}
...
func (o DeleteUser200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["deletedUser"] = o.DeletedUser
	return toSerialize, nil
}

func (o *DeleteUser200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteUser200ResponseData := _DeleteUser200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteUser200ResponseData)

	if err != nil {
		return err
	}

	*o = DeleteUser200ResponseData(varDeleteUser200ResponseData)

	return err
}

type NullableDeleteUser200ResponseData struct {
	value *DeleteUser200ResponseData
	isSet bool
}

func (v NullableDeleteUser200ResponseData) Get() *DeleteUser200ResponseData {
	return v.value
}

func (v *NullableDeleteUser200ResponseData) Set(val *DeleteUser200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteUser200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteUser200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteUser200ResponseData(val *DeleteUser200ResponseData) *NullableDeleteUser200ResponseData {
	return &NullableDeleteUser200ResponseData{value: val, isSet: true}
}

func (v NullableDeleteUser200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteUser200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
