...
// checks if the DatasourceRunParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasourceRunParameters{}
...
// GetOnGeneration returns the OnGeneration field value if set, zero value otherwise.
func (o *DatasourceRunParameters) GetOnGeneration() bool {
	if o == nil || IsNil(o.OnGeneration) {
		var ret bool
		return ret
	}
...
// GetOnGenerationOk returns a tuple with the OnGeneration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DatasourceRunParameters) GetOnGenerationOk() (*bool, bool) {
	if o == nil || IsNil(o.OnGeneration) {
		return nil, false
	}
	return o.OnGeneration, true
}
...
// SetOnGeneration gets a reference to the given bool and assigns it to the OnGeneration field.
func (o *DatasourceRunParameters) SetOnGeneration(v bool) {
	o.OnGeneration = &v
}

// GetOnNewNode returns the OnNewNode field value if set, zero value otherwise.
func (o *DatasourceRunParameters) GetOnNewNode() bool {
	if o == nil || IsNil(o.OnNewNode) {
		var ret bool
		return ret
	}
	return *o.OnNewNode
...
// GetOnNewNodeOk returns a tuple with the OnNewNode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DatasourceRunParameters) GetOnNewNodeOk() (*bool, bool) {
	if o == nil || IsNil(o.OnNewNode) {
		return nil, false
	}
	return o.OnNewNode, true
}
...
// SetOnNewNode gets a reference to the given bool and assigns it to the OnNewNode field.
...
func (o *DatasourceRunParameters) GetSchedule() DatasourceRunParametersSchedule {
	if o == nil || IsNil(o.Schedule) {
		var ret DatasourceRunParametersSchedule
		return ret
	}
	return *o.Schedule
}
...
// SetSchedule gets a reference to the given DatasourceRunParametersSchedule and assigns it to the Schedule field.
func (o *DatasourceRunParameters) SetSchedule(v DatasourceRunParametersSchedule) {
	o.Schedule = &v
}

func (o DatasourceRunParameters) MarshalJSON() ([]byte, error) {
...
func (o DatasourceRunParameters) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.OnGeneration) {
		toSerialize["onGeneration"] = o.OnGeneration
	}
	if !IsNil(o.OnNewNode) {
		toSerialize["onNewNode"] = o.OnNewNode
	}
	if !IsNil(o.Schedule) {
...
type NullableDatasourceRunParameters struct {
	value *DatasourceRunParameters
	isSet bool
}

func (v NullableDatasourceRunParameters) Get() *DatasourceRunParameters {
	return v.value
}

func (v *NullableDatasourceRunParameters) Set(val *DatasourceRunParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasourceRunParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasourceRunParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasourceRunParameters(val *DatasourceRunParameters) *NullableDatasourceRunParameters {
	return &NullableDatasourceRunParameters{value: val, isSet: true}
}

func (v NullableDatasourceRunParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasourceRunParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
