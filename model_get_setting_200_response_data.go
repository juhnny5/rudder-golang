...
// checks if the GetSetting200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSetting200ResponseData{}

// GetSetting200ResponseData Information about the setting
type GetSetting200ResponseData struct {
...
func NewGetSetting200ResponseData() *GetSetting200ResponseData {
	this := GetSetting200ResponseData{}
	return &this
}
...
// SetSettingId gets a reference to the given string and assigns it to the SettingId field.
func (o *GetSetting200ResponseData) SetSettingId(v string) {
	o.SettingId = &v
}

func (o GetSetting200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetSetting200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGetSetting200ResponseData struct {
	value *GetSetting200ResponseData
	isSet bool
}

func (v NullableGetSetting200ResponseData) Get() *GetSetting200ResponseData {
	return v.value
}

func (v *NullableGetSetting200ResponseData) Set(val *GetSetting200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSetting200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSetting200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSetting200ResponseData(val *GetSetting200ResponseData) *NullableGetSetting200ResponseData {
	return &NullableGetSetting200ResponseData{value: val, isSet: true}
}

func (v NullableGetSetting200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSetting200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
