...
// checks if the NodeFullSoftwareInnerLicense type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullSoftwareInnerLicense{}

// NodeFullSoftwareInnerLicense Information about the license
type NodeFullSoftwareInnerLicense struct {
...
func NewNodeFullSoftwareInnerLicense() *NodeFullSoftwareInnerLicense {
	this := NodeFullSoftwareInnerLicense{}
	return &this
}
...
func (o NodeFullSoftwareInnerLicense) MarshalJSON() ([]byte, error) {
...
func (o NodeFullSoftwareInnerLicense) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullSoftwareInnerLicense struct {
	value *NodeFullSoftwareInnerLicense
	isSet bool
}

func (v NullableNodeFullSoftwareInnerLicense) Get() *NodeFullSoftwareInnerLicense {
	return v.value
}

func (v *NullableNodeFullSoftwareInnerLicense) Set(val *NodeFullSoftwareInnerLicense) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullSoftwareInnerLicense) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullSoftwareInnerLicense) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullSoftwareInnerLicense(val *NodeFullSoftwareInnerLicense) *NullableNodeFullSoftwareInnerLicense {
	return &NullableNodeFullSoftwareInnerLicense{value: val, isSet: true}
}

func (v NullableNodeFullSoftwareInnerLicense) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullSoftwareInnerLicense) UnmarshalJSON(src []byte) error {
	v.isSet = true
