...
// checks if the DirectiveRuleCompliance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectiveRuleCompliance{}

// DirectiveRuleCompliance struct for DirectiveRuleCompliance
type DirectiveRuleCompliance struct {
	...
	Components []DirectiveRuleComplianceComponentsInner `json:"components,omitempty"`
}

type _DirectiveRuleCompliance DirectiveRuleCompliance
...
func (o *DirectiveRuleCompliance) GetComponents() []DirectiveRuleComplianceComponentsInner {
	if o == nil || IsNil(o.Components) {
		var ret []DirectiveRuleComplianceComponentsInner
		return ret
	}
	return o.Components
}
...
// SetComponents gets a reference to the given []DirectiveRuleComplianceComponentsInner and assigns it to the Components field.
func (o *DirectiveRuleCompliance) SetComponents(v []DirectiveRuleComplianceComponentsInner) {
	o.Components = v
}

func (o DirectiveRuleCompliance) MarshalJSON() ([]byte, error) {
...
func (o DirectiveRuleCompliance) ToMap() (map[string]interface{}, error) {
...
func (o *DirectiveRuleCompliance) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectiveRuleCompliance := _DirectiveRuleCompliance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDirectiveRuleCompliance)

	if err != nil {
		return err
	}

	*o = DirectiveRuleCompliance(varDirectiveRuleCompliance)

	return err
}

type NullableDirectiveRuleCompliance struct {
	value *DirectiveRuleCompliance
	isSet bool
}

func (v NullableDirectiveRuleCompliance) Get() *DirectiveRuleCompliance {
	return v.value
}

func (v *NullableDirectiveRuleCompliance) Set(val *DirectiveRuleCompliance) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectiveRuleCompliance) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectiveRuleCompliance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectiveRuleCompliance(val *DirectiveRuleCompliance) *NullableDirectiveRuleCompliance {
	return &NullableDirectiveRuleCompliance{value: val, isSet: true}
}

func (v NullableDirectiveRuleCompliance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectiveRuleCompliance) UnmarshalJSON(src []byte) error {
	v.isSet = true
