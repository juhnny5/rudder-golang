...
// checks if the GetRulesCompliance200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRulesCompliance200Response{}

// GetRulesCompliance200Response struct for GetRulesCompliance200Response
type GetRulesCompliance200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetRulesCompliance200ResponseData `json:"data"`
}

type _GetRulesCompliance200Response GetRulesCompliance200Response
...
func NewGetRulesCompliance200Response(result string, action string, data GetRulesCompliance200ResponseData) *GetRulesCompliance200Response {
	this := GetRulesCompliance200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetRulesCompliance200Response) GetData() GetRulesCompliance200ResponseData {
	if o == nil {
		var ret GetRulesCompliance200ResponseData
		return ret
	}
...
func (o GetRulesCompliance200Response) MarshalJSON() ([]byte, error) {
...
func (o GetRulesCompliance200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetRulesCompliance200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRulesCompliance200Response := _GetRulesCompliance200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRulesCompliance200Response)

	if err != nil {
		return err
	}

	*o = GetRulesCompliance200Response(varGetRulesCompliance200Response)

	return err
}

type NullableGetRulesCompliance200Response struct {
	value *GetRulesCompliance200Response
	isSet bool
}

func (v NullableGetRulesCompliance200Response) Get() *GetRulesCompliance200Response {
	return v.value
}

func (v *NullableGetRulesCompliance200Response) Set(val *GetRulesCompliance200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRulesCompliance200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRulesCompliance200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRulesCompliance200Response(val *GetRulesCompliance200Response) *NullableGetRulesCompliance200Response {
	return &NullableGetRulesCompliance200Response{value: val, isSet: true}
}

func (v NullableGetRulesCompliance200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRulesCompliance200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
