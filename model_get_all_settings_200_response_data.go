...
// checks if the GetAllSettings200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllSettings200ResponseData{}

// GetAllSettings200ResponseData Information about the setting
type GetAllSettings200ResponseData struct {
	Settings GetAllSettings200ResponseDataSettings `json:"settings"`
}

type _GetAllSettings200ResponseData GetAllSettings200ResponseData
...
func NewGetAllSettings200ResponseData(settings GetAllSettings200ResponseDataSettings) *GetAllSettings200ResponseData {
	this := GetAllSettings200ResponseData{}
...
func (o *GetAllSettings200ResponseData) GetSettings() GetAllSettings200ResponseDataSettings {
	if o == nil {
		var ret GetAllSettings200ResponseDataSettings
		return ret
	}
...
func (o GetAllSettings200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetAllSettings200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["settings"] = o.Settings
	return toSerialize, nil
}

func (o *GetAllSettings200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllSettings200ResponseData := _GetAllSettings200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllSettings200ResponseData)

	if err != nil {
		return err
	}

	*o = GetAllSettings200ResponseData(varGetAllSettings200ResponseData)

	return err
}

type NullableGetAllSettings200ResponseData struct {
	value *GetAllSettings200ResponseData
	isSet bool
}

func (v NullableGetAllSettings200ResponseData) Get() *GetAllSettings200ResponseData {
	return v.value
}

func (v *NullableGetAllSettings200ResponseData) Set(val *GetAllSettings200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllSettings200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllSettings200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllSettings200ResponseData(val *GetAllSettings200ResponseData) *NullableGetAllSettings200ResponseData {
	return &NullableGetAllSettings200ResponseData{value: val, isSet: true}
}

func (v NullableGetAllSettings200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllSettings200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
