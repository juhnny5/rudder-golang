...
// checks if the SaveWorkflowUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveWorkflowUser200Response{}

// SaveWorkflowUser200Response struct for SaveWorkflowUser200Response
type SaveWorkflowUser200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ValidatedUser `json:"data"`
}

type _SaveWorkflowUser200Response SaveWorkflowUser200Response
...
func NewSaveWorkflowUser200Response(result string, action string, data ValidatedUser) *SaveWorkflowUser200Response {
	this := SaveWorkflowUser200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o SaveWorkflowUser200Response) MarshalJSON() ([]byte, error) {
...
func (o SaveWorkflowUser200Response) ToMap() (map[string]interface{}, error) {
...
func (o *SaveWorkflowUser200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSaveWorkflowUser200Response := _SaveWorkflowUser200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSaveWorkflowUser200Response)

	if err != nil {
		return err
	}

	*o = SaveWorkflowUser200Response(varSaveWorkflowUser200Response)

	return err
}

type NullableSaveWorkflowUser200Response struct {
	value *SaveWorkflowUser200Response
	isSet bool
}

func (v NullableSaveWorkflowUser200Response) Get() *SaveWorkflowUser200Response {
	return v.value
}

func (v *NullableSaveWorkflowUser200Response) Set(val *SaveWorkflowUser200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveWorkflowUser200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveWorkflowUser200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveWorkflowUser200Response(val *SaveWorkflowUser200Response) *NullableSaveWorkflowUser200Response {
	return &NullableSaveWorkflowUser200Response{value: val, isSet: true}
}

func (v NullableSaveWorkflowUser200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveWorkflowUser200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
