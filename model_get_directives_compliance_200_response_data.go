...
// checks if the GetDirectivesCompliance200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDirectivesCompliance200ResponseData{}

// GetDirectivesCompliance200ResponseData struct for GetDirectivesCompliance200ResponseData
type GetDirectivesCompliance200ResponseData struct {
	DirectivesCompliance GetDirectivesCompliance200ResponseDataDirectivesCompliance `json:"directivesCompliance"`
}

type _GetDirectivesCompliance200ResponseData GetDirectivesCompliance200ResponseData
...
func NewGetDirectivesCompliance200ResponseData(directivesCompliance GetDirectivesCompliance200ResponseDataDirectivesCompliance) *GetDirectivesCompliance200ResponseData {
	this := GetDirectivesCompliance200ResponseData{}
	this.DirectivesCompliance = directivesCompliance
	return &this
}
...
// GetDirectivesCompliance returns the DirectivesCompliance field value
func (o *GetDirectivesCompliance200ResponseData) GetDirectivesCompliance() GetDirectivesCompliance200ResponseDataDirectivesCompliance {
	if o == nil {
		var ret GetDirectivesCompliance200ResponseDataDirectivesCompliance
		return ret
	}
...
// GetDirectivesComplianceOk returns a tuple with the DirectivesCompliance field value
...
func (o *GetDirectivesCompliance200ResponseData) GetDirectivesComplianceOk() (*GetDirectivesCompliance200ResponseDataDirectivesCompliance, bool) {
	...
	return &o.DirectivesCompliance, true
}

// SetDirectivesCompliance sets field value
func (o *GetDirectivesCompliance200ResponseData) SetDirectivesCompliance(v GetDirectivesCompliance200ResponseDataDirectivesCompliance) {
	o.DirectivesCompliance = v
}

func (o GetDirectivesCompliance200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetDirectivesCompliance200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["directivesCompliance"] = o.DirectivesCompliance
	return toSerialize, nil
}

func (o *GetDirectivesCompliance200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDirectivesCompliance200ResponseData := _GetDirectivesCompliance200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDirectivesCompliance200ResponseData)

	if err != nil {
		return err
	}

	*o = GetDirectivesCompliance200ResponseData(varGetDirectivesCompliance200ResponseData)

	return err
}

type NullableGetDirectivesCompliance200ResponseData struct {
	value *GetDirectivesCompliance200ResponseData
	isSet bool
}

func (v NullableGetDirectivesCompliance200ResponseData) Get() *GetDirectivesCompliance200ResponseData {
	return v.value
}

func (v *NullableGetDirectivesCompliance200ResponseData) Set(val *GetDirectivesCompliance200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDirectivesCompliance200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDirectivesCompliance200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDirectivesCompliance200ResponseData(val *GetDirectivesCompliance200ResponseData) *NullableGetDirectivesCompliance200ResponseData {
	return &NullableGetDirectivesCompliance200ResponseData{value: val, isSet: true}
}

func (v NullableGetDirectivesCompliance200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDirectivesCompliance200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
