...
// checks if the ApiSubInformations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiSubInformations200Response{}

// ApiSubInformations200Response struct for ApiSubInformations200Response
type ApiSubInformations200Response struct {
...
type _ApiSubInformations200Response ApiSubInformations200Response
...
func NewApiSubInformations200Response(result string, action string, data ApiGeneralInformations200ResponseData) *ApiSubInformations200Response {
	this := ApiSubInformations200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ApiSubInformations200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiSubInformations200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ApiSubInformations200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varApiSubInformations200Response := _ApiSubInformations200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiSubInformations200Response)

	if err != nil {
		return err
	}

	*o = ApiSubInformations200Response(varApiSubInformations200Response)

	return err
}

type NullableApiSubInformations200Response struct {
	value *ApiSubInformations200Response
	isSet bool
}

func (v NullableApiSubInformations200Response) Get() *ApiSubInformations200Response {
	return v.value
}

func (v *NullableApiSubInformations200Response) Set(val *ApiSubInformations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiSubInformations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiSubInformations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiSubInformations200Response(val *ApiSubInformations200Response) *NullableApiSubInformations200Response {
	return &NullableApiSubInformations200Response{value: val, isSet: true}
}

func (v NullableApiSubInformations200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiSubInformations200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
