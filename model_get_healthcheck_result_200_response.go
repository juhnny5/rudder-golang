...
// checks if the GetHealthcheckResult200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetHealthcheckResult200Response{}

// GetHealthcheckResult200Response struct for GetHealthcheckResult200Response
type GetHealthcheckResult200Response struct {
...
type _GetHealthcheckResult200Response GetHealthcheckResult200Response
...
func NewGetHealthcheckResult200Response(result string, action string, data []Check) *GetHealthcheckResult200Response {
	this := GetHealthcheckResult200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o GetHealthcheckResult200Response) MarshalJSON() ([]byte, error) {
...
func (o GetHealthcheckResult200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetHealthcheckResult200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetHealthcheckResult200Response := _GetHealthcheckResult200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetHealthcheckResult200Response)

	if err != nil {
		return err
	}

	*o = GetHealthcheckResult200Response(varGetHealthcheckResult200Response)

	return err
}

type NullableGetHealthcheckResult200Response struct {
	value *GetHealthcheckResult200Response
	isSet bool
}

func (v NullableGetHealthcheckResult200Response) Get() *GetHealthcheckResult200Response {
	return v.value
}

func (v *NullableGetHealthcheckResult200Response) Set(val *GetHealthcheckResult200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHealthcheckResult200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHealthcheckResult200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHealthcheckResult200Response(val *GetHealthcheckResult200Response) *NullableGetHealthcheckResult200Response {
	return &NullableGetHealthcheckResult200Response{value: val, isSet: true}
}

func (v NullableGetHealthcheckResult200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHealthcheckResult200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
