...
// checks if the DatasourceTypeParametersHeadersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasourceTypeParametersHeadersInner{}

// DatasourceTypeParametersHeadersInner struct for DatasourceTypeParametersHeadersInner
type DatasourceTypeParametersHeadersInner struct {
	// Name of the header
...
func NewDatasourceTypeParametersHeadersInner() *DatasourceTypeParametersHeadersInner {
	this := DatasourceTypeParametersHeadersInner{}
	return &this
}
...
func (o DatasourceTypeParametersHeadersInner) MarshalJSON() ([]byte, error) {
...
func (o DatasourceTypeParametersHeadersInner) ToMap() (map[string]interface{}, error) {
...
type NullableDatasourceTypeParametersHeadersInner struct {
	value *DatasourceTypeParametersHeadersInner
	isSet bool
}

func (v NullableDatasourceTypeParametersHeadersInner) Get() *DatasourceTypeParametersHeadersInner {
	return v.value
}

func (v *NullableDatasourceTypeParametersHeadersInner) Set(val *DatasourceTypeParametersHeadersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasourceTypeParametersHeadersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasourceTypeParametersHeadersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasourceTypeParametersHeadersInner(val *DatasourceTypeParametersHeadersInner) *NullableDatasourceTypeParametersHeadersInner {
	return &NullableDatasourceTypeParametersHeadersInner{value: val, isSet: true}
}

func (v NullableDatasourceTypeParametersHeadersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasourceTypeParametersHeadersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
