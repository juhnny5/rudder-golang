...
// checks if the MethodsCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MethodsCondition{}

// MethodsCondition Conditions generated by this method
type MethodsCondition struct {
...
func (o MethodsCondition) MarshalJSON() ([]byte, error) {
...
func (o MethodsCondition) ToMap() (map[string]interface{}, error) {
...
type NullableMethodsCondition struct {
	value *MethodsCondition
	isSet bool
}

func (v NullableMethodsCondition) Get() *MethodsCondition {
	return v.value
}

func (v *NullableMethodsCondition) Set(val *MethodsCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableMethodsCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableMethodsCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMethodsCondition(val *MethodsCondition) *NullableMethodsCondition {
	return &NullableMethodsCondition{value: val, isSet: true}
}

func (v NullableMethodsCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMethodsCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
