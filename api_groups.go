...
func (r ApiCreateGroupRequest) GroupNew(groupNew GroupNew) ApiCreateGroupRequest {
	r.groupNew = &groupNew
	return r
}
...
type ApiCreateGroupCategoryRequest struct {
	ctx context.Context
	ApiService *GroupsAPIService
	groupCategory *GroupCategory
}

func (r ApiCreateGroupCategoryRequest) GroupCategory(groupCategory GroupCategory) ApiCreateGroupCategoryRequest {
	r.groupCategory = &groupCategory
	return r
}

func (r ApiCreateGroupCategoryRequest) Execute() (*CreateGroupCategory200Response, *http.Response, error) {
	return r.ApiService.CreateGroupCategoryExecute(r)
}
...
Create a new group category
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateGroupCategoryRequest
*/
func (a *GroupsAPIService) CreateGroupCategory(ctx context.Context) ApiCreateGroupCategoryRequest {
	return ApiCreateGroupCategoryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *GroupsAPIService) CreateGroupCategoryExecute(r ApiCreateGroupCategoryRequest) (*CreateGroupCategory200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateGroupCategory200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsAPIService.CreateGroupCategory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/groups/categories"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.groupCategory == nil {
		return localVarReturnValue, nil, reportError("groupCategory is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.groupCategory
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["API-Tokens"]; ok {
...
func (r ApiDeleteGroupRequest) Execute() (*DeleteGroup200Response, *http.Response, error) {
...
func (a *GroupsAPIService) DeleteGroupExecute(r ApiDeleteGroupRequest) (*DeleteGroup200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteGroup200Response
	)
...
type ApiDeleteGroupCategoryRequest struct {
	ctx context.Context
	ApiService *GroupsAPIService
	groupCategoryId string
}

func (r ApiDeleteGroupCategoryRequest) Execute() (*DeleteGroupCategory200Response, *http.Response, error) {
	return r.ApiService.DeleteGroupCategoryExecute(r)
}
...
Delete a group category. It must have no child groups and no children categories.
 ...
 @return ApiDeleteGroupCategoryRequest
*/
func (a *GroupsAPIService) DeleteGroupCategory(ctx context.Context, groupCategoryId string) ApiDeleteGroupCategoryRequest {
	return ApiDeleteGroupCategoryRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *GroupsAPIService) DeleteGroupCategoryExecute(r ApiDeleteGroupCategoryRequest) (*DeleteGroupCategory200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteGroupCategory200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsAPIService.DeleteGroupCategory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/groups/categories/{groupCategoryId}"
	localVarPath = strings.Replace(localVarPath, "{"+"groupCategoryId"+"}", url.PathEscape(parameterValueToString(r.groupCategoryId, "groupCategoryId")), -1)
...
type ApiGetGroupCategoryDetailsRequest struct {
	ctx context.Context
	ApiService *GroupsAPIService
	groupCategoryId string
}

func (r ApiGetGroupCategoryDetailsRequest) Execute() (*GetGroupCategoryDetails200Response, *http.Response, error) {
	return r.ApiService.GetGroupCategoryDetailsExecute(r)
}
...
Get detailed information about a group category
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param groupCategoryId
 @return ApiGetGroupCategoryDetailsRequest
*/
func (a *GroupsAPIService) GetGroupCategoryDetails(ctx context.Context, groupCategoryId string) ApiGetGroupCategoryDetailsRequest {
	return ApiGetGroupCategoryDetailsRequest{
		ApiService: a,
		ctx: ctx,
		groupCategoryId: groupCategoryId,
...
func (a *GroupsAPIService) GetGroupCategoryDetailsExecute(r ApiGetGroupCategoryDetailsRequest) (*GetGroupCategoryDetails200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetGroupCategoryDetails200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsAPIService.GetGroupCategoryDetails")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetGroupTreeRequest struct {
	ctx context.Context
	ApiService *GroupsAPIService
}

func (r ApiGetGroupTreeRequest) Execute() (*GetGroupTree200Response, *http.Response, error) {
	return r.ApiService.GetGroupTreeExecute(r)
}
...
Get all available groups and their categories in a tree
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetGroupTreeRequest
*/
func (a *GroupsAPIService) GetGroupTree(ctx context.Context) ApiGetGroupTreeRequest {
	return ApiGetGroupTreeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *GroupsAPIService) GetGroupTreeExecute(r ApiGetGroupTreeRequest) (*GetGroupTree200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetGroupTree200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsAPIService.GetGroupTree")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/groups/tree"
...
type ApiGroupDetailsRequest struct {
	ctx context.Context
	ApiService *GroupsAPIService
	groupId string
}

func (r ApiGroupDetailsRequest) Execute() (*GroupDetails200Response, *http.Response, error) {
	return r.ApiService.GroupDetailsExecute(r)
}
...
Get detailed information about a group
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param groupId Id of the group
 @return ApiGroupDetailsRequest
*/
func (a *GroupsAPIService) GroupDetails(ctx context.Context, groupId string) ApiGroupDetailsRequest {
	return ApiGroupDetailsRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *GroupsAPIService) GroupDetailsExecute(r ApiGroupDetailsRequest) (*GroupDetails200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GroupDetails200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsAPIService.GroupDetails")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiReloadGroupRequest struct {
	ctx context.Context
	ApiService *GroupsAPIService
	groupId string
}

func (r ApiReloadGroupRequest) Execute() (*ReloadGroup200Response, *http.Response, error) {
	return r.ApiService.ReloadGroupExecute(r)
}
...
Recompute the content of a group
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param groupId Id of the group
 @return ApiReloadGroupRequest
*/
func (a *GroupsAPIService) ReloadGroup(ctx context.Context, groupId string) ApiReloadGroupRequest {
	return ApiReloadGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *GroupsAPIService) ReloadGroupExecute(r ApiReloadGroupRequest) (*ReloadGroup200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReloadGroup200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsAPIService.ReloadGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/groups/{groupId}/reload"
	localVarPath = strings.Replace(localVarPath, "{"+"groupId"+"}", url.PathEscape(parameterValueToString(r.groupId, "groupId")), -1)
...
type ApiUpdateGroupCategoryRequest struct {
	ctx context.Context
	ApiService *GroupsAPIService
	groupCategoryId string
	groupCategoryUpdate *GroupCategoryUpdate
}

func (r ApiUpdateGroupCategoryRequest) GroupCategoryUpdate(groupCategoryUpdate GroupCategoryUpdate) ApiUpdateGroupCategoryRequest {
	r.groupCategoryUpdate = &groupCategoryUpdate
	return r
}

func (r ApiUpdateGroupCategoryRequest) Execute() (*UpdateGroupCategory200Response, *http.Response, error) {
	return r.ApiService.UpdateGroupCategoryExecute(r)
}
...
Update detailed information about a group category
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param groupCategoryId
 @return ApiUpdateGroupCategoryRequest
*/
func (a *GroupsAPIService) UpdateGroupCategory(ctx context.Context, groupCategoryId string) ApiUpdateGroupCategoryRequest {
	return ApiUpdateGroupCategoryRequest{
		ApiService: a,
		ctx: ctx,
		groupCategoryId: groupCategoryId,
...
func (a *GroupsAPIService) UpdateGroupCategoryExecute(r ApiUpdateGroupCategoryRequest) (*UpdateGroupCategory200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateGroupCategory200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GroupsAPIService.UpdateGroupCategory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.groupCategoryUpdate == nil {
		return localVarReturnValue, nil, reportError("groupCategoryUpdate is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.groupCategoryUpdate
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["API-Tokens"]; ok {
