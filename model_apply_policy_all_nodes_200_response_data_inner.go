...
// checks if the ApplyPolicyAllNodes200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplyPolicyAllNodes200ResponseDataInner{}

// ApplyPolicyAllNodes200ResponseDataInner struct for ApplyPolicyAllNodes200ResponseDataInner
type ApplyPolicyAllNodes200ResponseDataInner struct {
...
func NewApplyPolicyAllNodes200ResponseDataInner() *ApplyPolicyAllNodes200ResponseDataInner {
	this := ApplyPolicyAllNodes200ResponseDataInner{}
	return &this
}
...
func (o ApplyPolicyAllNodes200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o ApplyPolicyAllNodes200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableApplyPolicyAllNodes200ResponseDataInner struct {
	value *ApplyPolicyAllNodes200ResponseDataInner
	isSet bool
}

func (v NullableApplyPolicyAllNodes200ResponseDataInner) Get() *ApplyPolicyAllNodes200ResponseDataInner {
	return v.value
}

func (v *NullableApplyPolicyAllNodes200ResponseDataInner) Set(val *ApplyPolicyAllNodes200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApplyPolicyAllNodes200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApplyPolicyAllNodes200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplyPolicyAllNodes200ResponseDataInner(val *ApplyPolicyAllNodes200ResponseDataInner) *NullableApplyPolicyAllNodes200ResponseDataInner {
	return &NullableApplyPolicyAllNodes200ResponseDataInner{value: val, isSet: true}
}

func (v NullableApplyPolicyAllNodes200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplyPolicyAllNodes200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
