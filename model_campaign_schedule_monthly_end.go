...
// checks if the CampaignScheduleMonthlyEnd type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleMonthlyEnd{}

// CampaignScheduleMonthlyEnd Date when the campaign should end
type CampaignScheduleMonthlyEnd struct {
...
func NewCampaignScheduleMonthlyEnd() *CampaignScheduleMonthlyEnd {
	this := CampaignScheduleMonthlyEnd{}
	return &this
}
...
func (o CampaignScheduleMonthlyEnd) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleMonthlyEnd) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleMonthlyEnd struct {
	value *CampaignScheduleMonthlyEnd
	isSet bool
}

func (v NullableCampaignScheduleMonthlyEnd) Get() *CampaignScheduleMonthlyEnd {
	return v.value
}

func (v *NullableCampaignScheduleMonthlyEnd) Set(val *CampaignScheduleMonthlyEnd) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleMonthlyEnd) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleMonthlyEnd) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleMonthlyEnd(val *CampaignScheduleMonthlyEnd) *NullableCampaignScheduleMonthlyEnd {
	return &NullableCampaignScheduleMonthlyEnd{value: val, isSet: true}
}

func (v NullableCampaignScheduleMonthlyEnd) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleMonthlyEnd) UnmarshalJSON(src []byte) error {
	v.isSet = true
