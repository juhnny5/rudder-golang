...
// checks if the CampaignScheduleOneshot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleOneshot{}

// CampaignScheduleOneshot struct for CampaignScheduleOneshot
type CampaignScheduleOneshot struct {
	// Date when the campaign should start
	Start *string `json:"start,omitempty"`
	// Date when the campaign should end
...
func (o CampaignScheduleOneshot) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleOneshot) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleOneshot struct {
	value *CampaignScheduleOneshot
	isSet bool
}

func (v NullableCampaignScheduleOneshot) Get() *CampaignScheduleOneshot {
	return v.value
}

func (v *NullableCampaignScheduleOneshot) Set(val *CampaignScheduleOneshot) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleOneshot) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleOneshot) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleOneshot(val *CampaignScheduleOneshot) *NullableCampaignScheduleOneshot {
	return &NullableCampaignScheduleOneshot{value: val, isSet: true}
}

func (v NullableCampaignScheduleOneshot) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleOneshot) UnmarshalJSON(src []byte) error {
	v.isSet = true
