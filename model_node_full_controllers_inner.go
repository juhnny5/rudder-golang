...
// checks if the NodeFullControllersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullControllersInner{}

// NodeFullControllersInner struct for NodeFullControllersInner
type NodeFullControllersInner struct {
	// Controller name
...
func (o NodeFullControllersInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullControllersInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullControllersInner struct {
	value *NodeFullControllersInner
	isSet bool
}

func (v NullableNodeFullControllersInner) Get() *NodeFullControllersInner {
	return v.value
}

func (v *NullableNodeFullControllersInner) Set(val *NodeFullControllersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullControllersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullControllersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullControllersInner(val *NodeFullControllersInner) *NullableNodeFullControllersInner {
	return &NullableNodeFullControllersInner{value: val, isSet: true}
}

func (v NullableNodeFullControllersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullControllersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
