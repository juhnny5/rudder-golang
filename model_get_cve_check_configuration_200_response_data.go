...
// checks if the GetCVECheckConfiguration200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCVECheckConfiguration200ResponseData{}

// GetCVECheckConfiguration200ResponseData struct for GetCVECheckConfiguration200ResponseData
type GetCVECheckConfiguration200ResponseData struct {
...
func NewGetCVECheckConfiguration200ResponseData() *GetCVECheckConfiguration200ResponseData {
	this := GetCVECheckConfiguration200ResponseData{}
	return &this
}
...
func (o GetCVECheckConfiguration200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetCVECheckConfiguration200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGetCVECheckConfiguration200ResponseData struct {
	value *GetCVECheckConfiguration200ResponseData
	isSet bool
}

func (v NullableGetCVECheckConfiguration200ResponseData) Get() *GetCVECheckConfiguration200ResponseData {
	return v.value
}

func (v *NullableGetCVECheckConfiguration200ResponseData) Set(val *GetCVECheckConfiguration200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCVECheckConfiguration200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCVECheckConfiguration200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCVECheckConfiguration200ResponseData(val *GetCVECheckConfiguration200ResponseData) *NullableGetCVECheckConfiguration200ResponseData {
	return &NullableGetCVECheckConfiguration200ResponseData{value: val, isSet: true}
}

func (v NullableGetCVECheckConfiguration200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCVECheckConfiguration200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
