...
// checks if the TechniquesResourcesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniquesResourcesInner{}

// TechniquesResourcesInner struct for TechniquesResourcesInner
type TechniquesResourcesInner struct {
	// Resource's name
...
func (o TechniquesResourcesInner) MarshalJSON() ([]byte, error) {
...
func (o TechniquesResourcesInner) ToMap() (map[string]interface{}, error) {
...
type NullableTechniquesResourcesInner struct {
	value *TechniquesResourcesInner
	isSet bool
}

func (v NullableTechniquesResourcesInner) Get() *TechniquesResourcesInner {
	return v.value
}

func (v *NullableTechniquesResourcesInner) Set(val *TechniquesResourcesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniquesResourcesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniquesResourcesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniquesResourcesInner(val *TechniquesResourcesInner) *NullableTechniquesResourcesInner {
	return &NullableTechniquesResourcesInner{value: val, isSet: true}
}

func (v NullableTechniquesResourcesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniquesResourcesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
