...
// checks if the DeleteRuleCategory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteRuleCategory200Response{}

// DeleteRuleCategory200Response struct for DeleteRuleCategory200Response
type DeleteRuleCategory200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data DeleteRuleCategory200ResponseData `json:"data"`
}

type _DeleteRuleCategory200Response DeleteRuleCategory200Response
...
func NewDeleteRuleCategory200Response(result string, action string, data DeleteRuleCategory200ResponseData) *DeleteRuleCategory200Response {
	this := DeleteRuleCategory200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *DeleteRuleCategory200Response) GetData() DeleteRuleCategory200ResponseData {
	if o == nil {
		var ret DeleteRuleCategory200ResponseData
		return ret
	}
...
func (o DeleteRuleCategory200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteRuleCategory200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteRuleCategory200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteRuleCategory200Response := _DeleteRuleCategory200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteRuleCategory200Response)

	if err != nil {
		return err
	}

	*o = DeleteRuleCategory200Response(varDeleteRuleCategory200Response)

	return err
}

type NullableDeleteRuleCategory200Response struct {
	value *DeleteRuleCategory200Response
	isSet bool
}

func (v NullableDeleteRuleCategory200Response) Get() *DeleteRuleCategory200Response {
	return v.value
}

func (v *NullableDeleteRuleCategory200Response) Set(val *DeleteRuleCategory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteRuleCategory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteRuleCategory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteRuleCategory200Response(val *DeleteRuleCategory200Response) *NullableDeleteRuleCategory200Response {
	return &NullableDeleteRuleCategory200Response{value: val, isSet: true}
}

func (v NullableDeleteRuleCategory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteRuleCategory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
