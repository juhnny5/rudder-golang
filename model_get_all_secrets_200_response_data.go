...
// checks if the GetAllSecrets200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllSecrets200ResponseData{}

// GetAllSecrets200ResponseData struct for GetAllSecrets200ResponseData
type GetAllSecrets200ResponseData struct {
	// List of API version and status
	Secrets []GetAllSecrets200ResponseDataSecretsInner `json:"secrets"`
}

type _GetAllSecrets200ResponseData GetAllSecrets200ResponseData
...
func NewGetAllSecrets200ResponseData(secrets []GetAllSecrets200ResponseDataSecretsInner) *GetAllSecrets200ResponseData {
	this := GetAllSecrets200ResponseData{}
...
func (o *GetAllSecrets200ResponseData) GetSecrets() []GetAllSecrets200ResponseDataSecretsInner {
	if o == nil {
		var ret []GetAllSecrets200ResponseDataSecretsInner
		return ret
	}
...
func (o GetAllSecrets200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetAllSecrets200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["secrets"] = o.Secrets
	return toSerialize, nil
}

func (o *GetAllSecrets200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllSecrets200ResponseData := _GetAllSecrets200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllSecrets200ResponseData)

	if err != nil {
		return err
	}

	*o = GetAllSecrets200ResponseData(varGetAllSecrets200ResponseData)

	return err
}

type NullableGetAllSecrets200ResponseData struct {
	value *GetAllSecrets200ResponseData
	isSet bool
}

func (v NullableGetAllSecrets200ResponseData) Get() *GetAllSecrets200ResponseData {
	return v.value
}

func (v *NullableGetAllSecrets200ResponseData) Set(val *GetAllSecrets200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllSecrets200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllSecrets200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllSecrets200ResponseData(val *GetAllSecrets200ResponseData) *NullableGetAllSecrets200ResponseData {
	return &NullableGetAllSecrets200ResponseData{value: val, isSet: true}
}

func (v NullableGetAllSecrets200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllSecrets200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
