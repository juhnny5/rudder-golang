...
// checks if the TechniqueMethodCall type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueMethodCall{}

// TechniqueMethodCall struct for TechniqueMethodCall
type TechniqueMethodCall struct {
	...
	Parameters []TechniqueMethodCallParametersInner `json:"parameters,omitempty"`
}
...
// GetDisableReporting returns the DisableReporting field value if set, zero value otherwise.
func (o *TechniqueMethodCall) GetDisableReporting() bool {
	if o == nil || IsNil(o.DisableReporting) {
		var ret bool
		return ret
	}
...
// GetDisableReportingOk returns a tuple with the DisableReporting field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TechniqueMethodCall) GetDisableReportingOk() (*bool, bool) {
	if o == nil || IsNil(o.DisableReporting) {
		return nil, false
	}
	return o.DisableReporting, true
}
...
// SetDisableReporting gets a reference to the given bool and assigns it to the DisableReporting field.
func (o *TechniqueMethodCall) SetDisableReporting(v bool) {
	o.DisableReporting = &v
}

// GetParameters returns the Parameters field value if set, zero value otherwise.
func (o *TechniqueMethodCall) GetParameters() []TechniqueMethodCallParametersInner {
	if o == nil || IsNil(o.Parameters) {
		var ret []TechniqueMethodCallParametersInner
		return ret
	}
	return o.Parameters
}
...
// SetParameters gets a reference to the given []TechniqueMethodCallParametersInner and assigns it to the Parameters field.
func (o *TechniqueMethodCall) SetParameters(v []TechniqueMethodCallParametersInner) {
	o.Parameters = v
}

func (o TechniqueMethodCall) MarshalJSON() ([]byte, error) {
...
func (o TechniqueMethodCall) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DisableReporting) {
		toSerialize["disableReporting"] = o.DisableReporting
	}
...
type NullableTechniqueMethodCall struct {
	value *TechniqueMethodCall
	isSet bool
}

func (v NullableTechniqueMethodCall) Get() *TechniqueMethodCall {
	return v.value
}

func (v *NullableTechniqueMethodCall) Set(val *TechniqueMethodCall) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueMethodCall) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueMethodCall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueMethodCall(val *TechniqueMethodCall) *NullableTechniqueMethodCall {
	return &NullableTechniqueMethodCall{value: val, isSet: true}
}

func (v NullableTechniqueMethodCall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueMethodCall) UnmarshalJSON(src []byte) error {
	v.isSet = true
