...
// checks if the ChangePendingNodeStatus200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangePendingNodeStatus200Response{}

// ChangePendingNodeStatus200Response struct for ChangePendingNodeStatus200Response
type ChangePendingNodeStatus200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ChangePendingNodeStatus200ResponseData `json:"data"`
}

type _ChangePendingNodeStatus200Response ChangePendingNodeStatus200Response
...
func NewChangePendingNodeStatus200Response(result string, action string, data ChangePendingNodeStatus200ResponseData) *ChangePendingNodeStatus200Response {
	this := ChangePendingNodeStatus200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ChangePendingNodeStatus200Response) GetData() ChangePendingNodeStatus200ResponseData {
	if o == nil {
		var ret ChangePendingNodeStatus200ResponseData
		return ret
	}
...
func (o ChangePendingNodeStatus200Response) MarshalJSON() ([]byte, error) {
...
func (o ChangePendingNodeStatus200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ChangePendingNodeStatus200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varChangePendingNodeStatus200Response := _ChangePendingNodeStatus200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChangePendingNodeStatus200Response)

	if err != nil {
		return err
	}

	*o = ChangePendingNodeStatus200Response(varChangePendingNodeStatus200Response)

	return err
}

type NullableChangePendingNodeStatus200Response struct {
	value *ChangePendingNodeStatus200Response
	isSet bool
}

func (v NullableChangePendingNodeStatus200Response) Get() *ChangePendingNodeStatus200Response {
	return v.value
}

func (v *NullableChangePendingNodeStatus200Response) Set(val *ChangePendingNodeStatus200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableChangePendingNodeStatus200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableChangePendingNodeStatus200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangePendingNodeStatus200Response(val *ChangePendingNodeStatus200Response) *NullableChangePendingNodeStatus200Response {
	return &NullableChangePendingNodeStatus200Response{value: val, isSet: true}
}

func (v NullableChangePendingNodeStatus200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangePendingNodeStatus200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
