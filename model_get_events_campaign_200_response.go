...
// checks if the GetEventsCampaign200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEventsCampaign200Response{}

// GetEventsCampaign200Response struct for GetEventsCampaign200Response
type GetEventsCampaign200Response struct {
...
type _GetEventsCampaign200Response GetEventsCampaign200Response
...
func NewGetEventsCampaign200Response(result string, action string, data GetAllCampaignEvents200ResponseData) *GetEventsCampaign200Response {
	this := GetEventsCampaign200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o GetEventsCampaign200Response) MarshalJSON() ([]byte, error) {
...
func (o GetEventsCampaign200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetEventsCampaign200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEventsCampaign200Response := _GetEventsCampaign200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEventsCampaign200Response)

	if err != nil {
		return err
	}

	*o = GetEventsCampaign200Response(varGetEventsCampaign200Response)

	return err
}

type NullableGetEventsCampaign200Response struct {
	value *GetEventsCampaign200Response
	isSet bool
}

func (v NullableGetEventsCampaign200Response) Get() *GetEventsCampaign200Response {
	return v.value
}

func (v *NullableGetEventsCampaign200Response) Set(val *GetEventsCampaign200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEventsCampaign200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEventsCampaign200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEventsCampaign200Response(val *GetEventsCampaign200Response) *NullableGetEventsCampaign200Response {
	return &NullableGetEventsCampaign200Response{value: val, isSet: true}
}

func (v NullableGetEventsCampaign200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEventsCampaign200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
