...
// checks if the CampaignEventDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEventDetails{}

// CampaignEventDetails struct for CampaignEventDetails
...
func (o *CampaignEventDetails) GetStatus() CampaignEventDetailsStatus {
	if o == nil || IsNil(o.Status) {
		var ret CampaignEventDetailsStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CampaignEventDetailsStatus and assigns it to the Status field.
...
func (o CampaignEventDetails) MarshalJSON() ([]byte, error) {
...
func (o CampaignEventDetails) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignEventDetails struct {
	value *CampaignEventDetails
	isSet bool
}

func (v NullableCampaignEventDetails) Get() *CampaignEventDetails {
	return v.value
}

func (v *NullableCampaignEventDetails) Set(val *CampaignEventDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignEventDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignEventDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignEventDetails(val *CampaignEventDetails) *NullableCampaignEventDetails {
	return &NullableCampaignEventDetails{value: val, isSet: true}
}

func (v NullableCampaignEventDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignEventDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
