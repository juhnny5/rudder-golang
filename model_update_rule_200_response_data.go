...
// checks if the UpdateRule200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateRule200ResponseData{}

// UpdateRule200ResponseData struct for UpdateRule200ResponseData
type UpdateRule200ResponseData struct {
	Rules []RuleWithCategory `json:"rules"`
}

type _UpdateRule200ResponseData UpdateRule200ResponseData
...
func NewUpdateRule200ResponseData(rules []RuleWithCategory) *UpdateRule200ResponseData {
	this := UpdateRule200ResponseData{}
	this.Rules = rules
	return &this
}
...
func (o UpdateRule200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o UpdateRule200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["rules"] = o.Rules
	return toSerialize, nil
}

func (o *UpdateRule200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateRule200ResponseData := _UpdateRule200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateRule200ResponseData)

	if err != nil {
		return err
	}

	*o = UpdateRule200ResponseData(varUpdateRule200ResponseData)

	return err
}

type NullableUpdateRule200ResponseData struct {
	value *UpdateRule200ResponseData
	isSet bool
}

func (v NullableUpdateRule200ResponseData) Get() *UpdateRule200ResponseData {
	return v.value
}

func (v *NullableUpdateRule200ResponseData) Set(val *UpdateRule200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRule200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRule200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRule200ResponseData(val *UpdateRule200ResponseData) *NullableUpdateRule200ResponseData {
	return &NullableUpdateRule200ResponseData{value: val, isSet: true}
}

func (v NullableUpdateRule200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRule200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
