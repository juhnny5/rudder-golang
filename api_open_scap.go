...
// OpenSCAPAPIService OpenSCAPAPI service
type OpenSCAPAPIService service

type ApiOpenscapReportRequest struct {
	ctx context.Context
	ApiService *OpenSCAPAPIService
	nodeId string
}

func (r ApiOpenscapReportRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.OpenscapReportExecute(r)
}
...
Get latest OpenSCAP report for the given node
 ...
 @return ApiOpenscapReportRequest
*/
func (a *OpenSCAPAPIService) OpenscapReport(ctx context.Context, nodeId string) ApiOpenscapReportRequest {
	return ApiOpenscapReportRequest{
		ApiService: a,
		ctx: ctx,
		nodeId: nodeId,
...
//  @return string
func (a *OpenSCAPAPIService) OpenscapReportExecute(r ApiOpenscapReportRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OpenSCAPAPIService.OpenscapReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/openscap/report/{nodeId}"
