...
// checks if the TechniqueCategories200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechniqueCategories200Response{}

// TechniqueCategories200Response struct for TechniqueCategories200Response
type TechniqueCategories200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data TechniqueCategories200ResponseData `json:"data"`
}

type _TechniqueCategories200Response TechniqueCategories200Response
...
func NewTechniqueCategories200Response(result string, action string, data TechniqueCategories200ResponseData) *TechniqueCategories200Response {
	this := TechniqueCategories200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *TechniqueCategories200Response) GetData() TechniqueCategories200ResponseData {
	if o == nil {
		var ret TechniqueCategories200ResponseData
		return ret
	}
...
func (o TechniqueCategories200Response) MarshalJSON() ([]byte, error) {
...
func (o TechniqueCategories200Response) ToMap() (map[string]interface{}, error) {
...
func (o *TechniqueCategories200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varTechniqueCategories200Response := _TechniqueCategories200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTechniqueCategories200Response)

	if err != nil {
		return err
	}

	*o = TechniqueCategories200Response(varTechniqueCategories200Response)

	return err
}

type NullableTechniqueCategories200Response struct {
	value *TechniqueCategories200Response
	isSet bool
}

func (v NullableTechniqueCategories200Response) Get() *TechniqueCategories200Response {
	return v.value
}

func (v *NullableTechniqueCategories200Response) Set(val *TechniqueCategories200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTechniqueCategories200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTechniqueCategories200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechniqueCategories200Response(val *TechniqueCategories200Response) *NullableTechniqueCategories200Response {
	return &NullableTechniqueCategories200Response{value: val, isSet: true}
}

func (v NullableTechniqueCategories200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechniqueCategories200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
