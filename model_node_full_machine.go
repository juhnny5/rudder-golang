...
// checks if the NodeFullMachine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullMachine{}
...
func (o NodeFullMachine) MarshalJSON() ([]byte, error) {
...
func (o NodeFullMachine) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullMachine struct {
	value *NodeFullMachine
	isSet bool
}

func (v NullableNodeFullMachine) Get() *NodeFullMachine {
	return v.value
}

func (v *NullableNodeFullMachine) Set(val *NodeFullMachine) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullMachine) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullMachine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullMachine(val *NodeFullMachine) *NullableNodeFullMachine {
	return &NullableNodeFullMachine{value: val, isSet: true}
}

func (v NullableNodeFullMachine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullMachine) UnmarshalJSON(src []byte) error {
	v.isSet = true
