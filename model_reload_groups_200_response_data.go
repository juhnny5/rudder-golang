...
// checks if the ReloadGroups200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadGroups200ResponseData{}

// ReloadGroups200ResponseData struct for ReloadGroups200ResponseData
type ReloadGroups200ResponseData struct {
	Groups string `json:"groups"`
}

type _ReloadGroups200ResponseData ReloadGroups200ResponseData
...
func NewReloadGroups200ResponseData(groups string) *ReloadGroups200ResponseData {
	this := ReloadGroups200ResponseData{}
	this.Groups = groups
	return &this
}
...
func (o ReloadGroups200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ReloadGroups200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["groups"] = o.Groups
	return toSerialize, nil
}

func (o *ReloadGroups200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadGroups200ResponseData := _ReloadGroups200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadGroups200ResponseData)

	if err != nil {
		return err
	}

	*o = ReloadGroups200ResponseData(varReloadGroups200ResponseData)

	return err
}

type NullableReloadGroups200ResponseData struct {
	value *ReloadGroups200ResponseData
	isSet bool
}

func (v NullableReloadGroups200ResponseData) Get() *ReloadGroups200ResponseData {
	return v.value
}

func (v *NullableReloadGroups200ResponseData) Set(val *ReloadGroups200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadGroups200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadGroups200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadGroups200ResponseData(val *ReloadGroups200ResponseData) *NullableReloadGroups200ResponseData {
	return &NullableReloadGroups200ResponseData{value: val, isSet: true}
}

func (v NullableReloadGroups200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadGroups200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
