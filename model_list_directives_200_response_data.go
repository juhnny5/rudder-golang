...
// checks if the ListDirectives200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDirectives200ResponseData{}

// ListDirectives200ResponseData struct for ListDirectives200ResponseData
type ListDirectives200ResponseData struct {
	Directives []Directive `json:"directives"`
}

type _ListDirectives200ResponseData ListDirectives200ResponseData
...
func NewListDirectives200ResponseData(directives []Directive) *ListDirectives200ResponseData {
	this := ListDirectives200ResponseData{}
...
func (o ListDirectives200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ListDirectives200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["directives"] = o.Directives
	return toSerialize, nil
}

func (o *ListDirectives200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varListDirectives200ResponseData := _ListDirectives200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListDirectives200ResponseData)

	if err != nil {
		return err
	}

	*o = ListDirectives200ResponseData(varListDirectives200ResponseData)

	return err
}

type NullableListDirectives200ResponseData struct {
	value *ListDirectives200ResponseData
	isSet bool
}

func (v NullableListDirectives200ResponseData) Get() *ListDirectives200ResponseData {
	return v.value
}

func (v *NullableListDirectives200ResponseData) Set(val *ListDirectives200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListDirectives200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListDirectives200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDirectives200ResponseData(val *ListDirectives200ResponseData) *NullableListDirectives200ResponseData {
	return &NullableListDirectives200ResponseData{value: val, isSet: true}
}

func (v NullableListDirectives200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDirectives200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
