...
// checks if the CreateArchive200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateArchive200Response{}

// CreateArchive200Response struct for CreateArchive200Response
type CreateArchive200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The kind of the archive
	Action string `json:"action"`
	Data CreateArchive200ResponseData `json:"data"`
}

type _CreateArchive200Response CreateArchive200Response
...
func (o *CreateArchive200Response) GetData() CreateArchive200ResponseData {
	if o == nil {
		var ret CreateArchive200ResponseData
		return ret
	}
...
func (o CreateArchive200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateArchive200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateArchive200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateArchive200Response := _CreateArchive200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateArchive200Response)

	if err != nil {
		return err
	}

	*o = CreateArchive200Response(varCreateArchive200Response)

	return err
}

type NullableCreateArchive200Response struct {
	value *CreateArchive200Response
	isSet bool
}

func (v NullableCreateArchive200Response) Get() *CreateArchive200Response {
	return v.value
}

func (v *NullableCreateArchive200Response) Set(val *CreateArchive200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateArchive200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateArchive200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateArchive200Response(val *CreateArchive200Response) *NullableCreateArchive200Response {
	return &NullableCreateArchive200Response{value: val, isSet: true}
}

func (v NullableCreateArchive200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateArchive200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
