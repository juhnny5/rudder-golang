...
// checks if the ParameterDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParameterDetails200Response{}

// ParameterDetails200Response struct for ParameterDetails200Response
type ParameterDetails200Response struct {
	// Id of the property
	Id string `json:"id"`
	...
	Data ListParameters200ResponseData `json:"data"`
}

type _ParameterDetails200Response ParameterDetails200Response
...
func NewParameterDetails200Response(id string, result string, action string, data ListParameters200ResponseData) *ParameterDetails200Response {
	this := ParameterDetails200Response{}
	this.Id = id
	this.Result = result
	this.Action = action
	this.Data = data
...
func (o *ParameterDetails200Response) GetData() ListParameters200ResponseData {
	if o == nil {
		var ret ListParameters200ResponseData
		return ret
	}
...
func (o ParameterDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o ParameterDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ParameterDetails200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varParameterDetails200Response := _ParameterDetails200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varParameterDetails200Response)

	if err != nil {
		return err
	}

	*o = ParameterDetails200Response(varParameterDetails200Response)

	return err
}

type NullableParameterDetails200Response struct {
	value *ParameterDetails200Response
	isSet bool
}

func (v NullableParameterDetails200Response) Get() *ParameterDetails200Response {
	return v.value
}

func (v *NullableParameterDetails200Response) Set(val *ParameterDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableParameterDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableParameterDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParameterDetails200Response(val *ParameterDetails200Response) *NullableParameterDetails200Response {
	return &NullableParameterDetails200Response{value: val, isSet: true}
}

func (v NullableParameterDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParameterDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
