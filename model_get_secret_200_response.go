...
// checks if the GetSecret200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSecret200Response{}

// GetSecret200Response struct for GetSecret200Response
type GetSecret200Response struct {
...
type _GetSecret200Response GetSecret200Response
...
func (o GetSecret200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSecret200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetSecret200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSecret200Response := _GetSecret200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetSecret200Response)

	if err != nil {
		return err
	}

	*o = GetSecret200Response(varGetSecret200Response)

	return err
}

type NullableGetSecret200Response struct {
	value *GetSecret200Response
	isSet bool
}

func (v NullableGetSecret200Response) Get() *GetSecret200Response {
	return v.value
}

func (v *NullableGetSecret200Response) Set(val *GetSecret200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSecret200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSecret200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSecret200Response(val *GetSecret200Response) *NullableGetSecret200Response {
	return &NullableGetSecret200Response{value: val, isSet: true}
}

func (v NullableGetSecret200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSecret200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
