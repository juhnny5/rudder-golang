...
// checks if the CreateDirective200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDirective200Response{}

// CreateDirective200Response struct for CreateDirective200Response
type CreateDirective200Response struct {
...
type _CreateDirective200Response CreateDirective200Response
...
func NewCreateDirective200Response(result string, action string, data ListDirectives200ResponseData) *CreateDirective200Response {
	this := CreateDirective200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o CreateDirective200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateDirective200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateDirective200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateDirective200Response := _CreateDirective200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateDirective200Response)

	if err != nil {
		return err
	}

	*o = CreateDirective200Response(varCreateDirective200Response)

	return err
}

type NullableCreateDirective200Response struct {
	value *CreateDirective200Response
	isSet bool
}

func (v NullableCreateDirective200Response) Get() *CreateDirective200Response {
	return v.value
}

func (v *NullableCreateDirective200Response) Set(val *CreateDirective200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDirective200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDirective200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDirective200Response(val *CreateDirective200Response) *NullableCreateDirective200Response {
	return &NullableCreateDirective200Response{value: val, isSet: true}
}

func (v NullableCreateDirective200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDirective200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
