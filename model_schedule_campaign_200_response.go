...
// checks if the ScheduleCampaign200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleCampaign200Response{}

// ScheduleCampaign200Response struct for ScheduleCampaign200Response
type ScheduleCampaign200Response struct {
...
type _ScheduleCampaign200Response ScheduleCampaign200Response
...
func NewScheduleCampaign200Response(result string, action string, data GetAllCampaignEvents200ResponseData) *ScheduleCampaign200Response {
	this := ScheduleCampaign200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ScheduleCampaign200Response) MarshalJSON() ([]byte, error) {
...
func (o ScheduleCampaign200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleCampaign200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleCampaign200Response := _ScheduleCampaign200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleCampaign200Response)

	if err != nil {
		return err
	}

	*o = ScheduleCampaign200Response(varScheduleCampaign200Response)

	return err
}

type NullableScheduleCampaign200Response struct {
	value *ScheduleCampaign200Response
	isSet bool
}

func (v NullableScheduleCampaign200Response) Get() *ScheduleCampaign200Response {
	return v.value
}

func (v *NullableScheduleCampaign200Response) Set(val *ScheduleCampaign200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleCampaign200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleCampaign200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleCampaign200Response(val *ScheduleCampaign200Response) *NullableScheduleCampaign200Response {
	return &NullableScheduleCampaign200Response{value: val, isSet: true}
}

func (v NullableScheduleCampaign200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleCampaign200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
