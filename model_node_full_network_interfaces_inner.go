...
// checks if the NodeFullNetworkInterfacesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullNetworkInterfacesInner{}

// NodeFullNetworkInterfacesInner struct for NodeFullNetworkInterfacesInner
type NodeFullNetworkInterfacesInner struct {
...
func NewNodeFullNetworkInterfacesInner() *NodeFullNetworkInterfacesInner {
	this := NodeFullNetworkInterfacesInner{}
	return &this
}
...
func (o NodeFullNetworkInterfacesInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullNetworkInterfacesInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullNetworkInterfacesInner struct {
	value *NodeFullNetworkInterfacesInner
	isSet bool
}

func (v NullableNodeFullNetworkInterfacesInner) Get() *NodeFullNetworkInterfacesInner {
	return v.value
}

func (v *NullableNodeFullNetworkInterfacesInner) Set(val *NodeFullNetworkInterfacesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullNetworkInterfacesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullNetworkInterfacesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullNetworkInterfacesInner(val *NodeFullNetworkInterfacesInner) *NullableNodeFullNetworkInterfacesInner {
	return &NullableNodeFullNetworkInterfacesInner{value: val, isSet: true}
}

func (v NullableNodeFullNetworkInterfacesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullNetworkInterfacesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
