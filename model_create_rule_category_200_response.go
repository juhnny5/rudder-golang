...
// checks if the CreateRuleCategory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRuleCategory200Response{}

// CreateRuleCategory200Response struct for CreateRuleCategory200Response
type CreateRuleCategory200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data CreateRuleCategory200ResponseData `json:"data"`
}

type _CreateRuleCategory200Response CreateRuleCategory200Response
...
func NewCreateRuleCategory200Response(result string, action string, data CreateRuleCategory200ResponseData) *CreateRuleCategory200Response {
	this := CreateRuleCategory200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *CreateRuleCategory200Response) GetData() CreateRuleCategory200ResponseData {
	if o == nil {
		var ret CreateRuleCategory200ResponseData
		return ret
	}
...
func (o CreateRuleCategory200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateRuleCategory200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateRuleCategory200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateRuleCategory200Response := _CreateRuleCategory200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateRuleCategory200Response)

	if err != nil {
		return err
	}

	*o = CreateRuleCategory200Response(varCreateRuleCategory200Response)

	return err
}

type NullableCreateRuleCategory200Response struct {
	value *CreateRuleCategory200Response
	isSet bool
}

func (v NullableCreateRuleCategory200Response) Get() *CreateRuleCategory200Response {
	return v.value
}

func (v *NullableCreateRuleCategory200Response) Set(val *CreateRuleCategory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRuleCategory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRuleCategory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRuleCategory200Response(val *CreateRuleCategory200Response) *NullableCreateRuleCategory200Response {
	return &NullableCreateRuleCategory200Response{value: val, isSet: true}
}

func (v NullableCreateRuleCategory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRuleCategory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
