...
// checks if the AgentKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentKey{}
...
func (o AgentKey) ToMap() (map[string]interface{}, error) {
...
func (o *AgentKey) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAgentKey)
