...
// checks if the RuleComplianceComponentComponentsInnerValuesInnerReportsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleComplianceComponentComponentsInnerValuesInnerReportsInner{}

// RuleComplianceComponentComponentsInnerValuesInnerReportsInner struct for RuleComplianceComponentComponentsInnerValuesInnerReportsInner
type RuleComplianceComponentComponentsInnerValuesInnerReportsInner struct {
	Status string `json:"status"`
	Message string `json:"message"`
}

type _RuleComplianceComponentComponentsInnerValuesInnerReportsInner RuleComplianceComponentComponentsInnerValuesInnerReportsInner
...
func NewRuleComplianceComponentComponentsInnerValuesInnerReportsInner(status string, message string) *RuleComplianceComponentComponentsInnerValuesInnerReportsInner {
	this := RuleComplianceComponentComponentsInnerValuesInnerReportsInner{}
	this.Status = status
...
func (o RuleComplianceComponentComponentsInnerValuesInnerReportsInner) MarshalJSON() ([]byte, error) {
...
func (o RuleComplianceComponentComponentsInnerValuesInnerReportsInner) ToMap() (map[string]interface{}, error) {
...
func (o *RuleComplianceComponentComponentsInnerValuesInnerReportsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleComplianceComponentComponentsInnerValuesInnerReportsInner := _RuleComplianceComponentComponentsInnerValuesInnerReportsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRuleComplianceComponentComponentsInnerValuesInnerReportsInner)

	if err != nil {
		return err
	}

	*o = RuleComplianceComponentComponentsInnerValuesInnerReportsInner(varRuleComplianceComponentComponentsInnerValuesInnerReportsInner)

	return err
}

type NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner struct {
	value *RuleComplianceComponentComponentsInnerValuesInnerReportsInner
	isSet bool
}

func (v NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner) Get() *RuleComplianceComponentComponentsInnerValuesInnerReportsInner {
	return v.value
}

func (v *NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner) Set(val *RuleComplianceComponentComponentsInnerValuesInnerReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner(val *RuleComplianceComponentComponentsInnerValuesInnerReportsInner) *NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner {
	return &NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner{value: val, isSet: true}
}

func (v NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleComplianceComponentComponentsInnerValuesInnerReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
