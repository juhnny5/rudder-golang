...
// checks if the CreateParameter200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateParameter200Response{}

// CreateParameter200Response struct for CreateParameter200Response
type CreateParameter200Response struct {
	// Id of the property
	Id string `json:"id"`
...
type _CreateParameter200Response CreateParameter200Response
...
func NewCreateParameter200Response(id string, result string, action string, data ListParameters200ResponseData) *CreateParameter200Response {
	this := CreateParameter200Response{}
	this.Id = id
	this.Result = result
	this.Action = action
	this.Data = data
...
func (o CreateParameter200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateParameter200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateParameter200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateParameter200Response := _CreateParameter200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateParameter200Response)

	if err != nil {
		return err
	}

	*o = CreateParameter200Response(varCreateParameter200Response)

	return err
}

type NullableCreateParameter200Response struct {
	value *CreateParameter200Response
	isSet bool
}

func (v NullableCreateParameter200Response) Get() *CreateParameter200Response {
	return v.value
}

func (v *NullableCreateParameter200Response) Set(val *CreateParameter200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateParameter200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateParameter200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateParameter200Response(val *CreateParameter200Response) *NullableCreateParameter200Response {
	return &NullableCreateParameter200Response{value: val, isSet: true}
}

func (v NullableCreateParameter200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateParameter200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
