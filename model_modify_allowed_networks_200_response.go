...
// checks if the ModifyAllowedNetworks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyAllowedNetworks200Response{}

// ModifyAllowedNetworks200Response struct for ModifyAllowedNetworks200Response
type ModifyAllowedNetworks200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ModifyAllowedNetworks200ResponseData `json:"data"`
}

type _ModifyAllowedNetworks200Response ModifyAllowedNetworks200Response
...
func NewModifyAllowedNetworks200Response(result string, action string, data ModifyAllowedNetworks200ResponseData) *ModifyAllowedNetworks200Response {
	this := ModifyAllowedNetworks200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ModifyAllowedNetworks200Response) GetData() ModifyAllowedNetworks200ResponseData {
	if o == nil {
		var ret ModifyAllowedNetworks200ResponseData
		return ret
	}
...
func (o ModifyAllowedNetworks200Response) MarshalJSON() ([]byte, error) {
...
func (o ModifyAllowedNetworks200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ModifyAllowedNetworks200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varModifyAllowedNetworks200Response := _ModifyAllowedNetworks200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModifyAllowedNetworks200Response)

	if err != nil {
		return err
	}

	*o = ModifyAllowedNetworks200Response(varModifyAllowedNetworks200Response)

	return err
}

type NullableModifyAllowedNetworks200Response struct {
	value *ModifyAllowedNetworks200Response
	isSet bool
}

func (v NullableModifyAllowedNetworks200Response) Get() *ModifyAllowedNetworks200Response {
	return v.value
}

func (v *NullableModifyAllowedNetworks200Response) Set(val *ModifyAllowedNetworks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyAllowedNetworks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyAllowedNetworks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyAllowedNetworks200Response(val *ModifyAllowedNetworks200Response) *NullableModifyAllowedNetworks200Response {
	return &NullableModifyAllowedNetworks200Response{value: val, isSet: true}
}

func (v NullableModifyAllowedNetworks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyAllowedNetworks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
