...
// checks if the DatasourceTypeParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasourceTypeParameters{}
...
type DatasourceTypeParameters struct {
	...
	Headers []DatasourceTypeParametersHeadersInner `json:"headers,omitempty"`
...
func (o *DatasourceTypeParameters) GetHeaders() []DatasourceTypeParametersHeadersInner {
	if o == nil || IsNil(o.Headers) {
		var ret []DatasourceTypeParametersHeadersInner
		return ret
	}
	return o.Headers
}
...
// SetHeaders gets a reference to the given []DatasourceTypeParametersHeadersInner and assigns it to the Headers field.
...
// GetCheckSsl returns the CheckSsl field value if set, zero value otherwise.
func (o *DatasourceTypeParameters) GetCheckSsl() bool {
	if o == nil || IsNil(o.CheckSsl) {
		var ret bool
		return ret
	}
	return *o.CheckSsl
...
// GetCheckSslOk returns a tuple with the CheckSsl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DatasourceTypeParameters) GetCheckSslOk() (*bool, bool) {
	if o == nil || IsNil(o.CheckSsl) {
		return nil, false
	}
	return o.CheckSsl, true
}
...
// SetCheckSsl gets a reference to the given bool and assigns it to the CheckSsl field.
...
// GetRequestMode returns the RequestMode field value if set, zero value otherwise.
func (o *DatasourceTypeParameters) GetRequestMode() DatasourceTypeParametersRequestMode {
	if o == nil || IsNil(o.RequestMode) {
		var ret DatasourceTypeParametersRequestMode
		return ret
	}
	return *o.RequestMode
}

// GetRequestModeOk returns a tuple with the RequestMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DatasourceTypeParameters) GetRequestModeOk() (*DatasourceTypeParametersRequestMode, bool) {
	if o == nil || IsNil(o.RequestMode) {
		return nil, false
	}
	return o.RequestMode, true
}
...
// SetRequestMode gets a reference to the given DatasourceTypeParametersRequestMode and assigns it to the RequestMode field.
func (o *DatasourceTypeParameters) SetRequestMode(v DatasourceTypeParametersRequestMode) {
	o.RequestMode = &v
}

func (o DatasourceTypeParameters) MarshalJSON() ([]byte, error) {
...
func (o DatasourceTypeParameters) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CheckSsl) {
		toSerialize["checkSsl"] = o.CheckSsl
	}
	if !IsNil(o.RequestTimeout) {
		toSerialize["requestTimeout"] = o.RequestTimeout
	}
	if !IsNil(o.RequestMode) {
		toSerialize["requestMode"] = o.RequestMode
	}
	return toSerialize, nil
}

type NullableDatasourceTypeParameters struct {
	value *DatasourceTypeParameters
	isSet bool
}

func (v NullableDatasourceTypeParameters) Get() *DatasourceTypeParameters {
	return v.value
}

func (v *NullableDatasourceTypeParameters) Set(val *DatasourceTypeParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasourceTypeParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasourceTypeParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasourceTypeParameters(val *DatasourceTypeParameters) *NullableDatasourceTypeParameters {
	return &NullableDatasourceTypeParameters{value: val, isSet: true}
}

func (v NullableDatasourceTypeParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasourceTypeParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
