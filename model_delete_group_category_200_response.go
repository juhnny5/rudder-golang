...
// checks if the DeleteGroupCategory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteGroupCategory200Response{}

// DeleteGroupCategory200Response struct for DeleteGroupCategory200Response
type DeleteGroupCategory200Response struct {
...
type _DeleteGroupCategory200Response DeleteGroupCategory200Response
...
func NewDeleteGroupCategory200Response(result string, action string, data CreateGroupCategory200ResponseData) *DeleteGroupCategory200Response {
	this := DeleteGroupCategory200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o DeleteGroupCategory200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteGroupCategory200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteGroupCategory200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteGroupCategory200Response := _DeleteGroupCategory200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteGroupCategory200Response)

	if err != nil {
		return err
	}

	*o = DeleteGroupCategory200Response(varDeleteGroupCategory200Response)

	return err
}

type NullableDeleteGroupCategory200Response struct {
	value *DeleteGroupCategory200Response
	isSet bool
}

func (v NullableDeleteGroupCategory200Response) Get() *DeleteGroupCategory200Response {
	return v.value
}

func (v *NullableDeleteGroupCategory200Response) Set(val *DeleteGroupCategory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteGroupCategory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteGroupCategory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteGroupCategory200Response(val *DeleteGroupCategory200Response) *NullableDeleteGroupCategory200Response {
	return &NullableDeleteGroupCategory200Response{value: val, isSet: true}
}

func (v NullableDeleteGroupCategory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteGroupCategory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
