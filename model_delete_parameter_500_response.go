...
// checks if the DeleteParameter500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteParameter500Response{}

// DeleteParameter500Response struct for DeleteParameter500Response
type DeleteParameter500Response struct {
...
type _DeleteParameter500Response DeleteParameter500Response
...
func NewDeleteParameter500Response(id string, result string, action string) *DeleteParameter500Response {
	this := DeleteParameter500Response{}
	this.Id = id
	this.Result = result
	this.Action = action
	return &this
...
func (o DeleteParameter500Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteParameter500Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteParameter500Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteParameter500Response := _DeleteParameter500Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteParameter500Response)

	if err != nil {
		return err
	}

	*o = DeleteParameter500Response(varDeleteParameter500Response)

	return err
}

type NullableDeleteParameter500Response struct {
	value *DeleteParameter500Response
	isSet bool
}

func (v NullableDeleteParameter500Response) Get() *DeleteParameter500Response {
	return v.value
}

func (v *NullableDeleteParameter500Response) Set(val *DeleteParameter500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteParameter500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteParameter500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteParameter500Response(val *DeleteParameter500Response) *NullableDeleteParameter500Response {
	return &NullableDeleteParameter500Response{value: val, isSet: true}
}

func (v NullableDeleteParameter500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteParameter500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
