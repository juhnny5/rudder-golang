...
// checks if the GetCampaignResults200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCampaignResults200Response{}

// GetCampaignResults200Response struct for GetCampaignResults200Response
type GetCampaignResults200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetCampaignResults200ResponseData `json:"data"`
}

type _GetCampaignResults200Response GetCampaignResults200Response
...
func NewGetCampaignResults200Response(result string, action string, data GetCampaignResults200ResponseData) *GetCampaignResults200Response {
	this := GetCampaignResults200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetCampaignResults200Response) GetData() GetCampaignResults200ResponseData {
	if o == nil {
		var ret GetCampaignResults200ResponseData
		return ret
	}
...
func (o GetCampaignResults200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCampaignResults200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetCampaignResults200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCampaignResults200Response := _GetCampaignResults200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCampaignResults200Response)

	if err != nil {
		return err
	}

	*o = GetCampaignResults200Response(varGetCampaignResults200Response)

	return err
}

type NullableGetCampaignResults200Response struct {
	value *GetCampaignResults200Response
	isSet bool
}

func (v NullableGetCampaignResults200Response) Get() *GetCampaignResults200Response {
	return v.value
}

func (v *NullableGetCampaignResults200Response) Set(val *GetCampaignResults200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCampaignResults200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCampaignResults200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCampaignResults200Response(val *GetCampaignResults200Response) *NullableGetCampaignResults200Response {
	return &NullableGetCampaignResults200Response{value: val, isSet: true}
}

func (v NullableGetCampaignResults200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCampaignResults200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
