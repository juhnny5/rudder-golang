...
// checks if the CreateTechnique200ResponseDataTechniques type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTechnique200ResponseDataTechniques{}

// CreateTechnique200ResponseDataTechniques struct for CreateTechnique200ResponseDataTechniques
type CreateTechnique200ResponseDataTechniques struct {
	Technique EditorTechnique `json:"technique"`
}

type _CreateTechnique200ResponseDataTechniques CreateTechnique200ResponseDataTechniques
...
func NewCreateTechnique200ResponseDataTechniques(technique EditorTechnique) *CreateTechnique200ResponseDataTechniques {
	this := CreateTechnique200ResponseDataTechniques{}
...
func (o CreateTechnique200ResponseDataTechniques) MarshalJSON() ([]byte, error) {
...
func (o CreateTechnique200ResponseDataTechniques) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["technique"] = o.Technique
	return toSerialize, nil
}

func (o *CreateTechnique200ResponseDataTechniques) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTechnique200ResponseDataTechniques := _CreateTechnique200ResponseDataTechniques{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTechnique200ResponseDataTechniques)

	if err != nil {
		return err
	}

	*o = CreateTechnique200ResponseDataTechniques(varCreateTechnique200ResponseDataTechniques)

	return err
}

type NullableCreateTechnique200ResponseDataTechniques struct {
	value *CreateTechnique200ResponseDataTechniques
	isSet bool
}

func (v NullableCreateTechnique200ResponseDataTechniques) Get() *CreateTechnique200ResponseDataTechniques {
	return v.value
}

func (v *NullableCreateTechnique200ResponseDataTechniques) Set(val *CreateTechnique200ResponseDataTechniques) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTechnique200ResponseDataTechniques) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTechnique200ResponseDataTechniques) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTechnique200ResponseDataTechniques(val *CreateTechnique200ResponseDataTechniques) *NullableCreateTechnique200ResponseDataTechniques {
	return &NullableCreateTechnique200ResponseDataTechniques{value: val, isSet: true}
}

func (v NullableCreateTechnique200ResponseDataTechniques) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTechnique200ResponseDataTechniques) UnmarshalJSON(src []byte) error {
	v.isSet = true
