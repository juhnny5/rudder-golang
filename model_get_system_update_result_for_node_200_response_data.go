...
// checks if the GetSystemUpdateResultForNode200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSystemUpdateResultForNode200ResponseData{}

// GetSystemUpdateResultForNode200ResponseData struct for GetSystemUpdateResultForNode200ResponseData
type GetSystemUpdateResultForNode200ResponseData struct {
	Noderesult []CampaignEventNodeResult `json:"noderesult,omitempty"`
}
...
func NewGetSystemUpdateResultForNode200ResponseData() *GetSystemUpdateResultForNode200ResponseData {
	this := GetSystemUpdateResultForNode200ResponseData{}
	return &this
}
...
// GetNoderesult returns the Noderesult field value if set, zero value otherwise.
func (o *GetSystemUpdateResultForNode200ResponseData) GetNoderesult() []CampaignEventNodeResult {
	if o == nil || IsNil(o.Noderesult) {
		var ret []CampaignEventNodeResult
		return ret
	}
	return o.Noderesult
}

// GetNoderesultOk returns a tuple with the Noderesult field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetSystemUpdateResultForNode200ResponseData) GetNoderesultOk() ([]CampaignEventNodeResult, bool) {
	if o == nil || IsNil(o.Noderesult) {
		return nil, false
	}
	return o.Noderesult, true
}
...
// SetNoderesult gets a reference to the given []CampaignEventNodeResult and assigns it to the Noderesult field.
func (o *GetSystemUpdateResultForNode200ResponseData) SetNoderesult(v []CampaignEventNodeResult) {
	o.Noderesult = v
}

func (o GetSystemUpdateResultForNode200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetSystemUpdateResultForNode200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Noderesult) {
		toSerialize["noderesult"] = o.Noderesult
	}
	return toSerialize, nil
}

type NullableGetSystemUpdateResultForNode200ResponseData struct {
	value *GetSystemUpdateResultForNode200ResponseData
	isSet bool
}

func (v NullableGetSystemUpdateResultForNode200ResponseData) Get() *GetSystemUpdateResultForNode200ResponseData {
	return v.value
}

func (v *NullableGetSystemUpdateResultForNode200ResponseData) Set(val *GetSystemUpdateResultForNode200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSystemUpdateResultForNode200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSystemUpdateResultForNode200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSystemUpdateResultForNode200ResponseData(val *GetSystemUpdateResultForNode200ResponseData) *NullableGetSystemUpdateResultForNode200ResponseData {
	return &NullableGetSystemUpdateResultForNode200ResponseData{value: val, isSet: true}
}

func (v NullableGetSystemUpdateResultForNode200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSystemUpdateResultForNode200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
