...
// checks if the CampaignDetailsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignDetailsInfo{}

// CampaignDetailsInfo common data about campaign
type CampaignDetailsInfo struct {
	// Campaign id
	...
	Status *CampaignDetailsInfoStatus `json:"status,omitempty"`
	Schedule *CampaignDetailsInfoSchedule `json:"schedule,omitempty"`
}
...
func (o *CampaignDetailsInfo) GetStatus() CampaignDetailsInfoStatus {
	if o == nil || IsNil(o.Status) {
		var ret CampaignDetailsInfoStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CampaignDetailsInfoStatus and assigns it to the Status field.
...
func (o *CampaignDetailsInfo) GetSchedule() CampaignDetailsInfoSchedule {
	if o == nil || IsNil(o.Schedule) {
		var ret CampaignDetailsInfoSchedule
		return ret
	}
	return *o.Schedule
}
...
// SetSchedule gets a reference to the given CampaignDetailsInfoSchedule and assigns it to the Schedule field.
func (o *CampaignDetailsInfo) SetSchedule(v CampaignDetailsInfoSchedule) {
	o.Schedule = &v
}

func (o CampaignDetailsInfo) MarshalJSON() ([]byte, error) {
...
func (o CampaignDetailsInfo) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignDetailsInfo struct {
	value *CampaignDetailsInfo
	isSet bool
}

func (v NullableCampaignDetailsInfo) Get() *CampaignDetailsInfo {
	return v.value
}

func (v *NullableCampaignDetailsInfo) Set(val *CampaignDetailsInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignDetailsInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignDetailsInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignDetailsInfo(val *CampaignDetailsInfo) *NullableCampaignDetailsInfo {
	return &NullableCampaignDetailsInfo{value: val, isSet: true}
}

func (v NullableCampaignDetailsInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignDetailsInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
