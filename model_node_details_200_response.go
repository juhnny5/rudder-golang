...
// checks if the NodeDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeDetails200Response{}

// NodeDetails200Response struct for NodeDetails200Response
type NodeDetails200Response struct {
...
type _NodeDetails200Response NodeDetails200Response
...
func (o NodeDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o NodeDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *NodeDetails200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeDetails200Response := _NodeDetails200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeDetails200Response)

	if err != nil {
		return err
	}

	*o = NodeDetails200Response(varNodeDetails200Response)

	return err
}

type NullableNodeDetails200Response struct {
	value *NodeDetails200Response
	isSet bool
}

func (v NullableNodeDetails200Response) Get() *NodeDetails200Response {
	return v.value
}

func (v *NullableNodeDetails200Response) Set(val *NodeDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeDetails200Response(val *NodeDetails200Response) *NullableNodeDetails200Response {
	return &NullableNodeDetails200Response{value: val, isSet: true}
}

func (v NullableNodeDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
