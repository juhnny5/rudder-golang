...
// checks if the GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails{}

// GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails struct for GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails
type GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails struct {
...
func NewGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails() *GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails {
	this := GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) GetErrorOk() (*float32, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
// and a boolean to check if the value has been set.
func (o *GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) GetSuccessRepairedOk() (*float32, bool) {
	if o == nil || IsNil(o.SuccessRepaired) {
		return nil, false
	}
...
func (o GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) MarshalJSON() ([]byte, error) {
...
func (o GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) ToMap() (map[string]interface{}, error) {
...
type NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails struct {
	value *GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails
	isSet bool
}

func (v NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) Get() *GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails {
	return v.value
}

func (v *NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) Set(val *GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails(val *GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) *NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails {
	return &NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails{value: val, isSet: true}
}

func (v NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
