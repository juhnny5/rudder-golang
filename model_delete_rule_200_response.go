...
// checks if the DeleteRule200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteRule200Response{}

// DeleteRule200Response struct for DeleteRule200Response
type DeleteRule200Response struct {
...
type _DeleteRule200Response DeleteRule200Response
...
func (o DeleteRule200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteRule200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteRule200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteRule200Response := _DeleteRule200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteRule200Response)

	if err != nil {
		return err
	}

	*o = DeleteRule200Response(varDeleteRule200Response)

	return err
}

type NullableDeleteRule200Response struct {
	value *DeleteRule200Response
	isSet bool
}

func (v NullableDeleteRule200Response) Get() *DeleteRule200Response {
	return v.value
}

func (v *NullableDeleteRule200Response) Set(val *DeleteRule200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteRule200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteRule200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteRule200Response(val *DeleteRule200Response) *NullableDeleteRule200Response {
	return &NullableDeleteRule200Response{value: val, isSet: true}
}

func (v NullableDeleteRule200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteRule200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
