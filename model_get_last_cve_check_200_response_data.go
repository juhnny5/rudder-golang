...
// checks if the GetLastCVECheck200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLastCVECheck200ResponseData{}

// GetLastCVECheck200ResponseData struct for GetLastCVECheck200ResponseData
type GetLastCVECheck200ResponseData struct {
	CVEChecks []CveCheck `json:"CVEChecks"`
}

type _GetLastCVECheck200ResponseData GetLastCVECheck200ResponseData
...
func NewGetLastCVECheck200ResponseData(cVEChecks []CveCheck) *GetLastCVECheck200ResponseData {
	this := GetLastCVECheck200ResponseData{}
...
// GetCVEChecks returns the CVEChecks field value
...
// GetCVEChecksOk returns a tuple with the CVEChecks field value
// and a boolean to check if the value has been set.
func (o *GetLastCVECheck200ResponseData) GetCVEChecksOk() ([]CveCheck, bool) {
	if o == nil {
		return nil, false
	}
	return o.CVEChecks, true
}

// SetCVEChecks sets field value
func (o *GetLastCVECheck200ResponseData) SetCVEChecks(v []CveCheck) {
	o.CVEChecks = v
}

func (o GetLastCVECheck200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetLastCVECheck200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["CVEChecks"] = o.CVEChecks
	return toSerialize, nil
}

func (o *GetLastCVECheck200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetLastCVECheck200ResponseData := _GetLastCVECheck200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetLastCVECheck200ResponseData)

	if err != nil {
		return err
	}

	*o = GetLastCVECheck200ResponseData(varGetLastCVECheck200ResponseData)

	return err
}

type NullableGetLastCVECheck200ResponseData struct {
	value *GetLastCVECheck200ResponseData
	isSet bool
}

func (v NullableGetLastCVECheck200ResponseData) Get() *GetLastCVECheck200ResponseData {
	return v.value
}

func (v *NullableGetLastCVECheck200ResponseData) Set(val *GetLastCVECheck200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLastCVECheck200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLastCVECheck200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLastCVECheck200ResponseData(val *GetLastCVECheck200ResponseData) *NullableGetLastCVECheck200ResponseData {
	return &NullableGetLastCVECheck200ResponseData{value: val, isSet: true}
}

func (v NullableGetLastCVECheck200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLastCVECheck200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
