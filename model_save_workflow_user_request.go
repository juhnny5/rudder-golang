...
// checks if the SaveWorkflowUserRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveWorkflowUserRequest{}

// SaveWorkflowUserRequest struct for SaveWorkflowUserRequest
type SaveWorkflowUserRequest struct {
	// list of user to put in validated list
	ValidatedUsers []string `json:"validatedUsers"`
}

type _SaveWorkflowUserRequest SaveWorkflowUserRequest
...
// GetValidatedUsers returns the ValidatedUsers field value
...
// GetValidatedUsersOk returns a tuple with the ValidatedUsers field value
// and a boolean to check if the value has been set.
func (o *SaveWorkflowUserRequest) GetValidatedUsersOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.ValidatedUsers, true
}

// SetValidatedUsers sets field value
func (o *SaveWorkflowUserRequest) SetValidatedUsers(v []string) {
	o.ValidatedUsers = v
}

func (o SaveWorkflowUserRequest) MarshalJSON() ([]byte, error) {
...
func (o SaveWorkflowUserRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["validatedUsers"] = o.ValidatedUsers
	return toSerialize, nil
}

func (o *SaveWorkflowUserRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSaveWorkflowUserRequest := _SaveWorkflowUserRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSaveWorkflowUserRequest)

	if err != nil {
		return err
	}

	*o = SaveWorkflowUserRequest(varSaveWorkflowUserRequest)

	return err
}

type NullableSaveWorkflowUserRequest struct {
	value *SaveWorkflowUserRequest
	isSet bool
}

func (v NullableSaveWorkflowUserRequest) Get() *SaveWorkflowUserRequest {
	return v.value
}

func (v *NullableSaveWorkflowUserRequest) Set(val *SaveWorkflowUserRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveWorkflowUserRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveWorkflowUserRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveWorkflowUserRequest(val *SaveWorkflowUserRequest) *NullableSaveWorkflowUserRequest {
	return &NullableSaveWorkflowUserRequest{value: val, isSet: true}
}

func (v NullableSaveWorkflowUserRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveWorkflowUserRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
