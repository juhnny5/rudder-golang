...
// checks if the GetAllCve200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllCve200ResponseData{}

// GetAllCve200ResponseData struct for GetAllCve200ResponseData
type GetAllCve200ResponseData struct {
	CVEs []CveDetails `json:"CVEs"`
}

type _GetAllCve200ResponseData GetAllCve200ResponseData
...
func (o GetAllCve200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetAllCve200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["CVEs"] = o.CVEs
	return toSerialize, nil
}

func (o *GetAllCve200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllCve200ResponseData := _GetAllCve200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllCve200ResponseData)

	if err != nil {
		return err
	}

	*o = GetAllCve200ResponseData(varGetAllCve200ResponseData)

	return err
}

type NullableGetAllCve200ResponseData struct {
	value *GetAllCve200ResponseData
	isSet bool
}

func (v NullableGetAllCve200ResponseData) Get() *GetAllCve200ResponseData {
	return v.value
}

func (v *NullableGetAllCve200ResponseData) Set(val *GetAllCve200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllCve200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllCve200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllCve200ResponseData(val *GetAllCve200ResponseData) *NullableGetAllCve200ResponseData {
	return &NullableGetAllCve200ResponseData{value: val, isSet: true}
}

func (v NullableGetAllCve200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllCve200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
