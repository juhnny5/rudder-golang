...
// checks if the GetRulesCompliance200ResponseDataRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRulesCompliance200ResponseDataRulesInner{}

// GetRulesCompliance200ResponseDataRulesInner struct for GetRulesCompliance200ResponseDataRulesInner
type GetRulesCompliance200ResponseDataRulesInner struct {
	// id of the rule
	Id string `json:"id"`
...
type _GetRulesCompliance200ResponseDataRulesInner GetRulesCompliance200ResponseDataRulesInner
...
func NewGetRulesCompliance200ResponseDataRulesInner(id string, mode string, compliance float32, complianceDetails GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails) *GetRulesCompliance200ResponseDataRulesInner {
	this := GetRulesCompliance200ResponseDataRulesInner{}
	this.Id = id
	this.Mode = mode
...
func (o GetRulesCompliance200ResponseDataRulesInner) MarshalJSON() ([]byte, error) {
...
func (o GetRulesCompliance200ResponseDataRulesInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetRulesCompliance200ResponseDataRulesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRulesCompliance200ResponseDataRulesInner := _GetRulesCompliance200ResponseDataRulesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRulesCompliance200ResponseDataRulesInner)

	if err != nil {
		return err
	}

	*o = GetRulesCompliance200ResponseDataRulesInner(varGetRulesCompliance200ResponseDataRulesInner)

	return err
}

type NullableGetRulesCompliance200ResponseDataRulesInner struct {
	value *GetRulesCompliance200ResponseDataRulesInner
	isSet bool
}

func (v NullableGetRulesCompliance200ResponseDataRulesInner) Get() *GetRulesCompliance200ResponseDataRulesInner {
	return v.value
}

func (v *NullableGetRulesCompliance200ResponseDataRulesInner) Set(val *GetRulesCompliance200ResponseDataRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRulesCompliance200ResponseDataRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRulesCompliance200ResponseDataRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRulesCompliance200ResponseDataRulesInner(val *GetRulesCompliance200ResponseDataRulesInner) *NullableGetRulesCompliance200ResponseDataRulesInner {
	return &NullableGetRulesCompliance200ResponseDataRulesInner{value: val, isSet: true}
}

func (v NullableGetRulesCompliance200ResponseDataRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRulesCompliance200ResponseDataRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
