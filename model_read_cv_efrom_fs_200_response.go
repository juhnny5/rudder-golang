...
// checks if the ReadCVEfromFS200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReadCVEfromFS200Response{}

// ReadCVEfromFS200Response struct for ReadCVEfromFS200Response
type ReadCVEfromFS200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data UpdateCVE200ResponseData `json:"data"`
}

type _ReadCVEfromFS200Response ReadCVEfromFS200Response
...
func (o *ReadCVEfromFS200Response) GetData() UpdateCVE200ResponseData {
	if o == nil {
		var ret UpdateCVE200ResponseData
		return ret
	}
...
func (o ReadCVEfromFS200Response) MarshalJSON() ([]byte, error) {
...
func (o ReadCVEfromFS200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReadCVEfromFS200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReadCVEfromFS200Response := _ReadCVEfromFS200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReadCVEfromFS200Response)

	if err != nil {
		return err
	}

	*o = ReadCVEfromFS200Response(varReadCVEfromFS200Response)

	return err
}

type NullableReadCVEfromFS200Response struct {
	value *ReadCVEfromFS200Response
	isSet bool
}

func (v NullableReadCVEfromFS200Response) Get() *ReadCVEfromFS200Response {
	return v.value
}

func (v *NullableReadCVEfromFS200Response) Set(val *ReadCVEfromFS200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReadCVEfromFS200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReadCVEfromFS200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadCVEfromFS200Response(val *ReadCVEfromFS200Response) *NullableReadCVEfromFS200Response {
	return &NullableReadCVEfromFS200Response{value: val, isSet: true}
}

func (v NullableReadCVEfromFS200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadCVEfromFS200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
