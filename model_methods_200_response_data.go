...
// checks if the Methods200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Methods200ResponseData{}

// Methods200ResponseData struct for Methods200ResponseData
type Methods200ResponseData struct {
	Methods Methods `json:"methods"`
}

type _Methods200ResponseData Methods200ResponseData
...
func (o Methods200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o Methods200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["methods"] = o.Methods
	return toSerialize, nil
}

func (o *Methods200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varMethods200ResponseData := _Methods200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMethods200ResponseData)

	if err != nil {
		return err
	}

	*o = Methods200ResponseData(varMethods200ResponseData)

	return err
}

type NullableMethods200ResponseData struct {
	value *Methods200ResponseData
	isSet bool
}

func (v NullableMethods200ResponseData) Get() *Methods200ResponseData {
	return v.value
}

func (v *NullableMethods200ResponseData) Set(val *Methods200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableMethods200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableMethods200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMethods200ResponseData(val *Methods200ResponseData) *NullableMethods200ResponseData {
	return &NullableMethods200ResponseData{value: val, isSet: true}
}

func (v NullableMethods200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMethods200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
