...
// checks if the ModifyAllowedNetworksRequestAllowedNetworks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyAllowedNetworksRequestAllowedNetworks{}

// ModifyAllowedNetworksRequestAllowedNetworks struct for ModifyAllowedNetworksRequestAllowedNetworks
type ModifyAllowedNetworksRequestAllowedNetworks struct {
...
func NewModifyAllowedNetworksRequestAllowedNetworks() *ModifyAllowedNetworksRequestAllowedNetworks {
	this := ModifyAllowedNetworksRequestAllowedNetworks{}
	return &this
}
...
func (o ModifyAllowedNetworksRequestAllowedNetworks) MarshalJSON() ([]byte, error) {
...
func (o ModifyAllowedNetworksRequestAllowedNetworks) ToMap() (map[string]interface{}, error) {
...
type NullableModifyAllowedNetworksRequestAllowedNetworks struct {
	value *ModifyAllowedNetworksRequestAllowedNetworks
	isSet bool
}

func (v NullableModifyAllowedNetworksRequestAllowedNetworks) Get() *ModifyAllowedNetworksRequestAllowedNetworks {
	return v.value
}

func (v *NullableModifyAllowedNetworksRequestAllowedNetworks) Set(val *ModifyAllowedNetworksRequestAllowedNetworks) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyAllowedNetworksRequestAllowedNetworks) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyAllowedNetworksRequestAllowedNetworks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyAllowedNetworksRequestAllowedNetworks(val *ModifyAllowedNetworksRequestAllowedNetworks) *NullableModifyAllowedNetworksRequestAllowedNetworks {
	return &NullableModifyAllowedNetworksRequestAllowedNetworks{value: val, isSet: true}
}

func (v NullableModifyAllowedNetworksRequestAllowedNetworks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyAllowedNetworksRequestAllowedNetworks) UnmarshalJSON(src []byte) error {
	v.isSet = true
