...
// checks if the ListPendingNodes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPendingNodes200Response{}

// ListPendingNodes200Response struct for ListPendingNodes200Response
type ListPendingNodes200Response struct {
...
type _ListPendingNodes200Response ListPendingNodes200Response
...
func NewListPendingNodes200Response(result string, action string, data ListAcceptedNodes200ResponseData) *ListPendingNodes200Response {
	this := ListPendingNodes200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ListPendingNodes200Response) MarshalJSON() ([]byte, error) {
...
func (o ListPendingNodes200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListPendingNodes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListPendingNodes200Response := _ListPendingNodes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListPendingNodes200Response)

	if err != nil {
		return err
	}

	*o = ListPendingNodes200Response(varListPendingNodes200Response)

	return err
}

type NullableListPendingNodes200Response struct {
	value *ListPendingNodes200Response
	isSet bool
}

func (v NullableListPendingNodes200Response) Get() *ListPendingNodes200Response {
	return v.value
}

func (v *NullableListPendingNodes200Response) Set(val *ListPendingNodes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListPendingNodes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListPendingNodes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPendingNodes200Response(val *ListPendingNodes200Response) *NullableListPendingNodes200Response {
	return &NullableListPendingNodes200Response{value: val, isSet: true}
}

func (v NullableListPendingNodes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPendingNodes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
