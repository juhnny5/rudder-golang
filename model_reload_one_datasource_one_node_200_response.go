...
// checks if the ReloadOneDatasourceOneNode200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReloadOneDatasourceOneNode200Response{}

// ReloadOneDatasourceOneNode200Response struct for ReloadOneDatasourceOneNode200Response
type ReloadOneDatasourceOneNode200Response struct {
...
type _ReloadOneDatasourceOneNode200Response ReloadOneDatasourceOneNode200Response
...
func NewReloadOneDatasourceOneNode200Response(result string, action string, data string) *ReloadOneDatasourceOneNode200Response {
	this := ReloadOneDatasourceOneNode200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o ReloadOneDatasourceOneNode200Response) MarshalJSON() ([]byte, error) {
...
func (o ReloadOneDatasourceOneNode200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ReloadOneDatasourceOneNode200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varReloadOneDatasourceOneNode200Response := _ReloadOneDatasourceOneNode200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReloadOneDatasourceOneNode200Response)

	if err != nil {
		return err
	}

	*o = ReloadOneDatasourceOneNode200Response(varReloadOneDatasourceOneNode200Response)

	return err
}

type NullableReloadOneDatasourceOneNode200Response struct {
	value *ReloadOneDatasourceOneNode200Response
	isSet bool
}

func (v NullableReloadOneDatasourceOneNode200Response) Get() *ReloadOneDatasourceOneNode200Response {
	return v.value
}

func (v *NullableReloadOneDatasourceOneNode200Response) Set(val *ReloadOneDatasourceOneNode200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReloadOneDatasourceOneNode200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReloadOneDatasourceOneNode200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReloadOneDatasourceOneNode200Response(val *ReloadOneDatasourceOneNode200Response) *NullableReloadOneDatasourceOneNode200Response {
	return &NullableReloadOneDatasourceOneNode200Response{value: val, isSet: true}
}

func (v NullableReloadOneDatasourceOneNode200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReloadOneDatasourceOneNode200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
