...
// checks if the Methods200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Methods200Response{}

// Methods200Response struct for Methods200Response
type Methods200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data Methods200ResponseData `json:"data"`
}

type _Methods200Response Methods200Response
...
func (o *Methods200Response) GetData() Methods200ResponseData {
	if o == nil {
		var ret Methods200ResponseData
		return ret
	}
...
func (o Methods200Response) MarshalJSON() ([]byte, error) {
...
func (o Methods200Response) ToMap() (map[string]interface{}, error) {
...
func (o *Methods200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varMethods200Response := _Methods200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMethods200Response)

	if err != nil {
		return err
	}

	*o = Methods200Response(varMethods200Response)

	return err
}

type NullableMethods200Response struct {
	value *Methods200Response
	isSet bool
}

func (v NullableMethods200Response) Get() *Methods200Response {
	return v.value
}

func (v *NullableMethods200Response) Set(val *Methods200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMethods200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMethods200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMethods200Response(val *Methods200Response) *NullableMethods200Response {
	return &NullableMethods200Response{value: val, isSet: true}
}

func (v NullableMethods200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMethods200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
