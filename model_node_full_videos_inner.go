...
// checks if the NodeFullVideosInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullVideosInner{}

// NodeFullVideosInner struct for NodeFullVideosInner
type NodeFullVideosInner struct {
	// Video card name
...
// GetChipset returns the Chipset field value if set, zero value otherwise.
func (o *NodeFullVideosInner) GetChipset() string {
	if o == nil || IsNil(o.Chipset) {
		var ret string
		return ret
	}
	return *o.Chipset
...
// GetChipsetOk returns a tuple with the Chipset field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeFullVideosInner) GetChipsetOk() (*string, bool) {
	if o == nil || IsNil(o.Chipset) {
		return nil, false
	}
	return o.Chipset, true
}
...
// SetChipset gets a reference to the given string and assigns it to the Chipset field.
...
func (o NodeFullVideosInner) MarshalJSON() ([]byte, error) {
...
func (o NodeFullVideosInner) ToMap() (map[string]interface{}, error) {
...
type NullableNodeFullVideosInner struct {
	value *NodeFullVideosInner
	isSet bool
}

func (v NullableNodeFullVideosInner) Get() *NodeFullVideosInner {
	return v.value
}

func (v *NullableNodeFullVideosInner) Set(val *NodeFullVideosInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullVideosInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullVideosInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullVideosInner(val *NodeFullVideosInner) *NullableNodeFullVideosInner {
	return &NullableNodeFullVideosInner{value: val, isSet: true}
}

func (v NullableNodeFullVideosInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullVideosInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
