...
// checks if the CreateRuleCategory200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateRuleCategory200ResponseData{}

// CreateRuleCategory200ResponseData struct for CreateRuleCategory200ResponseData
type CreateRuleCategory200ResponseData struct {
	RuleCategories []RuleCategory `json:"ruleCategories"`
}

type _CreateRuleCategory200ResponseData CreateRuleCategory200ResponseData
...
func NewCreateRuleCategory200ResponseData(ruleCategories []RuleCategory) *CreateRuleCategory200ResponseData {
	this := CreateRuleCategory200ResponseData{}
...
// GetRuleCategories returns the RuleCategories field value
...
// GetRuleCategoriesOk returns a tuple with the RuleCategories field value
// and a boolean to check if the value has been set.
func (o *CreateRuleCategory200ResponseData) GetRuleCategoriesOk() ([]RuleCategory, bool) {
	if o == nil {
		return nil, false
	}
	return o.RuleCategories, true
}

// SetRuleCategories sets field value
func (o *CreateRuleCategory200ResponseData) SetRuleCategories(v []RuleCategory) {
	o.RuleCategories = v
}

func (o CreateRuleCategory200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CreateRuleCategory200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["ruleCategories"] = o.RuleCategories
	return toSerialize, nil
}

func (o *CreateRuleCategory200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateRuleCategory200ResponseData := _CreateRuleCategory200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateRuleCategory200ResponseData)

	if err != nil {
		return err
	}

	*o = CreateRuleCategory200ResponseData(varCreateRuleCategory200ResponseData)

	return err
}

type NullableCreateRuleCategory200ResponseData struct {
	value *CreateRuleCategory200ResponseData
	isSet bool
}

func (v NullableCreateRuleCategory200ResponseData) Get() *CreateRuleCategory200ResponseData {
	return v.value
}

func (v *NullableCreateRuleCategory200ResponseData) Set(val *CreateRuleCategory200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRuleCategory200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRuleCategory200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRuleCategory200ResponseData(val *CreateRuleCategory200ResponseData) *NullableCreateRuleCategory200ResponseData {
	return &NullableCreateRuleCategory200ResponseData{value: val, isSet: true}
}

func (v NullableCreateRuleCategory200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRuleCategory200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
