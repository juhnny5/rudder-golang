...
// checks if the ApiVersionAllInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiVersionAllInner{}

// ApiVersionAllInner struct for ApiVersionAllInner
type ApiVersionAllInner struct {
	// API Version
...
type _ApiVersionAllInner ApiVersionAllInner
...
func (o ApiVersionAllInner) MarshalJSON() ([]byte, error) {
...
func (o ApiVersionAllInner) ToMap() (map[string]interface{}, error) {
...
func (o *ApiVersionAllInner) UnmarshalJSON(data []byte) (err error) {
	...
	varApiVersionAllInner := _ApiVersionAllInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiVersionAllInner)

	if err != nil {
		return err
	}

	*o = ApiVersionAllInner(varApiVersionAllInner)

	return err
}

type NullableApiVersionAllInner struct {
	value *ApiVersionAllInner
	isSet bool
}

func (v NullableApiVersionAllInner) Get() *ApiVersionAllInner {
	return v.value
}

func (v *NullableApiVersionAllInner) Set(val *ApiVersionAllInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiVersionAllInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiVersionAllInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiVersionAllInner(val *ApiVersionAllInner) *NullableApiVersionAllInner {
	return &NullableApiVersionAllInner{value: val, isSet: true}
}

func (v NullableApiVersionAllInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiVersionAllInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
