...
// checks if the DeleteTechnique200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteTechnique200ResponseData{}

// DeleteTechnique200ResponseData struct for DeleteTechnique200ResponseData
type DeleteTechnique200ResponseData struct {
	Techniques *DeleteTechnique200ResponseDataTechniques `json:"techniques,omitempty"`
}
...
func NewDeleteTechnique200ResponseData() *DeleteTechnique200ResponseData {
	this := DeleteTechnique200ResponseData{}
	return &this
}
...
func (o *DeleteTechnique200ResponseData) GetTechniques() DeleteTechnique200ResponseDataTechniques {
	if o == nil || IsNil(o.Techniques) {
		var ret DeleteTechnique200ResponseDataTechniques
		return ret
	}
	return *o.Techniques
}
...
// SetTechniques gets a reference to the given DeleteTechnique200ResponseDataTechniques and assigns it to the Techniques field.
func (o *DeleteTechnique200ResponseData) SetTechniques(v DeleteTechnique200ResponseDataTechniques) {
	o.Techniques = &v
}

func (o DeleteTechnique200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o DeleteTechnique200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteTechnique200ResponseData struct {
	value *DeleteTechnique200ResponseData
	isSet bool
}

func (v NullableDeleteTechnique200ResponseData) Get() *DeleteTechnique200ResponseData {
	return v.value
}

func (v *NullableDeleteTechnique200ResponseData) Set(val *DeleteTechnique200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteTechnique200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteTechnique200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteTechnique200ResponseData(val *DeleteTechnique200ResponseData) *NullableDeleteTechnique200ResponseData {
	return &NullableDeleteTechnique200ResponseData{value: val, isSet: true}
}

func (v NullableDeleteTechnique200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteTechnique200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
